...
//go:wasmexport good7
func good7(*H) {} // pointer to struct with HostLayout is allowed

//go:wasmexport good8
func good8(*[4]int32, *[2]H) {} // pointer to array is allowed, if the element type is okay

//go:wasmexport toomanyresults
func toomanyresults() (int32, int32) { return 0, 0 } // ERROR "go:wasmexport: too many return values"

//go:wasmexport bad9
func bad9() string { return "" } // ERROR "go:wasmexport: unsupported result type" // string cannot be a result
