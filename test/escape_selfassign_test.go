// test -v -gcflags=-l escape_selfassign.go
...
func TestCallInputFunctions(t *testing.T) {
	tests := []struct {
		...
		{name: "f A", f: func() { var p S; pp := &p; f(pp) }},
		{name: "f B", f: func() { var p S; pp := &p; esc(pp); f(pp) }},
		{name: "g A", f: func() { var p S; pp := &p; g(pp) }},
		{name: "g B", f: func() { var p S; pp := &p; esc(pp); g(pp) }},
		{name: "h", f: func() { h() }},
	}
