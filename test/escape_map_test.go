// test -v -gcflags=-l escape_map.go
...
func TestCallInputFunctions(t *testing.T) {
	tests := []struct {
		...
		{name: "map0", f: func() { map0() }},
		{name: "map1", f: func() { map1() }},
		{name: "map2", f: func() { map2() }},
		{name: "map3", f: func() { map3() }},
		{name: "map4", f: func() { map4() }},
		{name: "map5 A", f: func() { m := make(map[*int]*int, 10); map5(m) }},
		{name: "map5 B", f: func() { m := make(map[*int]*int, 10); esc(m); map5(m) }},
		{name: "map6 A", f: func() { m := make(map[*int]*int, 10); map6(m) }},
		{name: "map6 B", f: func() { m := make(map[*int]*int, 10); esc(m); map6(m) }},
		{name: "map7", f: func() { map7() }},
		{name: "map8", f: func() { map8() }},
		{name: "map9", f: func() { map9() }},
	}
