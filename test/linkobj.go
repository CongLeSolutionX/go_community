...
func main() {
	...
	for round := 0; round < 2; round++ {
		...
		run("go", "tool", "compile", pkg, "-l", "-o", "p1."+o, "-linkobj", "p1.lo", "p1.go")
		run("go", "tool", "compile", pkg, "-l", "-o", "p2."+o, "-linkobj", "p2.lo", "p2.go")
		run("go", "tool", "compile", pkg, "-l", "-o", "p3."+o, "-linkobj", "p3.lo", "p3.go")
		...
		run("go", "tool", "link", "-o", "a.out.exe", "p3."+o)
		out = run("./a.out.exe")
