...
func load_byte8_uint64_idx(s []byte, idx int) uint64 {
	// arm64:`MOVD\s\(R[0-9]+\)\(R[0-9]+<<3\)`,-`ORR\tR[0-9]+<<[0-9]+`
...
func zero_byte_idx_2(b []byte, idx int) {
	// arm64: `MOVH\sZR,\s\(R[0-9]+\)\(R[0-9]+<<1\)`,-`ORR\sR[0-9]+<<8`
	b[(idx<<1)+0] = 0
	b[(idx<<1)+1] = 0
}

func zero_byte_idx_4(b []byte, idx int) {
	// arm64: `MOVW\sZR,\s\(R[0-9]+\)\(R[0-9]+<<2\)`,-`ORR\sR[0-9]+<<[0-9]+`
	b[(idx<<2)+0] = 0
	b[(idx<<2)+1] = 0
	b[(idx<<2)+2] = 0
	b[(idx<<2)+3] = 0
...
func zero_byte_idx_8(b []byte, idx int) {
	// arm64: `MOVD\sZR,\s\(R[0-9]+\)\(R[0-9]+<<3\)`,-`ORR\sR[0-9]+<<[0-9]+`
	b[(idx<<3)+0] = 0
	b[(idx<<3)+1] = 0
	b[(idx<<3)+2] = 0
	b[(idx<<3)+3] = 0
