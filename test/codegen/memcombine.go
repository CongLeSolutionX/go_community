...
func load_be_byte4_uint32_idx_inv(s []byte, idx int) uint32 {
	// arm64:`MOVWU\s\(R[0-9]+\)\(R[0-9]+\)`,`REVW`,-`ORR`,-`MOV[BH]`,-`REV16W`
	return uint32(s[idx+3]) | uint32(s[idx+2])<<8 | uint32(s[idx+1])<<16 | uint32(s[idx])<<24
}
...
func load_be_byte8_uint64_idx_inv(s []byte, idx int) uint64 {
	// arm64:`MOVD\s\(R[0-9]+\)\(R[0-9]+\)`,`REV`,-`ORR`,-`MOV[BHW]`,-`REVW`,-`REV16W`
	return uint64(s[idx+7]) | uint64(s[idx+6])<<8 | uint64(s[idx+5])<<16 | uint64(s[idx+4])<<24 | uint64(s[idx+3])<<32 | uint64(s[idx+2])<<40 | uint64(s[idx+1])<<48 | uint64(s[idx])<<56
}
...
func load_be_byte4_uint32_idx4_inv(s []byte, idx int) uint32 {
	// arm64:`MOVWU\s\(R[0-9]+\)\(R[0-9]+<<2\)`,`REVW`,-`ORR`,-`MOV[BH]`,-`REV16W`
	return uint32(s[(idx<<2)+3]) | uint32(s[(idx<<2)+2])<<8 | uint32(s[(idx<<2)+1])<<16 | uint32(s[idx<<2])<<24
}
...
func load_be_byte8_uint64_idx8_inv(s []byte, idx int) uint64 {
	// arm64:`MOVD\s\(R[0-9]+\)\(R[0-9]+<<3\)`,`REV`,-`ORR`,-`MOV[BHW]`,-`REVW`,-`REV16W`
	return uint64(s[(idx<<3)+7]) | uint64(s[(idx<<3)+6])<<8 | uint64(s[(idx<<3)+5])<<16 | uint64(s[(idx<<3)+4])<<24 | uint64(s[(idx<<3)+3])<<32 | uint64(s[(idx<<3)+2])<<40 | uint64(s[(idx<<3)+1])<<48 | uint64(s[idx<<3])<<56
}
