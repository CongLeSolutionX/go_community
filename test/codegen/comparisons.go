...
// var + const
// 'x-const' might be canonicalized to 'x+(-const)' in opt phase, so no need to
// check -`SUB` here, and better to check both CMP and CMN for subtraction expressions.
