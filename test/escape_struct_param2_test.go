// test -v -gcflags=-l escape_struct_param2.go
...
func TestCallInputFunctions(t *testing.T) {
	tests := []struct {
		...
		{name: "tSPPi", f: func() { tSPPi() }},
		{name: "tiSPP", f: func() { tiSPP() }},
		{name: "tSP", f: func() { tSP() }},
		{name: "tUPiSPa", f: func() { tUPiSPa() }},
		{name: "tUPiSPb", f: func() { tUPiSPb() }},
		{name: "tUPiSPc", f: func() { tUPiSPc() }},
		{name: "tUPiSPd", f: func() { tUPiSPd() }},
		{name: "tUPiSPPia", f: func() { tUPiSPPia() }},
		{name: "tUPiSPPib", f: func() { tUPiSPPib() }},
		{name: "tUPiSPPic", f: func() { tUPiSPPic() }},
		{name: "tUPiSPPid", f: func() { tUPiSPPid() }},
		{name: "tUPPiSPPia", f: func() { tUPPiSPPia() }},
	}
