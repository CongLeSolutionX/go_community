...
func caller0b() {
	...
	sink = param0(&i) // ERROR "&i escapes to heap$"
}
...
func caller9b() {
	...
	p := &i            // ERROR "&i escapes to heap$" "moved to heap: p$"
	p2 := &p           // ERROR "&p escapes to heap$"
	sink = param9(&p2) // ERROR "caller9b &p2 does not escape$"
}
...
func caller10b() {
	...
	p := &i             // ERROR "&i escapes to heap$" "moved to heap: p$"
	p2 := &p            // ERROR "&p escapes to heap$"
	sink = param10(&p2) // ERROR "caller10b &p2 does not escape$"
}
...
func caller11b() {
	i := 0             // ERROR "moved to heap: i$"
	p := &i            // ERROR "&i escapes to heap$" "moved to heap: p$"
	sink = param11(&p) // ERROR "&p escapes to heap$"
}
