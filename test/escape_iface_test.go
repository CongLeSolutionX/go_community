// test -v -gcflags=-l escape_iface.go
...
func TestCallInputFunctions(t *testing.T) {
	tests := []struct {
		...
		{name: "mescapes A", f: func() { var m M; mescapes(m) }},
		{name: "mescapes B", f: func() { var m M; esc(m); mescapes(m) }},
		{name: "mdoesnotescape A", f: func() { var m M; mdoesnotescape(m) }},
		{name: "mdoesnotescape B", f: func() { var m M; esc(m); mdoesnotescape(m) }},
		{name: "efaceEscape0", f: func() { efaceEscape0() }},
		{name: "efaceEscape1", f: func() { efaceEscape1() }},
		{name: "efaceEscape2", f: func() { efaceEscape2() }},
		{name: "dotTypeEscape", f: func() { dotTypeEscape() }},
		{name: "dotTypeEscape2", f: func() { dotTypeEscape2() }},
		{name: "issue42279", allowPanic: true, f: func() { issue42279() }},
	}
