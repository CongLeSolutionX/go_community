...
func main() {
	{
		...
		if x := func() int { // ERROR "can inline main.func2"
			return 1
...

	{
		...
		if y := func(x int) int { // ERROR "can inline main.func4"
			return x + 2
...

	{
		...
		if y := func() int { // ERROR "can inline main.func21"
			return x
...

	{
		...
		if z := func(y int) int { // ERROR "can inline main.func23"
