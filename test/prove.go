...
func bitLen32(x uint32, ensureBothBranchesCouldHappen bool) int {
	...
	if ensureBothBranchesCouldHappen {
		if sz-6 <= y && y <= sz-3 { // ERROR "Proved Leq32$"
			return -42
		}
	} else {
		if y < sz-6 || sz-3 < y { // ERROR "Disproved Less32$"
			return 1337
		}
	}
	return y
...
func bitLen16(x uint16, ensureBothBranchesCouldHappen bool) int {
	...
	if ensureBothBranchesCouldHappen {
		if sz-6 <= y && y <= sz-3 { // ERROR "Proved Leq16$"
			return -42
		}
	} else {
		if y < sz-6 || sz-3 < y { // ERROR "Disproved Less16$"
			return 1337
		}
	}
	return y
...
func bitLen8(x uint8, ensureBothBranchesCouldHappen bool) int {
	...
	if ensureBothBranchesCouldHappen {
		if sz-6 <= y && y <= sz-3 { // ERROR "Proved Leq8$"
			return -42
		}
	} else {
		if y < sz-6 || sz-3 < y { // ERROR "Disproved Less8$"
			return 1337
		}
	}
	return y
