...
func InMyCode(x *Imported, y *HasAMethod, z *other.Exported) {
	...
	(*x).Do()
	x.Dont()    // ERROR "x\.Dont undefined \(pointer type \*Imported has no field or method Dont, and interface Imported also lacks method Dont\)"
	...
	z.Dont()      // ERROR "z\.Dont undefined \(pointer type \*other\.Exported has no field or method Dont, and interface other\.Exported also lacks method Dont\)"
