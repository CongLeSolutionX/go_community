// buildrun -t 2  -gcflags=-d=ssa/insert_resched_checks/on
...
func standinacorner2(i int) {
	// contains an irreducible loop changes to memory
	if i != 0 {
		goto midloop
	}
