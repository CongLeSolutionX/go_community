...
1. Align the stack frame offset to the architecture’s pointer size.
1. If F is a method, stack-assign an empty value of F's receiver type.
   This is the receiver's spill space.
1. For each argument A of F, stack-assign an empty value of A's type.
   This is A's spill space.
1. Align the stack frame offset to the architecture’s pointer size.
...
TODO: Closure call sequence

TODO: Passing float32 in 64-bit floating point registers

TODO: Describe softfloat
...
The stack pointer, RSP, is always aligned to 8 bytes.
