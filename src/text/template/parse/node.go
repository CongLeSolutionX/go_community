...
func (b *ContinueNode) Type() NodeType {
	return b.NodeType
}

func (b *ContinueNode) String() string {
	return "{{continue}}"
}

func (b *ContinueNode) Copy() Node {
	return b.tr.newContinue(b.Pos)
}

func (b *ContinueNode) Position() Pos {
	return b.Pos
}

func (b *ContinueNode) tree() *Tree {
	return b.tr
}
