...
func ExampleDate() {
	t := time.Date(2009, time.November, 25, 23, 0, 0, 0, time.UTC)
	fmt.Printf("Go launched at %s\n", t.Local())
	// Output: Go launched at 2009-11-25 15:00:00 -0800 PST
}
...
func ExampleTime_Format() {
	...
	t, err := time.Parse(time.UnixDate, "Sat Mar 25 11:06:39 PST 2015")
	...
	do("Basic full date", "Mon Jan 2 15:04:05 MST 2006", "Sat Mar 25 11:06:39 PST 2015")
	do("Basic short date", "2006/01/02", "2015/03/25")

	// The predefined constant Unix uses an underscore to pad the day.
	// Compare with our simple starter example.
	do("Unix", time.UnixDate, "Sat Mar 25 11:06:39 PST 2015")
	...
	t, err = time.Parse(time.UnixDate, "Sat Mar 25 11:06:39.1234 PST 2015")
	if err != nil {
		panic(err)
	}
	// It does not appear in the output if the layout string does not contain
	// a representation of the fractional second.
	do("No fraction", time.UnixDate, "Sat Mar 25 11:06:39 PST 2015")
	...
	// Output:
	// default format: 2015-03-25 11:06:39 -0800 PST
	// Unix format: Sat Mar 25 11:06:39 PST 2015
	// Same, in UTC: Sat Mar 25 19:06:39 UTC 2015
	//
	// Formats:
	//
	// Basic full date  "Mon Jan 2 15:04:05 MST 2006" gives "Sat Mar 25 11:06:39 PST 2015"
	// Basic short date "2006/01/02" gives "2015/03/25"
	// Suppressed pad   "04:05" gives "06:39"
	// Unix             "Mon Jan _2 15:04:05 MST 2006" gives "Sat Mar 25 11:06:39 PST 2015"
	// AM/PM            "3PM==3pm==15h" gives "11AM==11am==11h"
	// No fraction      "Mon Jan _2 15:04:05 MST 2006" gives "Sat Mar 25 11:06:39 PST 2015"
