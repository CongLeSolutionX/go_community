...
func (t *Time) UnmarshalBinary(data []byte) error {
	...
	if version == timeBinaryVersionV1 {
		if len(buf) != /*version*/ 1+ /*sec*/ 8+ /*nsec*/ 4+ /*zone offset*/ 2 {
			return errors.New("Time.UnmarshalBinary: invalid length")
		}
	} else if version == timeBinaryVersionV2 {
		if len(buf) != /*version*/ 1+ /*sec*/ 8+ /*nsec*/ 4+ /*zone offset*/ 3 {
			return errors.New("Time.UnmarshalBinary: invalid length")
		}
	}
	...
	var offset int
	if version == timeBinaryVersionV2 {
		offset = int(int16(buf[1])|int16(buf[0])<<8)*60 + int(buf[2])
	} else {
		// version is equal to timeBinaryVersionV1
