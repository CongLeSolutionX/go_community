...
// abs returns the time t as an absolute seconds, adjusted by the zone offset.
// It is called when computing a presentation property like Month or Hour.
func (t Time) abs() absSeconds {
	l := t.loc
...
func (t Time) Date() (year int, month Month, day int) {
	return t.abs().days().date()
}

// Year returns the year in which t occurs.
func (t Time) Year() int {
	century, cyear, ayday := t.abs().days().split()
	janFeb := ayday.janFeb()
