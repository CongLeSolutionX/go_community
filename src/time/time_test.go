...
func TestDataAddSecOverflowWithZoneTransition(t *testing.T) {
	...
	tests := [...]struct {
		...
		// The Time of UTC is 13 April 1991, 18:00:00
		...
		4: {Date(1991, April, 14, 2, 30, 0, 0, loc), Date(1991, April, 13, 18, 30, 0, 0, UTC)},
		...
		// The Time of UTC is 14 September 1991, 17:00:00
		5: {Date(1991, September, 14, 16, 50, 0, 0, loc), Date(1991, September, 14, 7, 50, 0, 0, UTC)},
		6: {Date(1991, September, 14, 17, 0, 0, 0, loc), Date(1991, September, 14, 8, 0, 0, 0, UTC)},
		7: {Date(1991, September, 15, 0, 50, 0, 0, loc), Date(1991, September, 14, 15, 50, 0, 0, UTC)},
		8: {Date(1991, September, 15, 1, 0, 0, 0, loc), Date(1991, September, 14, 17, 0, 0, 0, UTC)}}
