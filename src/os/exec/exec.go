...
// for the respective I/O loop copying to/from the process to complete; this has
// the implication that it is valid to call Wait before the caller has completed
// reading or writing from c.Stdin, c.Stdout or c.Stderr.
//
