...
// RunContext is like Run, but will kill the process if ctx is done
// before the process ends on its own.
...
// WaitContext is like Wait, but kills the process if ctx is done
// before the process ends on its own.
