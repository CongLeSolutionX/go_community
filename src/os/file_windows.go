...
// normiliseLinkPath converts absolute paths returned by
...
//  \??\Volume{abc}\ into C:\
func normiliseLinkPath(path string) (string, error) {
...
func readlink(path string) (string, error) {
	...
	case syscall.IO_REPARSE_TAG_SYMLINK:
		...
		return normiliseLinkPath(s)
	case windows.IO_REPARSE_TAG_MOUNT_POINT:
		return normiliseLinkPath((*windows.MountPointReparseBuffer)(unsafe.Pointer(&rdb.DUMMYUNIONNAME)).Path())
	default:
