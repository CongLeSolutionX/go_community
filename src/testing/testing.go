...
func MainStart(deps testDeps, tests []InternalTest, benchmarks []InternalBenchmark, examples []InternalExample) *M {
	// When running under 'go test', Init has always been called at this point
	// (see init.go). Call Init here anyway as a backstop for cases such as
	// running the tests using a build system other than cmd/go.
	Init()
	return &M{
		deps:       deps,
		tests:      tests,
