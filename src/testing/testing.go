...
type common struct {
	...
	lastRaceErrors atomic.Int64 // Number of races detected during the test or its subtests.
}
...
func (c *common) checkRaces() (raceErrors int64) {
	...
	// Detected a new race that has not yet been reported. Report it now.
...
func tRunner(t *T, fn func(t *T)) {
	...
	if t.parent == nil {
		...
		t.lastRaceErrors.Store(t.parent.checkRaces())
	}
	fn(t)
