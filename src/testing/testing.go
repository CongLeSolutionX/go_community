...
func (m *M) before() {
	...
	if *traceFile != "" {
		...
		if err != nil {
			// os.Create will fail if tracePath is a named pipe (FIFO), e.g.
			// when using bash process substitution. Handle this case by simply
			// making another attempt to open the file for writing.
