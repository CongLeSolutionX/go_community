...
//
// Each fuzz target should add a number of seed corpus entries using F.Add
// or by storing them in the testdata/fuzz/<FuzzTargetName> directory. A
// fuzz target must then provide a fuzz function by calling F.Fuzz once.
// See the testing package documentation for an example, and see the F.Fuzz
// and F.Add method documentation for details.
type F struct {
	common
