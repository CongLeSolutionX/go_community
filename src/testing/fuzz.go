...
func initFuzzFlags() {
	...
	fuzzCacheDir = flag.String("test.fuzzcachedir", "", "directory where interesting fuzzing inputs are stored (GOFUZZCACHE)")
...
func (f *F) Fuzz(ff interface{}) {
	...
	case f.context.coordinateFuzzing != nil:
		...
		var cacheTargetDir string
		if *fuzzCacheDir != "" && *fuzzCacheDir != "off" {
