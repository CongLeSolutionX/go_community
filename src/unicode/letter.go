...
// The tables in this directory are generated by
// golang.org/x/text/internal/export/unicode/gen.go.
// They are regenerated each time we update the Unicode version running
// go generate at the top of the x/text repo, which will ensure Unicode
// tables in the core packages and other golang.org subrepos are updated
