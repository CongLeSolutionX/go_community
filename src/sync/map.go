...
//
// In the terminology of the Go memory model, Map arranges that a write operation happens
// before any read operation that observes the effect of the write, where
