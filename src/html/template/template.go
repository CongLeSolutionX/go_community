...
// TODO(samueltan): consider reworking this interface to safehtml/template to allow
// safehtml/template state variables to influence custom escaping behavior. For
// example, we might allow a flag from safehtml/template.Template to determine whether
// or not its EscaperForContext allows custom data attributes.
