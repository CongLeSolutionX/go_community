...
var EventDescriptions = [EvCount]struct {
	...
	EvUserTaskCreate:    {"UserTaskCreate", 1010, true, []string{"taskid", "pid", "nameid"}},
	EvUserTaskEnd:       {"UserTaskEnd", 1010, true, []string{"taskid"}},
	EvUserSpan:          {"UserSpan", 1010, true, []string{"taskid", "mode", "nameid"}},
