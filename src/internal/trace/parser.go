...
var EventDescriptions = [EvCount]struct {
	...
	EvUserTaskCreate:    {"UserTaskCreate", 1010, true, []string{"taskid", "pid", "typeid"}, []string{"name"}},
	EvUserTaskEnd:       {"UserTaskEnd", 1010, true, []string{"taskid"}, nil},
	EvUserSpan:          {"UserSpan", 1010, true, []string{"taskid", "mode", "typeid"}, []string{"name"}},
	EvUserLog:           {"UserLog", 1010, true, []string{"id", "keyid"}, []string{"category", "message"}},
}
