...
var EventDescriptions = [EvCount]struct {
	...
	EvGCMarkAssistStart: {"GCMarkAssistStart", 1009, true, []string{"scanwork0", "scanwork", "debtbytes"}, nil},
	EvGCMarkAssistDone:  {"GCMarkAssistDone", 1009, false, []string{"retries"}, nil},
