...
The trailer consists of a single unsigned integer argument (the name doesn't
matter) that describes the length of the data in raw bytes. The following line
consists of a single argument 'data' and a Go-quoted string representing the
byte data within.
