...
func (r *Reader) ReadEvent() (e Event, err error) {
	...
	//
	// (1) Read in all the batches for a generation.
	...
	// (6) Read the next event for the selected M and update the min-heap.
	// (7) Return the selected event, goto (5) on the next call.
