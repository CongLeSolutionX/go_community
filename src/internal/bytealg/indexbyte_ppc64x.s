...
TEXT indexbytebody<>(SB),NOSPLIT|NOFRAME,$0-0
	...
	MTVRD	R5,V1
	LVSL	(R0+R0),V11	// set up the permute vector such that
	VSLB	V11,V10,V10	// V10 is used later to extract first bit of match result into GPR
...
foundat0:
	...
	VBPERMQ	V6,V10,V6
	MFVRD	V6,R3
	// count leading zeroes upto the match and
	// adjust it to the width of 16 bits
	CNTLZW	R3,R11
	ADD	$-16,R11
