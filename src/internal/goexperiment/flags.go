...
// Package experiment implements support for toolchain experiments.
//
...
//
// - In the runtime, the runtime/internal/sys.GOEXPERIMENT string is a
// comma-separated list of enabled experiments (lower case).
//
