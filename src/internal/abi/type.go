...
// NewOffset returns a new Offset with specified offset, alignment, pointer size, and slice alignment.
...
// It cannot be used directly in those places because it varies with
