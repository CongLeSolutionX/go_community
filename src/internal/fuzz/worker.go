...
//
// serve returns internal errors such as errors that occurred when communicating
// over pipes. serve does not return errors from method calls; those are passed
// through serialized responses.
