...
//
// Each bit represents an 8-bit counter basic block that's been rounded down
// to the nearest power of two. For example, the value 12 means the block
// has executed at least 4 times and at least 8 bytes (for different inputs).
