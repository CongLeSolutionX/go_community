...
// interfaces. For design details, see:
// https://go.googlesource.com/proposal/+/refs/heads/master/design/48815-custom-fuzz-input-types.md
...
func (m *mutator) mutate(ctx context.Context, vals []any, maxBytes int) error {
	...
	case customMutator:
		...
		if err := v.Mutate(ctx, seed); err != nil {
