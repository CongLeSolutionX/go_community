...
type CoverPkgConfig struct {
	...
	// Local mode indicates we're coverage testing a package imported
	// with a local path (e.g. "go test foo.go"). See corresponding
	// field in cmd/go's PackageInternal struct for more.
	Local bool
}
