...
// MetaSymbolHeader stores header information for the coverage meta
// data computed for a given Go package.
...
// more "segments" (each segment representing a given run) followed by
// a footer.
