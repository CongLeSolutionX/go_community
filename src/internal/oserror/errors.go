...
// IsTimeout returns a boolean indicating whether the error reports that a timeout occurred.
...
// IsTemporary returns a boolean indicating whether the error reports a temporary condition.
