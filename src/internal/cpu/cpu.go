...
type option struct {
	Name      string
	Feature   *bool
	Specified bool // feature value was specified in GODEBUGCPU
	Enable    bool // feature should be enabled
	Required  bool // feature is mandatory and can not be disabled
}
