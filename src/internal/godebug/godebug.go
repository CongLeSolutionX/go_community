...
// Note that while the metric is automatically made available
// to metrics.Read, it is not automatically added to the list
// returned by metrics.All (in runtime/metrics/description.go).
// Settings should be documented in that list as well.
package godebug
