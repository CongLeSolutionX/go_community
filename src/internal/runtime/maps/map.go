...
type Map struct {
	...
	// details.
	//
	// Small map optimization: if the map contains abi.SwissMapGroupSlots
	// or fewer entries, it fits entirely in a single group. In that case
	// dirPtr points directly to a single table.
	//
	// dirPtr *typ.Group
	//
