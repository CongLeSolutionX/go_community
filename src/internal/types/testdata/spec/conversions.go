...
func _[X Foo, T Far](x X) T {
	return T(x /* ERR cannot convert x (variable of type X constrained by Foo) to type T: cannot convert Foo (in X) to type Far (in T) */)
}
...
func _(x X0) T0           { return T0(x /* ERR cannot convert */) } // non-generic reference
func _[X X0, T T0](x X) T { return T(x /* ERR cannot convert */) }
func _[T T0](x X0) T      { return T(x /* ERR cannot convert */) }
func _[X X0](x X) T0      { return T0(x /* ERR cannot convert */) }
...
func _[X, T Integer | ~string](x X) T {
	return T(x /* ERR cannot convert x (variable of type X constrained by Integer \| ~string\) to type T: cannot convert string \(in X\) to type int \(in T\) */)
}
...
func _[X, T Float | Complex](x X) T {
	return T(x /* ERR cannot convert x (variable of type X constrained by Float \| Complex\) to type T: cannot convert float32 \(in X\) to type complex64 \(in T\) */)
}
...
func _[X Integer](x X) *string {
	return (*string)(x /* ERR cannot convert x (variable of type X constrained by Integer) to type \*string: cannot convert int \(in X\) to type \*string */)
}
...
func _[X Integer | ~[]byte | ~[]rune, T ~*string](x X) T {
	return T(x /* ERR cannot convert x (variable of type X constrained by Integer \| ~\[\]byte \| ~\[\]rune\) to type T: cannot convert int \(in X\) to type \*string \(in T\) */)
}
...
func _[T ~[]rune](x *string) T {
	return T(x /* ERR cannot convert x (variable of type \*string\) to type T: cannot convert \*string to type \[\]rune \(in T\) */)
}
...
func _[X ~*string, T ~[]byte | ~[]rune](x X) T {
	return T(x /* ERR cannot convert x (variable of type X constrained by ~\*string\) to type T: cannot convert \*string \(in X\) to type \[\]byte \(in T\) */)
}
...
func _[T unsafe.Pointer](x int64) T {
	return T(x /* ERR cannot convert x (variable of type int64) to type T: cannot convert int64 to type unsafe\.Pointer \(in T\) */)
}
...
func _[X unsafe.Pointer](x X) int64 {
	return int64(x /* ERR cannot convert x (variable of type X constrained by unsafe\.Pointer\) to type int64: cannot convert unsafe\.Pointer \(in X\) to type int64 */)
}
