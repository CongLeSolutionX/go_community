...
type (
	...
	_ interface{int|int /* ERR overlapping terms int */ }
	_ interface{int|~ /* ERR overlapping terms ~int */ int }
	_ interface{~int|~ /* ERR overlapping terms ~int */ int }
	_ interface{~int|MyInt /* ERR overlapping terms p.MyInt and ~int */ }
	_ interface{int|any}
	...
	_ interface{~ /* ERR invalid use of ~ */ any}
...
type (
	...
	bar any
	_ interface{foo}
	_ interface{~ /* ERR invalid use of ~ */ foo }
	_ interface{~ /* ERR invalid use of ~ */ bar }
)
...
type (
	...
	_[T interface{ T /* ERR term cannot be a type parameter */ } ] struct{}
	_[T interface{ ~T /* ERR type in term ~T cannot be a type parameter */ } ] struct{}
	_[T interface{ int|T /* ERR term cannot be a type parameter */ }] struct{}
)
...
func _[T interface{ myInt1|myInt2; int }]() T { return T(0 /* ERR cannot convert */ ) }
func _[T interface{ int; myInt1|myInt2 }]() T { return T(0 /* ERR cannot convert */ ) }
...
type (
	...
	_ interface{ Number | error /* ERR cannot use error in union */ }
	_ interface{ Ordered | comparable /* ERR cannot use comparable in union */ }
)
