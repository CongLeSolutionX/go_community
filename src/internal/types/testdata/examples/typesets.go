...
func _[A any, B A /* ERR cannot use a type parameter as constraint */]()    {}
func _[A any, B, C A /* ERR cannot use a type parameter as constraint */]() {}
...
func _[T string](x T) T {
	return x /* ERR constrained by string */ * x
}
