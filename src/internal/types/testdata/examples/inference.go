...
func _() {
	...
	// inferred types.
	mixed[int, string](1.1 /* ERR cannot use 1.1 */, "", false)
}
...
func _() {
	...
	related2(1.0, []int{})
	related2 /* ERR does not implement */ (float64(1.0), []int{}) // TODO(gri) fix error position
}
...
func _() {
	...
	// List[Elem].
	related3 /* ERR cannot infer Slice */ [int]()
}
