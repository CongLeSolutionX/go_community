...
type U6 interface { m(); m /* ERR duplicate method */ () }
type U7 interface { M32 /* ERR duplicate method */ ; m() }
type U8 interface { m(); M32 /* ERR duplicate method */ }
type U9 interface { M32; M64 /* ERR duplicate method */ }
