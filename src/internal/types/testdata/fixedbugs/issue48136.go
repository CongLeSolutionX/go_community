...
func _() {
        f1 /* ERR cannot infer P */ ()
        f2 /* ERR cannot infer P */ ()
        f3 /* ERR cannot infer P */ ()
        f4 /* ERR cannot infer P */ ()
        f5 /* ERR cannot infer P */ ()
        f6 /* ERR cannot infer P */ ()
}
