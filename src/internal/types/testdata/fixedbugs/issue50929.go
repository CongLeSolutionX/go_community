...
func _() {
	...
	var x F /* ERROR "not enough type arguments for type" */ [int]
...
func MMD[Rc RC /* ERROR "not enough type arguments for type" */ [RG], RG any, G any]() M /* ERROR "not enough type arguments for type" */ [Rc, RG] {

	var nFn NFn /* ERROR "not enough type arguments for type" */ [Rc, RG]
	...
	return M /* ERROR "not enough type arguments for type" */ [Rc, RG]{
		Fn: func(rc Rc) {
