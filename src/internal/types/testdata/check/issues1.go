...
func _[X comparable, Y interface{comparable; m()}]() {
	var x X
	var y Y
	eql(x, y /* ERR does not match */ ) // interfaces of different types
	eql(x, x)
	eql(y, y)
	eql(y, nil /* ERR cannot use nil as Y value in argument to eql */ )
	eql[io /* ERR does not implement comparable */ .Reader](nil, nil)
}
...
func _() {
	f2[T /* ERR m2 has pointer receiver */ ]()
	f2[*T]()
}
...
func _[P any]() {
    _ = T1[P /* ERR P does not implement interface{~uint} */ ]{}
}
...
func NewT2[U any]() T2[U /* ERR U does not implement Unsigned */ ] {
    return T2[U /* ERR U does not implement Unsigned */ ]{}
}
...
type inf1[T any] struct{ _ inf1 /* ERR invalid recursive type */ [T] }
type inf2[T any] struct{ inf2 /* ERR invalid recursive type */ [T] }
