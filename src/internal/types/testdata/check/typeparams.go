...
func _[T any](T /* ERR redeclared */ T)() {}
func _[T, T /* ERR redeclared */ any]() {}
...
var _ = reverse /* ERR cannot use generic function reverse */
var _ = reverse[int, float32 /* ERR got 2 type arguments */ ] ([]int{1, 2, 3})
var _ = reverse[int]([ /* ERR cannot use */ ]float32{1, 2, 3})
var f = reverse[chan int]
var _ = f(0 /* ERROR cannot use 0 .* as \[\]chan int */ )

func swap[A, B any](a A, b B) (B, A) { return b, a }

var _ = swap /* ERR multiple-value */ [int, float32](1, 2)
...
func _[T any](x, y T) bool { return x /* ERR type parameter T is not comparable */ < y }
func _[T interface{~int | ~float32 | ~bool}](x, y T) bool { return x /* ERR type parameter T is not comparable */ < y }

func _[T C1[T]](x, y T) bool { return x /* ERR type parameter T is not comparable */ < y }
...
var _ = new /* ERR cannot use generic function new */
var _ *int = new[int]()

func _[T any](map[T /* ERR invalid map key type T (missing comparable constraint) */]int) {} // w/o constraint we don't know if T is comparable
...
func _[T any] (x T, i int) { _ = x /* ERR cannot index */ [i] }
func _[T interface{ ~int }] (x T, i int) { _ = x /* ERR cannot index */ [i] }
func _[T interface{ ~string }] (x T, i int) { _ = x[i] }
func _[T interface{ ~[]int }] (x T, i int) { _ = x[i] }
func _[T interface{ ~[10]int | ~*[20]int | ~map[int]int }] (x T, i int) { _ = x /* ERR cannot index */ [i] } // map and non-map types
func _[T interface{ ~string | ~[]byte }] (x T, i int) { _ = x[i] }
func _[T interface{ ~[]int | ~[1]rune }] (x T, i int) { _ = x /* ERR cannot index */ [i] }
func _[T interface{ ~string | ~[]rune }] (x T, i int) { _ = x /* ERR cannot index */ [i] }

// indexing with various combinations of map types in type sets (see issue #42616)
func _[T interface{ ~[]E | ~map[int]E }, E any](x T, i int) { _ = x /* ERR cannot index */ [i] } // map and non-map types
func _[T interface{ ~[]E }, E any](x T, i int) { _ = &x[i] }
func _[T interface{ ~map[int]E }, E any](x T, i int) { _, _ = x[i] } // comma-ok permitted
func _[T interface{ ~map[int]E }, E any](x T, i int) { _ = &x /* ERR cannot take address */ [i] }
func _[T interface{ ~map[int]E | ~map[uint]E }, E any](x T, i int) { _ = x /* ERR cannot index */ [i] } // different map element types
func _[T interface{ ~[]E | ~map[string]E }, E any](x T, i int) { _ = x /* ERR cannot index */ [i] } // map and non-map types

// indexing with various combinations of array and other types in type sets
func _[T interface{ [10]int }](x T, i int) { _ = x[i]; _ = x[9]; _ = x[10 /* ERR out of bounds */ ] }
func _[T interface{ [10]byte | string }](x T, i int) { _ = x[i]; _ = x[9]; _ = x[10 /* ERR out of bounds */ ] }
func _[T interface{ [10]int | *[20]int | []int }](x T, i int) { _ = x[i]; _ = x[9]; _ = x[10 /* ERR out of bounds */ ] }

// indexing with strings and non-variable arrays (assignment not permitted)
func _[T string](x T) { _ = x[0]; x /* ERR cannot assign */ [0] = 0 }
func _[T []byte | string](x T) { x /* ERR cannot assign */ [0] = 0 }
func _[T [10]byte]() { f := func() (x T) { return }; f /* ERR cannot assign */ ()[0] = 0 }
func _[T [10]byte]() { f := func() (x *T) { return }; f /* ERR cannot index */ ()[0] = 0 }
...
func _[T interface{ ~string }] (x T, i, j, k int) { var _ T = x[i:j:k /* ERR 3-index slice of string */ ] }

type myByte1 []byte
type myByte2 []byte
func _[T interface{ []byte | myByte1 | myByte2 }] (x T, i, j, k int) { var _ T = x[i:j:k] }
func _[T interface{ []byte | myByte1 | []int }] (x T, i, j, k int) { var _ T = x /* ERR no core type */ [i:j:k] }

func _[T interface{ []byte | myByte1 | myByte2 | string }] (x T, i, j, k int) { var _ T = x[i:j] }
func _[T interface{ []byte | myByte1 | myByte2 | string }] (x T, i, j, k int) { var _ T = x[i:j:k /* ERR 3-index slice of string */ ] }
func _[T interface{ []byte | myByte1 | []int | string }] (x T, i, j, k int) { var _ T = x /* ERR no core type */ [i:j] }

// len/cap built-ins

func _[T any](x T) { _ = len(x /* ERR invalid argument */ ) }
func _[T interface{ ~int }](x T) { _ = len(x /* ERR invalid argument */ ) }
func _[T interface{ ~string | ~[]byte | ~int }](x T) { _ = len(x /* ERR invalid argument */ ) }
...
func _[T any](x T) { _ = cap(x /* ERR invalid argument */ ) }
func _[T interface{ ~int }](x T) { _ = cap(x /* ERR invalid argument */ ) }
func _[T interface{ ~string | ~[]byte | ~int }](x T) { _ = cap(x /* ERR invalid argument */ ) }
func _[T interface{ ~string }](x T) { _ = cap(x /* ERR invalid argument */ ) }
func _[T interface{ ~[10]int }](x T) { _ = cap(x) }
func _[T interface{ ~[]byte }](x T) { _ = cap(x) }
func _[T interface{ ~map[int]int }](x T) { _ = cap(x /* ERR invalid argument */ ) }
...
func _[
        ...
        for range c0 {}
        for _ = range c0 {}
        for _, _ /* ERR permits only one iteration variable */ = range c0 {}

        var c1 C1
        for range c1 {}
        for _ = range c1 {}
        for _, _ /* ERR permits only one iteration variable */ = range c1 {}

        var c2 C2
        for range c2 {}

        var c3 C3
        for range c3 /* ERR receive from send-only channel */ {}
...
var _ = new /* ERR cannot infer T */ ()

func f4[A, B, C any](A, B) C { panic(0) }

var _ = f4 /* ERR cannot infer C */ (1, 2)
var _ = f4[int, float32, complex128](1, 2)

func f5[A, B, C any](A, []*B, struct{f []C}) int { panic(0) }

var _ = f5[int, float32, complex128](0, nil, struct{f []complex128}{})
var _ = f5 /* ERR cannot infer */ (0, nil, struct{f []complex128}{})
...
var _ = f6nil /* ERR cannot infer */ (nil)

// type inference with variadic functions

func f7[T any](...T) T { panic(0) }

var _ int = f7 /* ERR cannot infer T */ ()
var _ int = f7(1)
var _ int = f7(1, 2)
var _ int = f7([]int{}...)
var _ int = f7 /* ERR cannot use */ ([]float64{}...)
var _ float64 = f7([]float64{}...)
var _ = f7[float64](1, 2.3)
var _ = f7(float64(1), 2.3)
var _ = f7(1, 2.3 /* ERR does not match */ )
var _ = f7(1.2, 3 /* ERR does not match */ )

func f8[A, B any](A, B, ...B) int { panic(0) }

var _ = f8(1) /* ERR not enough arguments */
var _ = f8(1, 2.3)
var _ = f8(1, 2.3, 3.4, 4.5)
var _ = f8(1, 2.3, 3.4, 4 /* ERR does not match */ )
...
func init() {}
func init[_ /* ERR func init must have no type parameters */ any]() {}
func init[P /* ERR func init must have no type parameters */ any]() {}

type T struct {}

func (T) m1() {}
func (T) m2[ /* ERR method must have no type parameters */ _ any]() {}
func (T) m3[ /* ERR method must have no type parameters */ P any]() {}
...
//
//         // type assertions and type switches over generic types are strict
//         _ = p /* ERR cannot have dynamic type I4 */.(I4)
//         switch p.(type) {
//         case I4 /* ERR cannot have dynamic type I4 */ :
//         }
// }
...
func _[T any](x T) {
	_ = x /* ERR cannot use type assertion */ .(int)
	switch x /* ERR cannot use type switch */ .(type) {
	}
...
func _[P I] (x P) {
	x.m /* ERR type P has no field or method m */ ()
}
