...
func _[T interface{ []byte | myByte1 | []int }] (x T, i, j, k int) { var _ T = x /* ERROR "results of different types" */ [i:j:k] }

func _[T interface{ []byte | myByte1 | myByte2 | string }] (x T, i, j, k int) { var _ T = x[i:j] }
func _[T interface{ []byte | myByte1 | myByte2 | string }] (x T, i, j, k int) { var _ T = x[i:j:k /* ERROR "3-index slice of string" */ ] }
func _[T interface{ []byte | myByte1 | []int | string }] (x T, i, j, k int) { var _ T = x /* ERROR "results of different types" */ [i:j] }
...
func _[
        ...
        var s2 S2
        for range s2 {} // ok to range without iteration variables
        ...
        var a2 A2
        for range a2 {} // ok to range without iteration variables
        ...
        var p2 P2
        for range p2 /* ERROR `cannot range over p2` */ {}
        ...
        var m2 M2
        for k := range m2 { _ = k } // ok to range without value iteration variable
}
