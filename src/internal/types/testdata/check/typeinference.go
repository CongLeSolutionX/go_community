...
func _() {
	var x Tb /* ERR got 1 arguments */ [*int]
	var y Tb[*int, int]
...
func _() {
	var x Tr /* ERR got 1 arguments */ [string]
...
func _() {
	var _ To0 /* ERR got 1 arguments */ [int]
	var _ To1 /* ERR got 1 arguments */ [int]
	var _ To2 /* ERR got 1 arguments */ [int]
	var _ To3 /* ERR got 1 arguments */ [int]
	var _ To4 /* ERR got 2 arguments */ [int, string]
}
...
func _() {
	var _ Tf0 /* ERR got 1 arguments but 2 type parameters */ [int]
	var _ Tf1 /* ERR got 1 arguments but 3 type parameters */ [int]
}
