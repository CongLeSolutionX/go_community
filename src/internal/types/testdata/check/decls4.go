...
func (Ai /* ERR cannot define new methods on non-local type int */) m1() {}
func (T0) m1() {}
func (A0) m1 /* ERR already declared */ () {}
func (A0) m2 () {}
func (A3 /* ERR invalid receiver */ ) m1 () {}
func (A10 /* ERR invalid receiver */ ) m1() {}
...
func (V0) m /* ERR already declared */ () {}
func (V1) n() {}

// alias receiver types (invalid due to cycles)
type (
	W0 /* ERR invalid recursive type */ = W1
	W1 = (W2)
	W2 = ((W0))
)
...
func (B0 /* ERR cannot define new methods on non-local type int */ ) m() {}
func (B1 /* ERR cannot define new methods on non-local type int */ ) n() {}

// cycles
type (
	C2 /* ERR invalid recursive type */ = C2
	C3 /* ERR invalid recursive type */ = C4
	C4 = C3
	C5 struct {
		f *C6
	}
	C6 = C5
	C7 /* ERR invalid recursive type */  struct {
		f C8
	}
	C8 = C7
)
...
var (
	s0 struct { T0 }
	s1 struct { A0 } = s0 /* ERR cannot use */ // embedded field names are different
)
...
var (
	_ = eD{}.xf /* ERR ambiguous selector eD{}.xf */
	_ = eD{}.xm /* ERR ambiguous selector eD{}.xm */
)

var (
	_ interface{ xm() } = eD /* ERR missing method xm */ {}
)