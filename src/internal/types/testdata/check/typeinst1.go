...
type _ interface {
	~int|~ /* ERR overlapping terms ~int */ int
	~int|int /* ERR overlapping terms int */
	int|int /* ERR overlapping terms int */
}

type _ interface {
	~struct{f int} | ~struct{g int} | ~ /* ERR overlapping terms */ struct{f int}
}
...
var _ = f0[bool]
var _ = f0[string]
var _ = f0[float64 /* ERR does not implement I0 */ ]
...
func f01[T I01]() {}
var _ = f01[int]
var _ = f01[bool /* ERR does not implement I0 */ ]
var _ = f01[string]
var _ = f01[float64 /* ERR does not implement I0 */ ]
...
func f12[T I12]() {}
var _ = f12[int /* ERR does not implement I12 */ ]
var _ = f12[bool /* ERR does not implement I12 */ ]
var _ = f12[string /* ERR does not implement I12 */ ]
var _ = f12[float64]
...
func f0_[T I0_]() {}
var _ = f0_[int]
var _ = f0_[bool /* ERR does not implement I0_ */ ]
var _ = f0_[string /* ERR does not implement I0_ */ ]
var _ = f0_[float64 /* ERR does not implement I0_ */ ]

// Using a function instance as a type is an error.
var _ f0 // ERR not a type
var _ f0 /* ERR not a type */ [int]
...
func _[T none]() {
	_ = ff[int /* ERR cannot implement none (empty type set) */ ]
