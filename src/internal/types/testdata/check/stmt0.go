...
func issue10148() {
	...
	for range 1.5 /* ERROR "cannot use 1.5 (untyped float constant) as int value in range clause (truncated)" */ {
		_ = "" /* ERROR "mismatched types untyped string and untyped int" */ + 1
	}
	for y /* ERROR "declared and not used" */ := range 1.5 /* ERROR "cannot use 1.5 (untyped float constant) as int value in range clause (truncated)" */ {
		_ = "" /* ERROR "mismatched types untyped string and untyped int" */ + 1
	}
}
