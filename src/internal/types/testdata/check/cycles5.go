...
type (
	T1 interface { T2 }
	T2 /* ERR invalid recursive type */ T2
)

type (
	T3 interface { T4 }
	T4 /* ERR invalid recursive type */ T5
	T5 = T6
	T6 = T7
	T7 = T4
)
...
type T10 /* ERR invalid recursive type */ = *T10                 // issue #25141
type T11 /* ERR invalid recursive type */ = interface{ f(T11) }  // issue #23139
...
type (
	a struct{ *b }
	b = c
	c struct{ *b /* ERR invalid use of type alias */ }
)
...
type (
	...
	M interface {
		F() P // ERR invalid use of type alias
	}
...
// issue #8699
type T12 /* ERR invalid recursive type */ [len(a12)]int
var a12 = makeArray()
func makeArray() (res T12) { return }

// issue #20770
var r /* ERR invalid cycle in declaration of r */ = newReader()
func newReader() r
...
// issue #25790
func ff(ff /* ERR not a type */ )
func gg((gg /* ERR not a type */ ))

type T13 /* ERR invalid recursive type T13 */ [len(b13)]int
var b13 T13
...
func h() [h /* ERR no value */ ()[0]]int { panic(0) }

var c14 /* ERR cycle */ T14
type T14 [uintptr(unsafe.Sizeof(&c14))]byte

// issue #34333
type T15 /* ERR invalid recursive type T15 */ struct {
	f func() T16
	b T16
}
