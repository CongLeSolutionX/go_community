...
func _[
	...
	_ = max(x1, x1)
	_ = max(1, x1, 2)
	const _ = max /* ERROR "max(1, x1, 2) (value of type P1 constrained by ~int | ~float64) not constant expression" */ (1, x1, 2)
...
func _[
	...
	_ = min(x1, x1)
	_ = min(1, x1, 2)
	const _ = min /* ERROR "min(1, x1, 2) (value of type P1 constrained by ~int | ~float64) not constant expression" */ (1, x1, 2)
