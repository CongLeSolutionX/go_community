...
//sys NhpAllocateAndGetInterfaceInfoFromStack(ppTable **IpInterfaceNameInfo, count *uint32, order bool, heap syscall.Handle, flags uint32) (errcode error) = iphlpapi.NhpAllocateAndGetInterfaceInfoFromStack
