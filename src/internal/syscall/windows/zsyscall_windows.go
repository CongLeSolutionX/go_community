...
func GetAddrInfoExOverlappedResult(overlapped *syscall.Overlapped) (code uint32) {
	r0, _, _ := syscall.Syscall(procGetAddrInfoExOverlappedResult.Addr(), 1, uintptr(unsafe.Pointer(overlapped)), 0, 0)
	code = uint32(r0)
	return
}
