...
func KernelVersion() (major int, minor int) {
	...
	if runtime.GOOS == "illumos" {
		// Illumos distributions like OmniOS and SmartOS use different formats without a
		// parsable pattern for the Version field while Release level string is guaranteed
		// to be in x.y or x.y.z format regardless of whether it's Solaris or illumos.
		ver = un.Release[:]
	}
