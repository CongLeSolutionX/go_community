...
TEXT ·libc_malloc_trampoline(SB),NOSPLIT,$0-0; JMP libc_malloc(SB)
TEXT ·libc_free_trampoline(SB),NOSPLIT,$0-0; JMP libc_free(SB)
TEXT ·libc_realloc_trampoline(SB),NOSPLIT,$0-0; JMP libc_realloc(SB)
...
TEXT ·libc_dlopen_trampoline(SB),NOSPLIT,$0-0; JMP libc_dlopen(SB)
TEXT ·libc_dlsym_trampoline(SB),NOSPLIT,$0-0; JMP libc_dlsym(SB)
TEXT ·libc_dlerror_trampoline(SB),NOSPLIT,$0-0; JMP libc_dlerror(SB)
TEXT ·libc_realpath_trampoline(SB),NOSPLIT,$0-0; JMP libc_realpath(SB)
