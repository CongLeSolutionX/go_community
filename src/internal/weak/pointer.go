...
// Disable checkptr here for Strong. We're clearly violating the unsafe.Pointer
// rules by creating a pointer value out of a uint64 in a way that the checkptr
// instrumentation doesn't understand.
//
//go:nocheckptr
