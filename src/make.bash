...
#
# GOROOT_BOOTSTRAP: A working Go tree >= Go 1.16 for bootstrap.
# If $GOROOT_BOOTSTRAP/bin/go is missing, $(go env GOROOT) is
# tried for all "go" in $PATH. $HOME/go1.16 by default.
...
export GOROOT_BOOTSTRAP=${GOROOT_BOOTSTRAP:-$HOME/go1.16}
...
if [ ! -x "$GOROOT_BOOTSTRAP/bin/go" ]; then
	...
	echo "Set \$GOROOT_BOOTSTRAP to a working Go tree >= Go 1.16." >&2
	exit 1
fi
...
# Throw ours, built with the bootstrap Go version, away after bootstrap.
