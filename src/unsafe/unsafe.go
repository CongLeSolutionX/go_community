...
// The return value of Sizeof is a Go constant if the type of the argument
// x has constant size
...
// The return value of Offsetof is a Go constant if the type of the argument
// structValue has constant size.
