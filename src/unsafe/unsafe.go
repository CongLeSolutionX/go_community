...
// Otherwise, (slice != nil && cap(slice) == 0), the return value is unspecified.
...
// The caller must not write to any of the underlying bytes, otherwise the program may behave unpredictably.
