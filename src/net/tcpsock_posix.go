...
func dialTCP(network string, laddr, raddr *TCPAddr, deadline time.Time) (*TCPConn, error) {
	fd, err := internetSocket(network, laddr, raddr, deadline, syscall.SOCK_STREAM, 0, "dial")
...
func listenTCP(network string, laddr *TCPAddr) (*TCPListener, error) {
	fd, err := internetSocket(network, laddr, nil, noDeadline, syscall.SOCK_STREAM, 0, "listen")
	if err != nil {
