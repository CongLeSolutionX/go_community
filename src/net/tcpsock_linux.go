...
func (c *TCPConn) Write(b []byte) (int, error) {
	...
	subCtx, cancel, oldCancelRelay := c.fastOpen.Dialer.parseDialContext(c.fastOpen.Context)
	if cancel != nil {
		defer cancel()
	}
...
func dialTCPFastOpen(ctx context.Context, dp *dialParam, laddr, raddr *TCPAddr, b []byte) (*netFD, int, error) {
