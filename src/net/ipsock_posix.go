...
func internetSocket(network string, sotype, proto int, mode string, fastopen bool, laddr, raddr sockaddr, deadline time.Time, cancel <-chan struct{}) (fd *netFD, err error) {
