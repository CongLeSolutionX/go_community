...
func (d *Dialer) Dial(network, address string) (Conn, error) {
	...
	if err != nil {
		return nil, &OpError{Op: "dial", Net: network, Addr: nil, RemoteAddr: nil, Err: err}
	}
...
func dialSingle(net, addr string, la, ra Addr, deadline time.Time) (c Conn, err error) {
	if la != nil && la.Network() != ra.Network() {
		return nil, &OpError{Op: "dial", Net: net, Addr: la, RemoteAddr: ra, Err: errors.New("mismatched local address type " + la.Network())}
	}
	switch ra := ra.(type) {
	case *TCPAddr:
		la, _ := la.(*TCPAddr)
	...
	default:
		return nil, &OpError{Op: "dial", Net: net, Addr: la, RemoteAddr: ra, Err: &AddrError{Err: "unexpected address type", Addr: addr}}
	}
	if err != nil {
...
func Listen(net, laddr string) (Listener, error) {
	...
	if err != nil {
		return nil, &OpError{Op: "listen", Net: net, Addr: nil, RemoteAddr: nil, Err: err}
	}
	var l Listener
	...
	default:
		return nil, &OpError{Op: "listen", Net: net, Addr: la, RemoteAddr: nil, Err: &AddrError{Err: "unexpected address type", Addr: laddr}}
	}
	if err != nil {
