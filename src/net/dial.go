...
// if supported by the operating system. This method can then be used
// to override the system default behavior to force using or not using
// Multipath TCP.
//
// If MPTCP is not available on the host or not supported by the server,
// the Dial method will fall back to TCP.
