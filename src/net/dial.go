...
type Dialer struct {
	...
	// If SetMultipathTCP is set, any call to Dial with "tcp(4|6)" as network
	// will use Multipath TCP (MPTCP) if supported by the operating system.
	SetMultipathTCP bool
}
...
type ListenConfig struct {
	...
	// If SetMultipathTCP is set, any call to Listen with "tcp(4|6)" as network
	// will use Multipath TCP (MPTCP) if supported by the operating system.
	SetMultipathTCP bool
}
