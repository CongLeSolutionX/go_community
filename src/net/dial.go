...
//
// The provided Context must be non-nil. If the context is done before
// the the dial is complete, the context's error is returned.
// Not all of dials support cancelation via a context.
//
// See func Dial for a description of the network and address
// parameters.
