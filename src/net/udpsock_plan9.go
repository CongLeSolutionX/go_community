...
func (c *UDPConn) ReadFromUDP(b []byte) (n int, addr *UDPAddr, err error) {
	...
	if err != nil {
		return 0, nil, &OpError{Op: "read", Net: c.fd.dir, Source: c.fd.laddr, Addr: nil, Err: err}
	}
	if m < udpHeaderSize {
		return 0, nil, &OpError{Op: "read", Net: c.fd.dir, Source: c.fd.laddr, Addr: nil, Err: errors.New("short read reading UDP header")}
	}
	buf = buf[:m]
