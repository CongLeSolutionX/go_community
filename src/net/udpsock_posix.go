...
func dialUDP(network string, laddr, raddr *UDPAddr, deadline time.Time) (*UDPConn, error) {
	fd, err := internetSocket(network, laddr, raddr, deadline, syscall.SOCK_DGRAM, 0, "dial")
	if err != nil {
...
func listenUDP(network string, laddr *UDPAddr) (*UDPConn, error) {
	fd, err := internetSocket(network, laddr, nil, noDeadline, syscall.SOCK_DGRAM, 0, "listen")
	if err != nil {
