...
const escapeMap = "\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00" +
	"\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00" +
	"\x00\x98\x18\x00\xbe\x00\xbe\x18\x98\x98\x98\xbe\xba\xfe\xfe\x82" +
	"\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\x9e\xba\x18\xbe\x18\x80" +
	"\x86\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff" +
	"\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\x18\x00\x18\x00\xfe" +
	"\x00\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff" +
	"\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\x00\x00\x00\xfe\x00" +
	"\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00" +
	"\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00" +
	"\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00" +
	"\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00" +
...
func shouldEscape(c byte, mode encoding) bool {
	return (escapeMap[int(c)]>>mode)&1 == 0
}
...
func escape(s string, mode encoding) string {
	...
	var i, j, nCopy = 0, 0, 0
	for i = 0; i < len(s); i++ {
		if c := s[i]; shouldEscape(c, mode) {
			if nCopy != 0 {
				copy(t[j:j+nCopy], s[i-nCopy:i])
				j += nCopy
				nCopy = 0
			}
			if c == ' ' && mode == encodeQueryComponent {
