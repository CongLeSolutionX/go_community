...
// The string may contain the square brackets.
func isValidIPv6Address(v6addr string) bool {
	...
	// There should be no less than 1 and no more than 7 colons
	ipv6PartsCount := strings.Count(v6addr, ":")
	if ipv6PartsCount < 1 || ipv6PartsCount > 7 {
		return false
	}
