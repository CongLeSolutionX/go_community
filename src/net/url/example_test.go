...
func ExampleParse() {
	examples := []struct {
		...
		// This for differs from path-only URLs by having a "//" prefix
		...
		// A URL may use the mailto URI scheme specified in RFC 6068.
		...
		// A URL may use the data URI scheme specified in RFC 2397.
