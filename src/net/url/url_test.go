...
var urltests = []URLTest{
	...
	// host subcomponent; ipv4 address
	{
		"http://192.168.0.1/",
		&URL{
			Scheme: "http",
	...
	// host and port subcomponents; ipv4 address
	{
	...
	// host subcomponent; ip-literal; ipv6 address
	{
		"http://[fe80::1]/",
		&URL{
			Scheme: "http",
	...
	// host and port subcomponents; ip-literal; ipv6 address
	{
		"http://[fe80::1]:8080/",
		&URL{
			Scheme: "http",
	...
	// host subcomponent; ip-literal; ipv6 address with zone identifier
	{
	...
	// host and port subcomponents; ip-literal; ipv6 address with zone identifier
	{
	...
	// host subcomponent; ip-literal; ipv6 address with zone identifier
	{
		"http://[fe80::1%25%65%6e%301-._~]/", // pct-encoded+unreserved zone identifier
		&URL{
			Scheme: "http",
			Host:   "[fe80::1%en01-._~]",
			Path:   "/",
	...
	// host and port subcomponents; ip-literal; ipv6 address with zone identifier
	{
		"http://[fe80::1%25%65%6e%301-._~]:8080/", // pct-encoded+unreserved zone identifier
		&URL{
			Scheme: "http",
...
var parseRequestURLTests = []struct {
	...
	{"http://[fe80::1%25%65%6e%301-._~]/", true},      // with pct-encoded+unreserved zone identifier
	{"http://[fe80::1%25%65%6e%301-._~]:8080/", true}, // with pct-encoded+unreserved zone identifier
