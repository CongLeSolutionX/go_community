...
func NewClient(conn net.Conn, host string) (*Client, error) {
	c := &Client{serverName: host, localName: "localhost"}
	if err := c.initText(conn); err != nil {
		return nil, err
	}
...
func (c *Client) initText(conn net.Conn) error {
...
//
// SendMail is a convenient wrapper around Client.DialAndSend.
//
