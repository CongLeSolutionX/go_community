...
// setting only one of Idle and Interval to a non-negative value while setting the
// other to a negative value will result in the negative one being recalculated as
// the quotient of tcp_keepalive_abort_interval(eight minutes as default) and the
