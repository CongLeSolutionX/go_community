...
// algorithm).
// The default is true (no delay), meaning that data is sent as soon
// as possible after a Write.
...
// DialTCP connects to the remote address raddr.
// Network must be "tcp", "tcp4", or "tcp6".
...
// connection's.
// Attempting to change properties of the original using this
...
// The caller can use the Addr method of TCPListener to retrieve the
// chosen address.
