...
// "ipv6-host%zone" and resolves the domain name on network, which
// must be "ip", "ip4" or "ip6".
func ResolveIPAddr(network, addr string) (*IPAddr, error) {
...
// associated out-of-band data into oob.
...
// b and the associated out-of-band data from oob.
...
// to receive and send IP packets with per-packet addressing.
