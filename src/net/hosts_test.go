...
func TestLookupStaticHost(t *testing.T) {
	...
	for _, tt := range lookupStaticHostTests {
		...
		for _, ent := range tt.ents {
			runStaticHostTest(t, tt.name, ent)
		}
	}
}

func runStaticHostTest(t *testing.T, hostsPath string, ent staticHostEntry) {
...
func TestLookupStaticAddr(t *testing.T) {
	...
	for _, tt := range lookupStaticAddrTests {
		testHookHostsPath = tt.name
		for _, ent := range tt.ents {
			runStaticAddrTest(t, tt.name, ent)
		}
	}
}

func runStaticAddrTest(t *testing.T, hostsPath string, ent staticHostEntry) {
...
func TestHostCacheModification(t *testing.T) {
	...
	runStaticAddrTest(t, testHookHostsPath, ent)
