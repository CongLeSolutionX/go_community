...
var lookupStaticHostTests = []struct {
	...
	},
	{
		...
		[]staticHostEntry{
			{"Preserve.Me", []string{"127.0.0.1", "::1"}},
			{"Preserve.Me.local", []string{"127.0.0.1", "::1"}},
		},
	},
}
...
var lookupStaticAddrTests = []struct {
	...
	},
	{
		"testdata/case-hosts", // see golang.org/issue/12806
		[]staticHostEntry{
			{"127.0.0.1", []string{"Preserve.Me", "Preserve.Me.local"}},
			{"::1", []string{"Preserve.Me", "Preserve.Me.local"}},
		},
	},
}
