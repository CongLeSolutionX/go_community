...
// tryUpdate tries to update conf with the named file.
// Name should be a resolver configutation file name such as
// "/etc/resolv.conf" and be only a variable for testing.
