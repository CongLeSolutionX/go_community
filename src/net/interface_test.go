...
func TestInterfaces(t *testing.T) {
	...
	default:
		...
		if supportsIPv4 && stats.loop+stats.other > 0 && stats.uni4 == 0 {
			t.Errorf("want more than or equal to one connected unicast route: %v", stats)
		}
		// Test the existence of connected unicast routes for
	...
	default:
		...
		//	t.Errorf("want more than or equal to one connected multicast route clones: %v", stats)
		//}
		// Test the existence of connected multicast route
