...
func TestInterfaces(t *testing.T) {
	...
	var nactvifs, naf4, naf6, nmaf4, nmaf6 int
	for _, ifi := range ift {
	...
	default:
		if supportsIPv4 && nactvifs > 0 && naf4 == 0 {
			t.Errorf("got %v; want more than or equal one", naf4)
		}
		if supportsIPv6 && nactvifs > 0 && naf6 == 0 {
			t.Errorf("got %v; want more than or equal one", naf6)
		}
	}
	switch runtime.GOOS {
	...
	default:
		...
		//	t.Errorf("got %v; want more than or equal one", nmaf4)
		//}
		if supportsIPv6 && nactvifs > 0 && nmaf6 == 0 {
			t.Errorf("got %v; want more than or equal one", nmaf6)
		}
	}
}
...
func TestInterfaceAddrs(t *testing.T) {
	...
	if supportsIPv4 && naf4 == 0 {
		t.Errorf("got %v; want more than or equal one", naf4)
	}
	if supportsIPv6 && naf6 == 0 {
		t.Errorf("got %v; want more than or equal one", naf6)
	}
}
