...
// representation. It should be used by servers to dump client
// requests for debugging purposes. The returned representation is an
// approximation only; some details of the initial request are lost
// while parsing it into an http.Request. In particular, the order and
// case of header names are lost. The order of values in multi-valued
