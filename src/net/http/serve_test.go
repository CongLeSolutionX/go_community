...
var serveMuxTests = []struct {
	...
	{MethodGet, "google.com", "/", 404, ""},
	{MethodGet, "google.com", "/dir", 301, "/dir/"},
	{MethodGet, "google.com", "/dir/", 200, "/dir/"},
	{MethodGet, "google.com", "/dir/file", 200, "/dir/"},
	{MethodGet, "google.com", "/search", 201, "/search"},
	{MethodGet, "google.com", "/search/", 404, ""},
	{MethodGet, "google.com", "/search/foo", 404, ""},
	{MethodGet, "codesearch.google.com", "/search", 202, "codesearch.google.com/search"},
	{MethodGet, "codesearch.google.com", "/search/", 203, "codesearch.google.com/"},
	{MethodGet, "codesearch.google.com", "/search/foo", 203, "codesearch.google.com/"},
	{MethodGet, "codesearch.google.com", "/", 203, "codesearch.google.com/"},
	{MethodGet, "images.google.com", "/search", 201, "/search"},
	{MethodGet, "images.google.com", "/search/", 404, ""},
	{MethodGet, "images.google.com", "/search/foo", 404, ""},
	{MethodGet, "google.com", "/../search", 301, "/search"},
	{MethodGet, "google.com", "/dir/..", 301, ""},
	{MethodGet, "google.com", "/dir/..", 301, ""},
	{MethodGet, "google.com", "/dir/./file", 301, "/dir/"},

	// The /foo -> /foo/ redirect applies to CONNECT requests
	// but the path canonicalization does not.
	{MethodConnect, "google.com", "/dir", 301, "/dir/"},
	{MethodConnect, "google.com", "/../search", 404, ""},
	{MethodConnect, "google.com", "/dir/..", 200, "/dir/"},
	{MethodConnect, "google.com", "/dir/..", 200, "/dir/"},
	{MethodConnect, "google.com", "/dir/./file", 200, "/dir/"},
}
...
var serveMuxTests2 = []struct {
	...
	{MethodGet, "google.com", "/", 404, false},
	{MethodGet, "example.com", "/test/?example.com/test/", 200, false},
	{MethodGet, "example.com", "test/?example.com/test/", 200, true},
}
...
func testTCPConnectionCloses(t *testing.T, req string, h Handler) {
	...
	res, err := ReadResponse(r, &Request{Method: MethodGet})
	if err != nil {
...
func TestOptions(t *testing.T) {
	...
	br := bufio.NewReader(conn)
	res, err := ReadResponse(br, &Request{Method: MethodOptions})
	if err != nil {
		t.Fatal(err)
	}
...
func TestHTTP10ConnectionHeader(t *testing.T) {
	...
	for _, tt := range tests {
		...
		resp, err := ReadResponse(bufio.NewReader(conn), &Request{Method: MethodGet})
		if err != nil {
