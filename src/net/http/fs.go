...
// the ETag and remaining slice after consuming ETag is returned. Otherwise,
// it returns "", nil.
func scanETag(s []byte) (etag string, remain []byte) {
...
// etagStrongMatch returns true if a and b match using strong ETag comparison.
// Assumes a and b are valid ETags.
func etagStrongMatch(a, b string) bool {
	return a == b && a != "" && a[0] == '"'
}

// etagWeakMatch returns true if a and b match using weak ETag comparison.
// Assumes a and b are valid ETags.
