...
var (
	ErrNilRequestUrl            = &ProtocolError{ErrorString: "http: nil Request.URL"}
	ErrNilRequestHeader         = &ProtocolError{ErrorString: "http: nil Request.Header"}
	ErrNoHostInRequestUrl       = &ProtocolError{ErrorString: "http: no Host in request URL"}
	ErrRequestCanceled          = &ProtocolError{ErrorString: "net/http: request canceled while waiting for connection"}
	ErrBrokenConnection         = &ProtocolError{ErrorString: "http: can't write HTTP request on broken connection"}
	ErrReadOnClosedResponseBody = &ProtocolError{ErrorString: "http: read on closed response body"}
)
