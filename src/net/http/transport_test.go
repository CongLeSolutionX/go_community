...
func TestTransportMaxConnsPerHostDialCancellation(t *testing.T) {
	run(t, testTransportMaxConnsPerHostDialCancellation, []testMode{http1Mode, https1Mode, http2Mode})
}
...
func testTransportMaxConnsPerHostDialCancellation(t *testing.T, mode testMode) {
	...
	// This request should succeed, but add a 1 second timeout in case of regressions.
