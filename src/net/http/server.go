...
// and hangs up the connection. To abort a response so the client sees
// an error but the stack trace isn't logged to the server's error
// log, panic with the value ErrAbortHandler.
