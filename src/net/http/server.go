...
func Redirect(w ResponseWriter, r *Request, url string, code int) {
	// Note: The "url" parameter looks good in godoc, but means we
	// have to access net/url package via helpers, such as parseURL.
...
// parseURL is an alias to url.Parse. It exists only so that url.Parse can be called
// in places where url name is taken by a parameter. See https://golang.org/cl/49930.
