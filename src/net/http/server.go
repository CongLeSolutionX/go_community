...
func (s *Server) Shutdown(ctx context.Context) error {
	...
	// TODO(bradfitz): do something classier than polling.
	// This works for now.
...
// closeIdleConns closes all idle connections and reports whether
// there are no connections left afterwards.
