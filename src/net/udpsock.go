...
func ListenUDP(network string, laddr *UDPAddr) (*UDPConn, error) {
	...
	c, err := sa.listenUDP(context.Background(), laddr)
	if err != nil {
...
func ListenMulticastUDP(network string, ifi *Interface, gaddr *UDPAddr) (*UDPConn, error) {
	...
	sa := &sysAnnouncer{network: network, address: gaddr.String()}
	c, err := sa.listenMulticastUDP(context.Background(), ifi, gaddr)
	if err != nil {
