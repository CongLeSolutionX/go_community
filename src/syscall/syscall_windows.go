...
//sys	getFinalPathNameByHandle(file Handle, filePath *uint16, filePathSize uint32, flags uint32) (n uint32, err error) [failretval>=filePathSize] = kernel32.GetFinalPathNameByHandleW
