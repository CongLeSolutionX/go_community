// The complete list of Windows error codes is generated in x/sys/windows
// Error codes relevant to Go are in types_windows
...
const (
	...
	EMFILE	  = ERROR_NO_MORE_FILES
	EEXIST	  = ERROR_FILE_EXISTS
	EPIPE	  = ERROR_BROKEN_PIPE
	ENOBUFS   = ERROR_INSUFFICIENT_BUFFER
