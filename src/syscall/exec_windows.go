...
// envBlockSorted sorts each key=value pair in envv by key, returning
// a nameValue slice as well as the null-padded length of all the key=value pairs.
...
//
// The environment variables will be sorted in alphabetical order by name,
// in case-insensitive, Unicode order, without regard to locale as per:
// * https://docs.microsoft.com/en-us/windows/desktop/ProcThread/changing-environment-variables
// * https://golang.org/issues/29530
