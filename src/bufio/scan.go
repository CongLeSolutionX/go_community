...
// with no error.
// If the token being delivered with this error is not nil, the token
// is the last token; otherwise, the scanning should immediately stop.
// The value is useful to stop processing early or when it is necessary to
// deliver a final empty token (which is different from a nil token).
// One could achieve the same behavior
