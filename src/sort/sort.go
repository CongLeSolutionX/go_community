...
type (
	// The number of values representable in compTimeMIBufMemb must be at least
	...
	// and a MI buffer.
	compTimeMIBuffer [5 * mIBufSize]compTimeMIBufMemb
)
...
func stable(data Interface, n int) {
	...
	for i := 3 * mIBufSize; i < len(compTimeMovImBuf); i++ {
