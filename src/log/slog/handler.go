...
type HandlerOptions struct {
	// When AddSource is true, the handler adds an attribute to the output with
	// indicating the source code position of the log statement. AddSource is
	// false by default to skip the cost of computing this information.
	AddSource bool
