...
func TestVet(t *testing.T) {
	...
	t.Run("loopclosure", func(t *testing.T) {
		...
		// REVIEWERS: GOTOOLCHAIN seems like a sledgehammer.
		// Why does it not suffice to have a go1.21 go.mod
		// file and a !go1.22 build tag in the file?
		cmd.Env = append(os.Environ(), "GOWORK=off", "GOTOOLCHAIN=go1.21.0")
