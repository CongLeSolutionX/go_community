...
const (
	...
	// and from which which we can extract boolean conditions like <, ==, etc.
	...
	OpSETEQ // arg0 encodes ==
	OpSETNE // arg0 encodes !=
	OpSETL  // arg0 encodes signed <
	OpSETGE // arg0 encodes signed >=
	OpSETB  // arg0 encodes unsigned <
