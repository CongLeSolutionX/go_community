...
const (
	...
	OpStore      // Store arg1 to arg0+aux.(int64).  arg2=memory
	OpSliceIndex // arg0=slice, arg1=index, arg2=memory
	OpCheckNil   // arg0 != nil
	OpCheckBound // 0 <= arg0 < arg1

	// function calls.  Arguments to the call have already been written to the stack.
	// Return values appear on the stack.  The method receiver, if any, is treated
	// as a phantom first argument.
	// TODO: closure pointer must be in a register.
	OpCall       // arg0=code pointer, arg1=context ptr, arg2=memory
	OpStaticCall // call function aux.(*gc.Sym), arg0=memory
