...
func TestFloatFloat64(t *testing.T) {
	const smallestNormalFloat = 2.2250738585072014e-308 // 1p-1022
	for _, test := range []struct {
		x   string
		out float64
		acc Accuracy
		...
		{"0x.fffffffffffffp-1022", smallestNormalFloat - math.SmallestNonzeroFloat64, Exact},
		{"4503599627370495p-1074", smallestNormalFloat - math.SmallestNonzeroFloat64, Exact},
