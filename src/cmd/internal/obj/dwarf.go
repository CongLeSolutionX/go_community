...
func (ctxt *Link) generateDebugLinesSymbol(s, lines *LSym) {
	...
	// The linker will drop the DW_LNE_set_address once determined; therefore,
	// it's omitted here.
...
// CreateDebugLinesFileTable populates the DWARFFileTable with the filenames used
// to generate the debug_lines DWARF section.
func (ctxt *Link) CreateDebugLinesFileTable() {
	ctxt.DWARFFileTable = ctxt.PosTable.DebugLinesFileTable()
}
