...
func (c dwCtxt) LookupOrCreateDwarfSym(die *dwarf.DWDie, name string, st objabi.SymKind, create bool) dwarf.Sym {
	if !create {
...
func (ctxt *Link) PopulateDWARFType(typ dwarf.Type) {
	...
	// some base dwarf type is already generated in the import package.
