...
// which is where xpos was ultimately inlined to. In the example above,
// main() contains inlined AST nodes from h(), but the outermost
// position for those nodes is line 2.
