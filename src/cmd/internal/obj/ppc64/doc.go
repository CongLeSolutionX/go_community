...
6. Shift instructions
  ...
  In the original Go assembly, some non-simple shifts have a mask and start bit
  specified in the Go assembler instruction. These shifts generate the
  appropriate PPC64 assembler instruction that includes the first bit and the
  range of the mask. See the ISA for more detail on these types of shifts. Here
  are a few examples:
