...
// number for a position. This is the file/line visible in the final binary
// (pcfile, pcln, etc).
...
// the relative line number for a position. This is the file/line visible in
// the final binary (pcfile, pcln, etc).
