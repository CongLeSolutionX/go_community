...
var encodings = [ALAST & obj.AMask]encoding{
	...
	AREVBIT4B & obj.AMask:   {bits: 0x00004800, fmt: insnFormatDJ},
	AREVBIT8B & obj.AMask:   {bits: 0x00004c00, fmt: insnFormatDJ},
	AREVBITW & obj.AMask:    {bits: 0x00005000, fmt: insnFormatDJ},
	AREVBITD & obj.AMask:    {bits: 0x00005400, fmt: insnFormatDJ},
	...
	ASLADDW & obj.AMask:     {bits: 0x00040000, fmt: insnFormatDJKUa2},
	ASLADDWU & obj.AMask:    {bits: 0x00060000, fmt: insnFormatDJKUa2},
	ACATPICKW & obj.AMask:   {bits: 0x00080000, fmt: insnFormatDJKUa2},
	ACATPICKD & obj.AMask:   {bits: 0x000c0000, fmt: insnFormatDJKUa3},
	...
	ASLADDD & obj.AMask:     {bits: 0x002c0000, fmt: insnFormatDJKUa2},
	...
	ACU52ID & obj.AMask:     {bits: 0x03000000, fmt: insnFormatDJSk12},
	...
	ACU32ID & obj.AMask:     {bits: 0x16000000, fmt: insnFormatDSj20},
	APCADDU2I & obj.AMask:   {bits: 0x18000000, fmt: insnFormatDSj20},
