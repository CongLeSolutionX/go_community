...
func Flushplist(ctxt *Link, plist *Plist, newprog ProgAlloc, myimportpath string, debugInfo DebugFunc) {
	...
	for _, s := range text {
		...
		linkpcln(ctxt, s)
		ctxt.populateDWARF(plist.Curfn, s, myimportpath, debugInfo)
	}
}
