...
//
// PkgIdx is either a predeclared index (see link.go:/PkgIdxNone) or
// an index of an imported package. For the latter case, PkgId is the
...
type OFuncInfo struct {
	...
	PcdataEnd   uint32
	Funcdataoff []uint32
	File        []OSymRef // TODO: just use string?
