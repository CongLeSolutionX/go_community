...
func runAssembler(t *testing.T, srcdata string) []byte {
	...
	cmd := testenv.Command(t, testenv.GoToolPath(t), "tool", "asm", "-S", srcfile)
...
// Check we can assemble a very simple function for regression.
...
// Check we can assemble a simple short branch case.
...
// Check we can assemble a simple function call.
