...
on arm64 must be a power of 2 and in the range of [8, 2048].
...
In the following example, function Add is aligned to a 128 byte boundary.
  Examples:
    TEXT ·Add(SB),$40-16
    MOVD $2, R0
    PCALIGN $32
...
In the following example, PCALIGN at function Add entry will align its address.
