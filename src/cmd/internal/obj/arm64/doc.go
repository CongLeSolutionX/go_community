...
2. Treat the optional pattern specifier <pattern> as a separate operand. The <pattern> is the optional pattern specifier,
defaulting to ALL. It can be POW2, VL1, VL2, VL3, VL4, VL6, VL7, VL8, VL16, VL32, VL64, VL128, VL256, MUL4, MUL3 or ALL.
...
The pattern VL* indicates that the specified immediate index value is multiplied by the size of the addressed
vector or predicate in memory, measured in bytes, irrespective of predication.
