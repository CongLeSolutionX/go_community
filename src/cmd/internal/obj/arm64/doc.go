...
Register with arrangement and register with arrangement and index.
  ...
  Examples:
    ...
    VST1.P V9.S[1], (R16)(R21)                    <=>    st1 {v9.s}[1], [x16], x21
    VST1.P [V13.H8, V14.H8, V15.H8], (R3)(R14)    <=>    st1 {v13.8h-v15.8h}, [x3], x14
    VST1.P [V14.D1, V15.D1], (R7)(R23)            <=>    st1 {v14.1d, v15.1d}, [x7], x213
...
>>>>>>> 6195b574a7 (cmd/internal/obj/arm64: add assembly syntax for the SVE)
*/
package arm64
