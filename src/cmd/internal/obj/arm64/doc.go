...
Advanced SIMD and floating-point SIMD instructions:
...
4. Most SVE and SME instructions have no suffix.

5. 16-bit floating-point instructions have a "H" suffix.

6. Go adds a V and F prefix for most advanced SIMD and floating-point instructions respectively,
except cryptographic extension instructions and floating-point(scalar) instructions.
