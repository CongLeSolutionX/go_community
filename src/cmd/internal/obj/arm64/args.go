...
// This file contains arm64 instruction argument types, which is the almost
// the same with cmd/vendor/golang.org/x/arch/arm64/arm64asm/arg.go.
// Most of them are generated by ARM tool, a small part is customized.
...
//
// - arg_Xmn: encoded in Rm[20:16] and Rn[9:5] fields.
//
...
//
// - arg_Xs_2_pair_even:
//     two consective registers and the number of the first register must be an even number.
//     Encoded in Xs field.
//
// - arg_Xt_pair:
//     two registers encoded in Xt1 and Xt2 fields.

type argtype uint16

//go:generate stringer -type argtype -trimprefix arg_
const (
	...
	arg_immediate_MSL__a_b_c_d_e_f_g_h
	...
	arg_immediate_bitmask_64_N_imms_immr
	arg_immediate_cmode__8_0__16_1
	arg_immediate_exp_3_pre_4_a_b_c_d_e_f_g_h
	...
	arg_Vm_arrangement_16B
	arg_Vm_arrangement_2D
