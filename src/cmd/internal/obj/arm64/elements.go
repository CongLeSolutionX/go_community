...
const(
	...
	sa_const_REGLIST1_S
	// { <Zt1>.B-<Zt2>.B }
	sa_const_REGLIST2C_B
	// { <Zt1>.D-<Zt2>.D }
	sa_const_REGLIST2C_D
	// { <Zdn1>.H-<Zdn2>.H }
	sa_const_REGLIST2C_H
	// { <Zd1>.Q-<Zd2>.Q }
	sa_const_REGLIST2C_Q
	// { <Zn1>.S-<Zn2>.S }
	sa_const_REGLIST2C_S
	// { <Vn>.16B, <Vn+1>.16B }
	...
	sa_const_REGLIST3_S
	// { <Zt1>.B-<Zt4>.B }
	sa_const_REGLIST4C_B
	// { <Zt1>.D-<Zt4>.D }
	sa_const_REGLIST4C_D
	// { <Zdn1>.H-<Zdn4>.H }
	sa_const_REGLIST4C_H
	// { <Zn1>.Q-<Zn4>.Q }
	sa_const_REGLIST4C_Q
	// { <Zn1>.S-<Zn4>.S }
	sa_const_REGLIST4C_S
	// { <Vn>.16B, <Vn+1>.16B, <Vn+2>.16B, <Vn+3>.16B }
	sa_const_REGLIST4_16B
	// { <Zt1>.B, <Zt2>.B, <Zt3>.B, <Zt4>.B }
	sa_const_REGLIST4_B
	// { <Zt1>.D, <Zt2>.D, <Zt3>.D, <Zt4>.D }
	sa_const_REGLIST4_D
	...
	// <ZAd><HV>.H[<Ws>, <offsf>:<offsl>]
	sa_const_ZAHVTILESEL_H
	// <ZAd><HV>.S[<Ws>, <offsf>:<offsl>]
