...
func (c *ctxt7) brdist(p *obj.Prog, arg *oprd, preshift int, flen int, shift int) int64 {
	v := int64(0)
	t := int64(0)
	q := arg.target()
	if q == nil {
...
func (c *ctxt7) checkShiftAmount(p *obj.Prog, a *oprd) {
	var amount int16
	amount = (a.Index >> 5) & 7
	switch p.As {
	case AMOVB, AMOVBU:
...
func (c *ctxt7) mem_optional_imm12_unsigned(p *obj.Prog, arg *oprd, shift uint) uint32 {
...
func (c *ctxt7) mem_imm7_signed(p *obj.Prog, arg *oprd, shift uint) uint32 {
	c.isCRegOrRSP(p, arg.Reg)
	vo := arg.Offset
...
func (c *ctxt7) imm5___B_1__H_2__S_4__D_8_index__imm5__imm5lt41gt_1__imm5lt42gt_2__imm5lt43gt_4__imm5lt4gt_8_1(p *obj.Prog, arg *oprd) uint32 {
	imm5 := uint32(0)
	switch (arg.Reg >> 5) & 15 {
	case ARNG_D:
...
func (c *ctxt7) imm5___B_1__H_2__S_4_index__imm5__imm5lt41gt_1__imm5lt42gt_2__imm5lt43gt_4_1(p *obj.Prog, arg *oprd) uint32 {
	imm5 := uint32(0)
	index := arg.Index
	switch (arg.Reg >> 5) & 15 {
	case ARNG_B:
...
func (c *ctxt7) imm5___D_8_index__imm5_1(p *obj.Prog, arg *oprd) uint32 {
	af := (arg.Reg >> 5) & 15
	if af != ARNG_D {
		c.ctxt.Diag("invalid arrangement: %v", p)
	}
...
func (c *ctxt7) encodeArg(p *obj.Prog, arg *oprd, atyp argtype) uint32 {
	if arg == nil {
		return 0
	}
	switch atyp {
