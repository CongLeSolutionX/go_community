...
func dconClass(offset int64) int {
	...
	if tzb >= 12 {
		if lo20 == ST1 || lo20 == ALL1 {
			...
			if (hi20 == ST1 && hi12 == ALL1) || ((hi20 == ST0 || hi20 == ALL1) && hi12 == ALL0) {
...
func cmp(a int, b int) bool {
	...
	case C_DCON:
		if b == C_LCON || b == C_DCON32_0 ||
			...
			b == C_DCON0_20S || b == C_DCON12_20S ||
			b == C_DCON20S_20 || b == C_DCON32_20 ||
			b == C_DCON0_12S || b == C_DCON12_12S ||
			b == C_DCON20S_12S || b == C_DCON32_12S ||
			b == C_DCON0_32S || b == C_DCON12_32S ||
			b == C_DCON20S_32 || b == C_DCON12_12U ||
	...
	case C_DCON12_0:
		if b == C_DCON0_20S || b == C_DCON0_12S {
			return true
		}

	case C_DCON12_20S:
		if b == C_DCON20S_20 || b == C_DCON12_12S ||
			b == C_DCON20S_12S || b == C_DCON0_32S ||
