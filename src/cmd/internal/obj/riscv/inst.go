// Code generated by parse.py -go rv64_a rv64_i rv64_m rv64_f rv64_d rv_a rv_i rv_m rv_f rv_d rv_q rv64_q rv_system rv_zicsr rv_s rv_h rv64_h rv_q_zfh; DO NOT EDIT.
package riscv
...
func encode(a obj.As) *inst {
	...
	case AFCVTHQ:
		return &inst{0x53, 0x0, 0x3, 1091, 0x22}
	case AFCVTLD:
	...
	case AFCVTQH:
		return &inst{0x53, 0x0, 0x2, 1122, 0x23}
	case AFCVTQL:
	...
	case AHLVB:
		return &inst{0x73, 0x4, 0x0, 1536, 0x30}
	case AHLVBU:
		return &inst{0x73, 0x4, 0x1, 1537, 0x30}
	case AHLVD:
		return &inst{0x73, 0x4, 0x0, 1728, 0x36}
	case AHLVH:
		return &inst{0x73, 0x4, 0x0, 1600, 0x32}
	case AHLVHU:
		return &inst{0x73, 0x4, 0x1, 1601, 0x32}
	case AHLVW:
		return &inst{0x73, 0x4, 0x0, 1664, 0x34}
	case AHLVWU:
		return &inst{0x73, 0x4, 0x1, 1665, 0x34}
	case AHLVXHU:
		return &inst{0x73, 0x4, 0x3, 1603, 0x32}
	case AHLVXWU:
		return &inst{0x73, 0x4, 0x3, 1667, 0x34}
	case AHSVB:
		return &inst{0x73, 0x4, 0x0, 1568, 0x31}
	case AHSVD:
		return &inst{0x73, 0x4, 0x0, 1760, 0x37}
	case AHSVH:
		return &inst{0x73, 0x4, 0x0, 1632, 0x33}
	case AHSVW:
		return &inst{0x73, 0x4, 0x0, 1696, 0x35}
	case AJAL:
