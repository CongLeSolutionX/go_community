...
// Push records at that lineno a new file with the given name was pushed onto the input stack.
...
// Update records that at lineno the file name and line number was changed using
