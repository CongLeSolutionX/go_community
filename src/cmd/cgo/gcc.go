...
//
// The compiler command line is split into arguments on whitespace. It may
// contain single and double quotes, which are interpreted the same way
// #cgo directives are interpreted in .go files.
//
