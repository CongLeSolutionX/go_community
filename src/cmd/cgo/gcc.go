...
var badPointerTypedefs = map[string]bool{
	"darwin.CFNumberRef": true, // darwin uses low byte as a tag, packs up to 56-bit numbers
	"darwin.CFDateRef":   true,
	"darwin.CFTypeRef":   true, // superclass of CFNumberRef
	"linux.foo":          true, // for testing
}
