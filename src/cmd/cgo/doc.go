...
"sizeof_", such as a function named "struct_stat". A workaround is to
use a "#define" in the preamble, as in "#define c_struct_stat" and
then in the Go code refer to "C.c_struct_stat".
