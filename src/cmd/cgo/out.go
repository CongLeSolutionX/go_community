...
func _cgoCheckArray(ptrToArray interface{}) {
	if !_localCgoCheckArray(ptrToArray) {
		// TODO:
		// cgoCheckArray gets a pointer to an array or slice
		// cgoCheckPointer previously took
		//     a pointer to an element in the array
		//     a slice or array itself
		_localCgoCheckPointer(todo, *ptrToArray)
	}
}
