...
TEXT main·foo(SB),DUPOK|NOSPLIT,$16-0 // TEXT main.foo(SB), DUPOK|NOSPLIT, $16-0
	...
	VSTRC	V18, V19, V20, V21	// e75230006f8a 
        VSTRCB	V18, V19, V20, V21	// e75230006f8a
        VSTRCH	V18, V19, V20, V21	// e75231006f8a
        VSTRCF	V18, V19, V20, V21	// e75232006f8a
        VSTRCBS V18, V19, V20, V21	// e75230106f8a
        VSTRCHS V18, V19, V20, V21	// e75231106f8a
        VSTRCFS V18, V19, V20, V21	// e75232106f8a
        VSTRCZB V18, V19, V20, V21	// e75230206f8a
        VSTRCZH V18, V19, V20, V21	// e75231206f8a
        VSTRCZF V18, V19, V20, V21	// e75232206f8a
        VSTRCZBS V18, V19, V20, V21	// e75230306f8a
        VSTRCZHS V18, V19, V20, V21	// e75231306f8a
        VSTRCZFS V18, V19, V20, V21	// e75232306f8a
