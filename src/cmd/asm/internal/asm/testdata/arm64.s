...
// imsr comes from the old 7a, we only support immediates and registers
	...
	ADD	R1, ZR, R3
	ADD	$1, R2, R3
	ADD	$2730, R2, R3                   // 43a82a91
	ADD	$2730, R2                       // 42a82a91
	ADD	$11182080, R2, R3               // 43a86a91
	ADD	$11182080, R2                   // 42a86a91
	ADD	$11184810, R2, R3               // 43a82a9163a86a91
	ADD	$11184810, R2                   // 42a82a9142a86a91
	SUB	$2730, R2, R3                   // 43a82ad1
	SUB	$2730, R2                       // 42a82ad1
	SUB	$11182080, R2, R3               // 43a86ad1
	SUB	$11182080, R2                   // 42a86ad1
	SUB	$11184810, R2, R3               // 43a82ad163a86ad1
	SUB	$11184810, R2                   // 42a82ad142a86ad1
	ADD	R1>>11, R2, R3
	ADD	R1<<22, R2, R3
	ADD	R1->33, R2, R3
	AND	R1@>33, R2, R3
