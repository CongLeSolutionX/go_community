...
// atomic operation
	...
	LDADDD	R5, (R6), R7    // LDADDD (R6), R5, R7   // c70025f8
	LDADDD	R5, (RSP), R7   // LDADDD (RSP), R5, R7  // e70325f8
	LDADDW	R5, (R6), R7    // LDADDW (R6), R5, R7   // c70025b8
	LDADDW	R5, (RSP), R7   // LDADDW (RSP), R5, R7  // e70325b8
	LDADDH	R5, (R6), R7    // LDADDH (R6), R5, R7   // c7002578
	LDADDH	R5, (RSP), R7   // LDADDH (RSP), R5, R7  // e7032578
	LDADDB	R5, (R6), R7    // LDADDB (R6), R5, R7   // c7002538
	LDADDB	R5, (RSP), R7   // LDADDB (RSP), R5, R7  // e7032538
	LDANDD	R5, (R6), R7    // LDANDD (R6), R5, R7   // c71025f8
	LDANDD	R5, (RSP), R7   // LDANDD (RSP), R5, R7  // e71325f8
	LDANDW	R5, (R6), R7    // LDANDW (R6), R5, R7   // c71025b8
	LDANDW	R5, (RSP), R7   // LDANDW (RSP), R5, R7  // e71325b8
	LDANDH	R5, (R6), R7    // LDANDH (R6), R5, R7   // c7102578
	LDANDH	R5, (RSP), R7   // LDANDH (RSP), R5, R7  // e7132578
	LDANDB	R5, (R6), R7    // LDANDB (R6), R5, R7   // c7102538
	LDANDB	R5, (RSP), R7   // LDANDB (RSP), R5, R7  // e7132538
	LDEORD	R5, (R6), R7    // LDEORD (R6), R5, R7   // c72025f8
	LDEORD	R5, (RSP), R7   // LDEORD (RSP), R5, R7  // e72325f8
	LDEORW	R5, (R6), R7    // LDEORW (R6), R5, R7   // c72025b8
	LDEORW	R5, (RSP), R7   // LDEORW (RSP), R5, R7  // e72325b8
	LDEORH	R5, (R6), R7    // LDEORH (R6), R5, R7   // c7202578
	LDEORH	R5, (RSP), R7   // LDEORH (RSP), R5, R7  // e7232578
	LDEORB	R5, (R6), R7    // LDEORB (R6), R5, R7   // c7202538
	LDEORB	R5, (RSP), R7   // LDEORB (RSP), R5, R7  // e7232538
	LDORD	R5, (R6), R7    // LDORD (R6), R5, R7    // c73025f8
	LDORD	R5, (RSP), R7   // LDORD (RSP), R5, R7   // e73325f8
	LDORW	R5, (R6), R7    // LDORW (R6), R5, R7    // c73025b8
	LDORW	R5, (RSP), R7   // LDORW (RSP), R5, R7   // e73325b8
	LDORH	R5, (R6), R7    // LDORH (R6), R5, R7    // c7302578
	LDORH	R5, (RSP), R7   // LDORH (RSP), R5, R7   // e7332578
	LDORB	R5, (R6), R7    // LDORB (R6), R5, R7    // c7302538
	LDORB	R5, (RSP), R7   // LDORB (RSP), R5, R7   // e7332538
