...
TEXT errors(SB),$0
	...
	MSR	R6, AIDR_EL1                                     // ERROR "expected writable system register or pstate"
	MSR	R6, AMCFGR_EL0                                   // ERROR "expected writable system register or pstate"
	MSR	R6, AMCGCR_EL0                                   // ERROR "expected writable system register or pstate"
	MSR	R6, AMEVTYPER00_EL0                              // ERROR "expected writable system register or pstate"
	MSR	R6, AMEVTYPER01_EL0                              // ERROR "expected writable system register or pstate"
	MSR	R6, AMEVTYPER02_EL0                              // ERROR "expected writable system register or pstate"
	MSR	R6, AMEVTYPER03_EL0                              // ERROR "expected writable system register or pstate"
	MSR	R6, AMEVTYPER04_EL0                              // ERROR "expected writable system register or pstate"
	MSR	R6, AMEVTYPER05_EL0                              // ERROR "expected writable system register or pstate"
	MSR	R6, AMEVTYPER06_EL0                              // ERROR "expected writable system register or pstate"
	MSR	R6, AMEVTYPER07_EL0                              // ERROR "expected writable system register or pstate"
	MSR	R6, AMEVTYPER08_EL0                              // ERROR "expected writable system register or pstate"
	MSR	R6, AMEVTYPER09_EL0                              // ERROR "expected writable system register or pstate"
	MSR	R6, AMEVTYPER010_EL0                             // ERROR "expected writable system register or pstate"
	MSR	R6, AMEVTYPER011_EL0                             // ERROR "expected writable system register or pstate"
	MSR	R6, AMEVTYPER012_EL0                             // ERROR "expected writable system register or pstate"
	MSR	R6, AMEVTYPER013_EL0                             // ERROR "expected writable system register or pstate"
	MSR	R6, AMEVTYPER014_EL0                             // ERROR "expected writable system register or pstate"
	MSR	R6, AMEVTYPER015_EL0                             // ERROR "expected writable system register or pstate"
	MSR	R6, CCSIDR2_EL1                                  // ERROR "expected writable system register or pstate"
	MSR	R6, CCSIDR_EL1                                   // ERROR "expected writable system register or pstate"
	MSR	R6, CLIDR_EL1                                    // ERROR "expected writable system register or pstate"
	MSR	R6, CNTPCT_EL0                                   // ERROR "expected writable system register or pstate"
	MSR	R6, CNTVCT_EL0                                   // ERROR "expected writable system register or pstate"
	MSR	R6, CTR_EL0                                      // ERROR "expected writable system register or pstate"
	MSR	R6, CurrentEL                                    // ERROR "expected writable system register or pstate"
	MSR	R6, DBGAUTHSTATUS_EL1                            // ERROR "expected writable system register or pstate"
	MSR	R6, DBGDTRRX_EL0                                 // ERROR "expected writable system register or pstate"
	MSR	R6, DCZID_EL0                                    // ERROR "expected writable system register or pstate"
	MSR	R6, ERRIDR_EL1                                   // ERROR "expected writable system register or pstate"
	MSR	R6, ERXFR_EL1                                    // ERROR "expected writable system register or pstate"
	MSR	R6, ERXPFGF_EL1                                  // ERROR "expected writable system register or pstate"
	MSR	R6, GMID_EL1                                     // ERROR "expected writable system register or pstate"
	MSR	R6, ICC_HPPIR0_EL1                               // ERROR "expected writable system register or pstate"
	MSR	R6, ICC_HPPIR1_EL1                               // ERROR "expected writable system register or pstate"
	MSR	R6, ICC_IAR0_EL1                                 // ERROR "expected writable system register or pstate"
	MSR	R6, ICC_IAR1_EL1                                 // ERROR "expected writable system register or pstate"
	MSR	R6, ICC_RPR_EL1                                  // ERROR "expected writable system register or pstate"
	MSR	R6, ICV_HPPIR0_EL1                               // ERROR "expected writable system register or pstate"
	MSR	R6, ICV_HPPIR1_EL1                               // ERROR "expected writable system register or pstate"
	MSR	R6, ICV_IAR0_EL1                                 // ERROR "expected writable system register or pstate"
	MSR	R6, ICV_IAR1_EL1                                 // ERROR "expected writable system register or pstate"
	MSR	R6, ICV_RPR_EL1                                  // ERROR "expected writable system register or pstate"
	MSR	R6, ID_AA64AFR0_EL1                              // ERROR "expected writable system register or pstate"
	MSR	R6, ID_AA64AFR1_EL1                              // ERROR "expected writable system register or pstate"
	MSR	R6, ID_AA64DFR0_EL1                              // ERROR "expected writable system register or pstate"
	MSR	R6, ID_AA64DFR1_EL1                              // ERROR "expected writable system register or pstate"
	MSR	R6, ID_AA64ISAR0_EL1                             // ERROR "expected writable system register or pstate"
	MSR	R6, ID_AA64ISAR1_EL1                             // ERROR "expected writable system register or pstate"
	MSR	R6, ID_AA64MMFR0_EL1                             // ERROR "expected writable system register or pstate"
	MSR	R6, ID_AA64MMFR1_EL1                             // ERROR "expected writable system register or pstate"
	MSR	R6, ID_AA64MMFR2_EL1                             // ERROR "expected writable system register or pstate"
	MSR	R6, ID_AA64PFR0_EL1                              // ERROR "expected writable system register or pstate"
	MSR	R6, ID_AA64PFR1_EL1                              // ERROR "expected writable system register or pstate"
	MSR	R6, ID_AA64ZFR0_EL1                              // ERROR "expected writable system register or pstate"
	MSR	R6, ID_AFR0_EL1                                  // ERROR "expected writable system register or pstate"
	MSR	R6, ID_DFR0_EL1                                  // ERROR "expected writable system register or pstate"
	MSR	R6, ID_ISAR0_EL1                                 // ERROR "expected writable system register or pstate"
	MSR	R6, ID_ISAR1_EL1                                 // ERROR "expected writable system register or pstate"
	MSR	R6, ID_ISAR2_EL1                                 // ERROR "expected writable system register or pstate"
	MSR	R6, ID_ISAR3_EL1                                 // ERROR "expected writable system register or pstate"
	MSR	R6, ID_ISAR4_EL1                                 // ERROR "expected writable system register or pstate"
	MSR	R6, ID_ISAR5_EL1                                 // ERROR "expected writable system register or pstate"
	MSR	R6, ID_ISAR6_EL1                                 // ERROR "expected writable system register or pstate"
	MSR	R6, ID_MMFR0_EL1                                 // ERROR "expected writable system register or pstate"
	MSR	R6, ID_MMFR1_EL1                                 // ERROR "expected writable system register or pstate"
	MSR	R6, ID_MMFR2_EL1                                 // ERROR "expected writable system register or pstate"
	MSR	R6, ID_MMFR3_EL1                                 // ERROR "expected writable system register or pstate"
	MSR	R6, ID_MMFR4_EL1                                 // ERROR "expected writable system register or pstate"
	MSR	R6, ID_PFR0_EL1                                  // ERROR "expected writable system register or pstate"
	MSR	R6, ID_PFR1_EL1                                  // ERROR "expected writable system register or pstate"
	MSR	R6, ID_PFR2_EL1                                  // ERROR "expected writable system register or pstate"
	MSR	R6, ISR_EL1                                      // ERROR "expected writable system register or pstate"
	MSR	R6, LORID_EL1                                    // ERROR "expected writable system register or pstate"
	MSR	R6, MDCCSR_EL0                                   // ERROR "expected writable system register or pstate"
	MSR	R6, MDRAR_EL1                                    // ERROR "expected writable system register or pstate"
	MSR	R6, MIDR_EL1                                     // ERROR "expected writable system register or pstate"
	MSR	R6, MPAMIDR_EL1                                  // ERROR "expected writable system register or pstate"
	MSR	R6, MPIDR_EL1                                    // ERROR "expected writable system register or pstate"
	MSR	R6, MVFR0_EL1                                    // ERROR "expected writable system register or pstate"
	MSR	R6, MVFR1_EL1                                    // ERROR "expected writable system register or pstate"
	MSR	R6, MVFR2_EL1                                    // ERROR "expected writable system register or pstate"
	MSR	R6, OSLSR_EL1                                    // ERROR "expected writable system register or pstate"
	MSR	R6, PMBIDR_EL1                                   // ERROR "expected writable system register or pstate"
	MSR	R6, PMCEID0_EL0                                  // ERROR "expected writable system register or pstate"
	MSR	R6, PMCEID1_EL0                                  // ERROR "expected writable system register or pstate"
	MSR	R6, PMMIR_EL1                                    // ERROR "expected writable system register or pstate"
	MSR	R6, PMSIDR_EL1                                   // ERROR "expected writable system register or pstate"
	MSR	R6, REVIDR_EL1                                   // ERROR "expected writable system register or pstate"
	MSR	R6, RNDR                                         // ERROR "expected writable system register or pstate"
	MRS	DBGDTRTX_EL0, R5                                 // ERROR "expected readable system register"
	MRS	ICV_DIR_EL1, R5                                  // ERROR "expected readable system register"
	MRS	ICC_SGI1R_EL1, R5                                // ERROR "expected readable system register"
	MRS	ICC_SGI0R_EL1, R5                                // ERROR "expected readable system register"
	MRS	ICC_EOIR1_EL1, R5                                // ERROR "expected readable system register"
	MRS	ICC_EOIR0_EL1, R5                                // ERROR "expected readable system register"
	MRS	ICC_DIR_EL1, R5                                  // ERROR "expected readable system register"
	MRS	ICC_ASGI1R_EL1, R5                               // ERROR "expected readable system register"
	MRS	ICV_EOIR0_EL1, R3                                // ERROR "expected readable system register"
	MRS	ICV_EOIR1_EL1, R3                                // ERROR "expected readable system register"
	MRS	PMSWINC_EL0, R3                                  // ERROR "expected readable system register"
