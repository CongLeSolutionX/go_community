...
TEXT errors(SB),$0
	...
	LDADDD	R5, (R6), ZR                                     // ERROR "illegal destination register ZR"
	LDADDW	R5, (R6), ZR                                     // ERROR "illegal destination register ZR"
	LDADDH	R5, (R6), ZR                                     // ERROR "illegal destination register ZR"
	LDADDB	R5, (R6), ZR                                     // ERROR "illegal destination register ZR"
	LDADDLD	R5, (R6), ZR                                     // ERROR "illegal destination register ZR"
	LDADDLW	R5, (R6), ZR                                     // ERROR "illegal destination register ZR"
	LDADDLH	R5, (R6), ZR                                     // ERROR "illegal destination register ZR"
	LDADDLB	R5, (R6), ZR                                     // ERROR "illegal destination register ZR"
	LDANDD	R5, (R6), ZR                                     // ERROR "illegal destination register ZR"
	LDANDW	R5, (R6), ZR                                     // ERROR "illegal destination register ZR"
	LDANDH	R5, (R6), ZR                                     // ERROR "illegal destination register ZR"
	LDANDB	R5, (R6), ZR                                     // ERROR "illegal destination register ZR"
	LDANDLD	R5, (R6), ZR                                     // ERROR "illegal destination register ZR"
	LDANDLW	R5, (R6), ZR                                     // ERROR "illegal destination register ZR"
	LDANDLH	R5, (R6), ZR                                     // ERROR "illegal destination register ZR"
	LDANDLB	R5, (R6), ZR                                     // ERROR "illegal destination register ZR"
	LDEORD	R5, (R6), ZR                                     // ERROR "illegal destination register ZR"
	LDEORW	R5, (R6), ZR                                     // ERROR "illegal destination register ZR"
	LDEORH	R5, (R6), ZR                                     // ERROR "illegal destination register ZR"
	LDEORB	R5, (R6), ZR                                     // ERROR "illegal destination register ZR"
	LDEORLD	R5, (R6), ZR                                     // ERROR "illegal destination register ZR"
	LDEORLW	R5, (R6), ZR                                     // ERROR "illegal destination register ZR"
	LDEORLH	R5, (R6), ZR                                     // ERROR "illegal destination register ZR"
	LDEORLB	R5, (R6), ZR                                     // ERROR "illegal destination register ZR"
	LDORD	R5, (R6), ZR                                     // ERROR "illegal destination register ZR"
	LDORW	R5, (R6), ZR                                     // ERROR "illegal destination register ZR"
	LDORH	R5, (R6), ZR                                     // ERROR "illegal destination register ZR"
	LDORB	R5, (R6), ZR                                     // ERROR "illegal destination register ZR"
	LDORLD	R5, (R6), ZR                                     // ERROR "illegal destination register ZR"
	LDORLW	R5, (R6), ZR                                     // ERROR "illegal destination register ZR"
	LDORLH	R5, (R6), ZR                                     // ERROR "illegal destination register ZR"
	LDORLB	R5, (R6), ZR                                     // ERROR "illegal destination register ZR"
	RET
