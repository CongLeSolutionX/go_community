...
TEXT errors(SB),$0
	...
	ADDS	R5, R6, RSP                                      // ERROR "illegal combination"
	SUBS	R5, R6, RSP                                      // ERROR "illegal combination"
	ADDSW	R5, R6, RSP                                      // ERROR "illegal combination"
	SUBSW	R5, R6, RSP                                      // ERROR "illegal combination"
	...
	VFMLA	V1.H4, V12.H4, V3.H8                             // ERROR "operand mismatch"
	...
	VPMULL	V1.H4, V2.H4, V3.Q1                              // ERROR "invalid arrangement specifier"
	VPMULL	V1.D2, V2.D2, V3.Q1                              // ERROR "invalid arrangement specifier"
	VPMULL	V1.B16, V2.B16, V3.H8                            // ERROR "invalid arrangement specifier"
	VPMULL2	V1.D2, V2.H4, V3.Q1                              // ERROR "invalid arrangement specifier"
	VPMULL2	V1.H4, V2.H4, V3.Q1                              // ERROR "invalid arrangement specifier"
	VPMULL2	V1.D1, V2.D1, V3.Q1                              // ERROR "invalid arrangement specifier"
	VPMULL2	V1.B8, V2.B8, V3.H8                              // ERROR "invalid arrangement specifier"
	VEXT	$8, V1.B16, V2.B8, V2.B16                        // ERROR "operand mismatch"
	VEXT	$8, V1.H8, V2.H8, V2.H8                          // ERROR "invalid arrangement"
	VRBIT	V1.B16, V2.B8                                    // ERROR "operand mismatch"
	VRBIT	V1.H4, V2.H4                                     // ERROR "invalid arrangement"
	VUSHR	$15, V1.D2, V2.H4                                // ERROR "operand mismatch"
	VUSHR	$127, V1.D2, V2.D2                               // ERROR "shift out of range 1 to 64"
	...
	VUXTL	V30.D2, V30.H8                                   // ERROR "invalid arrangement specifier"
	VUXTL2	V20.B8, V21.H8                                   // ERROR "invalid arrangement specifier"
	VUXTL	V3.D2, V4.B8                                     // ERROR "invalid arrangement specifier"
	VUZP1	V0.B8, V30.B8, V1.B16                            // ERROR "operand mismatch"
	VUZP2	V0.Q1, V30.Q1, V1.Q1                             // ERROR "invalid arrangement"
	VUSHLL	$0, V30.D2, V30.H8                               // ERROR "invalid arrangement specifier"
	VUSHLL2	$0, V20.B8, V21.H8                               // ERROR "invalid arrangement specifier"
	VUSHLL	$8, V30.B8, V30.H8                               // ERROR "shift amount out of range 0 to 7"
	VUSHLL2	$32, V30.S4, V2.D2                               // ERROR "shift amount out of range 0 to 31"
	...
	VUADDW2	V9.B8, V12.S4, V14.S4                            // ERROR "invalid arrangement specifier"
	...
	ADDS	R2<<3, R3, RSP                                   // ERROR "illegal combination"
	...
	DC	PLDL1KEEP                                        // ERROR "illegal combination"
	DC	VMALLE1IS                                        // ERROR "illegal combination"
	DC	VAE1IS                                           // ERROR "illegal combination"
	DC	VAE1IS, R0                                       // ERROR "illegal argument"
	DC	IVAC                                             // ERROR "illegal combination"
	...
	SHA1H	V1.B16, V2.B16                                   // ERROR "illegal combination"
	RET
