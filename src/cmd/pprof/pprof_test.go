...
func TestDisasm(t *testing.T) {
	...
	// N.B. -buildmode=pie is default on Windows, but pprof can't
	// disassemle PIE. See https://golang.org/issue/46639.
	cmd := exec.Command(testenv.GoToolPath(t), "build", "-buildmode=exe", "-o", cpuExe, "cpu.go")
	cmd.Dir = "testdata/"
