...
X10 – X17, X8, X9, X18 – X23, this none numberical order is followed the order of psABI A0 – A7, S0 – S7
which makes assembly and disassembly much easier to understand and tools implement.
F10 – F17, F8, F9, F18 – F23 (FA0 - FA7, FS0-FS7) same reason above.
