...
*Rationale*: These register meanings are compatible with Go’s
stack-based calling convention. Context register X20 will change to X26 before this
register ABI been adopted. X8 – X15, F8 – F15 is used for compressed
...
*Rationale*: No hardware nor OS require stack pointer alignment to 16 bytes but
riscv psabi do limited stack alignment to 16 bytes.
