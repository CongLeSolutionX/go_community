...
// (approximately) GOGC will be reset to 100.  If GOGC is supplied as an
// environment variable, this function has no effect and the explicit request
// takes priority.
//
// Setting the environment variable GO_gc_LOG_HEAP_TWEAKS to a non-empty
// string will log GC-provoked GC adjustments to os.Stderr.
//
