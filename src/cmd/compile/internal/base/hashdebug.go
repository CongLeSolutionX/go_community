...
//  4. OR if evname(i) is a suffix of the sha1 hash of name
...
//
//  6. gossahash should return the (hopefully) single function whose
//     miscompilation causes the problem, and you can focus on that.
//
