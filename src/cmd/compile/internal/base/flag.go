...
func ParseFlags() {
	...
	*Flag.DwarfLocationLists = true
	...
	//  -2 => no change, log opportunities [is this worth supporting?]
	//  -1 => no change
	...
	// (**) For debugging purposes, provideing loopvar flag >= 11 will expand the hash-eligible set of loops to all.
