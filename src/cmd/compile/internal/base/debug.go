...
type DebugFlags struct {
	...
	WriteInlScoreAdjTab   string `help:"writes inliner's score adjustment table to file specified as arg"`
	ReadInlScoreAdjTab    string `help:"reads file and applies contents to inliner's score adjustment table" concurrent:"ok"`
