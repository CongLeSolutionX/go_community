...
type DebugFlags struct {
	...
	PGOBBReorder          int    `help:"enable basic block reordering in pgo mode, 0 to disable, 1 to enable simple heuristics based on raw block profile, 2 to enable simple heuristics based on heuristically constructed edge profile"`
