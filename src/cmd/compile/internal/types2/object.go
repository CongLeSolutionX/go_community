...
// Origin returns the canonical Var for its receiver, i.e. the object
// recorded in Info.Defs.
//
// For synthetic Vars (such as struct fields or function parameters that depend
// on type arguments), this will be the corresponding Var on the generic
// declaration. For all other variables Origin returns the receiver.
...
// Origin returns the canonical Func its receiver, i.e. the Func object
// recorded in Info.Defs.
//
