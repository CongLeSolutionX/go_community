...
type Object interface {
	...
	Pos() srcPos    // position of object identifier in declaration
...
func (obj *object) Pos() srcPos { return obj.pos }
...
func (obj *object) scopePos() srcPos { return obj.scopePos_ }

func (obj *object) setParent(parent *Scope) { obj.parent = parent }
func (obj *object) setType(typ Type)        { obj.typ = typ }
func (obj *object) setOrder(order uint32)   { assert(order > 0); obj.order_ = order }
func (obj *object) setColor(color color)    { assert(color != white); obj.color_ = color }
func (obj *object) setScopePos(pos srcPos)  { obj.scopePos_ = pos }
...
func NewPkgName(pos srcPos, pkg *Package, name string, imported *Package) *PkgName {
...
// The remaining arguments set the attributes found with all Objects.
func NewConst(pos srcPos, pkg *Package, name string, typ Type, val constant.Value) *Const {
...
// effect.
func NewTypeName(pos srcPos, pkg *Package, name string, typ Type) *TypeName {
	return &TypeName{object{nil, pos, pkg, name, typ, 0, colorFor(typ), nopos}}
}

// NewTypeNameLazy returns a new defined type like NewTypeName, but it
// lazily calls resolve to finish constructing the Named object.
func NewTypeNameLazy(pos srcPos, pkg *Package, name string, load func(named *Named) (tparams []*TypeParam, underlying Type, methods []*Func)) *TypeName {
...
func NewVar(pos srcPos, pkg *Package, name string, typ Type) *Var {
	return &Var{object: object{nil, pos, pkg, name, typ, 0, colorFor(typ), nopos}}
}

// NewParam returns a new variable representing a function parameter.
func NewParam(pos srcPos, pkg *Package, name string, typ Type) *Var {
...
func NewField(pos srcPos, pkg *Package, name string, typ Type, embedded bool) *Var {
...
// the function's type.
func NewFunc(pos srcPos, pkg *Package, name string, sig *Signature) *Func {
...
func NewLabel(pos srcPos, pkg *Package, name string) *Label {
