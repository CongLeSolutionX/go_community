...
var gcArchSizes = map[string]*StdSizes{
	"386":      {WordSize: 4, MaxAlign: 4, gcSizes: &gcSizes{4, 4}},
	"amd64":    {WordSize: 8, MaxAlign: 8, gcSizes: &gcSizes{8, 8}},
	"amd64p32": {WordSize: 4, MaxAlign: 8, gcSizes: &gcSizes{4, 8}},
	"arm":      {WordSize: 4, MaxAlign: 4, gcSizes: &gcSizes{4, 4}},
	"arm64":    {WordSize: 8, MaxAlign: 8, gcSizes: &gcSizes{8, 8}},
	"loong64":  {WordSize: 8, MaxAlign: 8, gcSizes: &gcSizes{8, 8}},
	"mips":     {WordSize: 4, MaxAlign: 4, gcSizes: &gcSizes{4, 4}},
	"mipsle":   {WordSize: 4, MaxAlign: 4, gcSizes: &gcSizes{4, 4}},
	"mips64":   {WordSize: 8, MaxAlign: 8, gcSizes: &gcSizes{8, 8}},
	"mips64le": {WordSize: 8, MaxAlign: 8, gcSizes: &gcSizes{8, 8}},
	"ppc64":    {WordSize: 8, MaxAlign: 8, gcSizes: &gcSizes{8, 8}},
	"ppc64le":  {WordSize: 8, MaxAlign: 8, gcSizes: &gcSizes{8, 8}},
	"riscv64":  {WordSize: 8, MaxAlign: 8, gcSizes: &gcSizes{8, 8}},
	"s390x":    {WordSize: 8, MaxAlign: 8, gcSizes: &gcSizes{8, 8}},
	"sparc64":  {WordSize: 8, MaxAlign: 8, gcSizes: &gcSizes{8, 8}},
	"wasm":     {WordSize: 8, MaxAlign: 8, gcSizes: &gcSizes{8, 8}},
