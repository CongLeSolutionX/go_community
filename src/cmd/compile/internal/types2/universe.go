...
func init() {
	...
	universeComparable = Universe.Lookup("comparable").(*TypeName)

	// "any" is only visible as constraint in a type parameter list
	delete(Universe.elems, "any")

	// "comparable" is only visible with Go 1.18 or later
	delete(Universe.elems, "comparable")
}
