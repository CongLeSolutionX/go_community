...
// which are used to report a version error of allowVersion returns false.
func (check *Checker) allowVersionf(pkg *Package, at poser, major, minor int, format string, args ...any) bool {
