...
func (t *TypeParam) iface() *Interface {
	...
	case *Interface:
		if underIsIface && isTypeParam(bound) {
...
// singleType returns the single type of the type parameters's constraint; or nil.
...
// If there are no specific terms, i.e., no calls to f, the result is false.
