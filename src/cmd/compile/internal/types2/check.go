...
// If debug is set, setDesc sets a printf-formatted description for action a.
// Otherwise, it is a no-op.
func (a *action) setDesc(pos poser, format string, args ...interface{}) {
	if debug {
...
// via action.setDesc for debugging, if desired.
