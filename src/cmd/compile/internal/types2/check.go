...
// brokenAlias records that alias doesn't have determined type yet.
...
// validAlias records that alias has the valid type typ.
// Note that typ may be Typ[Invalid].
func (check *Checker) validAlias(alias *TypeName, typ Type) {
	delete(check.brokenAliases, alias)
	alias.typ = typ
}

// isBrokenAlias reports whether alias has a valid type.
