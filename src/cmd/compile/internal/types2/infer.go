...
// of the type parameters in tparams occured in the type.
// In any case, if typ is a generic type or function, type parameters held with typ
// are not changed and must be updated separately if desired.
