...
func (w *monoGraph) recordInstance(pkg *Package, pos srcPos, tparams []*TypeParam, targs []Type, xlist []syntax.Expr) {
...
func (w *monoGraph) assign(pkg *Package, pos srcPos, tpar *TypeParam, targ Type) {
...
func (w *monoGraph) addEdge(dst, src, weight int, pos srcPos, typ Type) {
