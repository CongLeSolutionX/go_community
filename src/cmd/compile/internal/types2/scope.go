...
type Scope struct {
	...
	pos, end srcPos            // scope extent; may be invalid
...
func NewScope(parent *Scope, pos, end srcPos, comment string) *Scope {
...
func (s *Scope) LookupParent(name string, pos srcPos) (*Scope, Object) {
...
func (s *Scope) Pos() srcPos { return s.pos }
func (s *Scope) End() srcPos { return s.end }

// Contains reports whether pos is within the scope's extent.
// The result is guaranteed to be valid only if the type-checked
// AST has complete position information.
func (s *Scope) Contains(pos srcPos) bool {
...
// The result is guaranteed to be valid only if the type-checked
// AST has complete position information.
func (s *Scope) Innermost(pos srcPos) *Scope {
...
func (*lazyObject) Pos() srcPos                           { panic("unreachable") }
...
func (*lazyObject) scopePos() srcPos                      { panic("unreachable") }
func (*lazyObject) setScopePos(pos srcPos)                { panic("unreachable") }
