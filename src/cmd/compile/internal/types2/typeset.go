...
func computeInterfaceTypeSet(check *Checker, pos srcPos, ityp *Interface) *_TypeSet {
	if ityp.tset != nil {
		return ityp.tset
	}
	...
	var seen objset
	var allMethods []*Func
	mpos := make(map[*Func]srcPos) // method specification or method embedding position, for good error messages
	addMethod := func(pos srcPos, m *Func, explicit bool) {
	...
	for i, typ := range ityp.embeddeds {
		...
		var pos srcPos // embedding position
...
func computeUnionTypeSet(check *Checker, unionSets map[*Union]*_TypeSet, pos srcPos, utyp *Union) *_TypeSet {
