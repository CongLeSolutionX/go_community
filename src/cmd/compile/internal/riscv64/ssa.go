...
func ssaGenValue(s *ssagen.State, v *ssa.Value) {
	...
	case ssa.OpRISCV64ADD, ssa.OpRISCV64SUB, ssa.OpRISCV64SUBW, ssa.OpRISCV64XOR, ssa.OpRISCV64OR, ssa.OpRISCV64AND,
		...
		ssa.OpRISCV64ANDN, ssa.OpRISCV64ORN, ssa.OpRISCV64XNOR, ssa.OpRISCV64ROL, ssa.OpRISCV64ROLW,
	...
	case ssa.OpRISCV64FSQRTS, ssa.OpRISCV64FNEGS, ssa.OpRISCV64FABSD, ssa.OpRISCV64FSQRTD, ssa.OpRISCV64FNEGD,
		...
		ssa.OpRISCV64CLZ, ssa.OpRISCV64CLZW, ssa.OpRISCV64CTZ, ssa.OpRISCV64CTZW,
		ssa.OpRISCV64CPOP, ssa.OpRISCV64CPOPW, ssa.OpRISCV64REV8:
		p := s.Prog(v.Op.Asm())
		p.From.Type = obj.TYPE_REG
		p.From.Reg = v.Args[0].Reg()
		p.To.Type = obj.TYPE_REG
...
<<<<<<< PATCH SET (1c8d65 cmd/compiler: extend compiler for Zba, Zbb, Zbs instructions)
		...
		ssa.OpRISCV64SLTIU, ssa.OpRISCV64SLLIUW, ssa.OpRISCV64RORI, ssa.OpRISCV64RORIW,
