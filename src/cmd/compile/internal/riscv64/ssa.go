...
func loadByType(t *types.Type) obj.As {
	...
	if t.IsFloat() {
		...
		case 8:
			return riscv.AMOVD
		default:
			base.Fatal("unknown float width for load %d in type %v", width, t)
			return 0
		}
	}
	...
	case 8:
		return riscv.AMOV
	default:
		base.Fatal("unknown width for load %d in type %v", width, t)
		return 0
	}
}
...
func storeByType(t *types.Type) obj.As {
	...
	if t.IsFloat() {
		...
		case 8:
			return riscv.AMOVD
		default:
			base.Fatal("unknown float width for store %d in type %v", width, t)
			return 0
		}
	}
	...
	case 8:
		return riscv.AMOV
	default:
		base.Fatal("unknown width for store %d in type %v", width, t)
		return 0
	}
}
