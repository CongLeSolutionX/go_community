...
func Info(fnsym *obj.LSym, infosym *obj.LSym, curfn interface{}) ([]dwarf.Scope, dwarf.InlCalls) {
	...
	if isODCLFUNC {
		for _, n := range fn.Dcl {
			...
			base.Ctxt.DwarfCtxt.DefGoTypeDefault(reflectdata.DwarfType{Type: n.Type()})
...
func createDwarfVars(fnsym *obj.LSym, complexOK bool, fn *ir.Func, apDecls []*ir.Name) ([]*ir.Name, []*dwarf.Var) {
	...
	for _, n := range dcl {
		...
		vars = append(vars, &dwarf.Var{
			...
			Type:          dwctxt.DefGoTypeDefault(reflectdata.DwarfType{Type: n.Type()}),
...
func createSimpleVar(fnsym *obj.LSym, n *ir.Name) *dwarf.Var {
	...
	return &dwarf.Var{
		...
		Type:          base.Ctxt.DwarfCtxt.DefGoTypeDefault(reflectdata.DwarfType{Type: n.Type()}),
		DeclFile:      declpos.RelFilename(),
		DeclLine:      declpos.RelLine(),
		DeclCol:       declpos.RelCol(),
		InlIndex:      int32(inlIndex),
