...
// errors are compared against the errors declared in the those files.
//
...
// with any white space around rx stripped.
//
...
// If multiple error comments appear before a token, only the last
// one is considered.
