...
func TestNumbers(t *testing.T) {
	for _, test := range []struct {
		...
		{FloatLit, "0b1e10", "0b1e10", "invalid exponent on binary literal"},
		{FloatLit, "0b1P-1", "0b1P-1", "invalid exponent on binary literal"},
		...
		{FloatLit, "0o1E+2", "0o1E+2", "invalid exponent on octal literal"},
		{FloatLit, "0o1p10", "0o1p10", "invalid exponent on octal literal"},
		...
		{FloatLit, "0p0", "0p0", "invalid exponent 'p' on decimal float literal"},
		{FloatLit, "1.0P-1", "1.0P-1", "invalid exponent 'P' on decimal float literal"},
		...
		{FloatLit, "0x0.", "0x0.", "hexadecimal float literal requires an exponent"},
		{FloatLit, "0x.0", "0x.0", "hexadecimal float literal requires an exponent"},
		{FloatLit, "0x1.1", "0x1.1", "hexadecimal float literal requires an exponent"},
		{FloatLit, "0x1.1e0", "0x1.1e0", "hexadecimal float literal requires an exponent"},
		{FloatLit, "0x1.2gp1a", "0x1.2 gp1a", "hexadecimal float literal requires an exponent"},
		...
		{IntLit, "0b__1000", "0b__1000", "'_' does not separate consecutive digits"},
		{IntLit, "0o60___0", "0o60___0", "'_' does not separate consecutive digits"},
		{IntLit, "0466_", "0466_", "'_' does not separate consecutive digits"},
		{FloatLit, "1_.", "1_.", "'_' does not separate consecutive digits"},
		{FloatLit, "0._1", "0._1", "'_' does not separate consecutive digits"},
		{FloatLit, "2.7_e0", "2.7_e0", "'_' does not separate consecutive digits"},
		{ImagLit, "10e+12_i", "10e+12_i", "'_' does not separate consecutive digits"},
		{IntLit, "0x___0", "0x___0", "'_' does not separate consecutive digits"},
		{FloatLit, "0x1.0_p0", "0x1.0_p0", "'_' does not separate consecutive digits"},
	} {
		var s scanner
		var err string
