...
func TestNumbers(t *testing.T) {
	for _, test := range []struct {
		...
		{IntLit, "0b__1000", "0b__1000", "'_' does not separate successive digits"},
		{IntLit, "0o60___0", "0o60___0", "'_' does not separate successive digits"},
		{IntLit, "0466_", "0466_", "'_' does not separate successive digits"},
		{FloatLit, "1_.", "1_.", "'_' does not separate successive digits"},
		{FloatLit, "0._1", "0._1", "'_' does not separate successive digits"},
		{FloatLit, "2.7_e0", "2.7_e0", "'_' does not separate successive digits"},
		{ImagLit, "10e+12_i", "10e+12_i", "'_' does not separate successive digits"},
		{IntLit, "0x___0", "0x___0", "'_' does not separate successive digits"},
		{FloatLit, "0x1.0_p0", "0x1.0_p0", "'_' does not separate successive digits"},
	} {
		var s scanner
		var err string
