...
func Declare(n *ir.Name, ctxt ir.Class) {
	...
	// kludgy: TypecheckAllowed means we're past parsing. Eg genwrapper may declare out of package names later.
...
var funcStack []funcStackEnt // stack of previous values of Curfn/DeclContext
