...
// AddrTakenImplyStackObject represents whether an address taken variable requires
// a stack object. This is applied to all OADDR nodes introduced during noder.
