...
func runtimeTypes() []*types.Type {
	...
	typs[150] = newSig(params(typs[7], typs[62], typs[149], typs[28], typs[15]), params(typs[62]))
	typs[151] = newSig(params(typs[9], typs[6]), nil)
	return typs[:]
}
