...
var runtimeDecls = [...]struct {
	...
	{"concatbyte2", funcTag, 155},
	{"concatbyte3", funcTag, 156},
	{"concatbyte4", funcTag, 157},
	{"concatbyte5", funcTag, 158},
	{"concatbytes", funcTag, 159},
}
...
func runtimeTypes() []*types.Type {
	...
	typs[155] = newSig(params(typs[33], typs[28], typs[28]), params(typs[49]))
	typs[156] = newSig(params(typs[33], typs[28], typs[28], typs[28]), params(typs[49]))
	typs[157] = newSig(params(typs[33], typs[28], typs[28], typs[28], typs[28]), params(typs[49]))
	typs[158] = newSig(params(typs[33], typs[28], typs[28], typs[28], typs[28], typs[28]), params(typs[49]))
	typs[159] = newSig(params(typs[33], typs[38]), params(typs[49]))
	return typs[:]
}
