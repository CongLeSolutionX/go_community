...
var runtimeDecls = [...]struct {
	...
	{"mapextra", typeTag, 0},
	{"g", typeTag, 0},
	{"lockRankStruct", typeTag, 177},
	{"lockRankStruct_on", typeTag, 179},
	{"lockRank", typeTag, 15},
	{"itab", typeTag, 183},
	{"interfacetype", typeTag, 187},
	{"name", typeTag, 188},
	{"imethod", typeTag, 191},
	{"_type", typeTag, 193},
	{"nameOff", typeTag, 12},
...
func runtimeTypes() []*types.Type {
	var stringStructDWARFType = importtype(src.NoXPos, ir.Pkgs.Runtime.Lookup("stringStructDWARF")).Type()
	var sliceType = importtype(src.NoXPos, ir.Pkgs.Runtime.Lookup("slice")).Type()
	var hmapType = importtype(src.NoXPos, ir.Pkgs.Runtime.Lookup("hmap")).Type()
	var bmapType = importtype(src.NoXPos, ir.Pkgs.Runtime.Lookup("bmap")).Type()
	var sudogType = importtype(src.NoXPos, ir.Pkgs.Runtime.Lookup("sudog")).Type()
	var waitqType = importtype(src.NoXPos, ir.Pkgs.Runtime.Lookup("waitq")).Type()
	var mutexType = importtype(src.NoXPos, ir.Pkgs.Runtime.Lookup("mutex")).Type()
	...
	typs[151] = types.NewStruct(types.NoPkg, []*types.Field{types.NewField(src.NoXPos, Lookup("str"), typs[1]), types.NewField(src.NoXPos, Lookup("len"), typs[15])})
	typs[152] = types.NewStruct(types.NoPkg, []*types.Field{types.NewField(src.NoXPos, Lookup("array"), typs[7]), types.NewField(src.NoXPos, Lookup("len"), typs[15]), types.NewField(src.NoXPos, Lookup("cap"), typs[15])})
	typs[153] = mapextraType
	typs[154] = types.NewPtr(typs[153])
	typs[155] = types.NewStruct(types.NoPkg, []*types.Field{types.NewField(src.NoXPos, Lookup("count"), typs[15]), types.NewField(src.NoXPos, Lookup("flags"), typs[66]), types.NewField(src.NoXPos, Lookup("B"), typs[66]), types.NewField(src.NoXPos, Lookup("noverflow"), typs[60]), types.NewField(src.NoXPos, Lookup("hash0"), typs[62]), types.NewField(src.NoXPos, Lookup("buckets"), typs[7]), types.NewField(src.NoXPos, Lookup("oldbuckets"), typs[7]), types.NewField(src.NoXPos, Lookup("nevacuate"), typs[5]), types.NewField(src.NoXPos, Lookup("extra"), typs[154])})
	typs[156] = types.NewArray(typs[66], 8)
	typs[157] = types.NewStruct(types.NoPkg, []*types.Field{types.NewField(src.NoXPos, Lookup("tophash"), typs[156])})
	typs[158] = gType
	typs[159] = types.NewPtr(typs[158])
	typs[160] = sudogType
	typs[161] = types.NewPtr(typs[160])
	typs[162] = hchanType
	typs[163] = types.NewPtr(typs[162])
	typs[164] = types.NewStruct(types.NoPkg, []*types.Field{types.NewField(src.NoXPos, Lookup("g"), typs[159]), types.NewField(src.NoXPos, Lookup("next"), typs[161]), types.NewField(src.NoXPos, Lookup("prev"), typs[161]), types.NewField(src.NoXPos, Lookup("elem"), typs[7]), types.NewField(src.NoXPos, Lookup("acquiretime"), typs[22]), types.NewField(src.NoXPos, Lookup("releasetime"), typs[22]), types.NewField(src.NoXPos, Lookup("ticket"), typs[62]), types.NewField(src.NoXPos, Lookup("isSelect"), typs[6]), types.NewField(src.NoXPos, Lookup("success"), typs[6]), types.NewField(src.NoXPos, Lookup("parent"), typs[161]), types.NewField(src.NoXPos, Lookup("waitlink"), typs[161]), types.NewField(src.NoXPos, Lookup("waittail"), typs[161]), types.NewField(src.NoXPos, Lookup("c"), typs[163])})
	typs[165] = types.NewStruct(types.NoPkg, []*types.Field{types.NewField(src.NoXPos, Lookup("first"), typs[161]), types.NewField(src.NoXPos, Lookup("last"), typs[161])})
	typs[166] = lockRankStructType
	typs[167] = types.NewStruct(types.NoPkg, []*types.Field{newEmbedFiled(src.NoXPos, Lookup("lockRankStruct"), typs[166]), types.NewField(src.NoXPos, Lookup("key"), typs[5])})
	typs[168] = _typeType
	typs[169] = types.NewPtr(typs[168])
	typs[170] = waitqType
	typs[171] = mutexType
	typs[172] = types.NewStruct(types.NoPkg, []*types.Field{types.NewField(src.NoXPos, Lookup("qcount"), typs[17]), types.NewField(src.NoXPos, Lookup("dataqsiz"), typs[17]), types.NewField(src.NoXPos, Lookup("buf"), typs[7]), types.NewField(src.NoXPos, Lookup("elemsize"), typs[60]), types.NewField(src.NoXPos, Lookup("closed"), typs[62]), types.NewField(src.NoXPos, Lookup("elemtype"), typs[169]), types.NewField(src.NoXPos, Lookup("sendx"), typs[17]), types.NewField(src.NoXPos, Lookup("recvx"), typs[17]), types.NewField(src.NoXPos, Lookup("recvq"), typs[170]), types.NewField(src.NoXPos, Lookup("sendq"), typs[170]), types.NewField(src.NoXPos, Lookup("lock"), typs[171])})
	typs[173] = types.NewStruct(types.NoPkg, []*types.Field{types.NewField(src.NoXPos, Lookup("_type"), typs[169]), types.NewField(src.NoXPos, Lookup("data"), typs[7])})
	typs[174] = itabType
	typs[175] = types.NewPtr(typs[174])
	typs[176] = types.NewStruct(types.NoPkg, []*types.Field{types.NewField(src.NoXPos, Lookup("tab"), typs[175]), types.NewField(src.NoXPos, Lookup("data"), typs[7])})
	typs[177] = types.NewStruct(types.NoPkg, nil)
	typs[178] = lockRankType
	typs[179] = types.NewStruct(types.NoPkg, []*types.Field{types.NewField(src.NoXPos, Lookup("rank"), typs[178]), types.NewField(src.NoXPos, Lookup("pad"), typs[15])})
	typs[180] = interfacetypeType
	typs[181] = types.NewPtr(typs[180])
	typs[182] = types.NewArray(typs[5], 1)
	typs[183] = types.NewStruct(types.NoPkg, []*types.Field{types.NewField(src.NoXPos, Lookup("inter"), typs[181]), types.NewField(src.NoXPos, Lookup("_type"), typs[169]), types.NewField(src.NoXPos, Lookup("hash"), typs[62]), types.NewField(src.NoXPos, Lookup("_"), typs[41]), types.NewField(src.NoXPos, Lookup("fun"), typs[182])})
	typs[184] = nameType
	typs[185] = imethodType
	typs[186] = types.NewSlice(typs[185])
	typs[187] = types.NewStruct(types.NoPkg, []*types.Field{types.NewField(src.NoXPos, Lookup("typ"), typs[168]), types.NewField(src.NoXPos, Lookup("pkgpath"), typs[184]), types.NewField(src.NoXPos, Lookup("mhdr"), typs[186])})
	typs[188] = types.NewStruct(types.NoPkg, []*types.Field{types.NewField(src.NoXPos, Lookup("bytes"), typs[1])})
	typs[189] = nameOffType
	typs[190] = typeOffType
	typs[191] = types.NewStruct(types.NoPkg, []*types.Field{types.NewField(src.NoXPos, Lookup("name"), typs[189]), types.NewField(src.NoXPos, Lookup("ityp"), typs[190])})
	typs[192] = tflagType
	typs[193] = types.NewStruct(types.NoPkg, []*types.Field{types.NewField(src.NoXPos, Lookup("size"), typs[5]), types.NewField(src.NoXPos, Lookup("ptrdata"), typs[5]), types.NewField(src.NoXPos, Lookup("hash"), typs[62]), types.NewField(src.NoXPos, Lookup("tflag"), typs[192]), types.NewField(src.NoXPos, Lookup("align"), typs[66]), types.NewField(src.NoXPos, Lookup("fieldAlign"), typs[66]), types.NewField(src.NoXPos, Lookup("kind"), typs[66]), types.NewField(src.NoXPos, Lookup("equal"), typs[125]), types.NewField(src.NoXPos, Lookup("gcdata"), typs[1]), types.NewField(src.NoXPos, Lookup("str"), typs[189]), types.NewField(src.NoXPos, Lookup("ptrToThis"), typs[190])})
	stringStructDWARFType.SetUnderlying(typs[151])
	sliceType.SetUnderlying(typs[152])
	hmapType.SetUnderlying(typs[155])
	bmapType.SetUnderlying(typs[157])
	sudogType.SetUnderlying(typs[164])
	waitqType.SetUnderlying(typs[165])
	mutexType.SetUnderlying(typs[167])
	hchanType.SetUnderlying(typs[172])
	efaceType.SetUnderlying(typs[173])
	ifaceType.SetUnderlying(typs[176])
	mapextraType.SetUnderlying(typs[0])
	gType.SetUnderlying(typs[0])
	lockRankStructType.SetUnderlying(typs[177])
	lockRankStruct_onType.SetUnderlying(typs[179])
	lockRankType.SetUnderlying(typs[15])
	itabType.SetUnderlying(typs[183])
	interfacetypeType.SetUnderlying(typs[187])
	nameType.SetUnderlying(typs[188])
	imethodType.SetUnderlying(typs[191])
	_typeType.SetUnderlying(typs[193])
