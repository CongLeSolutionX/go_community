...
func runtimeTypes() []*types.Type {
	...
	typs[122] = newSig(params(typs[5], typs[5]), params(typs[5], typs[6]))
	...
	typs[135] = newSig(params(typs[20]), params(typs[62]))
	...
	typs[141] = newSig(params(typs[62]), params(typs[20]))
	...
	typs[149] = newSig(params(typs[66], typs[66], typs[17]), nil)
	typs[150] = newSig(params(typs[60], typs[60], typs[17]), nil)
	typs[151] = newSig(params(typs[62], typs[62], typs[17]), nil)
	...
	typs[155] = newSig(params(typs[7], typs[62], typs[154], typs[28], typs[15], typs[66], typs[66]), params(typs[62]))
	return typs[:]
}
