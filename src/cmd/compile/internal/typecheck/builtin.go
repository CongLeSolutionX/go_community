...
var runtimeDecls = [...]struct {
	...
	{"_type", typeTag, 0},
	{"g", typeTag, 0},
	{"lockRankStruct", typeTag, 0},
	{"lockRankStruct_on", typeTag, 174},
	{"lockRank", typeTag, 15},
}
...
func runtimeTypes() []*types.Type {
	...
	typs[162] = newNamed("lockRankStruct", typs[0])
	typs[163] = types.NewStruct(types.NoPkg, []*types.Field{types.NewField(src.NoXPos, Lookup("lockRankStruct"), typs[162]), types.NewField(src.NoXPos, Lookup("key"), typs[5])})
	typs[164] = newNamed("mutex", typs[163])
	typs[165] = types.NewStruct(types.NoPkg, []*types.Field{types.NewField(src.NoXPos, Lookup("qcount"), typs[17]), types.NewField(src.NoXPos, Lookup("dataqsiz"), typs[17]), types.NewField(src.NoXPos, Lookup("buf"), typs[7]), types.NewField(src.NoXPos, Lookup("elemsize"), typs[60]), types.NewField(src.NoXPos, Lookup("closed"), typs[62]), types.NewField(src.NoXPos, Lookup("elemtype"), typs[159]), types.NewField(src.NoXPos, Lookup("sendx"), typs[17]), types.NewField(src.NoXPos, Lookup("recvx"), typs[17]), types.NewField(src.NoXPos, Lookup("recvq"), typs[161]), types.NewField(src.NoXPos, Lookup("sendq"), typs[161]), types.NewField(src.NoXPos, Lookup("lock"), typs[164])})
	typs[166] = newNamed("hchan", typs[165])
	typs[167] = types.NewPtr(typs[166])
	typs[168] = types.NewStruct(types.NoPkg, []*types.Field{types.NewField(src.NoXPos, Lookup("g"), typs[157]), types.NewField(src.NoXPos, Lookup("next"), typs[1]), types.NewField(src.NoXPos, Lookup("prev"), typs[1]), types.NewField(src.NoXPos, Lookup("elem"), typs[7]), types.NewField(src.NoXPos, Lookup("acquiretime"), typs[22]), types.NewField(src.NoXPos, Lookup("releasetime"), typs[22]), types.NewField(src.NoXPos, Lookup("ticket"), typs[62]), types.NewField(src.NoXPos, Lookup("isSelect"), typs[6]), types.NewField(src.NoXPos, Lookup("success"), typs[6]), types.NewField(src.NoXPos, Lookup("parent"), typs[1]), types.NewField(src.NoXPos, Lookup("waitlink"), typs[1]), types.NewField(src.NoXPos, Lookup("waittail"), typs[1]), types.NewField(src.NoXPos, Lookup("c"), typs[167])})
	typs[169] = types.NewStruct(types.NoPkg, []*types.Field{types.NewField(src.NoXPos, Lookup("_type"), typs[159]), types.NewField(src.NoXPos, Lookup("data"), typs[7])})
	typs[170] = newNamed("itab", typs[0])
	typs[171] = types.NewPtr(typs[170])
	typs[172] = types.NewStruct(types.NoPkg, []*types.Field{types.NewField(src.NoXPos, Lookup("tab"), typs[171]), types.NewField(src.NoXPos, Lookup("data"), typs[7])})
	typs[173] = newNamed("lockRank", typs[15])
	typs[174] = types.NewStruct(types.NoPkg, []*types.Field{types.NewField(src.NoXPos, Lookup("rank"), typs[173]), types.NewField(src.NoXPos, Lookup("pad"), typs[15])})
	return typs[:]
}
