...
func tcArrayType(n *ir.ArrayType) (res ir.Node) {
...
func tcChanType(n *ir.ChanType) (res ir.Node) {
	n.Elem = typecheck(n.Elem, ctxType)
	l := n.Elem
	if l.Type() == nil {
		return n
...
func tcSliceType(n *ir.SliceType) (res ir.Node) {
	n.Elem = typecheck(n.Elem, ctxType)
	if n.Elem.Type() == nil {
		return n
	}
...
func tcStructType(n *ir.StructType) (res ir.Node) {
