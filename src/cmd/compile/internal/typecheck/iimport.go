...
func (r *importReader) typ1() *types.Type {
	...
	case typeParamType:
		...
		// Similar code to defined types, since we "declared" typeparams
		// to deal with recursion (typeparam is used within its own
		// bound).
...
// substInstType completes the re-instantiation of a generic type by doing a
// substitution on the underlying type itself and any methods.
