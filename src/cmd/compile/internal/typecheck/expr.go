...
func tcAddr(n *ir.AddrExpr) (res ir.Node) {
	n.X = Expr(n.X)
	if n.X.Type() == nil {
		n.SetType(nil)
		return n
...
func tcArith(n ir.Node) (res ir.Node) {
	var l, r ir.Node
	var setLR func()
	switch n := n.(type) {
...
func tcCompLit(n *ir.CompLitExpr) (res ir.Node) {
	...
	case types.TSLICE:
		...
		n.Ntype = ir.Node(ir.NewInt(length)).(ir.Ntype)
...
func tcConv(n *ir.ConvExpr) (res ir.Node) {
...
func tcDot(n *ir.SelectorExpr, top int) (res ir.Node) {
	if n.Op() == ir.OXDOT {
		n = AddImplicitDots(n)
		n.SetOp(ir.ODOT)
		if n.X == nil {
...
func tcDotType(n *ir.TypeAssertExpr) (res ir.Node) {
	n.X = Expr(n.X)
	n.X = DefaultLit(n.X, nil)
	l := n.X
	t := l.Type()
...
func tcITab(n *ir.UnaryExpr) (res ir.Node) {
	n.X = Expr(n.X)
	t := n.X.Type()
	if t == nil {
		n.SetType(nil)
...
func tcIndex(n *ir.IndexExpr) (res ir.Node) {
	n.X = Expr(n.X)
	n.X = DefaultLit(n.X, nil)
...
func tcLenCap(n *ir.UnaryExpr) (res ir.Node) {
	n.X = Expr(n.X)
	n.X = DefaultLit(n.X, nil)
	n.X = implicitstar(n.X)
	l := n.X
...
func tcRecv(n *ir.UnaryExpr) (res ir.Node) {
	n.X = Expr(n.X)
	n.X = DefaultLit(n.X, nil)
	l := n.X
	t := l.Type()
...
func tcSPtr(n *ir.UnaryExpr) (res ir.Node) {
	n.X = Expr(n.X)
	t := n.X.Type()
	if t == nil {
		n.SetType(nil)
...
func tcSlice(n *ir.SliceExpr) (res ir.Node) {
	n.X = Expr(n.X)
...
func tcSliceHeader(n *ir.SliceHeaderExpr) (res ir.Node) {
...
func tcStar(n *ir.StarExpr, top int) (res ir.Node) {
	n.X = typecheck(n.X, ctxExpr|ctxType)
	l := n.X
	t := l.Type()
	if t == nil {
...
func tcUnaryArith(n *ir.UnaryExpr) (res ir.Node) {
	n.X = Expr(n.X)
	l := n.X
	t := l.Type()
	if t == nil {
