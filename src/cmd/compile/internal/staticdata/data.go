...
// StringSymNoCommon is like StringSym, but produces a symbol that is not addressable.
// This symbol is not supposed to appear in the final binary. It is only used to pass
// string arguments to the linker like R_USENAMEDMETHOD does.
