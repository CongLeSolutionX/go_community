...
func InitTables() {
	...
	addF("math/bits", "Len64",
		...
		sys.AMD64, sys.ARM64, sys.ARM, sys.S390X, sys.MIPS, sys.MIPS64, sys.PPC64, sys.Wasm)
	addF("math/bits", "Len32",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
			return s.newValue1(ssa.OpBitLen32, types.Types[types.TINT], args[0])
		},
		sys.AMD64, sys.ARM64, sys.PPC64, sys.MIPS64)
	addF("math/bits", "Len32",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
			if s.config.PtrSize == 4 {
				return s.newValue1(ssa.OpBitLen32, types.Types[types.TINT], args[0])
	...
	addF("math/bits", "Len16",
		...
		sys.ARM64, sys.ARM, sys.S390X, sys.MIPS, sys.MIPS64, sys.PPC64, sys.Wasm)
	addF("math/bits", "Len16",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
	...
	addF("math/bits", "Len",
		...
		sys.AMD64, sys.ARM64, sys.ARM, sys.S390X, sys.MIPS, sys.PPC64, sys.Wasm, sys.MIPS64)
