...
func ssaGenValue(s *gc.SSAGenState, v *ssa.Value) {
	...
	case ssa.OpWasmLoweredStaticCall, ssa.OpWasmLoweredClosureCall, ssa.OpWasmLoweredInterCall:
		s.PrepareCall(v)
		if call, ok := v.Aux.(*ssa.AuxCall); ok && call.Fn == types.Syms.Deferreturn {
	...
	case ssa.OpWasmLoweredMove:
		...
		p := s.Prog(wasm.ACall)
		p.To = obj.Addr{Type: obj.TYPE_MEM, Name: obj.NAME_EXTERN, Sym: types.Syms.WasmMove}

	case ssa.OpWasmLoweredZero:
		getValue32(s, v.Args[0])
		i32Const(s, int32(v.AuxInt))
		p := s.Prog(wasm.ACall)
		p.To = obj.Addr{Type: obj.TYPE_MEM, Name: obj.NAME_EXTERN, Sym: types.Syms.WasmZero}
	...
	case ssa.OpWasmLoweredNilCheck:
		...
		p.To = obj.Addr{Type: obj.TYPE_MEM, Name: obj.NAME_EXTERN, Sym: types.Syms.SigPanic}
		s.Prog(wasm.AEnd)
		if logopt.Enabled() {
...
func ssaGenValueOnStack(s *gc.SSAGenState, v *ssa.Value, extend bool) {
	...
	case ssa.OpWasmI64DivS:
		...
		if v.Type.Size() == 8 {
			...
			p := s.Prog(wasm.ACall)
			p.To = obj.Addr{Type: obj.TYPE_MEM, Name: obj.NAME_EXTERN, Sym: types.Syms.WasmDiv}
			break
		}
	...
	case ssa.OpWasmI64TruncSatF32S, ssa.OpWasmI64TruncSatF64S:
		...
		if objabi.GOWASM.SatConv {
			...
			p := s.Prog(wasm.ACall)
			p.To = obj.Addr{Type: obj.TYPE_MEM, Name: obj.NAME_EXTERN, Sym: types.Syms.WasmTruncS}
		}
	...
	case ssa.OpWasmI64TruncSatF32U, ssa.OpWasmI64TruncSatF64U:
		...
		if objabi.GOWASM.SatConv {
			...
			p := s.Prog(wasm.ACall)
			p.To = obj.Addr{Type: obj.TYPE_MEM, Name: obj.NAME_EXTERN, Sym: types.Syms.WasmTruncU}
		}
