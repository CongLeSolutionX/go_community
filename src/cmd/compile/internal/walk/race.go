...
func instrument(fn *ir.Func) {
	...
	if (fn.Pragma&ir.Norace != 0 && base.Flag.DelaySan == 0) || (fn.Linksym() != nil && fn.Linksym().ABIWrapper()) {
		return
	}

	if base.Flag.DelaySan != 0 && ir.FuncName(fn) == "delay" && base.Ctxt.Pkgpath == "runtime" {
