...
func walkIndexMap(n *ir.IndexExpr, init *ir.Nodes) ir.Node {
	...
	mapFn := func() ir.Node {
		if n.Assigned {
			return mapfn(mapassign[fast], t, false)
		}
		if t.Elem().Width > zeroValSize {
			args = append(args, reflectdata.ZeroAddr(t.Elem().Width))
			return mapfn("mapaccess1_fat", t, true)
		}
		return mapfn(mapaccess1[fast], t, false)
	}
