	...
	if !inline {
		...
		if !base.Flag.CompilingRuntime && base.Flag.Race {
			...
			case t.IsArray():
				...
				call.PtrInit().Append(mkcall1(raceFn, nil, init, ptrL, ir.NewInt(base.Pos, t.NumElem()*t.Size())))
				call.PtrInit().Append(mkcall1(raceFn, nil, init, ptrR, ir.NewInt(base.Pos, t.NumElem()*t.Size())))
			}
		}
