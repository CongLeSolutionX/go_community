...
func ssaGenValue(s *gc.SSAGenState, v *ssa.Value) {
	...
	case ssa.OpPPC64LoweredZero:
		...
		// except that PPC MOVDU x,off(y) is increment-and-store,
		...
		case v.AuxInt%4 == 0:
			sz = 4
			movu = ppc64.AMOVWZU // no MOVWU instruction
		case v.AuxInt%2 == 0:
			sz = 2
			movu = ppc64.AMOVHU
		default:
	...
	case ssa.OpPPC64LoweredMove:
		...
		// except that PPC MOVDU x,off(y) is increment-and-store,
		// not store-and-increment.
		// Therefore arg0(R3) should be dest-align,
		// arg1(R4) should be src-align
