...
func (ra *returnsAnalyzer) results() []ResultPropBits {
...
// analyzeResult examines the expression 'n' being returned
...
func isSameFuncName(v1, v2 *ir.Name) bool {
	...
	// FIXME: is this the right way to go about this?
	// or can we always rely on sharing of name nodes?
	return v1.Sym() == v2.Sym()
}
