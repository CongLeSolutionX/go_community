...
// returns.go T_return_same_closure 268 0 1
// ResultFlags
//   0 ResultAlwaysSameInlinableFunc
// <endpropsdump>
// {"Flags":0,"ParamFlags":[],"ResultFlags":[32]}
// <endfuncpreamble>
// returns.go T_return_same_closure.func1 271 0 1
// <endpropsdump>
// {"Flags":0,"ParamFlags":[0],"ResultFlags":[0]}
// <endfuncpreamble>
func T_return_same_closure() func(int) int {
	/* NB: we currently get just "same func" and not
	   "same inlinable func" here, need to look into this. */
...
// returns.go T_return_different_closures 293 0 1
// <endpropsdump>
// {"Flags":0,"ParamFlags":[],"ResultFlags":[0]}
// <endfuncpreamble>
// returns.go T_return_different_closures.func1 294 0 1
// <endpropsdump>
// {"Flags":0,"ParamFlags":[0],"ResultFlags":[0]}
// <endfuncpreamble>
// returns.go T_return_different_closures.func2 298 0 1
// ResultFlags
//   0 ResultAlwaysSameConstant
// <endpropsdump>
...
// returns.go T_return_noninlinable 316 0 1
// ResultFlags
//   0 ResultAlwaysSameFunc
// <endpropsdump>
// {"Flags":0,"ParamFlags":[0],"ResultFlags":[16]}
// <endfuncpreamble>
// returns.go T_return_noninlinable.func1 317 0 1
// <endpropsdump>
// {"Flags":0,"ParamFlags":[0],"ResultFlags":[0]}
// <endfuncpreamble>
// returns.go T_return_noninlinable.func1.1 318 0 1
// <endpropsdump>
