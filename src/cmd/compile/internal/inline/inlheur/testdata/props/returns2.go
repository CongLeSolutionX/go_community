...
func returnsFunc2() func(int) {
	return func(x int) {
		adder(x)
	}
}

func returnsNonInlinableFunc() func(int) {
	return adderNoInline
}

func multiReturnsFunc() (int, func(int), int) {
	return 42, func(x int) { G++ }, -42
}
