...
// computeCallSiteTable builds and returns a table of call sites for the specified region in function fn.
...
func ScoreCalls(fn *ir.Func) {
	...
	scoreCallsRegion(fn, fn.Body, fih.cstab, doCallResults)
}
