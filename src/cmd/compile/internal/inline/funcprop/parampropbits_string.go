...
func _() {
	...
	_ = x[ParamFeedsIndirectCall-4]
	_ = x[ParamFeedsIfOrSwitch-8]
	_ = x[ParamTop-16]
}
...
var _ParamPropBits_value = [...]uint64{
	...
	0x4,  /* ParamFeedsIndirectCall */
	0x8,  /* ParamFeedsIfOrSwitch */
	0x10, /* ParamTop */
}

const _ParamPropBits_name = "ParamNoInfoParamFeedsInterfaceMethodCallParamFeedsIndirectCallParamFeedsIfOrSwitchParamTop"

var _ParamPropBits_index = [...]uint8{0, 11, 40, 62, 82, 90}
