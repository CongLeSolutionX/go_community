...
// FrameOffset returns the location that function would spill an input or output parameter
// to, if such a spill slot exists. For register-allocated inputs,
// that is their spill offset reserved for morestack (this may change in the future);
