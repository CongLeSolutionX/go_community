...
// TestLoopVarOptGo1_22flag checks for loopvar transformation enabled by command line flag (1.22).
func TestLoopVarOptGo1_22flag(t *testing.T) {
	switch runtime.GOOS {
	case "linux", "darwin":
	default:
		t.Skipf("Slow test, usually avoid it, os=%s not linux or darwin", runtime.GOOS)
...
// TestLoopVarOptGo1_22build checks for loopvar transformation enabled by go:build version (1.22).
func TestLoopVarOptGo1_22build(t *testing.T) {
	switch runtime.GOOS {
	case "linux", "darwin":
	default:
		t.Skipf("Slow test, usually avoid it, os=%s not linux or darwin", runtime.GOOS)
...
// TestLoopVarOptGo1_21flag checks for loopvar transformation DISABLED by command line version (1.21).
func TestLoopVarOptGo1_21flag(t *testing.T) {
	switch runtime.GOOS {
	case "linux", "darwin":
	default:
		t.Skipf("Slow test, usually avoid it, os=%s not linux or darwin", runtime.GOOS)
...
// TestLoopVarOptGo1_21build checks for loopvar transformation DISABLED by go:build version (1.21).
func TestLoopVarOptGo1_21build(t *testing.T) {
	switch runtime.GOOS {
	case "linux", "darwin":
	default:
		t.Skipf("Slow test, usually avoid it, os=%s not linux or darwin", runtime.GOOS)
