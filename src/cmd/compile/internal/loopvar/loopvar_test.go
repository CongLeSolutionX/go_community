...
// TODO investigate why the simple closure does not produce any logging in the loopvar=2 case
var for_files_plus = append(for_files, "for_esc_minimal_closure.go")
...
// TODO investigate why the simple closure does not produce any logging in the loopvar=2 case
var range_files_plus = append(range_files, "range_esc_minimal_closure.go")

var cases = []testcase{
	{"-2", "Maybe for 3-clause loop variable leak i", 11, for_files_plus},
	{"-1", "", 11, for_files_plus},
	{"0", "", 0, for_files_plus},
	{"1", "", 0, for_files_plus},
	{"2", "Transformed loop variable i ", 0, for_files},

	{"-2", "Maybe range loop variable leak i", 11, range_files_plus},
	{"-1", "", 11, range_files_plus},
	{"0", "", 0, range_files_plus},
	{"1", "", 0, range_files_plus},
