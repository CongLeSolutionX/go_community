...
type gfInfo struct {
	...
	// values/expressions (OXDOT), and closures with generic params or
	// captures variables (OCLOSURE).
...
type instInfo struct {
	...
	// Map from nodes in instantiated fun (OCALL, OCALLMETHO, OFUNCINST, OMETHEXPR,
	// OCLOSURE) to the associated dictionary entry for a sub-dictionary
