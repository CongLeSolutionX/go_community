...
func (pw *pkgWriter) objIdx(obj types2.Object) pkgbits.Index {
	if !isGlobal(obj) {
		pw.fatalf(obj, "objIdx called on non-package-scope object: %v", obj)
	}
...
func (pw *pkgWriter) bodyIdx(sig *types2.Signature, block *syntax.BlockStmt, dict *writerDict) (idx pkgbits.Index, closureVars []posObj) {
