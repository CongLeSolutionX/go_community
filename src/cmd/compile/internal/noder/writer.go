...
func (w *writer) typ(typ types2.Type) {
	derived, idx := w.p.typIdx(typ, w.dict)
...
func (pw *pkgWriter) typIdx(typ types2.Type, dict *writerDict) (bool, int) {
	if quirksMode() {
...
func (pw *pkgWriter) objIdx(obj types2.Object, ctxt *writerDict) int {
