...
func accumGcshape(fl []*types.Field, buf *bytes.Buffer, t *types.Type) []*types.Field {
	...
	case types.TARRAY:
		...
		if n == 1 {
			...
			accumGcshape(ignore, buf, t.Elem())
			buf.WriteByte(')')
		}
