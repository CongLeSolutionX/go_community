...
func (p *irgen) typ(typ types2.Type) *types.Type {
	switch typ := typ.(type) {
	case *types2.Basic:
		return p.basic(typ)
	case *types2.Named:
...
func (p *irgen) signature(recv *types.Field, sig *types2.Signature) *types.Type {
...
func (p *irgen) sym(obj types2.Object) *types.Sym {
...
func (p *irgen) selector(obj types2.Object) *types.Sym {
...
func (p *irgen) field(v *types2.Var) *types.Field {
	return types.NewField(p.pos(v), p.selector(v), p.typ(v.Type()))
}

func (p *irgen) param(v *types2.Var) *types.Field {
	return types.NewField(p.pos(v), p.sym(v), p.typ(v.Type()))
}

func (p *irgen) tpkg(typ types2.Type) *types.Pkg {
...
func (p *irgen) basic(typ *types2.Basic) *types.Type {
	switch typ.Name() {
	case "byte":
