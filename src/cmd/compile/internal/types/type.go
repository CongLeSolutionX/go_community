...
// IsScalar returns TRUE if 't' is a scalar Go type: either a numeric
// type (bool/int*/float*/complex*) or something pointer-shaped. Note
// that struct and array types consisting of a single scalar element
// are not considered scalar.
func (t *Type) IsScalar() bool {
	switch t.kind {
	case TBOOL, TINT8, TUINT8, TINT16, TUINT16, TINT32,
		TUINT32, TINT64, TUINT64, TINT, TUINT,
		TUINTPTR, TCOMPLEX64, TCOMPLEX128, TFLOAT32, TFLOAT64,
		TMAP, TPTR, TUNSAFEPTR, TCHAN, TFUNC:
		return true
	}
	return false
}
