...
type Type struct {
	...
	nod Object
	// the underlying unnamed type (type literal or predefined type) for a defined type
	underlying *Type
...
// A Field is a (Sym, Type) pairing along with some other information, and is used
// to represent:
//  - a field in a struct
//  - a method (name and type) in an interface or associated with a named type
