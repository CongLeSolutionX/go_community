...
type Field struct {
	...
	// or interface Type.  Exception: if field is function receiver, argor result
	// this is BOGUS_FUNARG_OFFSET; types does not know the Abi.
	Offset int64
}
...
func NewResults(types []*Type) *Type {
	if len(types) == 1 && types[0] == TypeMem && TypeResultMem != nil {
