...
func (t *Type) Size() int64 {
	if t.kind == TSSA {
		if t == TypeInt128 || t == TypeStr128 || t == TypeInter128 || t == TypeSlice128 {
			return 16
		}
		return 0
	}
...
var (
	...
	TypeSlice128  = newSSA("slice128") // except this one has a pointer in it
	// TypeSlice128 holds the slice pointer and length, not the capacity.
	// TODO: swap len and cap.
)
...
func init() {
	...
	TypeSlice128.width = 16
	TypeSlice128.align = 8 // TODO for drchase to make this 16
}
