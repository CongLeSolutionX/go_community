...
func TestShiftOverflow(t *testing.T) {
	if v, w, z := variableShiftOverflow64x8(-64, makeU8(255), 2); v != -32 || w != -128 || z != -32 {
		t.Errorf("got %d %d 0x%x, expected -32 -128 -32", v, w, z)
	}
	if v, w, z := variableShiftOverflow32x8(-64, makeU8(255), 2); v != -32 || w != -128 || z != -32 {
		t.Errorf("got %d %d 0x%x, expected -32 -128 -32", v, w, z)
	}
	if v, w, z := variableShiftOverflow16x8(-64, makeU8(255), 2); v != -32 || w != -128 || z != -32 {
		t.Errorf("got %d %d 0x%x, expected -32 -128 -32", v, w, z)
	}
	if v, w, z := variableShiftOverflow8x8(-64, makeU8(255), 2); v != -32 || w != -128 || z != -32 {
		t.Errorf("got %d %d 0x%x, expected -32 -128 -32", v, w, z)
	}
	if v, w, z := variableShiftOverflow64x16(-64, makeU16(0xffff), 2); v != -32 || w != -128 || z != -32 {
		t.Errorf("got %d %d 0x%x, expected -32 -128 -32", v, w, z)
	}
	if v, w, z := variableShiftOverflow32x16(-64, makeU16(0xffff), 2); v != -32 || w != -128 || z != -32 {
		t.Errorf("got %d %d 0x%x, expected -32 -128 -32", v, w, z)
	}
	if v, w, z := variableShiftOverflow16x16(-64, makeU16(0xffff), 2); v != -32 || w != -128 || z != -32 {
		t.Errorf("got %d %d 0x%x, expected -32 -128 -32", v, w, z)
	}
	if v, w, z := variableShiftOverflow8x16(-64, makeU16(0xffff), 2); v != -32 || w != -128 || z != -32 {
		t.Errorf("got %d %d 0x%x, expected -32 -128 -32", v, w, z)
	}
}
