...
var progtable = [s390x.ALAST & obj.AMask]gc.ProgInfo{
	...
	s390x.AMOVDO & obj.AMask:   {Flags: gc.SizeQ | gc.LeftRead | gc.RightWrite | gc.Move},
	s390x.AMOVDGT & obj.AMask:  {Flags: gc.SizeQ | gc.LeftRead | gc.RightWrite | gc.Move},
	s390x.AMOVDNLE & obj.AMask: {Flags: gc.SizeQ | gc.LeftRead | gc.RightWrite | gc.Move},
	s390x.AMOVDLT & obj.AMask:  {Flags: gc.SizeQ | gc.LeftRead | gc.RightWrite | gc.Move},
	s390x.AMOVDNGE & obj.AMask: {Flags: gc.SizeQ | gc.LeftRead | gc.RightWrite | gc.Move},
	s390x.AMOVDLG & obj.AMask:  {Flags: gc.SizeQ | gc.LeftRead | gc.RightWrite | gc.Move},
	...
	s390x.AMOVDNLG & obj.AMask: {Flags: gc.SizeQ | gc.LeftRead | gc.RightWrite | gc.Move},
	s390x.AMOVDGE & obj.AMask:  {Flags: gc.SizeQ | gc.LeftRead | gc.RightWrite | gc.Move},
	s390x.AMOVDNL & obj.AMask:  {Flags: gc.SizeQ | gc.LeftRead | gc.RightWrite | gc.Move},
	s390x.AMOVDLE & obj.AMask:  {Flags: gc.SizeQ | gc.LeftRead | gc.RightWrite | gc.Move},
	s390x.AMOVDNG & obj.AMask:  {Flags: gc.SizeQ | gc.LeftRead | gc.RightWrite | gc.Move},
	s390x.AMOVDNO & obj.AMask:  {Flags: gc.SizeQ | gc.LeftRead | gc.RightWrite | gc.Move},
	...
	s390x.ABO & obj.AMask:      {Flags: gc.Cjmp},
	s390x.ABGT & obj.AMask:     {Flags: gc.Cjmp},
	s390x.ABNLE & obj.AMask:    {Flags: gc.Cjmp},
	s390x.ABLT & obj.AMask:     {Flags: gc.Cjmp},
	s390x.ABNGE & obj.AMask:    {Flags: gc.Cjmp},
	s390x.ABLG & obj.AMask:     {Flags: gc.Cjmp},
	s390x.ABNE & obj.AMask:     {Flags: gc.Cjmp},
	s390x.ABEQ & obj.AMask:     {Flags: gc.Cjmp},
	s390x.ABNLG & obj.AMask:    {Flags: gc.Cjmp},
	s390x.ABGE & obj.AMask:     {Flags: gc.Cjmp},
	s390x.ABNL & obj.AMask:     {Flags: gc.Cjmp},
	s390x.ABLE & obj.AMask:     {Flags: gc.Cjmp},
	s390x.ABNG & obj.AMask:     {Flags: gc.Cjmp},
	s390x.ABNO & obj.AMask:     {Flags: gc.Cjmp},
