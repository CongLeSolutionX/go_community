...
func init() {
	...
	var WasmOps = []opData{
		...
		{name: "MemoryCopy", asm: "MemoryCopy", argLength: 3, reg: gp30}, // memory.copy(dst, src, count)
		{name: "MemoryFill", asm: "MemoryFill", argLength: 3, reg: gp30}, // memory.fill(dst, value, count)
	}
