...
func init() {
	...
	ops := []opData{
		...
		{name: "FMOVSgpfp", argLength: 1, reg: gpfp, asm: "FMOVS"}, // move int32 to float64 (no conversion)
		{name: "FMOVSfpgp", argLength: 1, reg: fpgp, asm: "FMOVS"}, // move float64 to int32 (no conversion)
