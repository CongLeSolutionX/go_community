...
func init() {
	...
	ops := []opData{
		...
		{name: "NEGshiftRO", argLength: 1, reg: gp11, asm: "NEG", aux: "Int64"},                   // -(arg0 ROR auxInt), signed shift, auxInt should be in the range 0 to 63.
		...
		{name: "ADDshiftRO", argLength: 2, reg: gp21, asm: "ADD", aux: "Int64"},                   // arg0 + arg1 ROR auxInt, signed shift, auxInt should be in the range 0 to 63.
		...
		{name: "SUBshiftRO", argLength: 2, reg: gp21, asm: "SUB", aux: "Int64"},                   // arg0 - arg1 ROR auxInt, signed shift, auxInt should be in the range 0 to 63.
		...
		{name: "CMPshiftRO", argLength: 2, reg: gp2flags, asm: "CMP", aux: "Int64", typ: "Flags"}, // arg0 compare to arg1 ROR auxInt, signed shift, auxInt should be in the range 0 to 63.
		...
		{name: "CMNshiftRO", argLength: 2, reg: gp2flags, asm: "CMN", aux: "Int64", typ: "Flags"}, // (arg0 + arg1 ROR auxInt) compare to 0, signed shift, auxInt should be in the range 0 to 63.
