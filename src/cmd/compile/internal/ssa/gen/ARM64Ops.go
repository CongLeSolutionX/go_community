...
func init() {
	...
	ops := []opData{
		...
		{name: "LoweredWB", argLength: 3, reg: regInfo{inputs: []regMask{buildReg("R2"), buildReg("R3")}, clobbers: (callerSave &^ gp) | buildReg("R30")}, clobberFlags: true, aux: "Sym", symEffect: "None"},
	}
