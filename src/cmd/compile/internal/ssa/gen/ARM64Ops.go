...
func init() {
	...
	ops := []opData{
		...
		{name: "FCMPSconst", argLength: 1, reg: fp1flags, asm: "FCMPS", aux: "Float32", typ: "Flags"}, // arg0 compare to auxInt
		{name: "FCMPDconst", argLength: 1, reg: fp1flags, asm: "FCMPD", aux: "Float64", typ: "Flags"}, // arg0 compare to auxInt
		...
		{name: "LessThanZero", argLength: 1, reg: readflags},     // bool, true flags encode x < 0 false otherwise.
		{name: "GreaterEqualZero", argLength: 1, reg: readflags}, // bool, true flags encode x >= 0 false otherwise.
