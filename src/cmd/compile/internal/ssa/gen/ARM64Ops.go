...
func init() {
	...
	ops := []opData{
		...
		{name: "FMOVSloadidx", argLength: 3, reg: fp2load, asm: "FMOVS"}, // load 32-bit float from arg0 + arg1, arg2=mem.
		{name: "FMOVDloadidx", argLength: 3, reg: fp2load, asm: "FMOVD"}, // load 64-bit float from arg0 + arg1, arg2=mem.
