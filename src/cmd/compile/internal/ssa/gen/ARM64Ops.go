...
func init() {
	...
	ops := []opData{
		...
		// comparisons
		{name: "TST", argLength: 2, reg: gp2flags1, asm: "ANDS", commutative: true, typ: "Flags"},  // arg0 & arg1 compare to 0
		{name: "TSTconst", argLength: 1, reg: gp1flags, asm: "ANDS", aux: "Int64", typ: "Flags"},   // arg0 & auxInt compare to 0
		{name: "TSTWconst", argLength: 1, reg: gp1flags, asm: "ANDSW", aux: "Int64", typ: "Flags"}, // arg0 & auxInt compare to 0
