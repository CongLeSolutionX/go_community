...
func init() {
	...
	ops := []opData{
		...
		// 3-operand, the addend comes second
		{name: "FMADDS", argLength: 3, reg: fp31, asm: "FMADDS"},   // arg1 + (arg0 * arg2)
		{name: "FMADDD", argLength: 3, reg: fp31, asm: "FMADDD"},   // arg1 + (arg0 * arg2)
		{name: "FNMADDS", argLength: 3, reg: fp31, asm: "FNMADDS"}, // -arg1 - (arg0 * arg2)
		{name: "FNMADDD", argLength: 3, reg: fp31, asm: "FNMADDD"}, // -arg1 - (arg0 * arg2)
		{name: "FMSUBS", argLength: 3, reg: fp31, asm: "FMSUBS"},   // arg1 - (arg0 * arg2)
		{name: "FMSUBD", argLength: 3, reg: fp31, asm: "FMSUBD"},   // arg1 - (arg0 * arg2)
		{name: "FNMSUBS", argLength: 3, reg: fp31, asm: "FNMSUBS"}, // -arg1 + (arg0 * arg2)
		{name: "FNMSUBD", argLength: 3, reg: fp31, asm: "FNMSUBD"}, // -arg1 + (arg0 * arg2)
