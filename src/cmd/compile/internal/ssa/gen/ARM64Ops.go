...
func init() {
	...
	ops := []opData{
		...
		{name: "VCNT", argLength: 1, reg: fp11, asm: "VCNT"},       // population count, 64-bit
		{name: "VUADDLV", argLength: 1, reg: fp11, asm: "VUADDLV"}, // unsigned sum of every vector element in simd register and write scalar result to destination twice as long as source
