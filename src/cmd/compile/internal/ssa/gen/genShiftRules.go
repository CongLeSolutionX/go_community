...
// generated shift rules. w1, w2, and w3 are bit widths, while hdr indicates
// if the function should write out a header only
type pieceGen func(w io.Writer, w1, w2, w3 int, hdr bool)
...
func largeShift(w io.Writer, w1, w2, w3 int, hdr bool) {
	if hdr {
...
func zeroShift(w io.Writer, w1, w2, w3 int, hdr bool) {
	if hdr {
