...
func init() {
	...
	var WasmOps = []opData{
		...
		{name: "I64Load8U", asm: "I64Load8U", argLength: 2, reg: gpload, aux: "SymOff", typ: "UInt8", symEffect: "Read"},                   // read unsigned 8-bit integer from address arg0+aux, arg1=mem
		{name: "I64Load8S", asm: "I64Load8S", argLength: 2, reg: gpload, aux: "SymOff", typ: "Int8", symEffect: "Read"},                    // read signed 8-bit integer from address arg0+aux, arg1=mem
		{name: "I64Load16U", asm: "I64Load16U", argLength: 2, reg: gpload, aux: "SymOff", typ: "UInt16", symEffect: "Read"},                // read unsigned 16-bit integer from address arg0+aux, arg1=mem
		{name: "I64Load16S", asm: "I64Load16S", argLength: 2, reg: gpload, aux: "SymOff", typ: "Int16", symEffect: "Read"},                 // read signed 16-bit integer from address arg0+aux, arg1=mem
		{name: "I64Load32U", asm: "I64Load32U", argLength: 2, reg: gpload, aux: "SymOff", typ: "UInt32", symEffect: "Read"},                // read unsigned 32-bit integer from address arg0+aux, arg1=mem
		{name: "I64Load32S", asm: "I64Load32S", argLength: 2, reg: gpload, aux: "SymOff", typ: "Int32", symEffect: "Read"},                 // read signed 32-bit integer from address arg0+aux, arg1=mem
		{name: "I64Load", asm: "I64Load", argLength: 2, reg: gpload, aux: "SymOff", typ: "UInt64", symEffect: "Read"},                      // read 64-bit integer from address arg0+aux, arg1=mem
		{name: "I64Store8", asm: "I64Store8", argLength: 3, reg: gpstore, aux: "SymOff", typ: "Mem", symEffect: "Write"},                   // store 8-bit integer arg1 at address arg0+aux, arg2=mem, returns mem
		{name: "I64Store8Const", asm: "I64Store8", argLength: 2, reg: gpstoreconst, aux: "SymValAndOff", typ: "Mem", symEffect: "Write"},   // store 8-bit integer aux.val at address arg0+aux.off, arg1=mem, returns mem
		{name: "I64Store16", asm: "I64Store16", argLength: 3, reg: gpstore, aux: "SymOff", typ: "Mem", symEffect: "Write"},                 // store 16-bit integer arg1 at address arg0+aux, arg2=mem, returns mem
		{name: "I64Store16Const", asm: "I64Store16", argLength: 2, reg: gpstoreconst, aux: "SymValAndOff", typ: "Mem", symEffect: "Write"}, // store 16-bit integer aux.val at address arg0+aux.off, arg1=mem, returns mem
		{name: "I64Store32", asm: "I64Store32", argLength: 3, reg: gpstore, aux: "SymOff", typ: "Mem", symEffect: "Write"},                 // store 32-bit integer arg1 at address arg0+aux, arg2=mem, returns mem
		{name: "I64Store32Const", asm: "I64Store32", argLength: 2, reg: gpstoreconst, aux: "SymValAndOff", typ: "Mem", symEffect: "Write"}, // store 32-bit integer aux.val at address arg0+aux.off, arg1=mem, returns mem
		{name: "I64Store", asm: "I64Store", argLength: 3, reg: gpstore, aux: "SymOff", typ: "Mem", symEffect: "Write"},                     // store 64-bit integer arg1 at address arg0+aux, arg2=mem, returns mem
		{name: "I64StoreConst", asm: "I64Store", argLength: 2, reg: gpstoreconst, aux: "SymValAndOff", typ: "Mem", symEffect: "Write"},     // store 64-bit integer aux.val at address arg0+aux.off, arg1=mem, returns mem

		{name: "F32Load", asm: "F32Load", argLength: 2, reg: fpload, aux: "SymOff", typ: "Float64", symEffect: "Read"}, // read 32-bit float from address arg0+aux, arg1=mem
		{name: "F64Load", asm: "F64Load", argLength: 2, reg: fpload, aux: "SymOff", typ: "Float64", symEffect: "Read"}, // read 64-bit float from address arg0+aux, arg1=mem
		{name: "F32Store", asm: "F32Store", argLength: 3, reg: fpstore, aux: "SymOff", typ: "Mem", symEffect: "Write"}, // store 32-bit float arg1 at address arg0+aux, arg2=mem, returns mem
		{name: "F64Store", asm: "F64Store", argLength: 3, reg: fpstore, aux: "SymOff", typ: "Mem", symEffect: "Write"}, // store 64-bit float arg1 at address arg0+aux, arg2=mem, returns mem
