...
func init() {
	...
	ops := []opData{
		...
		{name: "ADDS", argLength: 2, reg: gp21cf, asm: "ADD", commutative: true, typ: "ValueAndFlags"}, // arg0 + arg1, set carry flag
		{name: "ADC", argLength: 3, reg: gp2flags1, asm: "ADC", commutative: true},                     // arg0 + arg1 + carry, arg2=flags
		{name: "SUBS", argLength: 2, reg: gp21cf, asm: "SUB", typ: "ValueAndFlags"},                    // arg0 - arg1, set carry flag
		...
		{name: "LoweredCarry", argLength: 1, reg: regInfo{inputs: []regMask{flags}, outputs: []regMask{flags}}, typ: "Flags"},       // flags of a ValAndFlags
		{name: "LoweredValue32", argLength: 1, reg: gp11, resultInArg0: true, typ: "UInt32"},                                        // value of a ValAndFlags
		{name: "LoweredHi32", argLength: 1, reg: regInfo{inputs: []regMask{gp}, outputs: []regMask{buildReg("R0")}}, typ: "UInt32"}, // high 32-bit of a MULLU, read from R0
