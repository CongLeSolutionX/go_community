...
func init() {
	...
	var (
		gp         = buildReg("R1 R2 R3 R4 R5 R6 R7 R8 R9 R10 R11 R12 R13 R14 R15 R16 R17 R18 R19 R20 R21 R22 R24 R25 R28")
		gpg        = gp | buildReg("g")
		gpsp       = gp | buildReg("SP")
	...
	ops := []opData{
		...
		{name: "MOVDconst", argLength: 0, reg: fp01, aux: "Float32", asm: "MOVD", typ: "Float64", rematerializeable: true}, // auxint as 64-bit float
		...
		{name: "LoweredAtomicAddconst", argLength: 2, reg: regInfo{inputs: []regMask{gpspsbg}, outputs: []regMask{gp}}, aux: "Int64", resultNotInArgs: true, faultOnNilArg0: true},
		...
		{name: "MakeResultCarryTuple", argLength: 2}, // <result=uint/int,carry=bool> pseudo op as result of Add/Sub32carry
