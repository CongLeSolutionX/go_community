...
func init() {
	...
	ops := []opData{
		...
		{name: "MADDHD", argLength: 3, reg: gp31, asm: "MADDHD", typ: "Int64"},                  // ((arg0*arg1)>>64)+arg2 (signed 64-bit)
		{name: "MADDHDU", argLength: 3, reg: gp31, asm: "MADDHDU", typ: "Int64"},                // ((arg0*arg1)>>64)+arg2 (unsigned signed 64-bit)
