...
func init() {
	...
	ops := []opData{
		...
		{name: "LoweredAtomicLoad32", argLength: 2, reg: gpload, typ: "UInt32", faultOnNilArg0: true},
		{name: "LoweredAtomicLoad64", argLength: 2, reg: gpload, typ: "Int64", faultOnNilArg0: true},
		{name: "LoweredAtomicLoadPtr", argLength: 2, reg: gpload, typ: "Int64", faultOnNilArg0: true},
