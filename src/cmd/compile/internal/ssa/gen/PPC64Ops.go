...
func init() {
	...
	ops := []opData{
		...
		{name: "ANDCCconst", argLength: 1, reg: regInfo{inputs: []regMask{gp | sp | sb}, outputs: []regMask{gp}}, asm: "ANDCC", aux: "Int64", clobberFlags: true, typ: "(UInt,Flags)"}, // arg0&aux == 0 // and-immediate sets CC on PPC, always.
