...
func init() {
	...
	var (
		...
		addridx     = regInfo{inputs: []regMask{gp | sp | sb}, outputs: []regMask{gp}}
	...
	ops := []opData{
		...
		{name: "MOVDaddridx", argLength: 1, reg: addridx, aux: "SymOff", asm: "MOVD", rematerializeable: true, symEffect: "Read"},
