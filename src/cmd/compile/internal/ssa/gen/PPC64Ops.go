...
func init() {
	...
	ops := []opData{
		...
		{name: "SRAD", argLength: 2, reg: gp21, asm: "SRAD"}, // arg0 >>a arg1, 64 bits (all sign if 64 <= arg1 <= 127)
		{name: "SRAW", argLength: 2, reg: gp21, asm: "SRAW"}, // arg0 >>a arg1, 32 bits (all sign if 32 <= arg1 <= 63)
		{name: "SRD", argLength: 2, reg: gp21, asm: "SRD"},   // arg0 >> arg1, 64 bits  (0 if 64 <= arg1 <= 127)
		{name: "SRW", argLength: 2, reg: gp21, asm: "SRW"},   // arg0 >> arg1, 32 bits  (0 if 32 <= arg1 <= 63)
		{name: "SLD", argLength: 2, reg: gp21, asm: "SLD"},   // arg0 << arg1, 64 bits  (0 if 64 <= arg1 <= 127)
		{name: "SLW", argLength: 2, reg: gp21, asm: "SLW"},   // arg0 << arg1, 32 bits  (0 if 32 <= arg1 <= 63)

		{name: "ADDIforC", argLength: 1, reg: regInfo{inputs: []regMask{gp | sp | sb}, // _, carry := arg0 + aux
			outputs:  []regMask{cr},
			clobbers: tmp}, aux: "Int16", asm: "ADDC", typ: "Flags"},
		{name: "MaskIfNotCarry", argLength: 1, reg: crgp, asm: "ADDME", typ: "Int64"}, // carry - 1 (if carry then 0 else -1)

		{name: "SRADconst", argLength: 1, reg: gp11, asm: "SRAD", aux: "Int64"}, // arg0 >>a aux, 64 bits (all sign if 64 <= arg1 <= 127)
		{name: "SRAWconst", argLength: 1, reg: gp11, asm: "SRAW", aux: "Int64"}, // arg0 >>a aux, 32 bits (all sign if 32 <= arg1 <= 63)
		{name: "SRDconst", argLength: 1, reg: gp11, asm: "SRD", aux: "Int64"},   // arg0 >> aux, 64 bits  (0 if 64 <= arg1 <= 127)
		{name: "SRWconst", argLength: 1, reg: gp11, asm: "SRW", aux: "Int64"},   // arg0 >> aux, 32 bits  (0 if 32 <= arg1 <= 63)
		{name: "SLDconst", argLength: 1, reg: gp11, asm: "SLD", aux: "Int64"},   // arg0 << aux, 64 bits  (0 if 64 <= arg1 <= 127)
		{name: "SLWconst", argLength: 1, reg: gp11, asm: "SLW", aux: "Int64"},   // arg0 << aux, 32 bits  (0 if 32 <= arg1 <= 63)
		...
		{name: "CMPWconst", argLength: 1, reg: gp1cr, asm: "CMPW", aux: "Int64", typ: "Flags"},
		{name: "CMPWUconst", argLength: 1, reg: gp1cr, asm: "CMPWU", aux: "Int64", typ: "Flags"},
		...
		// outcomes: eitjher the three from the signed total order (<,==,>)
