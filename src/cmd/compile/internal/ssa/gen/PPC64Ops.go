...
func init() {
	...
	var (
		...
		gpxer1      = regInfo{inputs: []regMask{xer}, outputs: []regMask{gp}, clobbers: xer}
		xergp1      = regInfo{inputs: []regMask{gp | sp | sb, xer}, outputs: []regMask{gp}, clobbers: xer}
	...
	ops := []opData{
		...
		{name: "ADDZE", argLength: 2, reg: xergp1, asm: "ADDZE", typ: "UInt64"},                                // arg0 + CA (arg1) -> out
		{name: "SUBZE", argLength: 2, reg: xergp1, asm: "SUBZE", typ: "UInt64"},                                // $0 - arg0 - CA (arg1) -> out
		{name: "ADDZEzero", argLength: 1, reg: gpxer1, asm: "ADDZE", typ: "UInt64"},                            // CA (arg0) + $0 -> out
		{name: "SUBZEzero", argLength: 1, reg: gpxer1, asm: "SUBZE", typ: "UInt64"},                            // $0 - CA (arg0) -> out
