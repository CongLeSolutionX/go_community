...
// balance returns the number of '(' characters minus the number of ')'
// characters in a string. For example, a positive number can mean that the
// string contains an incomplete expression.
