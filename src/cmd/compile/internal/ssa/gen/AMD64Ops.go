...
func init() {
	...
	var AMD64ops = []opData{
		...
		{name: "MOVZero", reg: gpstoreconst},                                                   // store auxint 0 bytes into arg0 using a series of MOV instructions. arg1=mem.
		{name: "REPSTOSQ", reg: regInfo{[]regMask{buildReg("DI")}, buildReg("DI AX CX"), nil}}, // store auxint 0 bytes into arg0 using STOSQ. arg1=mem.
