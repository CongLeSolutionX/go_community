...
func init() {
	...
	var AMD64ops = []opData{
		...
		{name: "STOREArgI0", argLength: 3, reg: regInfo{inputs: []regMask{sp, buildReg("DI"), 0}}, asm: "FAKEMOV", aux: "TypeOff"},
		{name: "STOREArgI1", argLength: 3, reg: regInfo{inputs: []regMask{sp, buildReg("SI"), 0}}, asm: "FAKEMOV", aux: "TypeOff"},
		{name: "STOREArgI2", argLength: 3, reg: regInfo{inputs: []regMask{sp, buildReg("DX"), 0}}, asm: "FAKEMOV", aux: "TypeOff"},
		{name: "STOREArgI3", argLength: 3, reg: regInfo{inputs: []regMask{sp, buildReg("CX"), 0}}, asm: "FAKEMOV", aux: "TypeOff"},
		{name: "STOREArgI4", argLength: 3, reg: regInfo{inputs: []regMask{sp, buildReg("R8"), 0}}, asm: "FAKEMOV", aux: "TypeOff"},
		{name: "STOREArgI5", argLength: 3, reg: regInfo{inputs: []regMask{sp, buildReg("R9"), 0}}, asm: "FAKEMOV", aux: "TypeOff"},

		{name: "LOADArgI0", argLength: 2, reg: regInfo{inputs: []regMask{sp, 0}, outputs: []regMask{buildReg("AX")}}, asm: "FAKEMOV", aux: "TypeOff"},
		{name: "LOADArgI1", argLength: 2, reg: regInfo{inputs: []regMask{sp, 0}, outputs: []regMask{buildReg("DX")}}, asm: "FAKEMOV", aux: "TypeOff"},
		{name: "LOADArgI2", argLength: 2, reg: regInfo{inputs: []regMask{sp, 0}, outputs: []regMask{buildReg("BX")}}, asm: "FAKEMOV", aux: "TypeOff"},
		{name: "LOADArgI3", argLength: 2, reg: regInfo{inputs: []regMask{sp, 0}, outputs: []regMask{buildReg("CX")}}, asm: "FAKEMOV", aux: "TypeOff"},
		{name: "LOADArgI4", argLength: 2, reg: regInfo{inputs: []regMask{sp, 0}, outputs: []regMask{buildReg("R8")}}, asm: "FAKEMOV", aux: "TypeOff"},
		{name: "LOADArgI5", argLength: 2, reg: regInfo{inputs: []regMask{sp, 0}, outputs: []regMask{buildReg("R9")}}, asm: "FAKEMOV", aux: "TypeOff"},

		{name: "STOREArgF0", argLength: 3, reg: regInfo{inputs: []regMask{sp, buildReg("X0"), 0}}, asm: "FAKEMOV", aux: "TypeOff"},
		{name: "STOREArgF1", argLength: 3, reg: regInfo{inputs: []regMask{sp, buildReg("X1"), 0}}, asm: "FAKEMOV", aux: "TypeOff"},
		{name: "STOREArgF2", argLength: 3, reg: regInfo{inputs: []regMask{sp, buildReg("X2"), 0}}, asm: "FAKEMOV", aux: "TypeOff"},
		{name: "STOREArgF3", argLength: 3, reg: regInfo{inputs: []regMask{sp, buildReg("X3"), 0}}, asm: "FAKEMOV", aux: "TypeOff"},
		{name: "STOREArgF4", argLength: 3, reg: regInfo{inputs: []regMask{sp, buildReg("X4"), 0}}, asm: "FAKEMOV", aux: "TypeOff"},
		{name: "STOREArgF5", argLength: 3, reg: regInfo{inputs: []regMask{sp, buildReg("X5"), 0}}, asm: "FAKEMOV", aux: "TypeOff"},

		{name: "LOADArgF0", argLength: 2, reg: regInfo{inputs: []regMask{sp, 0}, outputs: []regMask{buildReg("X0")}}, asm: "FAKEMOV", aux: "TypeOff"},
		{name: "LOADArgF1", argLength: 2, reg: regInfo{inputs: []regMask{sp, 0}, outputs: []regMask{buildReg("X1")}}, asm: "FAKEMOV", aux: "TypeOff"},
		{name: "LOADArgF2", argLength: 2, reg: regInfo{inputs: []regMask{sp, 0}, outputs: []regMask{buildReg("X2")}}, asm: "FAKEMOV", aux: "TypeOff"},
		{name: "LOADArgF3", argLength: 2, reg: regInfo{inputs: []regMask{sp, 0}, outputs: []regMask{buildReg("X3")}}, asm: "FAKEMOV", aux: "TypeOff"},
		{name: "LOADArgF4", argLength: 2, reg: regInfo{inputs: []regMask{sp, 0}, outputs: []regMask{buildReg("X4")}}, asm: "FAKEMOV", aux: "TypeOff"},
		{name: "LOADArgF5", argLength: 2, reg: regInfo{inputs: []regMask{sp, 0}, outputs: []regMask{buildReg("X5")}}, asm: "FAKEMOV", aux: "TypeOff"},
