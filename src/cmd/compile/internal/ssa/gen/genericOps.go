...
var genericOps = []opData{
	...
	{name: "Int64Make", argLength: 2, typ: "Int64"}, // arg0=hi, arg1=lo
	{name: "Int64Hi", argLength: 1, typ: "Int32"},   // high 32-bit of arg0
	{name: "Int64Lo", argLength: 1, typ: "Int32"},   // low 32-bit of arg0

	{name: "Add32setcarry", argLength: 2, commutative: true}, // arg0 + arg1, set carry flag if applicable
	{name: "Add32carrybit", argLength: 2, commutative: true}, // 1 if uint32(arg0)+uint32(arg1) >= 1<<32, 0 otherwise
	{name: "Add32withcarry", argLength: 3},                   // arg0 + arg1 + arg2, arg2=carry (0 or 1)

	{name: "Sub32setcarry", argLength: 2},  // arg0 - arg1, set carry flag if applicable
	{name: "Sub32carrybit", argLength: 2},  // 1 if uint32(arg0)+uint32(-arg1) >= 1<<32, 0 otherwise
