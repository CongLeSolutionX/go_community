...
func init() {
	...
	RISCV64ops := []opData{
		...
		{name: "CALLclosure", argLength: -1, reg: callClosure, aux: "CallOff", call: true},       // call function via closure. arg0=codeptr, arg1=closure, arg2=mem, auxint=argsize, returns mem
		{name: "CALLinter", argLength: -1, reg: callInter, aux: "CallOff", call: true},           // call fn by pointer. arg0=codeptr, arg1=mem, auxint=argsize, returns mem

		// duffzero
		// arg0 = address of memory to zero (in X24, changed as side effect)
		// arg1 = mem
		...
		// returns mem
		{
			...
			argLength: 2,
			reg: regInfo{
				inputs:   []regMask{regNamed["X24"]},
				clobbers: regNamed["X1"] | regNamed["X24"],
			},
			typ:            "Mem",
			faultOnNilArg0: true,
		},
	...
	archs = append(archs, arch{
		...
		// Integer parameters passed in register A0-A7 followed by S0-S8
		ParamIntRegNames: "X10 X11 X12 X13 X14 X15 X16 X17 X8 X9 X18 X19 X20 X21 X22 X23",
		// Float parameters passed in register FA0-FA7 followed by FS0-FS8
