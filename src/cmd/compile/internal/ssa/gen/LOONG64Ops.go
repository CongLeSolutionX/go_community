...
var regNamesLOONG64 = []string{
	...
	"R28",
	"R29",
	//"R30",   // REGTMP not used in regalloc
	"R31",
...
func init() {
	...
	var (
		gp         = buildReg("R1 R4 R5 R6 R7 R8 R9 R10 R11 R12 R13 R14 R15 R16 R17 R18 R19 R20 R24 R25 R26 R27 R28 R29 R31") //R2-tp,R3-sp,R22-fp,r,R21-unused
		gps        = buildReg("R1 R4 R5 R6 R7 R8 R9 R10 R11 R12 R13 R14 R15 R16 R19 R20 R24 R25 R26 R27 R28 R29 R31") | buildReg("g")
		gpg        = gp | buildReg("g")
		gpsp       = gp | buildReg("SP")
		...
		r1         = buildReg("R19")         //R1->R19
		r2         = buildReg("R18")         //R2->R18
		r3         = buildReg("R17")         //R3->R17
		r4         = buildReg("R4")
	)
	// Common regInfo
	var (
	...
	ops := []opData{
...

		{
			...
			argLength: 2,
			reg: regInfo{
				inputs:   []regMask{gps, gps},
				outputs:  []regMask{buildReg("R17"), buildReg("R18")},
				clobbers: buildReg("R17 R18"),
			},
			clobberFlags: true,
			typ:          "(Int64,Int64)",
		},
		...
		{name: "CALLclosure", argLength: 3, reg: regInfo{inputs: []regMask{gpsp, buildReg("R29"), 0}, clobbers: callerSave}, aux: "CallOff", clobberFlags: true, call: true}, // call function via closure.  arg0=codeptr, arg1=closure, arg2=mem, auxint=argsize, returns mem  //MIPS:R22-> LA:R29
		...
		// returns mem
		// R1 aka loong64.REGRT1 changed as side effect
		{
			name:      "DUFFZERO",
			aux:       "Int64",
			argLength: 2,
			reg: regInfo{
				inputs:   []regMask{gp},
				clobbers: buildReg("R19 R1"), //MIPS:R1(reserved for runtime)->LA:R19,MIPS:R31(ra)- LA:R1
			},
			faultOnNilArg0: true,
		},

		// duffcopy
		// arg0 = address of dst memory (in R4, changed as side effect) REGRT2
		...
		// returns mem
		{
			...
			argLength: 3,
			reg: regInfo{
				inputs:   []regMask{buildReg("R4"), buildReg("R19")}, //MIPS:R1->R19,R2->R4.R31->R1
				clobbers: buildReg("R19 R4 R1"),
			},
			faultOnNilArg0: true,
			faultOnNilArg1: true,
		},
		...
		//	BNE	Rarg1, R19, -2(PC)
		{
			...
			argLength: 3,
			reg: regInfo{
				inputs:   []regMask{buildReg("R19"), gp}, //MIPS:R1->R19
		...
		{name: "LoweredGetClosurePtr", reg: regInfo{outputs: []regMask{buildReg("R29")}}, zeroWidth: true}, //MIPS:R22->R29
		...
		// and R30 (REGTMP).
		{name: "LoweredWB", argLength: 3, reg: regInfo{inputs: []regMask{buildReg("R27"), buildReg("R28")}, clobbers: (callerSave &^ gpg) | buildReg("R1")}, clobberFlags: true, aux: "Sym", symEffect: "None"}, //LA:R21(reserved)
