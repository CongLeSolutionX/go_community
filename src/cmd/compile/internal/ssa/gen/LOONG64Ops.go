...
func init() {
	...
	var (
		gp         = buildReg("R4 R5 R6 R7 R8 R9 R10 R11 R12 R13 R14 R15 R16 R17 R18 R19 R20 R24 R25 R26 R27 R28 R29 R31") //R2-tp,R3-sp,R22-fp,r,R21-unused
		gps        = buildReg("R4 R5 R6 R7 R8 R9 R10 R11 R12 R13 R14 R15 R16 R19 R20 R24 R25 R26 R27 R28 R29 R31") | buildReg("g")
		gpg        = gp | buildReg("g")
		gpsp       = gp | buildReg("SP")
