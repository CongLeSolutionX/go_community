...
func init() {
	...
	var S390Xblocks = []blockData{
		...
		{name: "CIJ", controls: 1, aux: "S390XCCMask", auxint: "Int8"},    // signed 32-bit integer comparison
		{name: "CGIJ", controls: 1, aux: "S390XCCMask", auxint: "Int8"},   // signed 64-bit integer comparison
		{name: "CLIJ", controls: 1, aux: "S390XCCMask", auxint: "UInt8"},  // unsigned 32-bit integer comparison
		{name: "CLGIJ", controls: 1, aux: "S390XCCMask", auxint: "UInt8"}, // unsigned 64-bit integer comparison
	}
