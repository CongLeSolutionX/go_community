...
func rewriteValue386_Op386ADDL(v *Value) bool {
	...
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			x := v_0
			if v_1.Op != Op386SHLLconst || int32(v_1.AuxInt) != 3 {
				continue
			}
			y := v_1.Args[0]
			v.reset(Op386LEAL8)
	...
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			x := v_0
			if v_1.Op != Op386SHLLconst || int32(v_1.AuxInt) != 2 {
				continue
			}
			y := v_1.Args[0]
			v.reset(Op386LEAL4)
	...
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			x := v_0
			if v_1.Op != Op386SHLLconst || int32(v_1.AuxInt) != 1 {
				continue
			}
			y := v_1.Args[0]
			v.reset(Op386LEAL2)
...
func rewriteValue386_Op386ADDLconstmodify(v *Value) bool {
	...
	for {
		...
		v.AuxInt = int64(valoff1.addOffset32(off2))
		v.Aux = sym
		v.AddArg2(base, mem)
		return true
	}
...
func rewriteValue386_Op386LEAL1(v *Value) bool {
	...
	// result: (ADDL x y)
	for {
		if int32(v.AuxInt) != 0 || auxToSym(v.Aux) != nil {
			break
		}
		x := v_0
		y := v_1
...
func rewriteValue386_Op386MOVLstore(v *Value) bool {
	...
	for {
		...
		ptr := v_0
		y := v_1
		if y.Op != Op386ADDLload || int32(y.AuxInt) != off || auxToSym(y.Aux) != sym {
			break
		}
		mem := y.Args[2]
		x := y.Args[0]
	...
	for {
		...
		ptr := v_0
		y := v_1
		if y.Op != Op386ANDLload || int32(y.AuxInt) != off || auxToSym(y.Aux) != sym {
			break
		}
		mem := y.Args[2]
		x := y.Args[0]
	...
	for {
		...
		ptr := v_0
		y := v_1
		if y.Op != Op386ORLload || int32(y.AuxInt) != off || auxToSym(y.Aux) != sym {
			break
		}
		mem := y.Args[2]
		x := y.Args[0]
	...
	for {
		...
		ptr := v_0
		y := v_1
		if y.Op != Op386XORLload || int32(y.AuxInt) != off || auxToSym(y.Aux) != sym {
			break
		}
		mem := y.Args[2]
		x := y.Args[0]
	...
	for {
		...
		for _i0 := 0; _i0 <= 1; _i0, y_0, y_1 = _i0+1, y_1, y_0 {
			l := y_0
			if l.Op != Op386MOVLload || int32(l.AuxInt) != off || auxToSym(l.Aux) != sym {
				continue
			}
			mem := l.Args[1]
			if ptr != l.Args[0] {
...
func rewriteValue386_Op386MULLconst(v *Value) bool {
	...
	for {
		...
		v.reset(Op386LEAL2)
		v0 := b.NewValue0(v.Pos, Op386SHLLconst, v.Type)
		v0.AuxInt = int64(int32(log32(c - 2)))
		v0.AddArg(x)
		v.AddArg2(v0, x)
		return true
	}
	...
	for {
		...
		v.reset(Op386LEAL4)
		v0 := b.NewValue0(v.Pos, Op386SHLLconst, v.Type)
		v0.AuxInt = int64(int32(log32(c - 4)))
		v0.AddArg(x)
		v.AddArg2(v0, x)
		return true
	}
	...
	for {
		...
		v.reset(Op386LEAL8)
		v0 := b.NewValue0(v.Pos, Op386SHLLconst, v.Type)
		v0.AuxInt = int64(int32(log32(c - 8)))
		v0.AddArg(x)
		v.AddArg2(v0, x)
		return true
	}
...
func rewriteValue386_Op386SARL(v *Value) bool {
	...
	for {
		x := v_0
		if v_1.Op != Op386ANDLconst || int32(v_1.AuxInt) != 31 {
			break
		}
		y := v_1.Args[0]
		v.reset(Op386SARL)
...
func rewriteValue386_Op386SARW(v *Value) bool {
	...
	for {
		...
		v.AuxInt = int64(int16(min(int64(c&31), 15)))
		v.AddArg(x)
		return true
	}
	return false
...
func rewriteValue386_OpMove(v *Value) bool {
	...
	for {
		...
		v0.AuxInt = int64(int32(s % 4))
		v0.AddArg(dst)
		v1 := b.NewValue0(v.Pos, Op386ADDLconst, src.Type)
		v1.AuxInt = int64(int32(s % 4))
		v1.AddArg(src)
...
func rewriteValue386_OpZero(v *Value) bool {
	...
	for {
		...
		v0 := b.NewValue0(v.Pos, Op386MOVLstoreconst, types.TypeMem)
		v0.AuxInt = int64(makeValAndOff(0, 4))
		v1 := b.NewValue0(v.Pos, Op386MOVLstoreconst, types.TypeMem)
	...
	for {
		...
		mem := v_1
		v.reset(Op386MOVLstoreconst)
		v.AuxInt = int64(makeValAndOff(0, 12))
		v0 := b.NewValue0(v.Pos, Op386MOVLstoreconst, types.TypeMem)
		v0.AuxInt = int64(makeValAndOff(0, 8))
		v1 := b.NewValue0(v.Pos, Op386MOVLstoreconst, types.TypeMem)
		v1.AuxInt = int64(makeValAndOff(0, 4))
