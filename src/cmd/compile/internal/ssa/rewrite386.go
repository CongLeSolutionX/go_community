...
func rewriteValue386_Op386ADDLconstmodify(v *Value) bool {
	...
	// cond: ValAndOff(valoff1).canAdd(int64(off2))
	// result: (ADDLconstmodify [ValAndOff(ValAndOff(valoff1).add(int64(off2)))] {sym} base mem)
	for {
		...
		base := v_0.Args[0]
		mem := v_1
		if !(ValAndOff(valoff1).canAdd(int64(off2))) {
			break
		}
		v.reset(Op386ADDLconstmodify)
		v.AuxInt = valAndOffToAuxInt(ValAndOff(ValAndOff(valoff1).add(int64(off2))))
		v.Aux = symToAux(sym)
		v.AddArg2(base, mem)
		return true
	}
	// match: (ADDLconstmodify [valoff1] {sym1} (LEAL [off2] {sym2} base) mem)
	// cond: ValAndOff(valoff1).canAdd(int64(off2)) && canMergeSym(sym1, sym2) && (base.Op != OpSB || !config.ctxt.Flag_shared)
	// result: (ADDLconstmodify [ValAndOff(ValAndOff(valoff1).add(int64(off2)))] {mergeSym(sym1,sym2).(Sym)} base mem)
	for {
		valoff1 := auxIntToValAndOff(v.AuxInt)
		sym1 := auxToSym(v.Aux)
		if v_0.Op != Op386LEAL {
		...
		base := v_0.Args[0]
		mem := v_1
		if !(ValAndOff(valoff1).canAdd(int64(off2)) && canMergeSym(sym1, sym2) && (base.Op != OpSB || !config.ctxt.Flag_shared)) {
			break
		}
		v.reset(Op386ADDLconstmodify)
		v.AuxInt = valAndOffToAuxInt(ValAndOff(ValAndOff(valoff1).add(int64(off2))))
		v.Aux = symToAux(mergeSym(sym1, sym2).(Sym))
		v.AddArg2(base, mem)
		return true
	}
	return false
...
func rewriteValue386_Op386ADDLload(v *Value) bool {
	...
	// cond: is32Bit(int64(off1+off2)) && canMergeSym(sym1, sym2) && (base.Op != OpSB || !config.ctxt.Flag_shared)
	// result: (ADDLload [off1+off2] {mergeSym(sym1,sym2).(Sym)} val base mem)
	for {
		off1 := auxIntToInt32(v.AuxInt)
		sym1 := auxToSym(v.Aux)
		val := v_0
		...
		base := v_1.Args[0]
		mem := v_2
		if !(is32Bit(int64(off1+off2)) && canMergeSym(sym1, sym2) && (base.Op != OpSB || !config.ctxt.Flag_shared)) {
			break
		}
		v.reset(Op386ADDLload)
		v.AuxInt = int32ToAuxInt(off1 + off2)
...
func rewriteValue386_Op386ADDLmodify(v *Value) bool {
	...
	// cond: is32Bit(int64(off1+off2)) && canMergeSym(sym1, sym2) && (base.Op != OpSB || !config.ctxt.Flag_shared)
	// result: (ADDLmodify [off1+off2] {mergeSym(sym1,sym2).(Sym)} base val mem)
	for {
		off1 := auxIntToInt32(v.AuxInt)
		sym1 := auxToSym(v.Aux)
		if v_0.Op != Op386LEAL {
...
func rewriteValue386_Op386ADDSDload(v *Value) bool {
	...
	// cond: is32Bit(int64(off1+off2)) && canMergeSym(sym1, sym2) && (base.Op != OpSB || !config.ctxt.Flag_shared)
	// result: (ADDSDload [off1+off2] {mergeSym(sym1,sym2).(Sym)} val base mem)
	for {
		off1 := auxIntToInt32(v.AuxInt)
		sym1 := auxToSym(v.Aux)
		val := v_0
...
func rewriteValue386_Op386ADDSSload(v *Value) bool {
	...
	// cond: is32Bit(int64(off1+off2)) && canMergeSym(sym1, sym2) && (base.Op != OpSB || !config.ctxt.Flag_shared)
	// result: (ADDSSload [off1+off2] {mergeSym(sym1,sym2).(Sym)} val base mem)
	for {
		off1 := auxIntToInt32(v.AuxInt)
		sym1 := auxToSym(v.Aux)
		val := v_0
...
func rewriteValue386_Op386ANDLconstmodify(v *Value) bool {
	...
	// cond: ValAndOff(valoff1).canAdd(int64(off2))
	// result: (ANDLconstmodify [ValAndOff(ValAndOff(valoff1).add(int64(off2)))] {sym} base mem)
	for {
		valoff1 := auxIntToValAndOff(v.AuxInt)
		sym := auxToSym(v.Aux)
		if v_0.Op != Op386ADDLconst {
	...
	// cond: ValAndOff(valoff1).canAdd(int64(off2)) && canMergeSym(sym1, sym2) && (base.Op != OpSB || !config.ctxt.Flag_shared)
	// result: (ANDLconstmodify [ValAndOff(ValAndOff(valoff1).add(int64(off2)))] {mergeSym(sym1,sym2).(Sym)} base mem)
	for {
		valoff1 := auxIntToValAndOff(v.AuxInt)
		sym1 := auxToSym(v.Aux)
		if v_0.Op != Op386LEAL {
...
func rewriteValue386_Op386ANDLload(v *Value) bool {
	...
	// cond: is32Bit(int64(off1+off2)) && canMergeSym(sym1, sym2) && (base.Op != OpSB || !config.ctxt.Flag_shared)
	// result: (ANDLload [off1+off2] {mergeSym(sym1,sym2).(Sym)} val base mem)
	for {
		off1 := auxIntToInt32(v.AuxInt)
		sym1 := auxToSym(v.Aux)
		val := v_0
...
func rewriteValue386_Op386ANDLmodify(v *Value) bool {
	...
	// cond: is32Bit(int64(off1+off2)) && canMergeSym(sym1, sym2) && (base.Op != OpSB || !config.ctxt.Flag_shared)
	// result: (ANDLmodify [off1+off2] {mergeSym(sym1,sym2).(Sym)} base val mem)
	for {
		off1 := auxIntToInt32(v.AuxInt)
		sym1 := auxToSym(v.Aux)
		if v_0.Op != Op386LEAL {
...
func rewriteValue386_Op386CMPBconst(v *Value) bool {
	...
	// match: (CMPBconst (MOVLconst [x]) [y])
	// cond: x<int32(y) && uint8(x)<uint8(y)
	// result: (FlagLT_ULT)
	for {
		y := auxIntToInt8(v.AuxInt)
		if v_0.Op != Op386MOVLconst {
...
func rewriteValue386_Op386CMPWconst(v *Value) bool {
	...
	// match: (CMPWconst (MOVLconst [x]) [y])
	// cond: x<int32(y) && uint16(x)<uint16(y)
	// result: (FlagLT_ULT)
	for {
		y := auxIntToInt16(v.AuxInt)
		if v_0.Op != Op386MOVLconst {
		...
		x := auxIntToInt32(v_0.AuxInt)
		if !(x < int32(y) && uint16(x) < uint16(y)) {
			break
		}
		v.reset(Op386FlagLT_ULT)
		return true
...
func rewriteValue386_Op386DIVSDload(v *Value) bool {
	...
	// cond: is32Bit(int64(off1+off2)) && canMergeSym(sym1, sym2) && (base.Op != OpSB || !config.ctxt.Flag_shared)
	// result: (DIVSDload [off1+off2] {mergeSym(sym1,sym2).(Sym)} val base mem)
	for {
		off1 := auxIntToInt32(v.AuxInt)
		sym1 := auxToSym(v.Aux)
		val := v_0
...
func rewriteValue386_Op386DIVSSload(v *Value) bool {
	...
	// cond: is32Bit(int64(off1+off2)) && canMergeSym(sym1, sym2) && (base.Op != OpSB || !config.ctxt.Flag_shared)
	// result: (DIVSSload [off1+off2] {mergeSym(sym1,sym2).(Sym)} val base mem)
	for {
		off1 := auxIntToInt32(v.AuxInt)
		sym1 := auxToSym(v.Aux)
		val := v_0
...
func rewriteValue386_Op386LEAL(v *Value) bool {
	...
	// cond: is32Bit(int64(off1+off2)) && canMergeSym(sym1, sym2)
	// result: (LEAL [off1+off2] {mergeSym(sym1,sym2).(Sym)} x)
	for {
		off1 := auxIntToInt32(v.AuxInt)
		sym1 := auxToSym(v.Aux)
		if v_0.Op != Op386LEAL {
		...
		sym2 := auxToSym(v_0.Aux)
		x := v_0.Args[0]
		if !(is32Bit(int64(off1+off2)) && canMergeSym(sym1, sym2)) {
			break
		}
		v.reset(Op386LEAL)
		v.AuxInt = int32ToAuxInt(off1 + off2)
	...
	// cond: is32Bit(int64(off1+off2)) && canMergeSym(sym1, sym2)
	// result: (LEAL1 [off1+off2] {mergeSym(sym1,sym2).(Sym)} x y)
	for {
		off1 := auxIntToInt32(v.AuxInt)
		sym1 := auxToSym(v.Aux)
		if v_0.Op != Op386LEAL1 {
	...
	// cond: is32Bit(int64(off1+off2)) && canMergeSym(sym1, sym2)
	// result: (LEAL2 [off1+off2] {mergeSym(sym1,sym2).(Sym)} x y)
	for {
		off1 := auxIntToInt32(v.AuxInt)
		sym1 := auxToSym(v.Aux)
		if v_0.Op != Op386LEAL2 {
	...
	// cond: is32Bit(int64(off1+off2)) && canMergeSym(sym1, sym2)
	// result: (LEAL4 [off1+off2] {mergeSym(sym1,sym2).(Sym)} x y)
	for {
		off1 := auxIntToInt32(v.AuxInt)
		sym1 := auxToSym(v.Aux)
		if v_0.Op != Op386LEAL4 {
	...
	// cond: is32Bit(int64(off1+off2)) && canMergeSym(sym1, sym2)
	// result: (LEAL8 [off1+off2] {mergeSym(sym1,sym2).(Sym)} x y)
	for {
		off1 := auxIntToInt32(v.AuxInt)
		sym1 := auxToSym(v.Aux)
		if v_0.Op != Op386LEAL8 {
...
func rewriteValue386_Op386LEAL1(v *Value) bool {
	...
	// cond: is32Bit(int64(c+d)) && x.Op != OpSB
	// result: (LEAL1 [c+d] {s} x y)
	for {
		c := auxIntToInt32(v.AuxInt)
		s := auxToSym(v.Aux)
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			...
			x := v_0.Args[0]
			y := v_1
			if !(is32Bit(int64(c+d)) && x.Op != OpSB) {
				continue
			}
			v.reset(Op386LEAL1)
			v.AuxInt = int32ToAuxInt(c + d)
	...
	// cond: is32Bit(int64(off1+off2)) && canMergeSym(sym1, sym2) && x.Op != OpSB
	// result: (LEAL1 [off1+off2] {mergeSym(sym1,sym2).(Sym)} x y)
	for {
		off1 := auxIntToInt32(v.AuxInt)
		sym1 := auxToSym(v.Aux)
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			...
			x := v_0.Args[0]
			y := v_1
			if !(is32Bit(int64(off1+off2)) && canMergeSym(sym1, sym2) && x.Op != OpSB) {
				continue
			}
			v.reset(Op386LEAL1)
			v.AuxInt = int32ToAuxInt(off1 + off2)
	...
	for {
		...
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			...
			sym2 := auxToSym(v_1.Aux)
			y := v_1.Args[1]
			if y != v_1.Args[0] || !(is32Bit(int64(off1+off2)) && canMergeSym(sym1, sym2)) {
				continue
			}
			v.reset(Op386LEAL2)
			v.AuxInt = int32ToAuxInt(off1 + off2)
	...
	// cond: is32Bit(int64(off1+off2)) && canMergeSym(sym1, sym2)
	// result: (LEAL2 [off1+off2] {mergeSym(sym1, sym2).(Sym)} y x)
	for {
		off1 := auxIntToInt32(v.AuxInt)
		sym1 := auxToSym(v.Aux)
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
...
func rewriteValue386_Op386LEAL2(v *Value) bool {
	...
	// cond: is32Bit(int64(c+2*d)) && y.Op != OpSB
	...
	for {
		...
		d := auxIntToInt32(v_1.AuxInt)
		y := v_1.Args[0]
		if !(is32Bit(int64(c+2*d)) && y.Op != OpSB) {
			break
		}
		v.reset(Op386LEAL2)
	...
	// cond: is32Bit(int64(off1+2*off2))
	...
	for {
		...
		y := v_1.Args[1]
		if y != v_1.Args[0] || !(is32Bit(int64(off1 + 2*off2))) {
			break
		}
		v.reset(Op386LEAL4)
...
func rewriteValue386_Op386LEAL4(v *Value) bool {
	...
	// cond: is32Bit(int64(c+4*d)) && y.Op != OpSB
	...
	for {
		...
		d := auxIntToInt32(v_1.AuxInt)
		y := v_1.Args[0]
		if !(is32Bit(int64(c+4*d)) && y.Op != OpSB) {
			break
		}
		v.reset(Op386LEAL4)
	...
	// cond: is32Bit(int64(off1+4*off2))
	...
	for {
		...
		y := v_1.Args[1]
		if y != v_1.Args[0] || !(is32Bit(int64(off1 + 4*off2))) {
			break
		}
		v.reset(Op386LEAL8)
...
func rewriteValue386_Op386LEAL8(v *Value) bool {
	...
	// cond: is32Bit(int64(c+8*d)) && y.Op != OpSB
	...
	for {
		...
		d := auxIntToInt32(v_1.AuxInt)
		y := v_1.Args[0]
		if !(is32Bit(int64(c+8*d)) && y.Op != OpSB) {
			break
		}
		v.reset(Op386LEAL8)
...
func rewriteValue386_Op386MOVBLSXload(v *Value) bool {
	...
	// cond: is32Bit(int64(off1+off2)) && canMergeSym(sym1, sym2) && (base.Op != OpSB || !config.ctxt.Flag_shared)
	// result: (MOVBLSXload [off1+off2] {mergeSym(sym1,sym2).(Sym)} base mem)
	for {
		off1 := auxIntToInt32(v.AuxInt)
		sym1 := auxToSym(v.Aux)
		if v_0.Op != Op386LEAL {
...
func rewriteValue386_Op386MOVBload(v *Value) bool {
	...
	// cond: is32Bit(int64(off1+off2)) && canMergeSym(sym1, sym2) && (base.Op != OpSB || !config.ctxt.Flag_shared)
	// result: (MOVBload [off1+off2] {mergeSym(sym1,sym2).(Sym)} base mem)
	for {
		off1 := auxIntToInt32(v.AuxInt)
		sym1 := auxToSym(v.Aux)
		if v_0.Op != Op386LEAL {
...
func rewriteValue386_Op386MOVBstore(v *Value) bool {
	...
	// cond: is32Bit(int64(off1+off2)) && canMergeSym(sym1, sym2) && (base.Op != OpSB || !config.ctxt.Flag_shared)
	// result: (MOVBstore [off1+off2] {mergeSym(sym1,sym2).(Sym)} base val mem)
	for {
		off1 := auxIntToInt32(v.AuxInt)
		sym1 := auxToSym(v.Aux)
		if v_0.Op != Op386LEAL {
...
func rewriteValue386_Op386MOVBstoreconst(v *Value) bool {
	...
	// cond: ValAndOff(sc).canAdd(int64(off))
	// result: (MOVBstoreconst [ValAndOff(ValAndOff(sc).add(int64(off)))] {s} ptr mem)
	for {
		...
		ptr := v_0.Args[0]
		mem := v_1
		if !(ValAndOff(sc).canAdd(int64(off))) {
			break
		}
		v.reset(Op386MOVBstoreconst)
		v.AuxInt = valAndOffToAuxInt(ValAndOff(ValAndOff(sc).add(int64(off))))
		v.Aux = symToAux(s)
		v.AddArg2(ptr, mem)
		return true
	}
	// match: (MOVBstoreconst [sc] {sym1} (LEAL [off] {sym2} ptr) mem)
	// cond: canMergeSym(sym1, sym2) && ValAndOff(sc).canAdd(int64(off)) && (ptr.Op != OpSB || !config.ctxt.Flag_shared)
	// result: (MOVBstoreconst [ValAndOff(ValAndOff(sc).add(int64(off)))] {mergeSym(sym1, sym2).(Sym)} ptr mem)
	for {
		sc := auxIntToValAndOff(v.AuxInt)
		sym1 := auxToSym(v.Aux)
		if v_0.Op != Op386LEAL {
		...
		ptr := v_0.Args[0]
		mem := v_1
		if !(canMergeSym(sym1, sym2) && ValAndOff(sc).canAdd(int64(off)) && (ptr.Op != OpSB || !config.ctxt.Flag_shared)) {
			break
		}
		v.reset(Op386MOVBstoreconst)
		v.AuxInt = valAndOffToAuxInt(ValAndOff(ValAndOff(sc).add(int64(off))))
...
func rewriteValue386_Op386MOVLload(v *Value) bool {
	...
	// cond: is32Bit(int64(off1+off2)) && canMergeSym(sym1, sym2) && (base.Op != OpSB || !config.ctxt.Flag_shared)
	// result: (MOVLload [off1+off2] {mergeSym(sym1,sym2).(Sym)} base mem)
	for {
		off1 := auxIntToInt32(v.AuxInt)
		sym1 := auxToSym(v.Aux)
		if v_0.Op != Op386LEAL {
...
func rewriteValue386_Op386MOVLstore(v *Value) bool {
	...
	// cond: is32Bit(int64(off1+off2)) && canMergeSym(sym1, sym2) && (base.Op != OpSB || !config.ctxt.Flag_shared)
	// result: (MOVLstore [off1+off2] {mergeSym(sym1,sym2).(Sym)} base val mem)
	for {
		off1 := auxIntToInt32(v.AuxInt)
		sym1 := auxToSym(v.Aux)
		if v_0.Op != Op386LEAL {
...
func rewriteValue386_Op386MOVLstoreconst(v *Value) bool {
	...
	// cond: ValAndOff(sc).canAdd(int64(off))
	// result: (MOVLstoreconst [ValAndOff(ValAndOff(sc).add(int64(off)))] {s} ptr mem)
	for {
		sc := auxIntToValAndOff(v.AuxInt)
		s := auxToSym(v.Aux)
		if v_0.Op != Op386ADDLconst {
	...
	// cond: canMergeSym(sym1, sym2) && ValAndOff(sc).canAdd(int64(off)) && (ptr.Op != OpSB || !config.ctxt.Flag_shared)
	// result: (MOVLstoreconst [ValAndOff(ValAndOff(sc).add(int64(off)))] {mergeSym(sym1, sym2).(Sym)} ptr mem)
	for {
		sc := auxIntToValAndOff(v.AuxInt)
		sym1 := auxToSym(v.Aux)
		if v_0.Op != Op386LEAL {
...
func rewriteValue386_Op386MOVSDload(v *Value) bool {
	...
	// cond: is32Bit(int64(off1+off2)) && canMergeSym(sym1, sym2) && (base.Op != OpSB || !config.ctxt.Flag_shared)
	// result: (MOVSDload [off1+off2] {mergeSym(sym1,sym2).(Sym)} base mem)
	for {
		off1 := auxIntToInt32(v.AuxInt)
		sym1 := auxToSym(v.Aux)
		if v_0.Op != Op386LEAL {
...
func rewriteValue386_Op386MOVSDstore(v *Value) bool {
	...
	// cond: is32Bit(int64(off1+off2)) && canMergeSym(sym1, sym2) && (base.Op != OpSB || !config.ctxt.Flag_shared)
	// result: (MOVSDstore [off1+off2] {mergeSym(sym1,sym2).(Sym)} base val mem)
	for {
		off1 := auxIntToInt32(v.AuxInt)
		sym1 := auxToSym(v.Aux)
		if v_0.Op != Op386LEAL {
...
func rewriteValue386_Op386MOVSSload(v *Value) bool {
	...
	// cond: is32Bit(int64(off1+off2)) && canMergeSym(sym1, sym2) && (base.Op != OpSB || !config.ctxt.Flag_shared)
	// result: (MOVSSload [off1+off2] {mergeSym(sym1,sym2).(Sym)} base mem)
	for {
		off1 := auxIntToInt32(v.AuxInt)
		sym1 := auxToSym(v.Aux)
		if v_0.Op != Op386LEAL {
...
func rewriteValue386_Op386MOVSSstore(v *Value) bool {
	...
	// cond: is32Bit(int64(off1+off2)) && canMergeSym(sym1, sym2) && (base.Op != OpSB || !config.ctxt.Flag_shared)
	// result: (MOVSSstore [off1+off2] {mergeSym(sym1,sym2).(Sym)} base val mem)
	for {
		off1 := auxIntToInt32(v.AuxInt)
		sym1 := auxToSym(v.Aux)
		if v_0.Op != Op386LEAL {
...
func rewriteValue386_Op386MOVWLSXload(v *Value) bool {
	...
	// cond: is32Bit(int64(off1+off2)) && canMergeSym(sym1, sym2) && (base.Op != OpSB || !config.ctxt.Flag_shared)
	// result: (MOVWLSXload [off1+off2] {mergeSym(sym1,sym2).(Sym)} base mem)
	for {
		off1 := auxIntToInt32(v.AuxInt)
		sym1 := auxToSym(v.Aux)
		if v_0.Op != Op386LEAL {
...
func rewriteValue386_Op386MOVWload(v *Value) bool {
	...
	// cond: is32Bit(int64(off1+off2)) && canMergeSym(sym1, sym2) && (base.Op != OpSB || !config.ctxt.Flag_shared)
	// result: (MOVWload [off1+off2] {mergeSym(sym1,sym2).(Sym)} base mem)
	for {
		off1 := auxIntToInt32(v.AuxInt)
		sym1 := auxToSym(v.Aux)
		if v_0.Op != Op386LEAL {
...
func rewriteValue386_Op386MOVWstore(v *Value) bool {
	...
	// cond: is32Bit(int64(off1+off2)) && canMergeSym(sym1, sym2) && (base.Op != OpSB || !config.ctxt.Flag_shared)
	// result: (MOVWstore [off1+off2] {mergeSym(sym1,sym2).(Sym)} base val mem)
	for {
		off1 := auxIntToInt32(v.AuxInt)
		sym1 := auxToSym(v.Aux)
		if v_0.Op != Op386LEAL {
...
func rewriteValue386_Op386MOVWstoreconst(v *Value) bool {
	...
	// cond: ValAndOff(sc).canAdd(int64(off))
	// result: (MOVWstoreconst [ValAndOff(ValAndOff(sc).add(int64(off)))] {s} ptr mem)
	for {
		sc := auxIntToValAndOff(v.AuxInt)
		s := auxToSym(v.Aux)
		if v_0.Op != Op386ADDLconst {
	...
	// cond: canMergeSym(sym1, sym2) && ValAndOff(sc).canAdd(int64(off)) && (ptr.Op != OpSB || !config.ctxt.Flag_shared)
	// result: (MOVWstoreconst [ValAndOff(ValAndOff(sc).add(int64(off)))] {mergeSym(sym1, sym2).(Sym)} ptr mem)
	for {
		sc := auxIntToValAndOff(v.AuxInt)
		sym1 := auxToSym(v.Aux)
		if v_0.Op != Op386LEAL {
...
func rewriteValue386_Op386MULLload(v *Value) bool {
	...
	// cond: is32Bit(int64(off1+off2)) && canMergeSym(sym1, sym2) && (base.Op != OpSB || !config.ctxt.Flag_shared)
	// result: (MULLload [off1+off2] {mergeSym(sym1,sym2).(Sym)} val base mem)
	for {
		off1 := auxIntToInt32(v.AuxInt)
		sym1 := auxToSym(v.Aux)
		val := v_0
...
func rewriteValue386_Op386MULSDload(v *Value) bool {
	...
	// cond: is32Bit(int64(off1+off2)) && canMergeSym(sym1, sym2) && (base.Op != OpSB || !config.ctxt.Flag_shared)
	// result: (MULSDload [off1+off2] {mergeSym(sym1,sym2).(Sym)} val base mem)
	for {
		off1 := auxIntToInt32(v.AuxInt)
		sym1 := auxToSym(v.Aux)
		val := v_0
...
func rewriteValue386_Op386MULSSload(v *Value) bool {
	...
	// cond: is32Bit(int64(off1+off2)) && canMergeSym(sym1, sym2) && (base.Op != OpSB || !config.ctxt.Flag_shared)
	// result: (MULSSload [off1+off2] {mergeSym(sym1,sym2).(Sym)} val base mem)
	for {
		off1 := auxIntToInt32(v.AuxInt)
		sym1 := auxToSym(v.Aux)
		val := v_0
...
func rewriteValue386_Op386ORLconstmodify(v *Value) bool {
	...
	// cond: ValAndOff(valoff1).canAdd(int64(off2))
	// result: (ORLconstmodify [ValAndOff(ValAndOff(valoff1).add(int64(off2)))] {sym} base mem)
	for {
		valoff1 := auxIntToValAndOff(v.AuxInt)
		sym := auxToSym(v.Aux)
		if v_0.Op != Op386ADDLconst {
	...
	// cond: ValAndOff(valoff1).canAdd(int64(off2)) && canMergeSym(sym1, sym2) && (base.Op != OpSB || !config.ctxt.Flag_shared)
	// result: (ORLconstmodify [ValAndOff(ValAndOff(valoff1).add(int64(off2)))] {mergeSym(sym1,sym2).(Sym)} base mem)
	for {
		valoff1 := auxIntToValAndOff(v.AuxInt)
		sym1 := auxToSym(v.Aux)
		if v_0.Op != Op386LEAL {
...
func rewriteValue386_Op386ORLload(v *Value) bool {
	...
	// cond: is32Bit(int64(off1+off2)) && canMergeSym(sym1, sym2) && (base.Op != OpSB || !config.ctxt.Flag_shared)
	// result: (ORLload [off1+off2] {mergeSym(sym1,sym2).(Sym)} val base mem)
	for {
		off1 := auxIntToInt32(v.AuxInt)
		sym1 := auxToSym(v.Aux)
		val := v_0
...
func rewriteValue386_Op386ORLmodify(v *Value) bool {
	...
	// cond: is32Bit(int64(off1+off2)) && canMergeSym(sym1, sym2) && (base.Op != OpSB || !config.ctxt.Flag_shared)
	// result: (ORLmodify [off1+off2] {mergeSym(sym1,sym2).(Sym)} base val mem)
	for {
		off1 := auxIntToInt32(v.AuxInt)
		sym1 := auxToSym(v.Aux)
		if v_0.Op != Op386LEAL {
...
func rewriteValue386_Op386SUBLload(v *Value) bool {
	...
	// cond: is32Bit(int64(off1+off2)) && canMergeSym(sym1, sym2) && (base.Op != OpSB || !config.ctxt.Flag_shared)
	// result: (SUBLload [off1+off2] {mergeSym(sym1,sym2).(Sym)} val base mem)
	for {
		off1 := auxIntToInt32(v.AuxInt)
		sym1 := auxToSym(v.Aux)
		val := v_0
...
func rewriteValue386_Op386SUBLmodify(v *Value) bool {
	...
	// cond: is32Bit(int64(off1+off2)) && canMergeSym(sym1, sym2) && (base.Op != OpSB || !config.ctxt.Flag_shared)
	// result: (SUBLmodify [off1+off2] {mergeSym(sym1,sym2).(Sym)} base val mem)
	for {
		off1 := auxIntToInt32(v.AuxInt)
		sym1 := auxToSym(v.Aux)
		if v_0.Op != Op386LEAL {
...
func rewriteValue386_Op386SUBSDload(v *Value) bool {
	...
	// cond: is32Bit(int64(off1+off2)) && canMergeSym(sym1, sym2) && (base.Op != OpSB || !config.ctxt.Flag_shared)
	// result: (SUBSDload [off1+off2] {mergeSym(sym1,sym2).(Sym)} val base mem)
	for {
		off1 := auxIntToInt32(v.AuxInt)
		sym1 := auxToSym(v.Aux)
		val := v_0
...
func rewriteValue386_Op386SUBSSload(v *Value) bool {
	...
	// cond: is32Bit(int64(off1+off2)) && canMergeSym(sym1, sym2) && (base.Op != OpSB || !config.ctxt.Flag_shared)
	// result: (SUBSSload [off1+off2] {mergeSym(sym1,sym2).(Sym)} val base mem)
	for {
		off1 := auxIntToInt32(v.AuxInt)
		sym1 := auxToSym(v.Aux)
		val := v_0
...
func rewriteValue386_Op386XORLconstmodify(v *Value) bool {
	...
	// cond: ValAndOff(valoff1).canAdd(int64(off2))
	// result: (XORLconstmodify [ValAndOff(ValAndOff(valoff1).add(int64(off2)))] {sym} base mem)
	for {
		valoff1 := auxIntToValAndOff(v.AuxInt)
		sym := auxToSym(v.Aux)
		if v_0.Op != Op386ADDLconst {
	...
	// cond: ValAndOff(valoff1).canAdd(int64(off2)) && canMergeSym(sym1, sym2) && (base.Op != OpSB || !config.ctxt.Flag_shared)
	// result: (XORLconstmodify [ValAndOff(ValAndOff(valoff1).add(int64(off2)))] {mergeSym(sym1,sym2).(Sym)} base mem)
	for {
		valoff1 := auxIntToValAndOff(v.AuxInt)
		sym1 := auxToSym(v.Aux)
		if v_0.Op != Op386LEAL {
...
func rewriteValue386_Op386XORLload(v *Value) bool {
	...
	// cond: is32Bit(int64(off1+off2)) && canMergeSym(sym1, sym2) && (base.Op != OpSB || !config.ctxt.Flag_shared)
	// result: (XORLload [off1+off2] {mergeSym(sym1,sym2).(Sym)} val base mem)
	for {
		off1 := auxIntToInt32(v.AuxInt)
		sym1 := auxToSym(v.Aux)
		val := v_0
...
func rewriteValue386_Op386XORLmodify(v *Value) bool {
	...
	// cond: is32Bit(int64(off1+off2)) && canMergeSym(sym1, sym2) && (base.Op != OpSB || !config.ctxt.Flag_shared)
	// result: (XORLmodify [off1+off2] {mergeSym(sym1,sym2).(Sym)} base val mem)
	for {
		off1 := auxIntToInt32(v.AuxInt)
		sym1 := auxToSym(v.Aux)
		if v_0.Op != Op386LEAL {
