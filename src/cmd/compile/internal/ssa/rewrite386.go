...
func rewriteValue386_Op386ADDLconstmodify_0(v *Value) bool {
	...
	for {
		...
		v.setAuxValAndOff(ValAndOff(valoff1).add(off2))
		v.Aux = sym
		v.AddArg(base)
		v.AddArg(mem)
		return true
...
func rewriteValue386_Op386MOVLloadidx4_0(v *Value) bool {
	...
	for {
		...
		mem := v.Args[2]
		v.reset(Op386MOVLloadidx4)
		v.setAuxInt64(int64(int32(c + 4*d)))
		v.Aux = sym
		v.AddArg(ptr)
		v.AddArg(idx)
		v.AddArg(mem)
...
func rewriteValue386_Op386MOVSDloadidx8_0(v *Value) bool {
	...
	for {
		...
		mem := v.Args[2]
		v.reset(Op386MOVSDloadidx8)
		v.setAuxInt64(int64(int32(c + 8*d)))
		v.Aux = sym
		v.AddArg(ptr)
		v.AddArg(idx)
		v.AddArg(mem)
...
func rewriteValue386_Op386MOVWloadidx2_0(v *Value) bool {
	...
	for {
		...
		mem := v.Args[2]
		v.reset(Op386MOVWloadidx2)
		v.setAuxInt64(int64(int32(c + 2*d)))
		v.Aux = sym
		v.AddArg(ptr)
		v.AddArg(idx)
		v.AddArg(mem)
