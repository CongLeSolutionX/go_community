...
func rewriteValue386_Op386ADDLconstmodify(v *Value) bool {
	...
	// result: (ADDLconstmodify [ValAndOff(valoff1).add(int64(off2))] {mergeSym(sym1,sym2).(Sym)} base mem)
	for {
		valoff1 := v.AuxInt
		sym1 := v.Aux
		if v_0.Op != Op386LEAL {
		...
		v.reset(Op386ADDLconstmodify)
		v.AuxInt = ValAndOff(valoff1).add(int64(off2))
		v.Aux = mergeSym(sym1, sym2).(Sym)
		v.AddArg2(base, mem)
		return true
	}
	return false
...
func rewriteValue386_Op386ANDLconstmodify(v *Value) bool {
	...
	// cond: ValAndOff(valoff1).canAdd(off2) && canMergeSym(sym1, sym2) && (base.Op != OpSB || !config.ctxt.Flag_shared)
	// result: (ANDLconstmodify [ValAndOff(valoff1).add(int64(off2))] {mergeSym(sym1,sym2).(Sym)} base mem)
	for {
		valoff1 := v.AuxInt
		sym1 := v.Aux
		if v_0.Op != Op386LEAL {
...
func rewriteValue386_Op386ORLconstmodify(v *Value) bool {
	...
	// cond: ValAndOff(valoff1).canAdd(off2) && canMergeSym(sym1, sym2) && (base.Op != OpSB || !config.ctxt.Flag_shared)
	// result: (ORLconstmodify [ValAndOff(valoff1).add(int64(off2))] {mergeSym(sym1,sym2).(Sym)} base mem)
	for {
		valoff1 := v.AuxInt
		sym1 := v.Aux
		if v_0.Op != Op386LEAL {
...
func rewriteValue386_Op386XORLconstmodify(v *Value) bool {
	...
	// cond: ValAndOff(valoff1).canAdd(off2) && canMergeSym(sym1, sym2) && (base.Op != OpSB || !config.ctxt.Flag_shared)
	// result: (XORLconstmodify [ValAndOff(valoff1).add(int64(off2))] {mergeSym(sym1,sym2).(Sym)} base mem)
	for {
		valoff1 := v.AuxInt
		sym1 := v.Aux
		if v_0.Op != Op386LEAL {
