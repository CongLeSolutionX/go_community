...
type Logger interface {
	...
	Fatalf(line src.Lineno, msg string, args ...interface{})

	// Warnl writes compiler messages in the form expected by "errorcheck" tests
	Warnl(line src.Lineno, fmt_ string, args ...interface{})
...
func (c *Config) Fatalf(line src.Lineno, msg string, args ...interface{}) {
	c.fe.Fatalf(line, msg, args...)
}
func (c *Config) Warnl(line src.Lineno, msg string, args ...interface{}) {
	c.fe.Warnl(line, msg, args...)
}
