...
// maxPredVal is the current worst case
func BenchmarkDominatorsMaxPredVal1(b *testing.B)     { benchmarkDominators(b, 1, genMaxPredValue) }
func BenchmarkDominatorsMaxPredVal10(b *testing.B)    { benchmarkDominators(b, 10, genMaxPredValue) }
func BenchmarkDominatorsMaxPredVal100(b *testing.B)   { benchmarkDominators(b, 100, genMaxPredValue) }
func BenchmarkDominatorsMaxPredVal1000(b *testing.B)  { benchmarkDominators(b, 1000, genMaxPredValue) }
func BenchmarkDominatorsMaxPredVal10000(b *testing.B) { benchmarkDominators(b, 10000, genMaxPredValue) }
