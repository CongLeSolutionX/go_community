...
type sparseTreeMapEntry struct {
	...
	adjust       int32               // at what adjustment was this node entered into the sparse tree? The same block maybe be entered more than once, but at different adjustments.
}
...
func (m *SparseTreeMap) Insert(b *Block, adjust int32, x interface{}, helper *SparseTreeHelper) {
	...
	// sp will be the sparse parent with this tree (nearest ancestor in the larger tree that is also in this tree)
