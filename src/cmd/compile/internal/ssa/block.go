...
// FormatFlowgraph renders a flowgraph (hopefully in postorder,
// but not required )as a series of
//     preds -> node -> succs
// lines for easier human comprehension.
...
// MakeTestFlowgraph renders a flowgraph (hopefully in postorder)
// as a test case that with minimal editing be included in dom_test.go.
// The default behavior is to test the dominator tree construction, but
// other tests can be edited in by hand.
