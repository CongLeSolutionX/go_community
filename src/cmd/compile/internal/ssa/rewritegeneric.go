...
func rewriteValuegeneric(v *Value, config *Config) bool {
	...
	case OpArrayIndex:
		...
		// cond:
		// result: @v.Args[0].Block (Load <v.Type> (PtrIndex <v.Type.PtrTo()> ptr idx) mem)
		{
			if v.Args[0].Op != OpLoad {
				goto end1582058041d005a3bb0fdb3a3e457f0f
			}
			ptr := v.Args[0].Args[0]
			mem := v.Args[0].Args[1]
			idx := v.Args[1]
			...
			v.AddArg(v0)
			v0.Type = v.Type
			v1 := v.Args[0].Block.NewValue0(v.Line, OpPtrIndex, TypeInvalid)
		...
		goto end1582058041d005a3bb0fdb3a3e457f0f
	end1582058041d005a3bb0fdb3a3e457f0f:
		;
	case OpCom16:
		// match: (Com16 (Com16 x))
		// cond:
