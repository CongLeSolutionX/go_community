...
func rewriteValuegeneric_OpDiv16u_0(v *Value) bool {
	...
	// match: (Div16u x (Const16 [c]))
	// cond: umagicOK(16, c) && config.RegSize == 4 && !config.noAvg
	...
	for {
		...
		c := v_1.AuxInt
		if !(umagicOK(16, c) && config.RegSize == 4 && !config.noAvg) {
			break
		}
		v.reset(OpTrunc32to16)
		v0 := b.NewValue0(v.Pos, OpRsh32Ux64, typ.UInt32)
...
func rewriteValuegeneric_OpDiv32_0(v *Value) bool {
	...
	// match: (Div32 <t> x (Const32 [c]))
	// cond: smagicOK(32,c) && config.RegSize == 4 && smagic(32,c).m&1 == 0 && !config.noHmul
	...
	for {
		...
		c := v_1.AuxInt
		if !(smagicOK(32, c) && config.RegSize == 4 && smagic(32, c).m&1 == 0 && !config.noHmul) {
			break
		}
		v.reset(OpSub32)
		v.Type = t
...
func rewriteValuegeneric_OpDiv32u_0(v *Value) bool {
	...
	// cond: umagicOK(32, c) && config.RegSize == 4 && umagic(32,c).m&1 == 0 && !config.noHmul
	...
	for {
		...
		c := v_1.AuxInt
		if !(umagicOK(32, c) && config.RegSize == 4 && umagic(32, c).m&1 == 0 && !config.noHmul) {
			break
		}
		v.reset(OpRsh32Ux64)
		v.Type = typ.UInt32
	...
	// match: (Div32u x (Const32 [c]))
	// cond: umagicOK(32, c) && config.RegSize == 4 && c&1 == 0 && !config.noHmul
	...
	for {
		...
		c := v_1.AuxInt
		if !(umagicOK(32, c) && config.RegSize == 4 && c&1 == 0 && !config.noHmul) {
			break
		}
		v.reset(OpRsh32Ux64)
		v.Type = typ.UInt32
	...
	// match: (Div32u x (Const32 [c]))
	// cond: umagicOK(32, c) && config.RegSize == 4 && !config.noAvg && !config.noHmul
	...
	for {
		...
		c := v_1.AuxInt
		if !(umagicOK(32, c) && config.RegSize == 4 && !config.noAvg && !config.noHmul) {
			break
		}
		v.reset(OpRsh32Ux64)
		v.Type = typ.UInt32
	...
	// match: (Div32u x (Const32 [c]))
	// cond: umagicOK(32, c) && config.RegSize == 8 && !config.noAvg
	...
	for {
		...
		c := v_1.AuxInt
		if !(umagicOK(32, c) && config.RegSize == 8 && !config.noAvg) {
			break
		}
		v.reset(OpTrunc64to32)
		v0 := b.NewValue0(v.Pos, OpRsh64Ux64, typ.UInt64)
...
func rewriteValuegeneric_OpDiv64_0(v *Value) bool {
	...
	// cond: smagicOK(64,c) && smagic(64,c).m&1 == 0 && !config.noHmul
	...
	for {
		...
		c := v_1.AuxInt
		if !(smagicOK(64, c) && smagic(64, c).m&1 == 0 && !config.noHmul) {
			break
		}
		v.reset(OpSub64)
		v.Type = t
...
func rewriteValuegeneric_OpDiv64u_0(v *Value) bool {
	...
	// cond: umagicOK(64, c) && config.RegSize == 8 && umagic(64,c).m&1 == 0 && !config.noHmul
	...
	for {
		...
		c := v_1.AuxInt
		if !(umagicOK(64, c) && config.RegSize == 8 && umagic(64, c).m&1 == 0 && !config.noHmul) {
			break
		}
		v.reset(OpRsh64Ux64)
		v.Type = typ.UInt64
	...
	// match: (Div64u x (Const64 [c]))
	// cond: umagicOK(64, c) && config.RegSize == 8 && c&1 == 0 && !config.noHmul
	...
	for {
		...
		c := v_1.AuxInt
		if !(umagicOK(64, c) && config.RegSize == 8 && c&1 == 0 && !config.noHmul) {
			break
		}
		v.reset(OpRsh64Ux64)
		v.Type = typ.UInt64
	...
	// match: (Div64u x (Const64 [c]))
	// cond: umagicOK(64, c) && config.RegSize == 8 && !config.noAvg && !config.noHmul
	...
	for {
		...
		c := v_1.AuxInt
		if !(umagicOK(64, c) && config.RegSize == 8 && !config.noAvg && !config.noHmul) {
			break
		}
		v.reset(OpRsh64Ux64)
		v.Type = typ.UInt64
