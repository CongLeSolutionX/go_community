...
func rewriteValuegeneric_OpAndB(v *Value) bool {
	...
	// match: (AndB (Neq64 x (Const64 [c])) (Neq64 x (Const64 [d])))
	// cond: c > d && oneBit64(c^d)
	// result: (Neq64 (Or64 <x.Type> x (Const64 <x.Type> [c^d])) (Const64 <x.Type> [c]))
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			if v_0.Op != OpNeq64 {
				continue
	...
	// match: (AndB (Neq32 x (Const32 [c])) (Neq32 x (Const32 [d])))
	// cond: c > d && oneBit32(c^d)
	// result: (Neq32 (Or32 <x.Type> x (Const32 <x.Type> [c^d])) (Const32 <x.Type> [c]))
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			if v_0.Op != OpNeq32 {
				continue
	...
	// match: (AndB (Neq16 x (Const16 [c])) (Neq16 x (Const16 [d])))
	// cond: c > d && oneBit16(c^d)
	// result: (Neq16 (Or16 <x.Type> x (Const16 <x.Type> [c^d])) (Const16 <x.Type> [c]))
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			if v_0.Op != OpNeq16 {
				continue
	...
	// match: (AndB (Neq8 x (Const8 [c])) (Neq8 x (Const8 [d])))
	// cond: c > d && oneBit8(c^d)
	// result: (Neq8 (Or8 <x.Type> x (Const8 <x.Type> [c^d])) (Const8 <x.Type> [c]))
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			if v_0.Op != OpNeq8 {
				continue
...
func rewriteValuegeneric_OpOrB(v *Value) bool {
	...
	// match: (OrB (Eq64 x (Const64 [c])) (Eq64 x (Const64 [d])))
	// cond: c > d && oneBit64(c^d)
	// result: (Eq64 (Or64 <x.Type> x (Const64 <x.Type> [c^d])) (Const64 <x.Type> [c]))
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			if v_0.Op != OpEq64 {
				continue
	...
	// match: (OrB (Eq32 x (Const32 [c])) (Eq32 x (Const32 [d])))
	// cond: c > d && oneBit32(c^d)
	// result: (Eq32 (Or32 <x.Type> x (Const32 <x.Type> [c^d])) (Const32 <x.Type> [c]))
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			if v_0.Op != OpEq32 {
				continue
	...
	// match: (OrB (Eq16 x (Const16 [c])) (Eq16 x (Const16 [d])))
	// cond: c > d && oneBit16(c^d)
	// result: (Eq16 (Or16 <x.Type> x (Const16 <x.Type> [c^d])) (Const16 <x.Type> [c]))
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			if v_0.Op != OpEq16 {
				continue
	...
	// match: (OrB (Eq8 x (Const8 [c])) (Eq8 x (Const8 [d])))
	// cond: c > d && oneBit8(c^d)
	// result: (Eq8 (Or8 <x.Type> x (Const8 <x.Type> [c^d])) (Const8 <x.Type> [c]))
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			if v_0.Op != OpEq8 {
				continue
