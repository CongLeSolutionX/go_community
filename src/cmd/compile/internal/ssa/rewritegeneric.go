...
func rewriteValuegeneric_OpLess16(v *Value) bool {
	...
	// cond: n == minValueForInt(v.Type)+1
	// result: (Eq16 x (Const16 <t> [minValueForInt(v.Type)]))
	for {
		x := v_0
		if v_1.Op != OpConst16 {
			break
		...
		if !(n == minValueForInt(v.Type)+1) {
			break
		}
		v.reset(OpEq16)
		v0 := b.NewValue0(v.Pos, OpConst16, t)
		v0.AuxInt = int16ToAuxInt(minValueForInt(v.Type))
		v.AddArg2(x, v0)
		return true
	}
	// match: (Less16 (Const16 <t> [n]) x)
	// cond: n == maxValueForInt(v.Type)-1
	// result: (Eq16 x (Const16 <t> [maxValueForInt(v.Type)]))
	for {
		if v_0.Op != OpConst16 {
			break
		}
		...
		x := v_1
		if !(n == maxValueForInt(v.Type)-1) {
			break
		}
		v.reset(OpEq16)
		v0 := b.NewValue0(v.Pos, OpConst16, t)
		v0.AuxInt = int16ToAuxInt(maxValueForInt(v.Type))
		v.AddArg2(x, v0)
		return true
	}
	return false
...
func rewriteValuegeneric_OpLess32(v *Value) bool {
	...
	// cond: n == minValueForInt(v.Type)+1
	// result: (Eq32 x (Const32 <t> [minValueForInt(v.Type)]))
	for {
		x := v_0
		if v_1.Op != OpConst32 {
			break
		...
		v.reset(OpEq32)
		v0 := b.NewValue0(v.Pos, OpConst32, t)
		v0.AuxInt = int32ToAuxInt(minValueForInt(v.Type))
		v.AddArg2(x, v0)
		return true
	}
	// match: (Less32 (Const32 <t> [n]) x)
	// cond: n == maxValueForInt(v.Type)-1
	// result: (Eq32 x (Const32 <t> [maxValueForInt(v.Type)]))
	for {
		if v_0.Op != OpConst32 {
			break
		}
		...
		v.reset(OpEq32)
		v0 := b.NewValue0(v.Pos, OpConst32, t)
		v0.AuxInt = int32ToAuxInt(maxValueForInt(v.Type))
		v.AddArg2(x, v0)
		return true
	}
	return false
...
func rewriteValuegeneric_OpLess64(v *Value) bool {
	...
	// cond: n == minValueForInt(v.Type)+1
	// result: (Eq64 x (Const64 <t> [minValueForInt(v.Type)]))
	for {
		x := v_0
		if v_1.Op != OpConst64 {
			break
		...
		v.reset(OpEq64)
		v0 := b.NewValue0(v.Pos, OpConst64, t)
		v0.AuxInt = int64ToAuxInt(minValueForInt(v.Type))
		v.AddArg2(x, v0)
		return true
	}
	// match: (Less64 (Const64 <t> [n]) x)
	// cond: n == maxValueForInt(v.Type)-1
	// result: (Eq64 x (Const64 <t> [maxValueForInt(v.Type)]))
	for {
		if v_0.Op != OpConst64 {
			break
		}
		...
		v.reset(OpEq64)
		v0 := b.NewValue0(v.Pos, OpConst64, t)
		v0.AuxInt = int64ToAuxInt(maxValueForInt(v.Type))
		v.AddArg2(x, v0)
		return true
	}
	return false
...
func rewriteValuegeneric_OpLess8(v *Value) bool {
	...
	// cond: n == minValueForInt(v.Type)+1
	// result: (Eq8 x (Const8 <t> [minValueForInt(v.Type)]))
	for {
		x := v_0
		if v_1.Op != OpConst8 {
			break
		...
		v.reset(OpEq8)
		v0 := b.NewValue0(v.Pos, OpConst8, t)
		v0.AuxInt = int8ToAuxInt(minValueForInt(v.Type))
		v.AddArg2(x, v0)
		return true
	}
	// match: (Less8 (Const8 <t> [n]) x)
	// cond: n == maxValueForInt(v.Type)-1
	// result: (Eq8 x (Const8 <t> [maxValueForInt(v.Type)]))
	for {
		if v_0.Op != OpConst8 {
			break
		}
		...
		v.reset(OpEq8)
		v0 := b.NewValue0(v.Pos, OpConst8, t)
		v0.AuxInt = int8ToAuxInt(maxValueForInt(v.Type))
		v.AddArg2(x, v0)
		return true
	}
	return false
