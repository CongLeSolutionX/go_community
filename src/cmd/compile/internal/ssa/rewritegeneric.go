...
func rewriteValuegeneric_OpEq16_0(v *Value) bool {
	...
	// result: (Leq16U (RotateLeft16 <t> (Mul16 <t> (Const16 <typ.UInt16> [int64(int16(udivisible(16,c).m))]) x) (Const16 <typ.UInt16> [int64(16-udivisible(16,c).k)]) ) (Const16 <typ.UInt16> [int64(int16(udivisible(16,c).max))]) )
	for {
		_ = v.Args[1]
		v_0 := v.Args[0]
		if v_0.Op != OpMod16u {
...
func rewriteValuegeneric_OpEq32_0(v *Value) bool {
	...
	// result: (Leq32U (RotateLeft32 <t> (Mul32 <t> (Const32 <typ.UInt32> [int64(int32(udivisible(32,c).m))]) x) (Const32 <typ.UInt32> [int64(32-udivisible(32,c).k)]) ) (Const32 <typ.UInt32> [int64(int32(udivisible(32,c).max))]) )
	for {
		_ = v.Args[1]
		v_0 := v.Args[0]
		if v_0.Op != OpMod32u {
...
func rewriteValuegeneric_OpEq8_0(v *Value) bool {
	...
	// result: (Leq8U (RotateLeft8 <t> (Mul8 <t> (Const8 <typ.UInt8> [int64(int8(udivisible(8,c).m))]) x) (Const8 <typ.UInt8> [int64(8-udivisible(8,c).k)]) ) (Const8 <typ.UInt8> [int64(int8(udivisible(8,c).max))]) )
	for {
		_ = v.Args[1]
		v_0 := v.Args[0]
		if v_0.Op != OpMod8u {
