...
func rewriteValuegeneric_OpDiv16u(v *Value, config *Config) bool {
	...
	// cond: umagicOK(16, c) && config.IntSize == 8
	...
	for {
		...
		c := v_1.AuxInt
		if !(umagicOK(16, c) && config.IntSize == 8) {
			break
		}
	...
	// match: (Div16u x (Const16 [c]))
	// cond: umagicOK(16, c) && config.IntSize == 4 && umagic(16,c).m&1 == 0
	...
	for {
		...
		c := v_1.AuxInt
		if !(umagicOK(16, c) && config.IntSize == 4 && umagic(16, c).m&1 == 0) {
			break
		}
	...
	// match: (Div16u x (Const16 [c]))
	// cond: umagicOK(16, c) && config.IntSize == 4 && c&1 == 0
	...
	for {
		...
		c := v_1.AuxInt
		if !(umagicOK(16, c) && config.IntSize == 4 && c&1 == 0) {
			break
		}
		v.reset(OpTrunc32to16)
		v0 := b.NewValue0(v.Pos, OpRsh32Ux64, config.fe.TypeUInt32())
	...
	// match: (Div16u x (Const16 [c]))
	// cond: umagicOK(16, c) && config.IntSize == 4
	...
	for {
		...
		c := v_1.AuxInt
		if !(umagicOK(16, c) && config.IntSize == 4) {
			break
		}
		v.reset(OpTrunc32to16)
		v0 := b.NewValue0(v.Pos, OpRsh32Ux64, config.fe.TypeUInt32())
...
func rewriteValuegeneric_OpDiv32(v *Value, config *Config) bool {
	...
	// cond: smagicOK(32,c) && config.IntSize == 8
	...
	for {
		...
		c := v_1.AuxInt
		if !(smagicOK(32, c) && config.IntSize == 8) {
			break
		}
		v.reset(OpSub32)
		v.Type = t
	...
	// match: (Div32 <t> x (Const32 [c]))
	// cond: smagicOK(32,c) && config.IntSize == 4 && smagic(32,c).m&1 == 0
	...
	for {
		...
		c := v_1.AuxInt
		if !(smagicOK(32, c) && config.IntSize == 4 && smagic(32, c).m&1 == 0) {
			break
		}
		v.reset(OpSub32)
		v.Type = t
...
func rewriteValuegeneric_OpDiv32u(v *Value, config *Config) bool {
	...
	// cond: umagicOK(32, c) && config.IntSize == 4 && umagic(32,c).m&1 == 0
	...
	for {
		...
		c := v_1.AuxInt
		if !(umagicOK(32, c) && config.IntSize == 4 && umagic(32, c).m&1 == 0) {
			break
		}
		v.reset(OpRsh32Ux64)
	...
	// match: (Div32u x (Const32 [c]))
	// cond: umagicOK(32, c) && config.IntSize == 4 && c&1 == 0
	...
	for {
		...
		c := v_1.AuxInt
		if !(umagicOK(32, c) && config.IntSize == 4 && c&1 == 0) {
			break
		}
		v.reset(OpRsh32Ux64)
		v.Type = config.fe.TypeUInt32()
	...
	// match: (Div32u x (Const32 [c]))
	// cond: umagicOK(32, c) && config.IntSize == 4
	...
	for {
		...
		c := v_1.AuxInt
		if !(umagicOK(32, c) && config.IntSize == 4) {
			break
		}
		v.reset(OpRsh32Ux64)
		v.Type = config.fe.TypeUInt32()
	...
	// match: (Div32u x (Const32 [c]))
	// cond: umagicOK(32, c) && config.IntSize == 8 && umagic(32,c).m&1 == 0
	...
	for {
		...
		c := v_1.AuxInt
		if !(umagicOK(32, c) && config.IntSize == 8 && umagic(32, c).m&1 == 0) {
			break
		}
	...
	// match: (Div32u x (Const32 [c]))
	// cond: umagicOK(32, c) && config.IntSize == 8 && c&1 == 0
	...
	for {
		...
		c := v_1.AuxInt
		if !(umagicOK(32, c) && config.IntSize == 8 && c&1 == 0) {
			break
		}
		v.reset(OpTrunc64to32)
		v0 := b.NewValue0(v.Pos, OpRsh64Ux64, config.fe.TypeUInt64())
	...
	// match: (Div32u x (Const32 [c]))
	// cond: umagicOK(32, c) && config.IntSize == 8
	...
	for {
		...
		c := v_1.AuxInt
		if !(umagicOK(32, c) && config.IntSize == 8) {
			break
		}
		v.reset(OpTrunc64to32)
		v0 := b.NewValue0(v.Pos, OpRsh64Ux64, config.fe.TypeUInt64())
...
func rewriteValuegeneric_OpDiv64u(v *Value, config *Config) bool {
	...
	// cond: umagicOK(64, c) && config.IntSize == 8 && umagic(64,c).m&1 == 0
	...
	for {
		...
		c := v_1.AuxInt
		if !(umagicOK(64, c) && config.IntSize == 8 && umagic(64, c).m&1 == 0) {
			break
		}
		v.reset(OpRsh64Ux64)
	...
	// match: (Div64u x (Const64 [c]))
	// cond: umagicOK(64, c) && config.IntSize == 8 && c&1 == 0
	...
	for {
		...
		c := v_1.AuxInt
		if !(umagicOK(64, c) && config.IntSize == 8 && c&1 == 0) {
			break
		}
		v.reset(OpRsh64Ux64)
		v.Type = config.fe.TypeUInt64()
	...
	// match: (Div64u x (Const64 [c]))
	// cond: umagicOK(64, c) && config.IntSize == 8
	...
	for {
		...
		c := v_1.AuxInt
		if !(umagicOK(64, c) && config.IntSize == 8) {
			break
		}
		v.reset(OpRsh64Ux64)
		v.Type = config.fe.TypeUInt64()
