...
func rewriteValuegeneric_OpSelectN(v *Value) bool {
	...
	// match: (SelectN [1] (StaticCall {sym} _ newLen:(Const64) _ _ _))
	// cond: v.Type.IsInteger() && isSameCall(sym, "runtime.growslicebyte")
	// result: newLen
	for {
		if auxIntToInt64(v.AuxInt) != 1 || v_0.Op != OpStaticCall || len(v_0.Args) != 5 {
			break
		}
		sym := auxToCall(v_0.Aux)
		_ = v_0.Args[1]
		newLen := v_0.Args[1]
		if newLen.Op != OpConst64 || !(v.Type.IsInteger() && isSameCall(sym, "runtime.growslicebyte")) {
			break
		}
		v.copyOf(newLen)
		return true
	}
	// match: (SelectN [1] (StaticCall {sym} _ newLen:(Const32) _ _ _))
	// cond: v.Type.IsInteger() && isSameCall(sym, "runtime.growslicebyte")
	// result: newLen
	for {
		if auxIntToInt64(v.AuxInt) != 1 || v_0.Op != OpStaticCall || len(v_0.Args) != 5 {
		...
		_ = v_0.Args[1]
		newLen := v_0.Args[1]
		if newLen.Op != OpConst32 || !(v.Type.IsInteger() && isSameCall(sym, "runtime.growslicebyte")) {
			break
		}
		v.copyOf(newLen)
		return true
	...
	// match: (SelectN [1] (StaticCall {sym} _ newLen:(Const64) _ _ _))
	// cond: v.Type.IsInteger() && isSameCall(sym, "runtime.growslicestr")
	// result: newLen
	for {
		if auxIntToInt64(v.AuxInt) != 1 || v_0.Op != OpStaticCall || len(v_0.Args) != 5 {
			break
		...
		_ = v_0.Args[1]
		newLen := v_0.Args[1]
		if newLen.Op != OpConst64 || !(v.Type.IsInteger() && isSameCall(sym, "runtime.growslicestr")) {
			break
		}
		v.copyOf(newLen)
		return true
	...
	for {
		...
		_ = v_0.Args[1]
		newLen := v_0.Args[1]
		if newLen.Op != OpConst32 || !(v.Type.IsInteger() && isSameCall(sym, "runtime.growslicestr")) {
			break
		}
		v.copyOf(newLen)
		return true
	...
	// match: (SelectN [1] (StaticCall {sym} _ newLen:(Const64) _ _ _))
	// cond: v.Type.IsInteger() && isSameCall(sym, "runtime.growslice32")
	// result: newLen
	for {
		if auxIntToInt64(v.AuxInt) != 1 || v_0.Op != OpStaticCall || len(v_0.Args) != 5 {
			break
		...
		_ = v_0.Args[1]
		newLen := v_0.Args[1]
		if newLen.Op != OpConst64 || !(v.Type.IsInteger() && isSameCall(sym, "runtime.growslice32")) {
			break
		}
		v.copyOf(newLen)
		return true
	...
	for {
		...
		_ = v_0.Args[1]
		newLen := v_0.Args[1]
		if newLen.Op != OpConst32 || !(v.Type.IsInteger() && isSameCall(sym, "runtime.growslice32")) {
			break
		}
		v.copyOf(newLen)
		return true
	...
	// match: (SelectN [1] (StaticCall {sym} _ newLen:(Const64) _ _ _))
	// cond: v.Type.IsInteger() && isSameCall(sym, "runtime.growslice64")
	// result: newLen
	for {
		if auxIntToInt64(v.AuxInt) != 1 || v_0.Op != OpStaticCall || len(v_0.Args) != 5 {
			break
		...
		_ = v_0.Args[1]
		newLen := v_0.Args[1]
		if newLen.Op != OpConst64 || !(v.Type.IsInteger() && isSameCall(sym, "runtime.growslice64")) {
			break
		}
		v.copyOf(newLen)
		return true
	...
	for {
		...
		_ = v_0.Args[1]
		newLen := v_0.Args[1]
		if newLen.Op != OpConst32 || !(v.Type.IsInteger() && isSameCall(sym, "runtime.growslice64")) {
			break
		}
		v.copyOf(newLen)
		return true
...
func rewriteValuegeneric_OpSliceLen(v *Value) bool {
	...
	// match: (SliceLen (SelectN [0] (StaticLECall {sym} _ newLen:(Const64) _ _ _)))
	// cond: isSameCall(sym, "runtime.growslicebyte")
	// result: newLen
	for {
		if v_0.Op != OpSelectN || auxIntToInt64(v_0.AuxInt) != 0 {
			break
		...
		v_0_0 := v_0.Args[0]
		if v_0_0.Op != OpStaticLECall || len(v_0_0.Args) != 5 {
			break
		}
		sym := auxToCall(v_0_0.Aux)
		_ = v_0_0.Args[1]
		newLen := v_0_0.Args[1]
		if newLen.Op != OpConst64 || !(isSameCall(sym, "runtime.growslicebyte")) {
			break
		}
		v.copyOf(newLen)
		return true
	}
	// match: (SliceLen (SelectN [0] (StaticLECall {sym} _ newLen:(Const32) _ _ _)))
	// cond: isSameCall(sym, "runtime.growslicebyte")
	// result: newLen
	for {
		if v_0.Op != OpSelectN || auxIntToInt64(v_0.AuxInt) != 0 {
		...
		_ = v_0_0.Args[1]
		newLen := v_0_0.Args[1]
		if newLen.Op != OpConst32 || !(isSameCall(sym, "runtime.growslicebyte")) {
			break
		}
		v.copyOf(newLen)
		return true
	...
	// match: (SliceLen (SelectN [0] (StaticLECall {sym} _ newLen:(Const64) _ _ _)))
	// cond: isSameCall(sym, "runtime.growslicestr")
	// result: newLen
	for {
		if v_0.Op != OpSelectN || auxIntToInt64(v_0.AuxInt) != 0 {
			break
		...
		_ = v_0_0.Args[1]
		newLen := v_0_0.Args[1]
		if newLen.Op != OpConst64 || !(isSameCall(sym, "runtime.growslicestr")) {
			break
		}
		v.copyOf(newLen)
		return true
	...
	for {
		...
		_ = v_0_0.Args[1]
		newLen := v_0_0.Args[1]
		if newLen.Op != OpConst32 || !(isSameCall(sym, "runtime.growslicestr")) {
			break
		}
		v.copyOf(newLen)
		return true
	...
	// match: (SliceLen (SelectN [0] (StaticLECall {sym} _ newLen:(Const64) _ _ _)))
	// cond: isSameCall(sym, "runtime.growslice32")
	// result: newLen
	for {
		if v_0.Op != OpSelectN || auxIntToInt64(v_0.AuxInt) != 0 {
			break
		...
		_ = v_0_0.Args[1]
		newLen := v_0_0.Args[1]
		if newLen.Op != OpConst64 || !(isSameCall(sym, "runtime.growslice32")) {
			break
		}
		v.copyOf(newLen)
		return true
	...
	for {
		...
		_ = v_0_0.Args[1]
		newLen := v_0_0.Args[1]
		if newLen.Op != OpConst32 || !(isSameCall(sym, "runtime.growslice32")) {
			break
		}
		v.copyOf(newLen)
		return true
	...
	// match: (SliceLen (SelectN [0] (StaticLECall {sym} _ newLen:(Const64) _ _ _)))
	// cond: isSameCall(sym, "runtime.growslice64")
	// result: newLen
	for {
		if v_0.Op != OpSelectN || auxIntToInt64(v_0.AuxInt) != 0 {
			break
		...
		_ = v_0_0.Args[1]
		newLen := v_0_0.Args[1]
		if newLen.Op != OpConst64 || !(isSameCall(sym, "runtime.growslice64")) {
			break
		}
		v.copyOf(newLen)
		return true
	...
	for {
		...
		_ = v_0_0.Args[1]
		newLen := v_0_0.Args[1]
		if newLen.Op != OpConst32 || !(isSameCall(sym, "runtime.growslice64")) {
			break
		}
		v.copyOf(newLen)
		return true
