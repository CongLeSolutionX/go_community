...
func rewriteValueMIPS_OpMIPSAND(v *Value) bool {
	...
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			if v_0.Op != OpMIPSSGTUconst || int32(v_0.AuxInt) != 1 {
				continue
			}
			x := v_0.Args[0]
			if v_1.Op != OpMIPSSGTUconst || int32(v_1.AuxInt) != 1 {
				continue
			}
			y := v_1.Args[0]
			v.reset(OpMIPSSGTUconst)
...
func rewriteValueMIPS_OpMIPSCMOVZ(v *Value) bool {
	...
	for {
		f := v_1
		if v_2.Op != OpMIPSMOVWconst || int32(v_2.AuxInt) != 0 {
			break
		}
		v.copyOf(f)
		return true
	...
	for {
		a := v_0
		if v_1.Op != OpMIPSMOVWconst || int32(v_1.AuxInt) != 0 {
			break
		}
		c := v_2
...
func rewriteValueMIPS_OpMIPSMOVFload(v *Value) bool {
	...
	for {
		...
		sym := auxToSym(v.Aux)
		ptr := v_0
		if v_1.Op != OpMIPSMOVWstore || int32(v_1.AuxInt) != off || auxToSym(v_1.Aux) != sym {
			break
		}
		val := v_1.Args[1]
		if ptr != v_1.Args[0] {
...
func rewriteValueMIPS_OpMIPSMOVWload(v *Value) bool {
	...
	for {
		...
		sym := auxToSym(v.Aux)
		ptr := v_0
		if v_1.Op != OpMIPSMOVFstore || int32(v_1.AuxInt) != off || auxToSym(v_1.Aux) != sym {
			break
		}
		val := v_1.Args[1]
		if ptr != v_1.Args[0] {
...
func rewriteValueMIPS_OpMIPSMUL(v *Value) bool {
	...
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			if v_0.Op != OpMIPSMOVWconst || int32(v_0.AuxInt) != 0 {
				continue
			}
			v.reset(OpMIPSMOVWconst)
			return true
	...
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			if v_0.Op != OpMIPSMOVWconst || int32(v_0.AuxInt) != 1 {
				continue
			}
			x := v_1
			v.copyOf(x)
	...
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			...
			v.reset(OpMIPSSLLconst)
			v.AuxInt = int64(int32(log2uint32(int64(c))))
			v.AddArg(x)
			return true
		}
		break
...
func rewriteValueMIPS_OpMove(v *Value) bool {
	...
	for {
		...
		v.AuxInt = int64(int32(t.Alignment()))
...
func rewriteValueMIPS_OpRotateLeft32(v *Value) bool {
	...
	for {
		...
		v1 := b.NewValue0(v.Pos, OpMIPSMOVWconst, typ.UInt32)
		v1.AuxInt = int64(c & 31)
		v0.AddArg2(x, v1)
		v2 := b.NewValue0(v.Pos, OpRsh32Ux32, t)
		v3 := b.NewValue0(v.Pos, OpMIPSMOVWconst, typ.UInt32)
		v3.AuxInt = int64(-c & 31)
		v2.AddArg2(x, v3)
		v.AddArg2(v0, v2)
		return true
	}
...
func rewriteValueMIPS_OpRotateLeft64(v *Value) bool {
	...
	for {
		...
		v1 := b.NewValue0(v.Pos, OpMIPSMOVWconst, typ.UInt32)
		v1.AuxInt = int64(c & 63)
		v0.AddArg2(x, v1)
		v2 := b.NewValue0(v.Pos, OpRsh64Ux32, t)
		v3 := b.NewValue0(v.Pos, OpMIPSMOVWconst, typ.UInt32)
		v3.AuxInt = int64(-c & 63)
		v2.AddArg2(x, v3)
		v.AddArg2(v0, v2)
		return true
	}
...
func rewriteValueMIPS_OpSelect0(v *Value) bool {
	...
	for {
		...
		for _i0 := 0; _i0 <= 1; _i0, v_0_0, v_0_1 = _i0+1, v_0_1, v_0_0 {
			if v_0_0.Op != OpMIPSMOVWconst || int32(v_0_0.AuxInt) != 0 {
				continue
			}
			v.reset(OpMIPSMOVWconst)
			return true
	...
	for {
		...
		v_0_1 := v_0.Args[1]
		for _i0 := 0; _i0 <= 1; _i0, v_0_0, v_0_1 = _i0+1, v_0_1, v_0_0 {
			if v_0_0.Op != OpMIPSMOVWconst || int32(v_0_0.AuxInt) != 1 {
				continue
			}
			v.reset(OpMIPSMOVWconst)
			return true
	...
	for {
		...
		for _i0 := 0; _i0 <= 1; _i0, v_0_0, v_0_1 = _i0+1, v_0_1, v_0_0 {
			...
			v.reset(OpMIPSSRLconst)
			v.AuxInt = int64(int32(32 - log2uint32(int64(c))))
			v.AddArg(x)
			return true
		}
		break
	...
	for {
		...
		for _i0 := 0; _i0 <= 1; _i0, v_0_0, v_0_1 = _i0+1, v_0_1, v_0_0 {
			...
			v.reset(OpMIPSMOVWconst)
			v.AuxInt = int64(int32((int64(uint32(c)) * int64(uint32(d))) >> 32))
			return true
		}
		break
	}
