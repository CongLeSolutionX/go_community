...
func rewriteValueMIPS_OpMIPSMUL_0(v *Value) bool {
	...
	for {
		...
		v.reset(OpMIPSSLLconst)
		v.setAuxInt32(log2(int64(uint32(c))))
		v.AddArg(x)
		return true
	}
	...
	for {
		...
		d := v_1.auxInt32()
		v.reset(OpMIPSMOVWconst)
		v.setAuxInt32(int64(int32(c) * int32(d)))
		return true
	}
...
func rewriteValueMIPS_OpMIPSSLLconst_0(v *Value) bool {
	...
	for {
		...
		d := v_0.auxInt32()
		v.reset(OpMIPSMOVWconst)
		v.setAuxInt32(int64(int32(uint32(d) << uint32(c))))
		return true
	}
	return false
}
...
func rewriteValueMIPS_OpMIPSSRAconst_0(v *Value) bool {
	...
	for {
		...
		d := v_0.auxInt32()
		v.reset(OpMIPSMOVWconst)
		v.setAuxInt32(int64(int32(d) >> uint32(c)))
		return true
	}
	return false
}
...
func rewriteValueMIPS_OpMIPSSRLconst_0(v *Value) bool {
	...
	for {
		...
		d := v_0.auxInt32()
		v.reset(OpMIPSMOVWconst)
		v.setAuxInt32(int64(uint32(d) >> uint32(c)))
		return true
	}
	return false
}
...
func rewriteValueMIPS_OpMove_10(v *Value) bool {
	...
	for {
		...
		v.setAuxInt32(t.(*types.Type).Alignment())
		v.AddArg(dst)
		v.AddArg(src)
...
func rewriteValueMIPS_OpSelect0_0(v *Value) bool {
	...
	for {
		...
		v.reset(OpMIPSSRLconst)
		v.setAuxInt32(32 - log2(int64(uint32(c))))
		v.AddArg(x)
		return true
	}
