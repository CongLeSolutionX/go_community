...
func rewriteValueMIPS_OpAtomicAnd8(v *Value) bool {
	...
	for {
		...
		v4 := b.NewValue0(v.Pos, OpMIPSMOVBUreg, typ.UInt32)
		v4.AddArg(val)
		v3.AddArg(v4)
...
func rewriteValueMIPS_OpAtomicOr8(v *Value) bool {
	...
	for {
		...
		v3 := b.NewValue0(v.Pos, OpMIPSMOVBUreg, typ.UInt32)
		v3.AddArg(val)
		v2.AddArg(v3)
...
func rewriteValueMIPS_OpDiv16(v *Value) bool {
	...
	for {
		...
		v1 := b.NewValue0(v.Pos, OpMIPSMOVHreg, typ.Int32)
		v1.AddArg(x)
		v0.AddArg(v1)
		v2 := b.NewValue0(v.Pos, OpMIPSMOVHreg, typ.Int32)
		v2.AddArg(y)
		v0.AddArg(v2)
		v.AddArg(v0)
		return true
...
func rewriteValueMIPS_OpDiv16u(v *Value) bool {
	...
	for {
		...
		v1 := b.NewValue0(v.Pos, OpMIPSMOVHUreg, typ.UInt32)
		v1.AddArg(x)
		v0.AddArg(v1)
		v2 := b.NewValue0(v.Pos, OpMIPSMOVHUreg, typ.UInt32)
		v2.AddArg(y)
		v0.AddArg(v2)
		v.AddArg(v0)
		return true
...
func rewriteValueMIPS_OpDiv8(v *Value) bool {
	...
	for {
		...
		v.reset(OpSelect1)
		v0 := b.NewValue0(v.Pos, OpMIPSDIV, types.NewTuple(typ.Int32, typ.Int32))
		v1 := b.NewValue0(v.Pos, OpMIPSMOVBreg, typ.Int32)
		v1.AddArg(x)
		v0.AddArg(v1)
		v2 := b.NewValue0(v.Pos, OpMIPSMOVBreg, typ.Int32)
		v2.AddArg(y)
		v0.AddArg(v2)
		v.AddArg(v0)
		return true
...
func rewriteValueMIPS_OpDiv8u(v *Value) bool {
	...
	for {
		...
		v.reset(OpSelect1)
		v0 := b.NewValue0(v.Pos, OpMIPSDIVU, types.NewTuple(typ.UInt32, typ.UInt32))
		v1 := b.NewValue0(v.Pos, OpMIPSMOVBUreg, typ.UInt32)
		v1.AddArg(x)
		v0.AddArg(v1)
		v2 := b.NewValue0(v.Pos, OpMIPSMOVBUreg, typ.UInt32)
		v2.AddArg(y)
		v0.AddArg(v2)
		v.AddArg(v0)
		return true
...
func rewriteValueMIPS_OpGreater16(v *Value) bool {
	...
	for {
		...
		y := v_1
		v.reset(OpMIPSSGT)
		v0 := b.NewValue0(v.Pos, OpMIPSMOVHreg, typ.Int32)
		v0.AddArg(x)
		v.AddArg(v0)
		v1 := b.NewValue0(v.Pos, OpMIPSMOVHreg, typ.Int32)
		v1.AddArg(y)
...
func rewriteValueMIPS_OpGreater16U(v *Value) bool {
	...
	for {
		...
		y := v_1
		v.reset(OpMIPSSGTU)
		v0 := b.NewValue0(v.Pos, OpMIPSMOVHUreg, typ.UInt32)
		v0.AddArg(x)
		v.AddArg(v0)
		v1 := b.NewValue0(v.Pos, OpMIPSMOVHUreg, typ.UInt32)
		v1.AddArg(y)
...
func rewriteValueMIPS_OpGreater8(v *Value) bool {
	...
	for {
		...
		y := v_1
		v.reset(OpMIPSSGT)
		v0 := b.NewValue0(v.Pos, OpMIPSMOVBreg, typ.Int32)
		v0.AddArg(x)
		v.AddArg(v0)
		v1 := b.NewValue0(v.Pos, OpMIPSMOVBreg, typ.Int32)
		v1.AddArg(y)
...
func rewriteValueMIPS_OpGreater8U(v *Value) bool {
	...
	for {
		...
		y := v_1
		v.reset(OpMIPSSGTU)
		v0 := b.NewValue0(v.Pos, OpMIPSMOVBUreg, typ.UInt32)
		v0.AddArg(x)
		v.AddArg(v0)
		v1 := b.NewValue0(v.Pos, OpMIPSMOVBUreg, typ.UInt32)
		v1.AddArg(y)
...
func rewriteValueMIPS_OpLsh16x16(v *Value) bool {
	...
	for {
		...
		v3.AuxInt = 32
		v4 := b.NewValue0(v.Pos, OpMIPSMOVHUreg, typ.UInt32)
		v4.AddArg(y)
		v3.AddArg(v4)
		v.AddArg(v3)
		return true
...
func rewriteValueMIPS_OpRsh16Ux16(v *Value) bool {
	...
	for {
		...
		v4.AuxInt = 32
		v5 := b.NewValue0(v.Pos, OpMIPSMOVHUreg, typ.UInt32)
		v5.AddArg(y)
		v4.AddArg(v5)
		v.AddArg(v4)
		return true
...
func rewriteValueMIPS_OpRsh16Ux8(v *Value) bool {
	...
	for {
		...
		v4 := b.NewValue0(v.Pos, OpMIPSSGTUconst, typ.Bool)
		v4.AuxInt = 32
		v5 := b.NewValue0(v.Pos, OpMIPSMOVBUreg, typ.UInt32)
		v5.AddArg(y)
		v4.AddArg(v5)
		v.AddArg(v4)
		return true
