...
type use struct {
	...
	line src.Lineno // line number of the use
...
type startReg struct {
	...
	line src.Lineno // line number of use of this register
}
...
func (s *regAllocState) allocValToReg(v *Value, mask regMask, nospill bool, line src.Lineno) *Value {
	vi := &s.values[v.ID]
...
func (s *regAllocState) addUse(id ID, dist int32, line src.Lineno) {
	r := s.freeUseRecords
	if r != nil {
...
type contentRecord struct {
	...
	line  src.Lineno // line number of use of the value
}
...
type dstRecord struct {
	...
	line   src.Lineno // line number of use of this location
}
...
func (e *edgeState) processDest(loc Location, vid ID, splice **Value, line src.Lineno) bool {
...
func (e *edgeState) set(loc Location, vid ID, c *Value, final bool, line src.Lineno) {
	e.s.f.setHome(c, loc)
	e.erase(loc)
...
type liveInfo struct {
	...
	line src.Lineno // line number of next use
}
