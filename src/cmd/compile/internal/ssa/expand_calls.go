...
func expandCalls(f *Func) {
	...
	// rewriteSelect recursively walks from leaf selector to a root (OpSelectN, Op-Load, OpArg)
	...
	// decomposeArgOrLoad decomposes a Load or an Arg into smaller parts, parameterized by the decomposeOne and decomposeTwo functions
	// passed to it.  If the type does not matches one of the expected aggregate types, it returns nil of the result mem.
