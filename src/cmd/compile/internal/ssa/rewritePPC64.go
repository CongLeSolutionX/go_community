...
func rewriteValuePPC64_OpPPC64ISEL(v *Value) bool {
	...
	// match: (ISEL [6] x y (CMPconst [0] (ISELB [c] one cmp)))
...
func rewriteValuePPC64_OpPPC64ISELB(v *Value) bool {
	...
	// match: (ISELB [2] x (CMPconst [0] (Select0 (ANDCCconst [n] z))))
	...
	// match: (ISELB [6] x (CMPconst [0] (Select0 (ANDCCconst [n] z))))
...
func rewriteBlockPPC64(b *Block) bool {
	...
	case BlockPPC64NE:
		// match: (NE (CMPconst [0] (Select0 (ANDCCconst [1] (Equal cc)))) yes no)
		// result: (EQ cc yes no)
		for b.Controls[0].Op == OpPPC64CMPconst {
			v_0 := b.Controls[0]
			if auxIntToInt64(v_0.AuxInt) != 0 {
		...
		// match: (NE (CMPconst [0] (Select0 (ANDCCconst [1] (NotEqual cc)))) yes no)
		// result: (NE cc yes no)
		for b.Controls[0].Op == OpPPC64CMPconst {
			v_0 := b.Controls[0]
			if auxIntToInt64(v_0.AuxInt) != 0 {
		...
		// match: (NE (CMPconst [0] (Select0 (ANDCCconst [1] (LessThan cc)))) yes no)
		// result: (LT cc yes no)
		for b.Controls[0].Op == OpPPC64CMPconst {
			v_0 := b.Controls[0]
			if auxIntToInt64(v_0.AuxInt) != 0 {
		...
		// match: (NE (CMPconst [0] (Select0 (ANDCCconst [1] (LessEqual cc)))) yes no)
		// result: (LE cc yes no)
		for b.Controls[0].Op == OpPPC64CMPconst {
			v_0 := b.Controls[0]
			if auxIntToInt64(v_0.AuxInt) != 0 {
		...
		// match: (NE (CMPconst [0] (Select0 (ANDCCconst [1] (GreaterThan cc)))) yes no)
		// result: (GT cc yes no)
		for b.Controls[0].Op == OpPPC64CMPconst {
			v_0 := b.Controls[0]
			if auxIntToInt64(v_0.AuxInt) != 0 {
		...
		// match: (NE (CMPconst [0] (Select0 (ANDCCconst [1] (GreaterEqual cc)))) yes no)
		// result: (GE cc yes no)
		for b.Controls[0].Op == OpPPC64CMPconst {
			v_0 := b.Controls[0]
			if auxIntToInt64(v_0.AuxInt) != 0 {
		...
		// match: (NE (CMPconst [0] (Select0 (ANDCCconst [1] (FLessThan cc)))) yes no)
		// result: (FLT cc yes no)
		for b.Controls[0].Op == OpPPC64CMPconst {
			v_0 := b.Controls[0]
			if auxIntToInt64(v_0.AuxInt) != 0 {
		...
		// match: (NE (CMPconst [0] (Select0 (ANDCCconst [1] (FLessEqual cc)))) yes no)
		// result: (FLE cc yes no)
		for b.Controls[0].Op == OpPPC64CMPconst {
			v_0 := b.Controls[0]
			if auxIntToInt64(v_0.AuxInt) != 0 {
		...
		// match: (NE (CMPconst [0] (Select0 (ANDCCconst [1] (FGreaterThan cc)))) yes no)
		// result: (FGT cc yes no)
		for b.Controls[0].Op == OpPPC64CMPconst {
			v_0 := b.Controls[0]
			if auxIntToInt64(v_0.AuxInt) != 0 {
		...
		// match: (NE (CMPconst [0] (Select0 (ANDCCconst [1] (FGreaterEqual cc)))) yes no)
		// result: (FGE cc yes no)
		for b.Controls[0].Op == OpPPC64CMPconst {
			v_0 := b.Controls[0]
			if auxIntToInt64(v_0.AuxInt) != 0 {
