...
func rewriteValuePPC64_OpLsh32x32(v *Value, config *Config) bool {
	...
	// match: (Lsh32x32 x y)
	// cond:
	// result: (SLW x  (ORN y <config.fe.TypeInt32()> (MaskIfNotCarry <config.fe.TypeInt32()> (ADDIforC [-32] (ZeroExt32to64 y)))))
	for {
		x := v.Args[0]
		y := v.Args[1]
		v.reset(OpPPC64SLW)
		v.AddArg(x)
		v0 := b.NewValue0(v.Line, OpPPC64ORN, config.fe.TypeInt32())
		v0.AddArg(y)
		v1 := b.NewValue0(v.Line, OpPPC64MaskIfNotCarry, config.fe.TypeInt32())
...
func rewriteValuePPC64_OpRsh32Ux32(v *Value, config *Config) bool {
	...
	// match: (Rsh32Ux32 x y)
	// cond:
	// result: (SRW x  (ORN y <config.fe.TypeInt32()> (MaskIfNotCarry <config.fe.TypeInt32()> (ADDIforC [-32] (ZeroExt32to64 y)))))
	for {
		x := v.Args[0]
		y := v.Args[1]
		v.reset(OpPPC64SRW)
...
func rewriteValuePPC64_OpRsh32x32(v *Value, config *Config) bool {
	...
	// match: (Rsh32x32 x y)
	// cond:
	// result: (SRAW x (ORN y <config.fe.TypeInt32()> (MaskIfNotCarry <config.fe.TypeInt32()> (ADDIforC [-32] (ZeroExt32to64 y)))))
	for {
		x := v.Args[0]
		y := v.Args[1]
		v.reset(OpPPC64SRAW)
