...
func rewriteValuePPC64_OpCondSelect(v *Value) bool {
	...
	// result: (ISEL [6] x y (CMPconst [0] bool))
	for {
		x := v_0
		y := v_1
		bool := v_2
...
func rewriteValuePPC64_OpPPC64CMPconst(v *Value) bool {
	...
	// match: (CMPconst [0] (Select0 (ANDCCconst [n] z)))
	// result: (Select1 <types.TypeFlags> (ANDCCconst [n] z))
	for {
		...
		n := auxIntToInt64(v_0_0.AuxInt)
		z := v_0_0.Args[0]
		v.reset(OpSelect1)
		v.Type = types.TypeFlags
		v0 := b.NewValue0(v.Pos, OpPPC64ANDCCconst, types.NewTuple(typ.Int, types.TypeFlags))
		v0.AuxInt = int64ToAuxInt(n)
		v0.AddArg(z)
		v.AddArg(v0)
		return true
	}
...
func rewriteValuePPC64_OpPPC64Equal(v *Value) bool {
	...
	// match: (Equal cmp)
	// result: (ISEL [2] (MOVDconst [1]) (MOVDconst [0]) cmp)
	for {
		cmp := v_0
		v.reset(OpPPC64ISEL)
		v.AuxInt = int32ToAuxInt(2)
...
func rewriteValuePPC64_OpPPC64FGreaterEqual(v *Value) bool {
	...
	// result: (ISEL [2] (MOVDconst [1]) (ISEL [1] (MOVDconst [1]) (MOVDconst [0]) cmp) cmp)
	for {
		cmp := v_0
		v.reset(OpPPC64ISEL)
		v.AuxInt = int32ToAuxInt(2)
...
func rewriteValuePPC64_OpPPC64FGreaterThan(v *Value) bool {
	...
	// result: (ISEL [1] (MOVDconst [1]) (MOVDconst [0]) cmp)
	for {
		cmp := v_0
		v.reset(OpPPC64ISEL)
...
func rewriteValuePPC64_OpPPC64FLessEqual(v *Value) bool {
	...
	// result: (ISEL [2] (MOVDconst [1]) (ISEL [0] (MOVDconst [1]) (MOVDconst [0]) cmp) cmp)
	for {
		cmp := v_0
		v.reset(OpPPC64ISEL)
		v.AuxInt = int32ToAuxInt(2)
...
func rewriteValuePPC64_OpPPC64FLessThan(v *Value) bool {
	...
	typ := &b.Func.Config.Types
	// match: (FLessThan cmp)
	// result: (ISEL [0] (MOVDconst [1]) (MOVDconst [0]) cmp)
	for {
		cmp := v_0
		v.reset(OpPPC64ISEL)
		v.AuxInt = int32ToAuxInt(0)
...
func rewriteValuePPC64_OpPPC64GreaterEqual(v *Value) bool {
	...
	// result: (ISEL [4] (MOVDconst [1]) (MOVDconst [0]) cmp)
	for {
		cmp := v_0
		v.reset(OpPPC64ISEL)
		v.AuxInt = int32ToAuxInt(4)
...
func rewriteValuePPC64_OpPPC64ISEL(v *Value) bool {
	...
	// match: (ISEL [2] (MOVDconst [1]) (MOVDconst [0]) (Select1 (ANDCCconst [1] x)))
	// result: (XORconst [1] (Select0 <typ.UInt64> (ANDCCconst [1] x)))
	for {
		if auxIntToInt32(v.AuxInt) != 2 || v_0.Op != OpPPC64MOVDconst || auxIntToInt64(v_0.AuxInt) != 1 || v_1.Op != OpPPC64MOVDconst || auxIntToInt64(v_1.AuxInt) != 0 || v_2.Op != OpSelect1 {
			break
		}
		v_2_0 := v_2.Args[0]
	...
	// match: (ISEL [6] (MOVDconst [1]) (MOVDconst [0]) (Select1 (ANDCCconst [1] x)))
	// result: (Select0 (ANDCCconst [1] x))
	for {
		if auxIntToInt32(v.AuxInt) != 6 || v_0.Op != OpPPC64MOVDconst || auxIntToInt64(v_0.AuxInt) != 1 || v_1.Op != OpPPC64MOVDconst || auxIntToInt64(v_1.AuxInt) != 0 || v_2.Op != OpSelect1 {
			break
		}
		v_2_0 := v_2.Args[0]
		if v_2_0.Op != OpPPC64ANDCCconst || auxIntToInt64(v_2_0.AuxInt) != 1 {
	...
	// match: (ISEL [6] x y (CMPconst [0] (ISEL [c] (MOVDconst [1]) (MOVDconst [0]) cmp)))
	...
	for {
		...
		v_2_0 := v_2.Args[0]
		if v_2_0.Op != OpPPC64ISEL {
			break
		}
		c := auxIntToInt32(v_2_0.AuxInt)
		cmp := v_2_0.Args[2]
		v_2_0_0 := v_2_0.Args[0]
		if v_2_0_0.Op != OpPPC64MOVDconst || auxIntToInt64(v_2_0_0.AuxInt) != 1 {
			break
		}
		v_2_0_1 := v_2_0.Args[1]
		if v_2_0_1.Op != OpPPC64MOVDconst || auxIntToInt64(v_2_0_1.AuxInt) != 0 {
			break
		}
		v.reset(OpPPC64ISEL)
...
func rewriteValuePPC64_OpPPC64LessEqual(v *Value) bool {
	...
	// match: (LessEqual cmp)
	// result: (ISEL [5] (MOVDconst [1]) (MOVDconst [0]) cmp)
	for {
		cmp := v_0
		v.reset(OpPPC64ISEL)
...
func rewriteValuePPC64_OpPPC64NotEqual(v *Value) bool {
	...
	// match: (NotEqual cmp)
	// result: (ISEL [6] (MOVDconst [1]) (MOVDconst [0]) cmp)
	for {
		cmp := v_0
		v.reset(OpPPC64ISEL)
		v.AuxInt = int32ToAuxInt(6)
...
func rewriteValuePPC64_OpPPC64XORconst(v *Value) bool {
	...
	// match: (XORconst [1] (ISEL [a] (MOVDconst [1]) (MOVDconst [0]) cmp))
	// result: (ISEL [a^0x4] (MOVDconst [1]) (MOVDconst [0]) cmp)
	for {
		if auxIntToInt64(v.AuxInt) != 1 || v_0.Op != OpPPC64ISEL {
			break
		}
		a := auxIntToInt32(v_0.AuxInt)
		cmp := v_0.Args[2]
		v_0_0 := v_0.Args[0]
		...
		v_0_1 := v_0.Args[1]
		if v_0_1.Op != OpPPC64MOVDconst || auxIntToInt64(v_0_1.AuxInt) != 0 {
			break
		}
		v.reset(OpPPC64ISEL)
...
func rewriteValuePPC64_OpRsh16x16(v *Value) bool {
	...
	// result: (ISEL [2] (SRAD <t> (MOVHreg x) y) (SRADconst <t> (MOVHreg x) [15]) (Select1 <types.TypeFlags> (ANDCCconst [(0xFFF0|0x00F0)] y)))
	for {
		t := v.Type
		x := v_0
		y := v_1
		...
		v3 := b.NewValue0(v.Pos, OpSelect1, types.TypeFlags)
		v4 := b.NewValue0(v.Pos, OpPPC64ANDCCconst, types.NewTuple(typ.Int, types.TypeFlags))
		v4.AuxInt = int64ToAuxInt((0xFFF0 | 0x00F0))
		v4.AddArg(y)
		v3.AddArg(v4)
		v.AddArg3(v0, v2, v3)
		return true
...
func rewriteValuePPC64_OpRsh32x16(v *Value) bool {
	...
	// result: (ISEL [2] (SRAW <t> x y) (SRAWconst <t> x [31]) (Select1 <types.TypeFlags> (ANDCCconst [(0xFFE0|0x00E0)] y)))
	for {
		t := v.Type
		x := v_0
		y := v_1
		...
		v2 := b.NewValue0(v.Pos, OpSelect1, types.TypeFlags)
		v3 := b.NewValue0(v.Pos, OpPPC64ANDCCconst, types.NewTuple(typ.Int, types.TypeFlags))
		v3.AuxInt = int64ToAuxInt((0xFFE0 | 0x00E0))
		v3.AddArg(y)
		v2.AddArg(v3)
		v.AddArg3(v0, v1, v2)
		return true
...
func rewriteValuePPC64_OpRsh64x16(v *Value) bool {
	...
	// result: (ISEL [2] (SRAD <t> x y) (SRADconst <t> x [63]) (Select1 <types.TypeFlags> (ANDCCconst [(0xFFC0|0x00C0)] y)))
	for {
		t := v.Type
		x := v_0
		y := v_1
		...
		v2 := b.NewValue0(v.Pos, OpSelect1, types.TypeFlags)
		v3 := b.NewValue0(v.Pos, OpPPC64ANDCCconst, types.NewTuple(typ.Int, types.TypeFlags))
		v3.AuxInt = int64ToAuxInt((0xFFC0 | 0x00C0))
		v3.AddArg(y)
		v2.AddArg(v3)
		v.AddArg3(v0, v1, v2)
		return true
...
func rewriteValuePPC64_OpRsh8x16(v *Value) bool {
	...
	// match: (Rsh8x16 <t> x y)
	// result: (ISEL [2] (SRAD <t> (MOVBreg x) y) (SRADconst <t> (MOVBreg x) [7]) (Select1 <types.TypeFlags> (ANDCCconst [(0xFFF8|0x00F8)] y)))
	for {
		t := v.Type
		x := v_0
		y := v_1
		...
		v3 := b.NewValue0(v.Pos, OpSelect1, types.TypeFlags)
		v4 := b.NewValue0(v.Pos, OpPPC64ANDCCconst, types.NewTuple(typ.Int, types.TypeFlags))
		v4.AuxInt = int64ToAuxInt((0xFFF8 | 0x00F8))
		v4.AddArg(y)
		v3.AddArg(v4)
		v.AddArg3(v0, v2, v3)
		return true
