...
func rewriteValuePPC64_OpCtz16(v *Value) bool {
	...
	typ := &b.Func.Config.Types
	// match: (Ctz16 x)
	// result: (POPCNTW (MOVHZreg (ANDN <typ.Int16> (ADDconst <typ.UInt16> [-1] x) x)))
	for {
		x := v_0
		v.reset(OpPPC64POPCNTW)
		v0 := b.NewValue0(v.Pos, OpPPC64MOVHZreg, typ.Int64)
		v1 := b.NewValue0(v.Pos, OpPPC64ANDN, typ.Int16)
		v2 := b.NewValue0(v.Pos, OpPPC64ADDconst, typ.UInt16)
...
func rewriteValuePPC64_OpEqB(v *Value) bool {
	...
	for {
		...
		v.reset(OpSelect0)
		v.Type = typ.Int
		v0 := b.NewValue0(v.Pos, OpPPC64ANDCCconst, types.NewTuple(typ.UInt64, types.TypeFlags))
		v0.AuxInt = int64ToAuxInt(1)
...
func rewriteValuePPC64_OpLsh32x64(v *Value) bool {
	...
	for {
		...
		for _i0 := 0; _i0 <= 1; _i0, v_1_0, v_1_1 = _i0+1, v_1_1, v_1_0 {
			...
			v1 := b.NewValue0(v.Pos, OpPPC64ANDCCconst, types.NewTuple(typ.UInt64, types.TypeFlags))
...
func rewriteValuePPC64_OpPPC64AND(v *Value) bool {
	...
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			...
			v.reset(OpSelect0)
			v0 := b.NewValue0(x.Pos, OpPPC64ANDCCconst, types.NewTuple(typ.UInt64, types.TypeFlags))
...
func rewriteValuePPC64_OpPPC64ISEL(v *Value) bool {
	...
	// match: (ISEL [3] x y (CMPconst [0] (Select0 (ANDCCconst [1] z))))
	// result: (ISEL [3] x y (Select1 <types.TypeFlags> (ANDCCconst [1] z )))
	for {
	...
	// match: (ISEL [3] x y (CMPWconst [0] (Select0 (ANDCCconst [1] z))))
	// result: (ISEL [3] x y (Select1 <types.TypeFlags> (ANDCCconst [1] z )))
	for {
		if auxIntToInt32(v.AuxInt) != 3 {
			break
...
func rewriteValuePPC64_OpPPC64ISELB(v *Value) bool {
	...
	// match: (ISELB [3] x (CMPconst [0] (Select0 (ANDCCconst [1] z))))
	// result: (ISELB [3] x (Select1 <types.TypeFlags> (ANDCCconst [1] z )))
	for {
		if auxIntToInt32(v.AuxInt) != 3 {
			break
		}
	...
	// result: (ISELB [6] x (Select1 <types.TypeFlags> (ANDCCconst [1] z )))
	for {
		if auxIntToInt32(v.AuxInt) != 6 {
			break
		}
	...
	// match: (ISELB [3] x (CMPWconst [0] (Select0 (ANDCCconst [1] z))))
	// result: (ISELB [3] x (Select1 <types.TypeFlags> (ANDCCconst [1] z )))
	for {
		if auxIntToInt32(v.AuxInt) != 3 {
			break
...
func rewriteValuePPC64_OpRsh32Ux64(v *Value) bool {
	...
	for {
		...
		v3 := b.NewValue0(v.Pos, OpPPC64ANDCCconst, types.NewTuple(typ.UInt64, types.TypeFlags))
	...
	for {
		...
		v2 := b.NewValue0(v.Pos, OpPPC64ANDCCconst, types.NewTuple(typ.UInt64, types.TypeFlags))
...
func rewriteBlockPPC64(b *Block) bool {
	...
	case BlockPPC64EQ:
		...
		for b.Controls[0].Op == OpPPC64CMPconst {
			...
			v1 := b.NewValue0(v_0.Pos, OpPPC64ANDCCconst, types.NewTuple(typ.UInt64, types.TypeFlags))
	...
	case BlockIf:
		...
		for {
			...
			v2 := b.NewValue0(cond.Pos, OpPPC64ANDCCconst, types.NewTuple(typ.UInt64, types.TypeFlags))
			v2.AuxInt = int64ToAuxInt(1)
			v2.AddArg(cond)
			v1.AddArg(v2)
			v0.AddArg(v1)
