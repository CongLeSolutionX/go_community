...
func rewriteValuePPC64_OpEqB(v *Value) bool {
	...
	for {
		...
		v.reset(OpSelect0)
		v.Type = typ.Int
		v0 := b.NewValue0(v.Pos, OpPPC64ANDCCconst, types.NewTuple(typ.UInt, types.TypeFlags))
		v0.AuxInt = int64ToAuxInt(1)
...
func rewriteValuePPC64_OpLsh32x64(v *Value) bool {
	...
	for {
		...
		for _i0 := 0; _i0 <= 1; _i0, v_1_0, v_1_1 = _i0+1, v_1_1, v_1_0 {
			...
			v1 := b.NewValue0(v.Pos, OpPPC64ANDCCconst, types.NewTuple(typ.UInt, types.TypeFlags))
...
func rewriteValuePPC64_OpPPC64AND(v *Value) bool {
	...
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			...
			v.reset(OpSelect0)
			v0 := b.NewValue0(x.Pos, OpPPC64ANDCCconst, types.NewTuple(typ.UInt, types.TypeFlags))
...
func rewriteValuePPC64_OpRsh32Ux64(v *Value) bool {
	...
	for {
		...
		v3 := b.NewValue0(v.Pos, OpPPC64ANDCCconst, types.NewTuple(typ.UInt, types.TypeFlags))
	...
	for {
		...
		v2 := b.NewValue0(v.Pos, OpPPC64ANDCCconst, types.NewTuple(typ.UInt, types.TypeFlags))
...
func rewriteBlockPPC64(b *Block) bool {
	...
	case BlockPPC64EQ:
		...
		for b.Controls[0].Op == OpPPC64CMPconst {
			...
			v1 := b.NewValue0(v_0.Pos, OpPPC64ANDCCconst, types.NewTuple(typ.UInt, types.TypeFlags))
	...
	case BlockIf:
		...
		for {
			...
			v2 := b.NewValue0(cond.Pos, OpPPC64ANDCCconst, types.NewTuple(typ.UInt, types.TypeFlags))
			v2.AuxInt = int64ToAuxInt(1)
			v2.AddArg(cond)
			v1.AddArg(v2)
			v0.AddArg(v1)
