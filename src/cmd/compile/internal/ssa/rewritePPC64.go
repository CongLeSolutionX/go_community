...
func rewriteValuePPC64_OpBitLen32_0(v *Value) bool {
	...
	// match: (BitLen32 x)
	// cond:
	// result: (SUB (MOVDconst [32]) (CNTLZW <types.Int32> x))
	for {
		x := v.Args[0]
		v.reset(OpPPC64SUB)
		...
		v0.AuxInt = 32
		v.AddArg(v0)
		v1 := b.NewValue0(v.Pos, OpPPC64CNTLZW, types.Int32)
		v1.AddArg(x)
		v.AddArg(v1)
		return true
	}
...
func rewriteValuePPC64_OpCtz32_0(v *Value) bool {
	...
	// result: (POPCNTW (MOVWZreg (ANDN <types.Int32> (ADDconst <types.Int32> [-1] x) x)))
	for {
		x := v.Args[0]
		if !(!config.BigEndian) {
			break
		...
		v1 := b.NewValue0(v.Pos, OpPPC64ANDN, types.Int32)
		v2 := b.NewValue0(v.Pos, OpPPC64ADDconst, types.Int32)
		v2.AuxInt = -1
		v2.AddArg(x)
		v1.AddArg(v2)
		v1.AddArg(x)
	...
	// match: (Ctz32 x)
	// cond: config.BigEndian
	// result: (CNTLZW (ANDN <types.Int32> (ADDconst <types.Int32> [-1] x) x))
	for {
		x := v.Args[0]
		if !(config.BigEndian) {
			break
		}
		v.reset(OpPPC64CNTLZW)
		v0 := b.NewValue0(v.Pos, OpPPC64ANDN, types.Int32)
		v1 := b.NewValue0(v.Pos, OpPPC64ADDconst, types.Int32)
		v1.AuxInt = -1
		v1.AddArg(x)
		v0.AddArg(v1)
		v0.AddArg(x)
...
func rewriteValuePPC64_OpCtz64_0(v *Value) bool {
	...
	// match: (Ctz64 x)
	// cond: config.BigEndian
	// result: (CNTLZD (ANDN <types.Int> (ADDconst <types.Int> [-1] x) x))
	for {
		x := v.Args[0]
		if !(config.BigEndian) {
			break
		}
		v.reset(OpPPC64CNTLZD)
		v0 := b.NewValue0(v.Pos, OpPPC64ANDN, types.Int)
		v1 := b.NewValue0(v.Pos, OpPPC64ADDconst, types.Int)
		v1.AuxInt = -1
		v1.AddArg(x)
		v0.AddArg(v1)
		v0.AddArg(x)
