...
func rewriteValuePPC64_OpPPC64ADDE(v *Value) bool {
	...
	for {
		...
		v_2_0 := v_2.Args[0]
		if v_2_0.Op != OpPPC64ADDCconst || v_2_0.AuxInt != -1 {
			break
		}
		v_2_0_0 := v_2_0.Args[0]
		if v_2_0_0.Op != OpPPC64MOVDconst || v_2_0_0.AuxInt != 0 {
			break
		}
		v.reset(OpPPC64ADDC)
		v.AddArg2(x, y)
...
func rewriteValuePPC64_OpPPC64ADDconst(v *Value) bool {
	...
	for {
		...
		v.reset(OpPPC64MOVDaddr)
		v.AuxInt = int64(int32(c + int64(d)))
		v.Aux = sym
		v.AddArg(x)
		return true
	}
...
func rewriteValuePPC64_OpPPC64AND(v *Value) bool {
	...
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			...
			v.AuxInt = encodePPC64RotateMask(r, m, 32)
			v.AddArg(x)
			return true
		}
		break
	...
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			...
			v.AuxInt = encodePPC64RotateMask(0, m, 32)
			v.AddArg2(x, r)
			return true
		}
		break
	...
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			...
			v.reset(OpPPC64RLWINM)
			v.AuxInt = mergePPC64AndSrwi(m, s)
			v.AddArg(x)
			return true
		}
		break
...
func rewriteValuePPC64_OpPPC64CLRLSLDI(v *Value) bool {
	...
	for {
		...
		v.reset(OpPPC64RLWINM)
		v.AuxInt = mergePPC64ClrlsldiSrw(int64(c), s)
		v.AddArg(x)
		return true
	}
	...
	for {
		...
		v.reset(OpPPC64RLWINM)
		v.AuxInt = mergePPC64ClrlsldiRlwinm(c, s)
		v.AddArg(x)
		return true
	}
	return false
...
func rewriteValuePPC64_OpPPC64FMOVDload(v *Value) bool {
	...
	for {
		...
		sym := auxToSym(v.Aux)
		ptr := v_0
		if v_1.Op != OpPPC64MOVDstore || int32(v_1.AuxInt) != off || auxToSym(v_1.Aux) != sym {
			break
		}
		x := v_1.Args[1]
		if ptr != v_1.Args[0] {
...
func rewriteValuePPC64_OpPPC64ISEL(v *Value) bool {
	...
	for {
		...
		v_2_0 := v_2.Args[0]
		if v_2_0.Op != OpPPC64ANDCCconst || v_2_0.AuxInt != 1 {
			break
		}
		v_2_0_0 := v_2_0.Args[0]
	...
	for {
		...
		x := v_0
		y := v_1
		if v_2.Op != OpPPC64CMPconst || v_2.AuxInt != 0 {
			break
		}
		v_2_0 := v_2.Args[0]
	...
	for {
		...
		x := v_0
		y := v_1
		if v_2.Op != OpPPC64CMPWconst || int32(v_2.AuxInt) != 0 {
			break
		}
		v_2_0 := v_2.Args[0]
		if v_2_0.Op != OpPPC64SETBC {
...
func rewriteValuePPC64_OpPPC64MFVSRD(v *Value) bool {
	...
	for {
		...
		v.reset(OpPPC64MOVDconst)
		v.AuxInt = int64(math.Float64bits(c))
		return true
	}
...
func rewriteValuePPC64_OpPPC64MOVDload(v *Value) bool {
	...
	for {
		...
		sym := auxToSym(v.Aux)
		ptr := v_0
		if v_1.Op != OpPPC64FMOVDstore || int32(v_1.AuxInt) != off || auxToSym(v_1.Aux) != sym {
			break
		}
		x := v_1.Args[1]
		if ptr != v_1.Args[0] {
...
func rewriteValuePPC64_OpPPC64ROTLWconst(v *Value) bool {
	...
	for {
		...
		for _i0 := 0; _i0 <= 1; _i0, v_0_0, v_0_1 = _i0+1, v_0_1, v_0_0 {
			...
			v.reset(OpPPC64RLWINM)
			v.AuxInt = encodePPC64RotateMask(r, rotateLeft32(m, r), 32)
			v.AddArg(x)
			return true
		}
		break
...
func rewriteValuePPC64_OpPPC64SETBC(v *Value) bool {
	...
	// result: (MOVDconst [1])
	for {
		if int32(v.AuxInt) != 0 || v_0.Op != OpPPC64FlagLT {
			break
		}
		v.reset(OpPPC64MOVDconst)
		v.AuxInt = 1
	...
	// result: (MOVDconst [0])
	for {
		if int32(v.AuxInt) != 0 || v_0.Op != OpPPC64FlagGT {
			break
		}
		v.reset(OpPPC64MOVDconst)
		return true
	...
	// result: (MOVDconst [0])
	for {
		if int32(v.AuxInt) != 0 || v_0.Op != OpPPC64FlagEQ {
			break
		}
		v.reset(OpPPC64MOVDconst)
		return true
	...
	// result: (MOVDconst [1])
	for {
		if int32(v.AuxInt) != 1 || v_0.Op != OpPPC64FlagGT {
			break
		}
		v.reset(OpPPC64MOVDconst)
		v.AuxInt = 1
	...
	// result: (MOVDconst [0])
	for {
		if int32(v.AuxInt) != 1 || v_0.Op != OpPPC64FlagLT {
			break
		}
		v.reset(OpPPC64MOVDconst)
		return true
	...
	// result: (MOVDconst [0])
	for {
		if int32(v.AuxInt) != 1 || v_0.Op != OpPPC64FlagEQ {
			break
		}
		v.reset(OpPPC64MOVDconst)
		return true
	...
	// result: (MOVDconst [1])
	for {
		if int32(v.AuxInt) != 2 || v_0.Op != OpPPC64FlagEQ {
			break
		}
		v.reset(OpPPC64MOVDconst)
		v.AuxInt = 1
	...
	// result: (MOVDconst [0])
	for {
		if int32(v.AuxInt) != 2 || v_0.Op != OpPPC64FlagLT {
			break
		}
		v.reset(OpPPC64MOVDconst)
		return true
	...
	// result: (MOVDconst [0])
	for {
		if int32(v.AuxInt) != 2 || v_0.Op != OpPPC64FlagGT {
			break
		}
		v.reset(OpPPC64MOVDconst)
		return true
	...
	// result: (SETBC [1] bool)
	for {
		if int32(v.AuxInt) != 0 || v_0.Op != OpPPC64InvertFlags {
			break
		}
		bool := v_0.Args[0]
		v.reset(OpPPC64SETBC)
	...
	// result: (SETBC [0] bool)
	for {
		if int32(v.AuxInt) != 1 || v_0.Op != OpPPC64InvertFlags {
			break
		}
		bool := v_0.Args[0]
		v.reset(OpPPC64SETBC)
	...
	// result: (SETBC [2] bool)
	for {
		if int32(v.AuxInt) != 2 || v_0.Op != OpPPC64InvertFlags {
			break
		}
		bool := v_0.Args[0]
		v.reset(OpPPC64SETBC)
	...
	for {
		if int32(v.AuxInt) != 2 || v_0.Op != OpPPC64CMPconst || v_0.AuxInt != 0 {
			break
		}
		v_0_0 := v_0.Args[0]
		...
		if v_0_0_0.Op != OpPPC64ANDCCconst || v_0_0_0.AuxInt != 1 {
			break
		}
		z := v_0_0_0.Args[0]
		v.reset(OpPPC64XORconst)
	...
	// result: (XORconst [1] (Select0 <typ.UInt64> (ANDCCconst [1] z )))
	for {
		if int32(v.AuxInt) != 2 || v_0.Op != OpPPC64CMPWconst || int32(v_0.AuxInt) != 0 {
			break
		}
		v_0_0 := v_0.Args[0]
		if v_0_0.Op != OpSelect0 {
...
func rewriteValuePPC64_OpPPC64SLDconst(v *Value) bool {
	...
	for {
		...
		v.reset(OpPPC64RLWINM)
		v.AuxInt = mergePPC64SldiSrw(l, r)
		v.AddArg(x)
		return true
	}
	...
	for {
		...
		v.AuxInt = int64(newPPC64ShiftAuxInt(c, 56, 63, 64))
		v.AddArg(x)
		return true
	}
	...
	for {
		...
		v.reset(OpPPC64CLRLSLDI)
		v.AuxInt = int64(newPPC64ShiftAuxInt(c, 48, 63, 64))
		v.AddArg(x)
		return true
	}
	...
	for {
		...
		v.reset(OpPPC64CLRLSLDI)
		v.AuxInt = int64(newPPC64ShiftAuxInt(c, 32, 63, 64))
		v.AddArg(x)
		return true
	}
	...
	for {
		...
		v.reset(OpPPC64CLRLSLDI)
		v.AuxInt = int64(newPPC64ShiftAuxInt(c, 64-getPPC64ShiftMaskLength(d), 63, 64))
		v.AddArg(x)
		return true
	}
...
func rewriteValuePPC64_OpPPC64SLWconst(v *Value) bool {
	...
	for {
		...
		v.AuxInt = int64(newPPC64ShiftAuxInt(c, 24, 31, 32))
		v.AddArg(x)
		return true
	}
	...
	for {
		...
		v.reset(OpPPC64CLRLSLWI)
		v.AuxInt = int64(newPPC64ShiftAuxInt(c, 16, 31, 32))
		v.AddArg(x)
		return true
	}
	...
	for {
		...
		v.reset(OpPPC64CLRLSLWI)
		v.AuxInt = int64(newPPC64ShiftAuxInt(c, 32-getPPC64ShiftMaskLength(d), 31, 32))
		v.AddArg(x)
		return true
	}
...
func rewriteValuePPC64_OpPPC64SRWconst(v *Value) bool {
	...
	for {
		...
		v.reset(OpPPC64RLWINM)
		v.AuxInt = mergePPC64AndSrwi(m>>uint(s), s)
		v.AddArg(x)
		return true
	}
...
func rewriteValuePPC64_OpPPC64SUBE(v *Value) bool {
	...
	for {
		...
		v_2_0 := v_2.Args[0]
		if v_2_0.Op != OpPPC64SUBCconst || v_2_0.AuxInt != 0 {
			break
		}
		v_2_0_0 := v_2_0.Args[0]
		if v_2_0_0.Op != OpPPC64MOVDconst || v_2_0_0.AuxInt != 0 {
...
func rewriteValuePPC64_OpPPC64XORconst(v *Value) bool {
	...
	// result: (SETBC [n] cmp)
	for {
		if v.AuxInt != 1 || v_0.Op != OpPPC64SETBCR {
			break
		}
		n := int32(v_0.AuxInt)
		cmp := v_0.Args[0]
	...
	// result: (SETBCR [n] cmp)
	for {
		if v.AuxInt != 1 || v_0.Op != OpPPC64SETBC {
			break
		}
		n := int32(v_0.AuxInt)
		cmp := v_0.Args[0]
...
func rewriteValuePPC64_OpSelect0(v *Value) bool {
	...
	// result: x
	for {
		if v_0.Op != OpPPC64ANDCCconst || v_0.AuxInt != -1 {
			break
		}
		x := v_0.Args[0]
		v.copyOf(x)
	...
	// result: (MOVDconst [0])
	for {
		if v_0.Op != OpPPC64ANDCCconst || v_0.AuxInt != 0 {
			break
		}
		v.reset(OpPPC64MOVDconst)
		return true
	...
	// result: (MOVBZreg x)
	for {
		if v_0.Op != OpPPC64ANDCCconst || v_0.AuxInt != 0xFF {
			break
		}
		v_0_0 := v_0.Args[0]
		if v_0_0.Op != OpPPC64MOVBreg {
	...
	// result: (MOVHZreg x)
	for {
		if v_0.Op != OpPPC64ANDCCconst || v_0.AuxInt != 0xFFFF {
			break
		}
		v_0_0 := v_0.Args[0]
		if v_0_0.Op != OpPPC64MOVHreg {
	...
	for {
		...
		z := v_0.Args[0]
		if z.Op != OpPPC64SRADconst || z.AuxInt != 63 {
			break
		}
		x := z.Args[0]
		if !(z.Uses == 1) {
...
func rewriteValuePPC64_OpSelect1(v *Value) bool {
	...
	// result: x
	for {
		if v_0.Op != OpPPC64ADDCconst || v_0.AuxInt != -1 {
			break
		}
		n := v_0.Args[0]
	...
	// result: x
	for {
		if v_0.Op != OpPPC64SUBCconst || v_0.AuxInt != 0 {
			break
		}
		n := v_0.Args[0]
		if n.Op != OpPPC64NEG {
