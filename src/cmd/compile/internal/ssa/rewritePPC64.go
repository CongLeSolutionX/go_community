...
func rewriteValuePPC64_OpLsh32x64(v *Value) bool {
	...
	// match: (Lsh32x64 x (Select0 (ANDCCconst <typ.Int32> [31] y)))
	// result: (SLW x (Select0 <typ.Int32> (ANDCCconst [31] y)))
	for {
		x := v_0
		if v_1.Op != OpSelect0 {
		...
		v_1_0 := v_1.Args[0]
		if v_1_0.Op != OpPPC64ANDCCconst || v_1_0.Type != typ.Int32 || auxIntToInt64(v_1_0.AuxInt) != 31 {
			break
		}
		y := v_1_0.Args[0]
		v.reset(OpPPC64SLW)
...
func rewriteValuePPC64_OpRsh8x16(v *Value) bool {
	...
	// match: (Rsh8x16 x y)
	// result: (SRAW (SignExt8to32 x) (ISEL [0] y (MOVDconst [-1]) (CMPU (SignExt16to64 y) (MOVDconst [8]))))
	for {
		x := v_0
		y := v_1
		v.reset(OpPPC64SRAW)
		...
		v2.AuxInt = int64ToAuxInt(-1)
		v3 := b.NewValue0(v.Pos, OpPPC64CMPU, types.TypeFlags)
		v4 := b.NewValue0(v.Pos, OpSignExt16to64, typ.Int64)
		v4.AddArg(y)
		v5 := b.NewValue0(v.Pos, OpPPC64MOVDconst, typ.Int64)
		v5.AuxInt = int64ToAuxInt(8)
		v3.AddArg2(v4, v5)
