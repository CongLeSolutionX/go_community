...
func rewriteValuePPC64_OpPPC64OR_40(v *Value) bool {
	...
	typ := &b.Func.Config.Types
	_ = typ
	// match: (OR <t> s2:(SLDconst x2:(MOVBZload [i2] {s} p mem) [32]) o0:(OR <t> s1:(SLDconst x1:(MOVBZload [i1] {s} p mem) [40]) s0:(SLDconst x0:(MOVHBRidxload <t> {s} p (MOVDaddridx <typ.Uintptr> [i0] {s} p) mem) [48])))
	...
	// match: (OR <t> s2:(SLDconst x2:(MOVBZload [i2] {s} p mem) [32]) o0:(OR <t> s0:(SLDconst x0:(MOVHBRidxload <t> {s} p (MOVDaddridx <typ.Uintptr> [i0] {s} p) mem) [48]) s1:(SLDconst x1:(MOVBZload [i1] {s} p mem) [40])))
	// cond: !config.BigEndian && i1 == i0+1 && i2 == i0+2 && x0.Uses == 1 && x1.Uses == 1 && x2.Uses == 1 && o0.Uses == 1 && s0.Uses == 1 && s1.Uses == 1 && s2.Uses == 1 && mergePoint(b, x0, x1, x2) != nil && clobber(x0) && clobber(x1) && clobber(x2) && clobber(s0) && clobber(s1) && clobber(s2) && clobber(o0)
	// result: @mergePoint(b,x0,x1,x2) (SLWconst <typ.UInt32> (MOVWBRidxload <t> {s} p (MOVDaddridx <typ.Uintptr> [i0] {s} p) mem) [32])
	for {
		t := v.Type
	...
	// match: (OR <t> o0:(OR <t> s1:(SLDconst x1:(MOVBZload [i1] {s} p mem) [40]) s0:(SLDconst x0:(MOVHBRidxload <t> {s} p (MOVDaddridx <typ.Uintptr> [i0] {s} p) mem) [48])) s2:(SLDconst x2:(MOVBZload [i2] {s} p mem) [32]))
	// cond: !config.BigEndian && i1 == i0+1 && i2 == i0+2 && x0.Uses == 1 && x1.Uses == 1 && x2.Uses == 1 && o0.Uses == 1 && s0.Uses == 1 && s1.Uses == 1 && s2.Uses == 1 && mergePoint(b, x0, x1, x2) != nil && clobber(x0) && clobber(x1) && clobber(x2) && clobber(s0) && clobber(s1) && clobber(s2) && clobber(o0)
	// result: @mergePoint(b,x0,x1,x2) (SLWconst <typ.UInt32> (MOVWBRidxload <t> {s} p (MOVDaddridx <typ.Uintptr> [i0] {s} p) mem) [32])
	for {
		t := v.Type
	...
	// match: (OR <t> o0:(OR <t> s0:(SLDconst x0:(MOVHBRidxload <t> {s} p (MOVDaddridx <typ.Uintptr> [i0] {s} p) mem) [48]) s1:(SLDconst x1:(MOVBZload [i1] {s} p mem) [40])) s2:(SLDconst x2:(MOVBZload [i2] {s} p mem) [32]))
	// cond: !config.BigEndian && i1 == i0+1 && i2 == i0+2 && x0.Uses == 1 && x1.Uses == 1 && x2.Uses == 1 && o0.Uses == 1 && s0.Uses == 1 && s1.Uses == 1 && s2.Uses == 1 && mergePoint(b, x0, x1, x2) != nil && clobber(x0) && clobber(x1) && clobber(x2) && clobber(s0) && clobber(s1) && clobber(s2) && clobber(o0)
	// result: @mergePoint(b,x0,x1,x2) (SLWconst <typ.UInt32> (MOVWBRidxload <t> {s} p (MOVDaddridx <typ.Uintptr> [i0] {s} p) mem) [32])
	for {
		t := v.Type
