...
func rewriteValuePPC64_OpRsh16Ux64(v *Value, config *Config) bool {
	...
	// cond: uint64(c) < 16
	// result: (SRWconst (ZeroExt16to64 x) [c])
	for {
		x := v.Args[0]
		v_1 := v.Args[1]
		if v_1.Op != OpConst64 {
...
func rewriteValuePPC64_OpRsh16x64(v *Value, config *Config) bool {
	...
	// cond: uint64(c) < 16
	// result: (SRAWconst (SignExt16to64 x) [c])
	for {
		x := v.Args[0]
		v_1 := v.Args[1]
		if v_1.Op != OpConst64 {
	...
	// match: (Rsh16x64 x (Const64 [c]))
	// cond: uint64(c) >= 16
	// result: (SRADconst (SignExt16to64 x) [63])
	for {
		x := v.Args[0]
		v_1 := v.Args[1]
		if v_1.Op != OpConst64 {
...
func rewriteValuePPC64_OpRsh32Ux64(v *Value, config *Config) bool {
	...
	// cond: uint64(c) < 32
	// result: (SRWconst (ZeroExt32to64 x) [c])
	for {
		x := v.Args[0]
		v_1 := v.Args[1]
		if v_1.Op != OpConst64 {
...
func rewriteValuePPC64_OpRsh32x64(v *Value, config *Config) bool {
	...
	// cond: uint64(c) < 32
	// result: (SRAWconst (SignExt32to64 x) [c])
	for {
		x := v.Args[0]
		v_1 := v.Args[1]
		if v_1.Op != OpConst64 {
	...
	// match: (Rsh32x64 x (Const64 [c]))
	// cond: uint64(c) >= 32
	// result: (SRADconst (SignExt32to64 x) [63])
	for {
		x := v.Args[0]
		v_1 := v.Args[1]
		if v_1.Op != OpConst64 {
...
func rewriteValuePPC64_OpRsh8Ux64(v *Value, config *Config) bool {
	...
	// cond: uint64(c) < 8
	// result: (SRWconst (ZeroExt8to64  x) [c])
	for {
		x := v.Args[0]
		v_1 := v.Args[1]
		if v_1.Op != OpConst64 {
...
func rewriteValuePPC64_OpRsh8x64(v *Value, config *Config) bool {
	...
	// cond: uint64(c) < 8
	// result: (SRAWconst (SignExt8to64  x) [c])
	for {
		x := v.Args[0]
		v_1 := v.Args[1]
		if v_1.Op != OpConst64 {
	...
	// match: (Rsh8x64  x (Const64 [c]))
	// cond: uint64(c) >= 8
	// result: (SRADconst (SignExt8to64  x) [63])
	for {
		x := v.Args[0]
		v_1 := v.Args[1]
		if v_1.Op != OpConst64 {
