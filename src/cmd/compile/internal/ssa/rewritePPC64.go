...
func rewriteValuePPC64_OpPPC64FABS_0(v *Value) bool {
	...
	for {
		...
		x := v_0.auxFloat64()
		v.reset(OpPPC64FMOVDconst)
		v.setAuxFloat64(f2i(math.Abs(i2f(x))))
		return true
	}
	return false
}
...
func rewriteValuePPC64_OpPPC64FCEIL_0(v *Value) bool {
	...
	for {
		...
		x := v_0.auxFloat64()
		v.reset(OpPPC64FMOVDconst)
		v.setAuxFloat64(f2i(math.Ceil(i2f(x))))
		return true
	}
	return false
}
func rewriteValuePPC64_OpPPC64FFLOOR_0(v *Value) bool {
	...
	for {
		...
		x := v_0.auxFloat64()
		v.reset(OpPPC64FMOVDconst)
		v.setAuxFloat64(f2i(math.Floor(i2f(x))))
		return true
	}
	return false
}
...
func rewriteValuePPC64_OpPPC64FSQRT_0(v *Value) bool {
	...
	for {
		...
		x := v_0.auxFloat64()
		v.reset(OpPPC64FMOVDconst)
		v.setAuxFloat64(f2i(math.Sqrt(i2f(x))))
		return true
	}
	return false
}
...
func rewriteValuePPC64_OpPPC64FTRUNC_0(v *Value) bool {
	...
	for {
		...
		x := v_0.auxFloat64()
		v.reset(OpPPC64FMOVDconst)
		v.setAuxFloat64(f2i(math.Trunc(i2f(x))))
		return true
	}
	return false
}
