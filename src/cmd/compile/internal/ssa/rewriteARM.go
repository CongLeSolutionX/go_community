...
func rewriteValueARM_OpARMMOVBUload_0(v *Value) bool {
	...
	// match: (MOVBUload [0] {sym} (ADD idx ptr) mem)
	// cond: sym == nil
	// result: (MOVBUloadidx ptr idx mem)
	for {
		if v.AuxInt != 0 {
...
func rewriteValueARM_OpARMMOVBload_0(v *Value) bool {
	...
	// match: (MOVBload [0] {sym} (ADD idx ptr) mem)
	// cond: sym == nil
	// result: (MOVBloadidx ptr idx mem)
	for {
		if v.AuxInt != 0 {
...
func rewriteValueARM_OpARMMOVBstore_0(v *Value) bool {
	...
	// match: (MOVBstore [0] {sym} (ADD idx ptr) val mem)
	// cond: sym == nil
	// result: (MOVBstoreidx ptr idx val mem)
	for {
		if v.AuxInt != 0 {
...
func rewriteValueARM_OpARMMOVHUload_0(v *Value) bool {
	...
	// match: (MOVHUload [0] {sym} (ADD idx ptr) mem)
	// cond: sym == nil
	// result: (MOVHUloadidx ptr idx mem)
	for {
		if v.AuxInt != 0 {
...
func rewriteValueARM_OpARMMOVHload_0(v *Value) bool {
	...
	// match: (MOVHload [0] {sym} (ADD idx ptr) mem)
	// cond: sym == nil
	// result: (MOVHloadidx ptr idx mem)
	for {
		if v.AuxInt != 0 {
...
func rewriteValueARM_OpARMMOVHstore_0(v *Value) bool {
	...
	// match: (MOVHstore [0] {sym} (ADD idx ptr) val mem)
	// cond: sym == nil
	// result: (MOVHstoreidx ptr idx val mem)
	for {
		if v.AuxInt != 0 {
...
func rewriteValueARM_OpARMMOVWload_0(v *Value) bool {
	...
	// match: (MOVWload [0] {sym} (ADD idx ptr) mem)
	// cond: sym == nil
	// result: (MOVWloadidx ptr idx mem)
	for {
		if v.AuxInt != 0 {
...
func rewriteValueARM_OpARMMOVWstore_0(v *Value) bool {
	...
	// match: (MOVWstore [0] {sym} (ADD idx ptr) val mem)
	// cond: sym == nil
	// result: (MOVWstoreidx ptr idx val mem)
	for {
		if v.AuxInt != 0 {
...
func rewriteBlockARM(b *Block) bool {
	...
	case BlockARMEQ:
		...
		// match: (EQ (CMPconst [0] l:(ADD y x)) yes no)
		// cond: l.Uses==1
		// result: (EQ (CMN x y) yes no)
		for b.Controls[0].Op == OpARMCMPconst {
			v_0 := b.Controls[0]
		...
		// match: (EQ (CMPconst [0] l:(AND y x)) yes no)
		// cond: l.Uses==1
		// result: (EQ (TST x y) yes no)
		for b.Controls[0].Op == OpARMCMPconst {
			v_0 := b.Controls[0]
		...
		// match: (EQ (CMPconst [0] l:(XOR y x)) yes no)
		// cond: l.Uses==1
		// result: (EQ (TEQ x y) yes no)
		for b.Controls[0].Op == OpARMCMPconst {
			v_0 := b.Controls[0]
	...
	case BlockARMGE:
		...
		// match: (GE (CMPconst [0] l:(ADD y x)) yes no)
		// cond: l.Uses==1
		// result: (GE (CMN x y) yes no)
		for b.Controls[0].Op == OpARMCMPconst {
			v_0 := b.Controls[0]
		...
		// match: (GE (CMPconst [0] l:(AND y x)) yes no)
		// cond: l.Uses==1
		// result: (GE (TST x y) yes no)
		for b.Controls[0].Op == OpARMCMPconst {
			v_0 := b.Controls[0]
		...
		// match: (GE (CMPconst [0] l:(XOR y x)) yes no)
		// cond: l.Uses==1
		// result: (GE (TEQ x y) yes no)
		for b.Controls[0].Op == OpARMCMPconst {
			v_0 := b.Controls[0]
	...
	case BlockARMGT:
		...
		// match: (GT (CMPconst [0] l:(ADD y x)) yes no)
		// cond: l.Uses==1
		// result: (GT (CMN x y) yes no)
		for b.Controls[0].Op == OpARMCMPconst {
			v_0 := b.Controls[0]
		...
		// match: (GT (CMPconst [0] l:(AND y x)) yes no)
		// cond: l.Uses==1
		// result: (GT (TST x y) yes no)
		for b.Controls[0].Op == OpARMCMPconst {
			v_0 := b.Controls[0]
		...
		// match: (GT (CMPconst [0] l:(XOR y x)) yes no)
		// cond: l.Uses==1
		// result: (GT (TEQ x y) yes no)
		for b.Controls[0].Op == OpARMCMPconst {
			v_0 := b.Controls[0]
	...
	case BlockARMLE:
		...
		// match: (LE (CMPconst [0] l:(ADD y x)) yes no)
		// cond: l.Uses==1
		// result: (LE (CMN x y) yes no)
		for b.Controls[0].Op == OpARMCMPconst {
			v_0 := b.Controls[0]
		...
		// match: (LE (CMPconst [0] l:(AND y x)) yes no)
		// cond: l.Uses==1
		// result: (LE (TST x y) yes no)
		for b.Controls[0].Op == OpARMCMPconst {
			v_0 := b.Controls[0]
		...
		// match: (LE (CMPconst [0] l:(XOR y x)) yes no)
		// cond: l.Uses==1
		// result: (LE (TEQ x y) yes no)
		for b.Controls[0].Op == OpARMCMPconst {
			v_0 := b.Controls[0]
	...
	case BlockARMLT:
		...
		// match: (LT (CMPconst [0] l:(ADD y x)) yes no)
		// cond: l.Uses==1
		// result: (LT (CMN x y) yes no)
		for b.Controls[0].Op == OpARMCMPconst {
			v_0 := b.Controls[0]
		...
		// match: (LT (CMPconst [0] l:(AND y x)) yes no)
		// cond: l.Uses==1
		// result: (LT (TST x y) yes no)
		for b.Controls[0].Op == OpARMCMPconst {
			v_0 := b.Controls[0]
		...
		// match: (LT (CMPconst [0] l:(XOR y x)) yes no)
		// cond: l.Uses==1
		// result: (LT (TEQ x y) yes no)
		for b.Controls[0].Op == OpARMCMPconst {
			v_0 := b.Controls[0]
	...
	case BlockARMNE:
		...
		// match: (NE (CMPconst [0] l:(ADD y x)) yes no)
		// cond: l.Uses==1
		// result: (NE (CMN x y) yes no)
		for b.Controls[0].Op == OpARMCMPconst {
			v_0 := b.Controls[0]
		...
		// match: (NE (CMPconst [0] l:(AND y x)) yes no)
		// cond: l.Uses==1
		// result: (NE (TST x y) yes no)
		for b.Controls[0].Op == OpARMCMPconst {
			v_0 := b.Controls[0]
		...
		// match: (NE (CMPconst [0] l:(XOR y x)) yes no)
		// cond: l.Uses==1
		// result: (NE (TEQ x y) yes no)
		for b.Controls[0].Op == OpARMCMPconst {
			v_0 := b.Controls[0]
