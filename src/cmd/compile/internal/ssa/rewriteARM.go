...
func rewriteValueARM_OpARMADD(v *Value) bool {
	...
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			x := v_0
			if v_1.Op != OpARMRSBconst || int32(v_1.AuxInt) != 0 {
				continue
			}
			y := v_1.Args[0]
			v.reset(OpARMSUB)
...
func rewriteValueARM_OpARMADDshiftLL(v *Value) bool {
	...
	// result: (REV16 x)
	for {
		if v.Type != typ.UInt16 || int32(v.AuxInt) != 8 || v_0.Op != OpARMBFXU || v_0.Type != typ.UInt16 || int32(v_0.AuxInt) != int32(armBFAuxInt(8, 8)) {
			break
		}
		x := v_0.Args[0]
		if x != v_1 {
	...
	// result: (REV16 x)
	for {
		if v.Type != typ.UInt16 || int32(v.AuxInt) != 8 || v_0.Op != OpARMSRLconst || v_0.Type != typ.UInt16 || int32(v_0.AuxInt) != 24 {
			break
		}
		v_0_0 := v_0.Args[0]
		if v_0_0.Op != OpARMSLLconst || int32(v_0_0.AuxInt) != 16 {
			break
		}
		x := v_0_0.Args[0]
...
func rewriteValueARM_OpARMANDshiftLL(v *Value) bool {
	...
	for {
		c := int32(v.AuxInt)
		y := v_0
		if y.Op != OpARMSLLconst || int32(y.AuxInt) != c {
			break
		}
		x := y.Args[0]
		if x != v_1 {
...
func rewriteValueARM_OpARMANDshiftRA(v *Value) bool {
	...
	for {
		c := int32(v.AuxInt)
		y := v_0
		if y.Op != OpARMSRAconst || int32(y.AuxInt) != c {
			break
		}
		x := y.Args[0]
		if x != v_1 {
...
func rewriteValueARM_OpARMANDshiftRL(v *Value) bool {
	...
	for {
		c := int32(v.AuxInt)
		y := v_0
		if y.Op != OpARMSRLconst || int32(y.AuxInt) != c {
			break
		}
		x := y.Args[0]
		if x != v_1 {
...
func rewriteValueARM_OpARMBFX(v *Value) bool {
	...
	for {
		...
		d := int32(v_0.AuxInt)
		v.reset(OpARMMOVWconst)
		v.AuxInt = int64(d << (32 - uint32(c&0xff) - uint32(c>>8)) >> (32 - uint32(c>>8)))
		return true
	}
	return false
}
...
func rewriteValueARM_OpARMBICshiftLL(v *Value) bool {
	...
	for {
		c := int32(v.AuxInt)
		if v_0.Op != OpARMSLLconst || int32(v_0.AuxInt) != c {
			break
		}
		x := v_0.Args[0]
		if x != v_1 {
...
func rewriteValueARM_OpARMBICshiftRA(v *Value) bool {
	...
	for {
		c := int32(v.AuxInt)
		if v_0.Op != OpARMSRAconst || int32(v_0.AuxInt) != c {
			break
		}
		x := v_0.Args[0]
		if x != v_1 {
...
func rewriteValueARM_OpARMBICshiftRL(v *Value) bool {
	...
	for {
		c := int32(v.AuxInt)
		if v_0.Op != OpARMSRLconst || int32(v_0.AuxInt) != c {
			break
		}
		x := v_0.Args[0]
		if x != v_1 {
...
func rewriteValueARM_OpARMMOVWload(v *Value) bool {
	...
	for {
		...
		v.reset(OpARMMOVWconst)
		v.AuxInt = int64(int32(read32(sym, int64(off), config.ctxt.Arch.ByteOrder)))
		return true
	}
	return false
}
...
func rewriteValueARM_OpARMMUL(v *Value) bool {
	...
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			if v_1.Op != OpARMMOVWconst || int32(v_1.AuxInt) != 0 {
				continue
			}
			v.reset(OpARMMOVWconst)
			return true
	...
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			x := v_0
			if v_1.Op != OpARMMOVWconst || int32(v_1.AuxInt) != 1 {
				continue
			}
			v.copyOf(x)
			return true
	...
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			...
			v.reset(OpARMADDshiftLL)
			v.AuxInt = int64(int32(log32(c - 1)))
			v.AddArg2(x, x)
			return true
		}
		break
	...
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			...
			v.reset(OpARMSLLconst)
			v.AuxInt = int64(int32(log32(c / 3)))
	...
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			...
			v.reset(OpARMSLLconst)
			v.AuxInt = int64(int32(log32(c / 5)))
			v0 := b.NewValue0(v.Pos, OpARMADDshiftLL, x.Type)
			v0.AuxInt = 2
			v0.AddArg2(x, x)
			v.AddArg(v0)
	...
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			...
			v.reset(OpARMSLLconst)
			v.AuxInt = int64(int32(log32(c / 7)))
	...
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			...
			v.reset(OpARMSLLconst)
			v.AuxInt = int64(int32(log32(c / 9)))
			v0 := b.NewValue0(v.Pos, OpARMADDshiftLL, x.Type)
			v0.AuxInt = 3
			v0.AddArg2(x, x)
			v.AddArg(v0)
...
func rewriteValueARM_OpARMMULA(v *Value) bool {
	...
	for {
		...
		v.reset(OpARMADD)
		v0 := b.NewValue0(v.Pos, OpARMADDshiftLL, x.Type)
		v0.AuxInt = int64(int32(log32(c - 1)))
		v0.AddArg2(x, x)
		v.AddArg2(v0, a)
		return true
	}
	...
	for {
		...
		v.reset(OpARMADD)
		v0 := b.NewValue0(v.Pos, OpARMSLLconst, x.Type)
		v0.AuxInt = int64(int32(log32(c / 3)))
	...
	for {
		...
		v.reset(OpARMADD)
		v0 := b.NewValue0(v.Pos, OpARMSLLconst, x.Type)
		v0.AuxInt = int64(int32(log32(c / 5)))
		v1 := b.NewValue0(v.Pos, OpARMADDshiftLL, x.Type)
		v1.AuxInt = 2
		v1.AddArg2(x, x)
		v0.AddArg(v1)
	...
	for {
		...
		v.reset(OpARMADD)
		v0 := b.NewValue0(v.Pos, OpARMSLLconst, x.Type)
		v0.AuxInt = int64(int32(log32(c / 7)))
	...
	for {
		...
		v.reset(OpARMADD)
		v0 := b.NewValue0(v.Pos, OpARMSLLconst, x.Type)
		v0.AuxInt = int64(int32(log32(c / 9)))
		v1 := b.NewValue0(v.Pos, OpARMADDshiftLL, x.Type)
		v1.AuxInt = 3
		v1.AddArg2(x, x)
		v0.AddArg(v1)
	...
	// result: a
	for {
		if v_0.Op != OpARMMOVWconst || int32(v_0.AuxInt) != 0 {
			break
		}
		a := v_2
		v.copyOf(a)
	...
	// result: (ADD x a)
	for {
		if v_0.Op != OpARMMOVWconst || int32(v_0.AuxInt) != 1 {
			break
		}
		x := v_1
		a := v_2
...
func rewriteValueARM_OpARMTEQconst(v *Value) bool {
	...
	for {
		...
		x := int32(v_0.AuxInt)
		v.reset(OpARMFlagConstant)
		v.AuxInt = int64(logicFlags32(x ^ y))
		return true
	}
	return false
}
...
func rewriteValueARM_OpMove(v *Value) bool {
	...
	for {
		...
		v0.AuxInt = int64(int32(s - moveSize(t.Alignment(), config)))
		v0.AddArg(src)
...
func rewriteValueARM_OpSelect0(v *Value) bool {
	...
	for {
		...
		x := v_0.Args[0]
		v_0_1 := v_0.Args[1]
		if v_0_1.Op != OpARMMOVWconst || int32(v_0_1.AuxInt) != 1 {
			break
		}
		v.copyOf(x)
		return true
...
func rewriteBlockARM(b *Block) bool {
	...
	case BlockARMEQ:
		...
		for b.Controls[0].Op == OpARMCMP {
			...
			x := v_0.Args[0]
			v_0_1 := v_0.Args[1]
			if v_0_1.Op != OpARMRSBconst || int32(v_0_1.AuxInt) != 0 {
				break
			}
			y := v_0_1.Args[0]
