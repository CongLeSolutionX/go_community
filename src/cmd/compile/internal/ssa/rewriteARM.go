...
func rewriteValueARM_OpARMADCshiftLL_0(v *Value) bool {
	...
	for {
		...
		flags := v.Args[2]
		v.reset(OpARMADCconst)
		v.setAuxInt32(int64(int32(uint32(c) << uint64(d))))
		v.AddArg(x)
		v.AddArg(flags)
		return true
	}
...
func rewriteValueARM_OpARMADCshiftRA_0(v *Value) bool {
	...
	for {
		...
		flags := v.Args[2]
		v.reset(OpARMADCconst)
		v.setAuxInt32(int64(int32(c) >> uint64(d)))
		v.AddArg(x)
		v.AddArg(flags)
		return true
	}
...
func rewriteValueARM_OpARMANDconst_0(v *Value) bool {
	...
	for {
		...
		v.setAuxInt32(int64(int32(^uint32(c))))
		v.AddArg(x)
		return true
	}
	// match: (ANDconst [c] x)
...
func rewriteValueARM_OpARMBFX_0(v *Value) bool {
	...
	for {
		...
		d := v_0.auxInt32()
		v.reset(OpARMMOVWconst)
		v.setAuxInt32(int64(int32(d) << (32 - uint32(c&0xff) - uint32(c>>8)) >> (32 - uint32(c>>8))))
		return true
	}
	return false
}
func rewriteValueARM_OpARMBFXU_0(v *Value) bool {
	...
	for {
		...
		d := v_0.auxInt32()
		v.reset(OpARMMOVWconst)
		v.setAuxInt32(int64(int32(uint32(d) << (32 - uint32(c&0xff) - uint32(c>>8)) >> (32 - uint32(c>>8)))))
		return true
	}
	return false
}
...
func rewriteValueARM_OpARMMOVWloadshiftLL_0(v *Value) bool {
	...
	for {
		...
		mem := v.Args[2]
		v.reset(OpARMMOVWload)
		v.setAuxInt64(int64(uint32(c) << uint64(d)))
		v.AddArg(ptr)
		v.AddArg(mem)
		return true
	}
...
func rewriteValueARM_OpARMMOVWloadshiftRA_0(v *Value) bool {
	...
	for {
		...
		mem := v.Args[2]
		v.reset(OpARMMOVWload)
		v.setAuxInt64(int64(int32(c) >> uint64(d)))
		v.AddArg(ptr)
		v.AddArg(mem)
		return true
	}
...
func rewriteValueARM_OpARMMVNshiftLL_0(v *Value) bool {
	...
	for {
		...
		c := v_0.auxInt32()
		v.reset(OpARMMOVWconst)
		v.setAuxInt32(^int64(uint32(c) << uint64(d)))
		return true
	}
	return false
}
...
func rewriteValueARM_OpARMSLLconst_0(v *Value) bool {
	...
	for {
		...
		d := v_0.auxInt32()
		v.reset(OpARMMOVWconst)
		v.setAuxInt32(int64(int32(uint32(d) << uint64(c))))
		return true
	}
	return false
}
...
func rewriteValueARM_OpARMSRAconst_0(v *Value) bool {
	...
	for {
		...
		d := v_0.auxInt32()
		v.reset(OpARMMOVWconst)
		v.setAuxInt32(int64(int32(d) >> uint64(c)))
		return true
	}
...
func rewriteValueARM_OpARMXORshiftRR_0(v *Value) bool {
	...
	for {
		...
		c := v_1.auxInt32()
		v.reset(OpARMXORconst)
		v.setAuxInt32(int64(int32(uint32(c)>>uint64(d) | uint32(c)<<uint64(32-d))))
		v.AddArg(x)
		return true
	}
	return false
...
func rewriteValueARM_OpMove_0(v *Value) bool {
	...
	for {
		...
		v.setAuxInt64(t.(*types.Type).Alignment())
		v.AddArg(dst)
		v.AddArg(src)
		v0 := b.NewValue0(v.Pos, OpARMADDconst, src.Type)
		v0.setAuxInt32(s - moveSize(t.(*types.Type).Alignment(), config))
		v0.AddArg(src)
		v.AddArg(v0)
		v.AddArg(mem)
		return true
...
func rewriteValueARM_OpSelect0_0(v *Value) bool {
	...
	for {
		...
		d := v_0_1.auxInt32()
		v.reset(OpARMMOVWconst)
		v.setAuxInt32(int64(int32(uint32(c) / uint32(d))))
		return true
	}
	return false
}
