...
func rewriteValuedec64_OpMul64(v *Value, config *Config) bool {
	...
	// match: (Mul64 x y)
	// cond:
	// result: (Int64Make 		(Add32 <config.fe.TypeUInt32()> 			(Mul32 <config.fe.TypeUInt32()> (Int64Lo x) (Int64Hi y)) 			(Add32 <config.fe.TypeUInt32()> 				(Mul32 <config.fe.TypeUInt32()> (Int64Hi x) (Int64Lo y)) 				(Hi32 (Mul32uhilo (Int64Lo x) (Int64Lo y))))) 		(Lo32 (Mul32uhilo (Int64Lo x) (Int64Lo y))))
	for {
		x := v.Args[0]
		y := v.Args[1]
		v.reset(OpInt64Make)
		...
		v5.AddArg(v7)
		v4.AddArg(v5)
		v8 := b.NewValue0(v.Line, OpHi32, config.fe.TypeUInt32())
		v9 := b.NewValue0(v.Line, OpMul32uhilo, TypeUInt32x2)
		v10 := b.NewValue0(v.Line, OpInt64Lo, config.fe.TypeUInt32())
		v10.AddArg(x)
		v9.AddArg(v10)
		...
		v0.AddArg(v4)
		v.AddArg(v0)
		v12 := b.NewValue0(v.Line, OpLo32, config.fe.TypeUInt32())
		v13 := b.NewValue0(v.Line, OpMul32uhilo, TypeUInt32x2)
