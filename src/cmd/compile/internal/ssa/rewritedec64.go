...
func rewriteValuedec64_OpAdd64(v *Value, config *Config) bool {
	...
	// match: (Add64 x y)
	// cond:
	// result: (Int64Make 		(Add32withcarry <config.fe.TypeInt32()> (Int64Hi x) (Int64Hi y) 			(Add32carrybit <config.fe.TypeInt32()> (Int64Lo x) (Int64Lo y))) 		(Add32setcarry <config.fe.TypeInt32()> (Int64Lo x) (Int64Lo y)))
	for {
		x := v.Args[0]
		y := v.Args[1]
		v.reset(OpInt64Make)
		v0 := b.NewValue0(v.Line, OpAdd32withcarry, config.fe.TypeInt32())
		v1 := b.NewValue0(v.Line, OpInt64Hi, config.fe.TypeInt32())
		v1.AddArg(x)
		v0.AddArg(v1)
		v2 := b.NewValue0(v.Line, OpInt64Hi, config.fe.TypeInt32())
		v2.AddArg(y)
		v0.AddArg(v2)
		v3 := b.NewValue0(v.Line, OpAdd32carrybit, config.fe.TypeInt32())
		v4 := b.NewValue0(v.Line, OpInt64Lo, config.fe.TypeInt32())
		v4.AddArg(x)
		v3.AddArg(v4)
		v5 := b.NewValue0(v.Line, OpInt64Lo, config.fe.TypeInt32())
		v5.AddArg(y)
		v3.AddArg(v5)
		v0.AddArg(v3)
		v.AddArg(v0)
		v6 := b.NewValue0(v.Line, OpAdd32setcarry, config.fe.TypeInt32())
		v7 := b.NewValue0(v.Line, OpInt64Lo, config.fe.TypeInt32())
		v7.AddArg(x)
		v6.AddArg(v7)
		v8 := b.NewValue0(v.Line, OpInt64Lo, config.fe.TypeInt32())
		v8.AddArg(y)
		v6.AddArg(v8)
		v.AddArg(v6)
		return true
...
func rewriteValuedec64_OpAnd64(v *Value, config *Config) bool {
	...
	// match: (And64 x y)
	// cond:
	// result: (Int64Make 		(And32 <config.fe.TypeUInt32()> (Int64Hi x) (Int64Hi y)) 		(And32 <config.fe.TypeUInt32()> (Int64Lo x) (Int64Hi y)))
	for {
		x := v.Args[0]
		y := v.Args[1]
		v.reset(OpInt64Make)
		...
		v4.AddArg(x)
		v3.AddArg(v4)
		v5 := b.NewValue0(v.Line, OpInt64Hi, config.fe.TypeInt32())
		v5.AddArg(y)
		v3.AddArg(v5)
		v.AddArg(v3)
		return true
...
func rewriteValuedec64_OpArg(v *Value, config *Config) bool {
	...
	// result: (Int64Make     (Arg <config.fe.TypeInt32()> {n} [off+4])     (Arg <config.fe.TypeInt32()> {n} [off]))
	for {
		n := v.Aux
		off := v.AuxInt
		...
		v0.AuxInt = off + 4
		v.AddArg(v0)
		v1 := b.NewValue0(v.Line, OpArg, config.fe.TypeInt32())
		v1.Aux = n
		v1.AuxInt = off
		v.AddArg(v1)
		return true
...
func rewriteValuedec64_OpCom64(v *Value, config *Config) bool {
	...
	for {
		...
		v3 := b.NewValue0(v.Line, OpInt64Lo, config.fe.TypeInt32())
		v3.AddArg(x)
		v2.AddArg(v3)
		v.AddArg(v2)
		return true
...
func rewriteValuedec64_OpConst64(v *Value, config *Config) bool {
	...
	// match: (Const64 <t> [c])
	// cond: t.IsSigned()
	// result: (Int64Make (Const32 <config.fe.TypeInt32()> [c>>32]) (Const32 <config.fe.TypeInt32()> [c]))
	for {
		t := v.Type
		c := v.AuxInt
		if !(t.IsSigned()) {
		...
		v0.AuxInt = c >> 32
		v.AddArg(v0)
		v1 := b.NewValue0(v.Line, OpConst32, config.fe.TypeInt32())
		v1.AuxInt = c
		v.AddArg(v1)
		return true
	}
	// match: (Const64 <t> [c])
	// cond: !t.IsSigned()
	// result: (Int64Make (Const32 <config.fe.TypeUInt32()> [c>>32]) (Const32 <config.fe.TypeUInt32()> [c]))
	for {
		t := v.Type
		c := v.AuxInt
		if !(!t.IsSigned()) {
...
func rewriteValuedec64_OpEq64(v *Value, config *Config) bool {
	...
	// match: (Eq64 x y)
	// cond:
	// result: (AndB 		(Eq32 <config.fe.TypeBool()> (Int64Hi x) (Int64Hi y)) 		(Eq32 (Int64Lo x) (Int64Lo y)))
	for {
		x := v.Args[0]
		y := v.Args[1]
		v.reset(OpAndB)
...
func rewriteValuedec64_OpGeq64(v *Value, config *Config) bool {
	...
	for {
		...
		v5.AddArg(x)
		v4.AddArg(v5)
		v6 := b.NewValue0(v.Line, OpInt64Hi, config.fe.TypeInt32())
		v6.AddArg(y)
		v4.AddArg(v6)
		v3.AddArg(v4)
		...
		v8.AddArg(x)
		v7.AddArg(v8)
		v9 := b.NewValue0(v.Line, OpInt64Lo, config.fe.TypeInt32())
		v9.AddArg(y)
		v7.AddArg(v9)
		v3.AddArg(v7)
		v.AddArg(v3)
...
func rewriteValuedec64_OpLoad(v *Value, config *Config) bool {
	...
	// result: (Int64Make 		(Load <config.fe.TypeInt32()> (OffPtr <config.fe.TypeInt32().PtrTo()> [4] ptr) mem) 		(Load <config.fe.TypeInt32()> ptr mem))
	for {
		t := v.Type
		ptr := v.Args[0]
		mem := v.Args[1]
		...
		v0.AddArg(mem)
		v.AddArg(v0)
		v2 := b.NewValue0(v.Line, OpLoad, config.fe.TypeInt32())
		v2.AddArg(ptr)
		v2.AddArg(mem)
		v.AddArg(v2)
		return true
...
func rewriteValuedec64_OpOr64(v *Value, config *Config) bool {
	...
	// match: (Or64 x y)
	// cond:
	// result: (Int64Make 		(Or32 <config.fe.TypeUInt32()> (Int64Hi x) (Int64Hi y)) 		(Or32 <config.fe.TypeUInt32()> (Int64Lo x) (Int64Hi y)))
	for {
		x := v.Args[0]
		y := v.Args[1]
		v.reset(OpInt64Make)
...
func rewriteValuedec64_OpStore(v *Value, config *Config) bool {
	...
	// cond:
	// result: (Store [4] 		(OffPtr <hi.Type> [4] dst) 		hi 		(Store [4] dst lo mem))
	for {
		if v.AuxInt != 8 {
			break
		}
		...
		v.reset(OpStore)
		v.AuxInt = 4
		v0 := b.NewValue0(v.Line, OpOffPtr, hi.Type)
		v0.AuxInt = 4
		v0.AddArg(dst)
		v.AddArg(v0)
		v.AddArg(hi)
...
func rewriteValuedec64_OpSub64(v *Value, config *Config) bool {
	...
	// match: (Sub64 x y)
	// cond:
	// result: (Int64Make 		(Sub32withcarry <config.fe.TypeInt32()> (Int64Hi x) (Int64Hi y) 			(Sub32carrybit <config.fe.TypeInt32()> (Int64Lo x) (Int64Lo y))) 		(Sub32setcarry <config.fe.TypeInt32()> (Int64Lo x) (Int64Lo y)))
	for {
		x := v.Args[0]
		y := v.Args[1]
		v.reset(OpInt64Make)
		...
		v2.AddArg(y)
		v0.AddArg(v2)
		v3 := b.NewValue0(v.Line, OpSub32carrybit, config.fe.TypeInt32())
		v4 := b.NewValue0(v.Line, OpInt64Lo, config.fe.TypeInt32())
		v4.AddArg(x)
		v3.AddArg(v4)
		v5 := b.NewValue0(v.Line, OpInt64Lo, config.fe.TypeInt32())
		...
		v0.AddArg(v3)
		v.AddArg(v0)
		v6 := b.NewValue0(v.Line, OpSub32setcarry, config.fe.TypeInt32())
		v7 := b.NewValue0(v.Line, OpInt64Lo, config.fe.TypeInt32())
		v7.AddArg(x)
		v6.AddArg(v7)
		v8 := b.NewValue0(v.Line, OpInt64Lo, config.fe.TypeInt32())
...
func rewriteValuedec64_OpXor64(v *Value, config *Config) bool {
	...
	// match: (Xor64 x y)
	// cond:
	// result: (Int64Make 		(Xor32 <config.fe.TypeUInt32()> (Int64Hi x) (Int64Hi y)) 		(Xor32 <config.fe.TypeUInt32()> (Int64Lo x) (Int64Hi y)))
	for {
		x := v.Args[0]
		y := v.Args[1]
		v.reset(OpInt64Make)
