...
func rewriteValuedec64_OpAdd64(v *Value, config *Config) bool {
	...
	// match: (Add64 x y)
	// cond:
	// result: (Int64Make 		(Add32withcarry <config.fe.TypeInt32()> 			(Int64Hi x) 			(Int64Hi y) 			(Carry (Add32carry (Int64Lo x) (Int64Lo y)))) 		(Value32 (Add32carry (Int64Lo x) (Int64Lo y))))
	for {
		x := v.Args[0]
		y := v.Args[1]
		v.reset(OpInt64Make)
		...
		v2.AddArg(y)
		v0.AddArg(v2)
		v3 := b.NewValue0(v.Line, OpCarry, TypeFlags)
		v4 := b.NewValue0(v.Line, OpAdd32carry, TypeValAndFlags)
		...
		v0.AddArg(v3)
		v.AddArg(v0)
		v7 := b.NewValue0(v.Line, OpValue32, config.fe.TypeUInt32())
		v8 := b.NewValue0(v.Line, OpAdd32carry, TypeValAndFlags)
...
func rewriteValuedec64_OpSub64(v *Value, config *Config) bool {
	...
	// match: (Sub64 x y)
	// cond:
	// result: (Int64Make 		(Sub32withcarry <config.fe.TypeInt32()> 			(Int64Hi x) 			(Int64Hi y) 			(Carry (Sub32carry (Int64Lo x) (Int64Lo y)))) 		(Value32 (Sub32carry (Int64Lo x) (Int64Lo y))))
	for {
		x := v.Args[0]
		y := v.Args[1]
		v.reset(OpInt64Make)
		...
		v0.AddArg(v2)
		v3 := b.NewValue0(v.Line, OpCarry, TypeFlags)
		v4 := b.NewValue0(v.Line, OpSub32carry, TypeValAndFlags)
		v5 := b.NewValue0(v.Line, OpInt64Lo, config.fe.TypeUInt32())
		v5.AddArg(x)
		v4.AddArg(v5)
		v6 := b.NewValue0(v.Line, OpInt64Lo, config.fe.TypeUInt32())
		...
		v.AddArg(v0)
		v7 := b.NewValue0(v.Line, OpValue32, config.fe.TypeUInt32())
		v8 := b.NewValue0(v.Line, OpSub32carry, TypeValAndFlags)
		v9 := b.NewValue0(v.Line, OpInt64Lo, config.fe.TypeUInt32())
		v9.AddArg(x)
		v8.AddArg(v9)
		v10 := b.NewValue0(v.Line, OpInt64Lo, config.fe.TypeUInt32())
