...
func (DummyFrontend) Line(_ src.Lineno) string {
	return "unknown.go:0"
}
...
func (d DummyFrontend) Fatalf(_ src.Lineno, msg string, args ...interface{}) { d.t.Fatalf(msg, args...) }
func (d DummyFrontend) Warnl(_ src.Lineno, msg string, args ...interface{})  { d.t.Logf(msg, args...) }
