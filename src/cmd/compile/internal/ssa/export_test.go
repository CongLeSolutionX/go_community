...
func (DummyFrontend) Line(line Lineno) string {
	return "unknown.go:0"
}
...
func (d DummyFrontend) Fatalf(line Lineno, msg string, args ...interface{}) { d.t.Fatalf(msg, args...) }
func (d DummyFrontend) Warnl(line Lineno, msg string, args ...interface{})  { d.t.Logf(msg, args...) }
