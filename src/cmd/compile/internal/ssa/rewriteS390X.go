...
func rewriteValueS390X_OpMove_10(v *Value) bool {
	...
	for {
		...
		v.reset(OpS390XMVC)
		v.setAuxValAndOff(makeValAndOff(s, 0))
		v.AddArg(dst)
		v.AddArg(src)
		v.AddArg(mem)
		return true
	...
	for {
		...
		v.reset(OpS390XMVC)
		v.setAuxValAndOff(makeValAndOff(s-256, 256))
		v.AddArg(dst)
		v.AddArg(src)
		v0 := b.NewValue0(v.Pos, OpS390XMVC, types.TypeMem)
		v0.setAuxValAndOff(makeValAndOff(256, 0))
		v0.AddArg(dst)
		v0.AddArg(src)
		v0.AddArg(mem)
		v.AddArg(v0)
	...
	for {
		...
		v.reset(OpS390XMVC)
		v.setAuxValAndOff(makeValAndOff(s-512, 512))
		v.AddArg(dst)
		v.AddArg(src)
		v0 := b.NewValue0(v.Pos, OpS390XMVC, types.TypeMem)
		v0.setAuxValAndOff(makeValAndOff(256, 256))
		v0.AddArg(dst)
		v0.AddArg(src)
		v1 := b.NewValue0(v.Pos, OpS390XMVC, types.TypeMem)
		v1.setAuxValAndOff(makeValAndOff(256, 0))
		v1.AddArg(dst)
		v1.AddArg(src)
		v1.AddArg(mem)
		v0.AddArg(v1)
	...
	for {
		...
		v.reset(OpS390XMVC)
		v.setAuxValAndOff(makeValAndOff(s-768, 768))
		v.AddArg(dst)
		v.AddArg(src)
		v0 := b.NewValue0(v.Pos, OpS390XMVC, types.TypeMem)
		v0.setAuxValAndOff(makeValAndOff(256, 512))
		v0.AddArg(dst)
		v0.AddArg(src)
		v1 := b.NewValue0(v.Pos, OpS390XMVC, types.TypeMem)
		v1.setAuxValAndOff(makeValAndOff(256, 256))
		v1.AddArg(dst)
		v1.AddArg(src)
		v2 := b.NewValue0(v.Pos, OpS390XMVC, types.TypeMem)
		v2.setAuxValAndOff(makeValAndOff(256, 0))
		v2.AddArg(dst)
		v2.AddArg(src)
		v2.AddArg(mem)
		v1.AddArg(v2)
...
func rewriteValueS390X_OpS390XMOVBstore_0(v *Value) bool {
	...
	for {
		...
		v.setAuxValAndOff(makeValAndOff(int64(int8(c)), off))
		v.Aux = sym
		v.AddArg(ptr)
		v.AddArg(mem)
		return true
...
func rewriteValueS390X_OpS390XMOVBstoreconst_0(v *Value) bool {
	...
	for {
		...
		v.reset(OpS390XMOVBstoreconst)
		v.setAuxValAndOff(ValAndOff(sc).add(off))
		v.Aux = s
		v.AddArg(ptr)
		v.AddArg(mem)
		return true
	...
	for {
		...
		v.setAuxValAndOff(makeValAndOff(ValAndOff(c).Val()&0xff|ValAndOff(a).Val()<<8, ValAndOff(a).Off()))
		v.Aux = s
		v.AddArg(p)
		v.AddArg(mem)
		return true
...
func rewriteValueS390X_OpS390XMOVDstore_0(v *Value) bool {
	...
	for {
		...
		v.setAuxValAndOff(makeValAndOff(c, off))
		v.Aux = sym
		v.AddArg(ptr)
		v.AddArg(mem)
		return true
...
func rewriteValueS390X_OpS390XMOVHstore_0(v *Value) bool {
	...
	for {
		...
		v.reset(OpS390XMOVHstoreconst)
		v.setAuxValAndOff(makeValAndOff(int64(int16(c)), off))
		v.Aux = sym
		v.AddArg(ptr)
		v.AddArg(mem)
		return true
...
func rewriteValueS390X_OpS390XMOVHstoreconst_0(v *Value) bool {
	...
	for {
		...
		v.reset(OpS390XMOVWstore)
		v.setAuxInt64(ValAndOff(a).Off())
		v.Aux = s
		v.AddArg(p)
		v0 := b.NewValue0(v.Pos, OpS390XMOVDconst, typ.UInt64)
		v0.setAuxInt64(int64(int32(ValAndOff(c).Val()&0xffff | ValAndOff(a).Val()<<16)))
		v.AddArg(v0)
		v.AddArg(mem)
		return true
	}
...
func rewriteValueS390X_OpS390XMOVWstore_0(v *Value) bool {
	...
	for {
		...
		v.setAuxValAndOff(makeValAndOff(int64(int32(c)), off))
		v.Aux = sym
		v.AddArg(ptr)
		v.AddArg(mem)
		return true
...
func rewriteValueS390X_OpS390XMOVWstoreconst_0(v *Value) bool {
	...
	for {
		...
		v.AddArg(p)
		v0 := b.NewValue0(v.Pos, OpS390XMOVDconst, typ.UInt64)
		v0.setAuxInt64(ValAndOff(c).Val()&0xffffffff | ValAndOff(a).Val()<<32)
		v.AddArg(v0)
		v.AddArg(mem)
		return true
	}
...
func rewriteValueS390X_OpS390XSRAWconst_0(v *Value) bool {
	...
	for {
		...
		d := v_0.auxInt64()
		v.reset(OpS390XMOVDconst)
		v.setAuxInt64(int64(int32(d)) >> uint64(c))
		return true
	}
	return false
}
...
func rewriteValueS390X_OpZero_0(v *Value) bool {
	...
	for {
		...
		mem := v.Args[1]
		v.reset(OpS390XMOVBstoreconst)
		v.setAuxValAndOff(makeValAndOff(0, 4))
		v.AddArg(destptr)
	...
	for {
		...
		mem := v.Args[1]
		v.reset(OpS390XMOVWstoreconst)
		v.setAuxValAndOff(makeValAndOff(0, 3))
		v.AddArg(destptr)
		v0 := b.NewValue0(v.Pos, OpS390XMOVWstoreconst, types.TypeMem)
		v0.setAuxValAndOff(0)
		v0.AddArg(destptr)
