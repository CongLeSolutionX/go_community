...
func rewriteBlockS390X(b *Block) bool {
	...
	case BlockS390XBRC:
		...
		// result: (CGRJ {c.(s390x.CCMask)&s390x.NotUnordered} x y yes no)
		for b.Controls[0].Op == OpS390XCMP {
			v_0 := b.Controls[0]
			y := v_0.Args[1]
			x := v_0.Args[0]
			c := b.Aux
			b.Kind = BlockS390XCGRJ
			b.ResetControls()
			b.AddControl(x)
			b.AddControl(y)
			b.AuxInt = 0
			b.Aux = c.(s390x.CCMask) & s390x.NotUnordered
			return true
		}
		// match: (BRC {c} (CMPW x y) yes no)
		// result: (CRJ {c.(s390x.CCMask)&s390x.NotUnordered} x y yes no)
		for b.Controls[0].Op == OpS390XCMPW {
			v_0 := b.Controls[0]
			y := v_0.Args[1]
			x := v_0.Args[0]
			c := b.Aux
			b.Kind = BlockS390XCRJ
			b.ResetControls()
			b.AddControl(x)
			b.AddControl(y)
			b.AuxInt = 0
		...
		// result: (CLGRJ {c.(s390x.CCMask)&s390x.NotUnordered} x y yes no)
		for b.Controls[0].Op == OpS390XCMPU {
			v_0 := b.Controls[0]
			y := v_0.Args[1]
			x := v_0.Args[0]
			c := b.Aux
			b.Kind = BlockS390XCLGRJ
			b.ResetControls()
			b.AddControl(x)
			b.AddControl(y)
			b.AuxInt = 0
		...
		// result: (CLRJ {c.(s390x.CCMask)&s390x.NotUnordered} x y yes no)
		for b.Controls[0].Op == OpS390XCMPWU {
			v_0 := b.Controls[0]
			y := v_0.Args[1]
			x := v_0.Args[0]
			c := b.Aux
			b.Kind = BlockS390XCLRJ
			b.ResetControls()
			b.AddControl(x)
			b.AddControl(y)
			b.AuxInt = 0
		...
		// cond: is8Bit(y)
		// result: (CGIJ {c.(s390x.CCMask)&s390x.NotUnordered} x [int64(int8(y))] yes no)
		...
		// cond: is8Bit(y)
		// result: (CIJ {c.(s390x.CCMask)&s390x.NotUnordered} x [int64(int8(y))] yes no)
		...
		// cond: isU8Bit(y)
		// result: (CLGIJ {c.(s390x.CCMask)&s390x.NotUnordered} x [int64(int8(y))] yes no)
		...
		// cond: isU8Bit(y)
		// result: (CLIJ {c.(s390x.CCMask)&s390x.NotUnordered} x [int64(int8(y))] yes no)
