...
func rewriteValueS390X_OpMove(v *Value) bool {
	...
	for {
		...
		v.reset(OpS390XMVC)
		v.AuxInt = int64(makeValAndOff(int32(s), 0))
	...
	for {
		...
		v.reset(OpS390XMVC)
		v.AuxInt = int64(makeValAndOff(int32(s)-256, 256))
		v0 := b.NewValue0(v.Pos, OpS390XMVC, types.TypeMem)
		v0.AuxInt = int64(makeValAndOff(256, 0))
	...
	for {
		...
		v.reset(OpS390XMVC)
		v.AuxInt = int64(makeValAndOff(int32(s)-512, 512))
		v0 := b.NewValue0(v.Pos, OpS390XMVC, types.TypeMem)
		v0.AuxInt = int64(makeValAndOff(256, 256))
		v1 := b.NewValue0(v.Pos, OpS390XMVC, types.TypeMem)
		v1.AuxInt = int64(makeValAndOff(256, 0))
	...
	for {
		...
		v.reset(OpS390XMVC)
		v.AuxInt = int64(makeValAndOff(int32(s)-768, 768))
		v0 := b.NewValue0(v.Pos, OpS390XMVC, types.TypeMem)
		v0.AuxInt = int64(makeValAndOff(256, 512))
		v1 := b.NewValue0(v.Pos, OpS390XMVC, types.TypeMem)
		v1.AuxInt = int64(makeValAndOff(256, 256))
		v2 := b.NewValue0(v.Pos, OpS390XMVC, types.TypeMem)
		v2.AuxInt = int64(makeValAndOff(256, 0))
...
func rewriteValueS390X_OpS390XADDE(v *Value) bool {
	...
	for {
		...
		v_2_0 := v_2.Args[0]
		if v_2_0.Op != OpS390XADDCconst || int16(v_2_0.AuxInt) != -1 {
			break
		}
...
func rewriteValueS390X_OpS390XADDload(v *Value) bool {
	...
	for {
		...
		x := v_0
		ptr1 := v_1
		if v_2.Op != OpS390XFMOVDstore || int32(v_2.AuxInt) != off || auxToSym(v_2.Aux) != sym {
			break
		}
		y := v_2.Args[1]
		ptr2 := v_2.Args[0]
...
func rewriteValueS390X_OpS390XAND(v *Value) bool {
	...
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			...
			v.Aux = *s390x.NewRotateParams(0, 63, 0).OutMerge(uint64(c))
			v.AddArg(x)
			return true
		}
		break
...
func rewriteValueS390X_OpS390XFMOVDload(v *Value) bool {
	...
	for {
		...
		sym := auxToSym(v.Aux)
		ptr1 := v_0
		if v_1.Op != OpS390XMOVDstore || int32(v_1.AuxInt) != off || auxToSym(v_1.Aux) != sym {
			break
		}
		x := v_1.Args[1]
		ptr2 := v_1.Args[0]
	...
	for {
		...
		sym := auxToSym(v.Aux)
		ptr1 := v_0
		if v_1.Op != OpS390XFMOVDstore || int32(v_1.AuxInt) != off || auxToSym(v_1.Aux) != sym {
			break
		}
		x := v_1.Args[1]
		ptr2 := v_1.Args[0]
...
func rewriteValueS390X_OpS390XFMOVSload(v *Value) bool {
	...
	for {
		...
		sym := auxToSym(v.Aux)
		ptr1 := v_0
		if v_1.Op != OpS390XFMOVSstore || int32(v_1.AuxInt) != off || auxToSym(v_1.Aux) != sym {
			break
		}
		x := v_1.Args[1]
		ptr2 := v_1.Args[0]
...
func rewriteValueS390X_OpS390XMOVBZload(v *Value) bool {
	...
	for {
		...
		sym := auxToSym(v.Aux)
		ptr1 := v_0
		if v_1.Op != OpS390XMOVBstore || int32(v_1.AuxInt) != off || auxToSym(v_1.Aux) != sym {
			break
		}
		x := v_1.Args[1]
		ptr2 := v_1.Args[0]
...
func rewriteValueS390X_OpS390XMOVBstoreconst(v *Value) bool {
	...
	for {
		...
		v.reset(OpS390XMOVBstoreconst)
		v.AuxInt = int64(sc.addOffset32(off))
		v.Aux = s
		v.AddArg2(ptr, mem)
		return true
	}
...
func rewriteValueS390X_OpS390XMOVDstore(v *Value) bool {
	...
	for {
		...
		w1 := v_1
		x := v_2
		if x.Op != OpS390XMOVDstore || int32(x.AuxInt) != i-8 || auxToSym(x.Aux) != s {
			break
		}
		mem := x.Args[2]
		if p != x.Args[0] {
	...
	for {
		...
		w2 := v_1
		x := v_2
		if x.Op != OpS390XSTMG2 || int32(x.AuxInt) != i-16 || auxToSym(x.Aux) != s {
			break
		}
		mem := x.Args[3]
		if p != x.Args[0] {
	...
	for {
		...
		w3 := v_1
		x := v_2
		if x.Op != OpS390XSTMG3 || int32(x.AuxInt) != i-24 || auxToSym(x.Aux) != s {
			break
		}
		mem := x.Args[4]
		if p != x.Args[0] {
...
func rewriteValueS390X_OpS390XMOVHZload(v *Value) bool {
	...
	for {
		...
		sym := auxToSym(v.Aux)
		ptr1 := v_0
		if v_1.Op != OpS390XMOVHstore || int32(v_1.AuxInt) != off || auxToSym(v_1.Aux) != sym {
			break
		}
		x := v_1.Args[1]
		ptr2 := v_1.Args[0]
...
func rewriteValueS390X_OpS390XMOVHZreg(v *Value) bool {
	...
	for {
		...
		v.reset(OpS390XMOVWZreg)
		v0 := b.NewValue0(v.Pos, OpS390XANDWconst, typ.UInt32)
		v0.AuxInt = int64(int32(uint16(m)))
		v0.AddArg(x)
		v.AddArg(v0)
		return true
	}
...
func rewriteValueS390X_OpS390XMOVWZload(v *Value) bool {
	...
	for {
		...
		sym := auxToSym(v.Aux)
		ptr1 := v_0
		if v_1.Op != OpS390XMOVWstore || int32(v_1.AuxInt) != off || auxToSym(v_1.Aux) != sym {
			break
		}
		x := v_1.Args[1]
		ptr2 := v_1.Args[0]
...
func rewriteValueS390X_OpS390XMOVWstore(v *Value) bool {
	...
	for {
		...
		w1 := v_1
		x := v_2
		if x.Op != OpS390XMOVWstore || int32(x.AuxInt) != i-4 || auxToSym(x.Aux) != s {
			break
		}
		mem := x.Args[2]
		if p != x.Args[0] {
	...
	for {
		...
		w2 := v_1
		x := v_2
		if x.Op != OpS390XSTM2 || int32(x.AuxInt) != i-8 || auxToSym(x.Aux) != s {
			break
		}
		mem := x.Args[3]
		if p != x.Args[0] {
	...
	for {
		...
		w3 := v_1
		x := v_2
		if x.Op != OpS390XSTM3 || int32(x.AuxInt) != i-12 || auxToSym(x.Aux) != s {
			break
		}
		mem := x.Args[4]
		if p != x.Args[0] {
...
func rewriteValueS390X_OpS390XRISBGZ(v *Value) bool {
	...
	for {
		...
		v.reset(OpS390XRISBGZ)
		v.Aux = (*r.InMerge(^uint64(0) << c)).RotateLeft(c)
		v.AddArg(x)
		return true
	}
	...
	for {
		...
		v.reset(OpS390XRISBGZ)
		v.Aux = (*z.InMerge(y.OutMask())).RotateLeft(y.Amount)
		v.AddArg(x)
		return true
	}
	// match: (RISBGZ x {r})
	...
	for {
		...
		v.reset(OpS390XRISBGZ)
		v.Aux = s390x.NewRotateParams(r.Start, r.Start, -r.Start&63)
		v.AddArg(x)
		return true
	}
	// match: (RISBGZ x {r})
...
func rewriteValueS390X_OpS390XRLLG(v *Value) bool {
	...
	for {
		...
		c := v_1.AuxInt
		v.reset(OpS390XRISBGZ)
		v.Aux = s390x.NewRotateParams(0, 63, uint8(c&63))
		v.AddArg(x)
		return true
	}
	return false
...
func rewriteValueS390X_OpS390XSLDconst(v *Value) bool {
	...
	for {
		...
		x := v_0.Args[0]
		v.reset(OpS390XRISBGZ)
		v.Aux = s390x.NewRotateParams(uint8(max8(0, int8(c-d))), 63-d, uint8(int8(d-c)&63))
		v.AddArg(x)
		return true
	}
	...
	for {
		...
		v.reset(OpS390XRISBGZ)
		v.Aux = (*s390x.NewRotateParams(0, 63-c, c).InMerge(r.OutMask())).RotateLeft(r.Amount)
		v.AddArg(x)
		return true
	}
	// match: (SLDconst x [0])
...
func rewriteValueS390X_OpS390XSRDconst(v *Value) bool {
	...
	for {
		...
		x := v_0.Args[0]
		v.reset(OpS390XRISBGZ)
		v.Aux = s390x.NewRotateParams(d, uint8(min8(63, int8(63-c+d))), uint8(int8(c-d)&63))
		v.AddArg(x)
		return true
	}
	...
	for {
		...
		v.reset(OpS390XRISBGZ)
		v.Aux = (*s390x.NewRotateParams(c, 63, -c&63).InMerge(r.OutMask())).RotateLeft(r.Amount)
		v.AddArg(x)
		return true
	}
	// match: (SRDconst x [0])
...
func rewriteValueS390X_OpS390XSTM2(v *Value) bool {
	...
	for {
		...
		s := auxToSym(v.Aux)
		p := v_0
		if v_1.Op != OpS390XSRDconst || uint8(v_1.AuxInt) != 32 {
			break
		}
		x := v_1.Args[0]
		if x != v_2 {
...
func rewriteValueS390X_OpZero(v *Value) bool {
	...
	for {
		...
		v0.AuxInt = int64((int32(s) / 256) * 256)
		v0.AddArg(destptr)
...
func rewriteBlockS390X(b *Block) bool {
	...
	case BlockS390XCGIJ:
		...
		for b.Controls[0].Op == OpSelect0 {
			...
			if v_0_0_1.Op != OpS390XMOVDconst || v_0_0_1.AuxInt != 0 || b.AuxInt != 0 || auxToS390xCCMask(b.Aux) != s390x.Equal {
				break
			}
		...
		for b.Controls[0].Op == OpSelect0 {
			...
			v_0_0_1 := v_0_0.Args[1]
			if v_0_0_1.Op != OpS390XMOVDconst || v_0_0_1.AuxInt != 0 || int8(b.AuxInt) != 1 || auxToS390xCCMask(b.Aux) != s390x.Equal {
				break
			}
			b.resetWithControl(BlockS390XBRC, carry)
			b.Aux = s390x.Carry
		...
		for b.Controls[0].Op == OpSelect0 {
			...
			v_0_0_1 := v_0_0.Args[1]
			if v_0_0_1.Op != OpS390XMOVDconst || v_0_0_1.AuxInt != 0 || b.AuxInt != 0 || auxToS390xCCMask(b.Aux) != s390x.LessOrGreater {
				break
			}
			b.resetWithControl(BlockS390XBRC, carry)
			b.Aux = s390x.Carry
		...
		for b.Controls[0].Op == OpSelect0 {
			...
			v_0_0_1 := v_0_0.Args[1]
			if v_0_0_1.Op != OpS390XMOVDconst || v_0_0_1.AuxInt != 0 || int8(b.AuxInt) != 1 || auxToS390xCCMask(b.Aux) != s390x.LessOrGreater {
				break
			}
			b.resetWithControl(BlockS390XBRC, carry)
			b.Aux = s390x.NoCarry
		...
		for b.Controls[0].Op == OpSelect0 {
			...
			v_0_0_1 := v_0_0.Args[1]
			if v_0_0_1.Op != OpS390XMOVDconst || v_0_0_1.AuxInt != 0 || b.AuxInt != 0 || auxToS390xCCMask(b.Aux) != s390x.Greater {
				break
			}
			b.resetWithControl(BlockS390XBRC, carry)
			b.Aux = s390x.Carry
		...
		for b.Controls[0].Op == OpS390XNEG {
			...
			if v_0_0_0_0.Op != OpS390XMOVDconst || v_0_0_0_0.AuxInt != 0 {
				break
			}
			v_0_0_0_1 := v_0_0_0.Args[1]
			if v_0_0_0_1.Op != OpS390XMOVDconst || v_0_0_0_1.AuxInt != 0 || b.AuxInt != 0 || auxToS390xCCMask(b.Aux) != s390x.Equal {
				break
			}
			b.resetWithControl(BlockS390XBRC, borrow)
			b.Aux = s390x.NoBorrow
			return true
		}
		...
		for b.Controls[0].Op == OpS390XNEG {
			...
			v_0_0_0_1 := v_0_0_0.Args[1]
			if v_0_0_0_1.Op != OpS390XMOVDconst || v_0_0_0_1.AuxInt != 0 || int8(b.AuxInt) != 1 || auxToS390xCCMask(b.Aux) != s390x.Equal {
				break
			}
			b.resetWithControl(BlockS390XBRC, borrow)
			b.Aux = s390x.Borrow
		...
		for b.Controls[0].Op == OpS390XNEG {
			...
			v_0_0_0_1 := v_0_0_0.Args[1]
			if v_0_0_0_1.Op != OpS390XMOVDconst || v_0_0_0_1.AuxInt != 0 || b.AuxInt != 0 || auxToS390xCCMask(b.Aux) != s390x.LessOrGreater {
				break
			}
			b.resetWithControl(BlockS390XBRC, borrow)
			b.Aux = s390x.Borrow
		...
		for b.Controls[0].Op == OpS390XNEG {
			...
			v_0_0_0_1 := v_0_0_0.Args[1]
			if v_0_0_0_1.Op != OpS390XMOVDconst || v_0_0_0_1.AuxInt != 0 || int8(b.AuxInt) != 1 || auxToS390xCCMask(b.Aux) != s390x.LessOrGreater {
				break
			}
			b.resetWithControl(BlockS390XBRC, borrow)
			b.Aux = s390x.NoBorrow
		...
		for b.Controls[0].Op == OpS390XNEG {
			...
			v_0_0_0_1 := v_0_0_0.Args[1]
			if v_0_0_0_1.Op != OpS390XMOVDconst || v_0_0_0_1.AuxInt != 0 || b.AuxInt != 0 || auxToS390xCCMask(b.Aux) != s390x.Greater {
				break
			}
			b.resetWithControl(BlockS390XBRC, borrow)
			b.Aux = s390x.Borrow
	...
	case BlockS390XCLGIJ:
		...
		// result: (First yes no)
		for {
			if b.AuxInt != 0 || auxToS390xCCMask(b.Aux) != s390x.GreaterOrEqual {
				break
			}
			b.Reset(BlockFirst)
			return true
		...
		// result: (First no yes)
		for {
			if b.AuxInt != 0 || auxToS390xCCMask(b.Aux) != s390x.Less {
				break
			}
			b.Reset(BlockFirst)
			b.swapSuccessors()
		...
		for b.Controls[0].Op == OpSelect0 {
			...
			v_0_0_1 := v_0_0.Args[1]
			if v_0_0_1.Op != OpS390XMOVDconst || v_0_0_1.AuxInt != 0 || uint8(b.AuxInt) != 1 || auxToS390xCCMask(b.Aux) != s390x.Equal {
				break
			}
			b.resetWithControl(BlockS390XBRC, carry)
			b.Aux = s390x.Carry
		...
		for b.Controls[0].Op == OpSelect0 {
			...
			v_0_0_1 := v_0_0.Args[1]
			if v_0_0_1.Op != OpS390XMOVDconst || v_0_0_1.AuxInt != 0 || uint8(b.AuxInt) != 1 || auxToS390xCCMask(b.Aux) != s390x.LessOrGreater {
				break
			}
			b.resetWithControl(BlockS390XBRC, carry)
			b.Aux = s390x.NoCarry
		...
		for b.Controls[0].Op == OpS390XNEG {
			...
			v_0_0_0_1 := v_0_0_0.Args[1]
			if v_0_0_0_1.Op != OpS390XMOVDconst || v_0_0_0_1.AuxInt != 0 || uint8(b.AuxInt) != 1 || auxToS390xCCMask(b.Aux) != s390x.Equal {
				break
			}
			b.resetWithControl(BlockS390XBRC, borrow)
			b.Aux = s390x.Borrow
		...
		for b.Controls[0].Op == OpS390XNEG {
			...
			v_0_0_0_1 := v_0_0_0.Args[1]
			if v_0_0_0_1.Op != OpS390XMOVDconst || v_0_0_0_1.AuxInt != 0 || uint8(b.AuxInt) != 1 || auxToS390xCCMask(b.Aux) != s390x.LessOrGreater {
				break
			}
			b.resetWithControl(BlockS390XBRC, borrow)
			b.Aux = s390x.NoBorrow
	...
	case BlockS390XCLIJ:
		...
		for b.Controls[0].Op == OpS390XLOCGR {
			...
			x := v_0_1.AuxInt
			if b.AuxInt != 0 || auxToS390xCCMask(b.Aux) != s390x.LessOrGreater || !(int32(x) != 0) {
				break
			}
			b.resetWithControl(BlockS390XBRC, cmp)
			b.Aux = d
