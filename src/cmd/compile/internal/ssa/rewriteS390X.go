...
func rewriteValueS390X(v *Value) bool {
	...
	case OpS390XLOCGHI:
		return rewriteValueS390X_OpS390XLOCGHI_0(v) || rewriteValueS390X_OpS390XLOCGHI_10(v) || rewriteValueS390X_OpS390XLOCGHI_20(v) || rewriteValueS390X_OpS390XLOCGHI_30(v)
	case OpS390XLOCGR:
...
func rewriteValueS390X_OpS390XLOCGHI_0(v *Value) bool {
	...
	// match: (LOCGHI {c} [y] x cmp:(CMP _ _))
	// cond: c.(s390x.CCMask)&s390x.Unordered != 0
	// result: (LOCGHI {c.(s390x.CCMask)&^s390x.Unordered} [y] x cmp)
	for {
		y := v.AuxInt
		c := v.Aux
		_ = v.Args[1]
	...
	// match: (LOCGHI {c} [y] x cmp:(CMPU _ _))
	// cond: c.(s390x.CCMask)&s390x.Unordered != 0
	// result: (LOCGHI {c.(s390x.CCMask)&^s390x.Unordered} [y] x cmp)
	for {
		y := v.AuxInt
	...
	// match: (LOCGHI {c} [y] x cmp:(CMPW _ _))
	// cond: c.(s390x.CCMask)&s390x.Unordered != 0
	// result: (LOCGHI {c.(s390x.CCMask)&^s390x.Unordered} [y] x cmp)
	for {
		y := v.AuxInt
	...
	// match: (LOCGHI {c} [y] x cmp:(CMPWU _ _))
	// cond: c.(s390x.CCMask)&s390x.Unordered != 0
	// result: (LOCGHI {c.(s390x.CCMask)&^s390x.Unordered} [y] x cmp)
	for {
		y := v.AuxInt
	...
	// match: (LOCGHI {c} [y] x cmp:(CMPconst _))
	// cond: c.(s390x.CCMask)&s390x.Unordered != 0
	// result: (LOCGHI {c.(s390x.CCMask)&^s390x.Unordered} [y] x cmp)
	for {
		y := v.AuxInt
	...
	// match: (LOCGHI {c} [y] x cmp:(CMPUconst _))
	// cond: c.(s390x.CCMask)&s390x.Unordered != 0
	// result: (LOCGHI {c.(s390x.CCMask)&^s390x.Unordered} [y] x cmp)
	for {
		y := v.AuxInt
...
func rewriteValueS390X_OpS390XLOCGHI_10(v *Value) bool {
	// match: (LOCGHI {c} [y] x cmp:(CMPWconst _))
	// cond: c.(s390x.CCMask)&s390x.Unordered != 0
	// result: (LOCGHI {c.(s390x.CCMask)&^s390x.Unordered} [y] x cmp)
	for {
		y := v.AuxInt
	...
	// match: (LOCGHI {c} [y] x cmp:(CMPWUconst _))
	// cond: c.(s390x.CCMask)&s390x.Unordered != 0
	// result: (LOCGHI {c.(s390x.CCMask)&^s390x.Unordered} [y] x cmp)
	for {
		y := v.AuxInt
	...
	// match: (LOCGHI {c} [y] x cmp:(CMPUconst _ [0]))
	// cond: c.(s390x.CCMask)&s390x.Less != 0
	// result: (LOCGHI {c.(s390x.CCMask)&^s390x.Less} [y] x cmp)
	for {
		y := v.AuxInt
		c := v.Aux
		_ = v.Args[1]
	...
	// match: (LOCGHI {c} [y] x cmp:(CMPWUconst _ [0]))
	// cond: c.(s390x.CCMask)&s390x.Less != 0
	// result: (LOCGHI {c.(s390x.CCMask)&^s390x.Less} [y] x cmp)
	for {
		y := v.AuxInt
	...
	// match: (LOCGHI {s390x.Greater} [y] x (CMPWUconst (LOCGHI {d} [z] (MOVDconst [0]) cmp) [0]))
	// cond: uint32(z) != 0
	// result: (LOCGHI {d} [y] x cmp)
	for {
		y := v.AuxInt
		...
		x := v.Args[0]
		v_1 := v.Args[1]
		if v_1.Op != OpS390XCMPWUconst || v_1.AuxInt != 0 {
			break
		}
		v_1_0 := v_1.Args[0]
		if v_1_0.Op != OpS390XLOCGHI {
			break
		}
		z := v_1_0.AuxInt
		d := v_1_0.Aux
		...
		if v_1_0_0.Op != OpS390XMOVDconst || v_1_0_0.AuxInt != 0 || !(uint32(z) != 0) {
			break
		}
		v.reset(OpS390XLOCGHI)
		v.AuxInt = y
	...
	// match: (LOCGHI {s390x.Equal} [y] x (CMPWUconst (LOCGHI {d} [z] (MOVDconst [0]) cmp) [0]))
	// cond: uint32(z) != 0
	// result: (LOCGHI {d.(s390x.CCMask).Inverse()} [y] x cmp)
	for {
		y := v.AuxInt
		if v.Aux != s390x.Equal {
			break
	...
	// match: (LOCGHI {s390x.Greater} [y] x (CMPWUconst (LOCGHI {d} [0] (MOVDconst [z]) cmp) [0]))
	// cond: uint32(z) != 0
	// result: (LOCGHI {d.(s390x.CCMask).Inverse()} [y] x cmp)
	for {
		y := v.AuxInt
		...
		v_1_0 := v_1.Args[0]
		if v_1_0.Op != OpS390XLOCGHI || v_1_0.AuxInt != 0 {
			break
		}
		d := v_1_0.Aux
		cmp := v_1_0.Args[1]
		v_1_0_0 := v_1_0.Args[0]
		if v_1_0_0.Op != OpS390XMOVDconst {
			break
		}
		z := v_1_0_0.AuxInt
		if !(uint32(z) != 0) {
	...
	// match: (LOCGHI {s390x.Equal} [y] x (CMPWUconst (LOCGHI {d} [0] (MOVDconst [z]) cmp) [0]))
	// cond: uint32(z) != 0
	// result: (LOCGHI {d} [y] x cmp)
	for {
		y := v.AuxInt
	...
	// match: (LOCGHI {s390x.Greater} [y] x (CMPUconst (LOCGHI {d} [z] (MOVDconst [0]) cmp) [0]))
	// cond: uint64(z) != 0
	// result: (LOCGHI {d} [y] x cmp)
	for {
		y := v.AuxInt
		...
		x := v.Args[0]
		v_1 := v.Args[1]
		if v_1.Op != OpS390XCMPUconst || v_1.AuxInt != 0 {
			break
		}
		v_1_0 := v_1.Args[0]
		if v_1_0.Op != OpS390XLOCGHI {
		...
		cmp := v_1_0.Args[1]
		v_1_0_0 := v_1_0.Args[0]
		if v_1_0_0.Op != OpS390XMOVDconst || v_1_0_0.AuxInt != 0 || !(uint64(z) != 0) {
			break
		}
		v.reset(OpS390XLOCGHI)
		v.AuxInt = y
	...
	// match: (LOCGHI {s390x.Equal} [y] x (CMPUconst (LOCGHI {d} [z] (MOVDconst [0]) cmp) [0]))
	// cond: uint64(z) != 0
	// result: (LOCGHI {d.(s390x.CCMask).Inverse()} [y] x cmp)
	for {
		y := v.AuxInt
...
func rewriteValueS390X_OpS390XLOCGHI_20(v *Value) bool {
	// match: (LOCGHI {s390x.Greater} [y] x (CMPUconst (LOCGHI {d} [0] (MOVDconst [z]) cmp) [0]))
	// cond: uint64(z) != 0
	// result: (LOCGHI {d.(s390x.CCMask).Inverse()} [y] x cmp)
	for {
		y := v.AuxInt
	...
	// match: (LOCGHI {s390x.Equal} [y] x (CMPUconst (LOCGHI {d} [0] (MOVDconst [z]) cmp) [0]))
	// cond: uint64(z) != 0
	// result: (LOCGHI {d} [y] x cmp)
	for {
		y := v.AuxInt
	...
	// match: (LOCGHI {s390x.LessOrGreater} [y] x (CMPWconst (LOCGHI {d} [z] (MOVDconst [0]) cmp) [0]))
	// cond: int32(z) != 0
	// result: (LOCGHI {d} [y] x cmp)
	for {
		y := v.AuxInt
		...
		x := v.Args[0]
		v_1 := v.Args[1]
		if v_1.Op != OpS390XCMPWconst || v_1.AuxInt != 0 {
			break
		}
		v_1_0 := v_1.Args[0]
		if v_1_0.Op != OpS390XLOCGHI {
		...
		cmp := v_1_0.Args[1]
		v_1_0_0 := v_1_0.Args[0]
		if v_1_0_0.Op != OpS390XMOVDconst || v_1_0_0.AuxInt != 0 || !(int32(z) != 0) {
			break
		}
		v.reset(OpS390XLOCGHI)
		v.AuxInt = y
	...
	// match: (LOCGHI {s390x.Equal} [y] x (CMPWconst (LOCGHI {d} [z] (MOVDconst [0]) cmp) [0]))
	// cond: int32(z) != 0
	// result: (LOCGHI {d.(s390x.CCMask).Inverse()} [y] x cmp)
	for {
		y := v.AuxInt
	...
	// match: (LOCGHI {s390x.LessOrGreater} [y] x (CMPWconst (LOCGHI {d} [0] (MOVDconst [z]) cmp) [0]))
	// cond: int32(z) != 0
	// result: (LOCGHI {d.(s390x.CCMask).Inverse()} [y] x cmp)
	for {
		y := v.AuxInt
	...
	// match: (LOCGHI {s390x.Equal} [y] x (CMPWconst (LOCGHI {d} [0] (MOVDconst [z]) cmp) [0]))
	// cond: int32(z) != 0
	// result: (LOCGHI {d} [y] x cmp)
	for {
		y := v.AuxInt
	...
	// match: (LOCGHI {s390x.LessOrGreater} [y] x (CMPconst (LOCGHI {d} [z] (MOVDconst [0]) cmp) [0]))
	// cond: int64(z) != 0
	// result: (LOCGHI {d} [y] x cmp)
	for {
		y := v.AuxInt
		...
		x := v.Args[0]
		v_1 := v.Args[1]
		if v_1.Op != OpS390XCMPconst || v_1.AuxInt != 0 {
			break
		}
		v_1_0 := v_1.Args[0]
		if v_1_0.Op != OpS390XLOCGHI {
		...
		cmp := v_1_0.Args[1]
		v_1_0_0 := v_1_0.Args[0]
		if v_1_0_0.Op != OpS390XMOVDconst || v_1_0_0.AuxInt != 0 || !(int64(z) != 0) {
			break
		}
		v.reset(OpS390XLOCGHI)
		v.AuxInt = y
	...
	// match: (LOCGHI {s390x.Equal} [y] x (CMPconst (LOCGHI {d} [z] (MOVDconst [0]) cmp) [0]))
	// cond: int64(z) != 0
	// result: (LOCGHI {d.(s390x.CCMask).Inverse()} [y] x cmp)
	for {
		y := v.AuxInt
	...
	// match: (LOCGHI {s390x.LessOrGreater} [y] x (CMPconst (LOCGHI {d} [0] (MOVDconst [z]) cmp) [0]))
	// cond: int64(z) != 0
	// result: (LOCGHI {d.(s390x.CCMask).Inverse()} [y] x cmp)
	for {
		y := v.AuxInt
	...
	// match: (LOCGHI {s390x.Equal} [y] x (CMPconst (LOCGHI {d} [0] (MOVDconst [z]) cmp) [0]))
	// cond: int64(z) != 0
	// result: (LOCGHI {d} [y] x cmp)
	for {
		y := v.AuxInt
...
func rewriteValueS390X_OpS390XLOCGHI_30(v *Value) bool {
...
func rewriteValueS390X_OpS390XMOVBZreg_10(v *Value) bool {
	...
	// match: (MOVBZreg x:(LOCGHI [d] (MOVDconst [c]) _))
	// cond: int64(uint8(c)) == c && int64(uint8(d)) == d && (!x.Type.IsSigned() || x.Type.Size() > 1)
	// result: x
	for {
		x := v.Args[0]
		if x.Op != OpS390XLOCGHI {
			break
		}
		d := x.AuxInt
		_ = x.Args[1]
...
func rewriteBlockS390X(b *Block) bool {
	...
	case BlockS390XCLIJ:
		...
		// match: (CLIJ {s390x.LessOrGreater} (LOCGHI {d} [x] (MOVDconst [0]) cmp) [0] yes no)
		// cond: int32(x) != 0
		// result: (BRC {d} cmp yes no)
		for b.Controls[0].Op == OpS390XLOCGHI {
			v_0 := b.Controls[0]
			x := v_0.AuxInt
			d := v_0.Aux
			cmp := v_0.Args[1]
			v_0_0 := v_0.Args[0]
			if v_0_0.Op != OpS390XMOVDconst || v_0_0.AuxInt != 0 || b.AuxInt != 0 || b.Aux != s390x.LessOrGreater || !(int32(x) != 0) {
				break
			}
			b.Reset(BlockS390XBRC)
			b.AddControl(cmp)
