...
func rewriteValueWasm_OpRotateLeft16_0(v *Value) bool {
	...
	// cond:
	// result: (Or16 (Lsh16x64 <t> x (I64Const [c])) (Rsh16Ux64 <t> x (I64Const [16-c])))
	for {
		t := v.Type
		_ = v.Args[1]
		x := v.Args[0]
...
func rewriteValueWasm_OpRotateLeft32_0(v *Value) bool {
	...
	// cond:
	// result: (Or32 (Lsh32x64 <t> x (I64Const [c])) (Rsh32Ux64 <t> x (I64Const [32-c])))
	for {
		t := v.Type
		_ = v.Args[1]
		x := v.Args[0]
...
func rewriteValueWasm_OpRotateLeft8_0(v *Value) bool {
	...
	// cond:
	// result: (Or8 (Lsh8x64 <t> x (I64Const [c])) (Rsh8Ux64 <t> x (I64Const [8-c])))
	for {
		t := v.Type
		_ = v.Args[1]
		x := v.Args[0]
