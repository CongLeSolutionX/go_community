...
func rewriteValueWasm_OpAdd32F_0(v *Value) bool {
	...
	// match: (Add32F x y)
	// cond:
	// result: (LoweredRound32F (F64Add x y))
	for {
		_ = v.Args[1]
		x := v.Args[0]
		y := v.Args[1]
		v.reset(OpWasmLoweredRound32F)
		v0 := b.NewValue0(v.Pos, OpWasmF64Add, typ.Float64)
		v0.AddArg(x)
		v0.AddArg(y)
		v.AddArg(v0)
		return true
...
func rewriteValueWasm_OpDiv32F_0(v *Value) bool {
	...
	// match: (Div32F x y)
	// cond:
	// result: (LoweredRound32F (F64Div x y))
	for {
		_ = v.Args[1]
		x := v.Args[0]
		y := v.Args[1]
		v.reset(OpWasmLoweredRound32F)
		v0 := b.NewValue0(v.Pos, OpWasmF64Div, typ.Float64)
		v0.AddArg(x)
		v0.AddArg(y)
		v.AddArg(v0)
		return true
...
func rewriteValueWasm_OpLsh64x64_0(v *Value) bool {
	...
	// match: (Lsh64x64 x y)
	// cond:
	// result: (Select <typ.UInt64> (I64Shl x y) (I64Const [0]) (I64LtU y (I64Const [64])))
	for {
		_ = v.Args[1]
		x := v.Args[0]
		y := v.Args[1]
...
func rewriteValueWasm_OpMul32F_0(v *Value) bool {
	...
	// match: (Mul32F x y)
	// cond:
	// result: (LoweredRound32F (F64Mul x y))
	for {
		_ = v.Args[1]
		x := v.Args[0]
		y := v.Args[1]
		v.reset(OpWasmLoweredRound32F)
		v0 := b.NewValue0(v.Pos, OpWasmF64Mul, typ.Float64)
		v0.AddArg(x)
		v0.AddArg(y)
		v.AddArg(v0)
		return true
...
func rewriteValueWasm_OpRsh16x16_0(v *Value) bool {
	...
	// match: (Rsh16x16 x y)
	// cond:
	// result: (Rsh64x32 (SignExt16to64 x) (ZeroExt16to64 y))
	for {
		_ = v.Args[1]
		x := v.Args[0]
		y := v.Args[1]
...
func rewriteValueWasm_OpRsh16x32_0(v *Value) bool {
	...
	// match: (Rsh16x32 x y)
	// cond:
	// result: (Rsh64x32 (SignExt16to64 x) (ZeroExt32to64 y))
	for {
		_ = v.Args[1]
		x := v.Args[0]
		y := v.Args[1]
...
func rewriteValueWasm_OpRsh16x64_0(v *Value) bool {
	...
	// match: (Rsh16x64 x y)
	// cond:
	// result: (Rsh64x32 (SignExt16to64 x) y)
	for {
		_ = v.Args[1]
		x := v.Args[0]
		y := v.Args[1]
...
func rewriteValueWasm_OpRsh16x8_0(v *Value) bool {
	...
	// match: (Rsh16x8 x y)
	// cond:
	// result: (Rsh64x32 (SignExt16to64 x) (ZeroExt8to64 y))
	for {
		_ = v.Args[1]
		x := v.Args[0]
		y := v.Args[1]
...
func rewriteValueWasm_OpRsh32x16_0(v *Value) bool {
	...
	// match: (Rsh32x16 x y)
	// cond:
	// result: (Rsh64x32 (SignExt32to64 x) (ZeroExt16to64 y))
	for {
		_ = v.Args[1]
		x := v.Args[0]
		y := v.Args[1]
...
func rewriteValueWasm_OpRsh32x32_0(v *Value) bool {
	...
	// match: (Rsh32x32 x y)
	// cond:
	// result: (Rsh64x32 (SignExt32to64 x) (ZeroExt32to64 y))
	for {
		_ = v.Args[1]
		x := v.Args[0]
		y := v.Args[1]
...
func rewriteValueWasm_OpRsh32x64_0(v *Value) bool {
	...
	// match: (Rsh32x64 x y)
	// cond:
	// result: (Rsh64x32 (SignExt32to64 x) y)
	for {
		_ = v.Args[1]
		x := v.Args[0]
		y := v.Args[1]
...
func rewriteValueWasm_OpRsh32x8_0(v *Value) bool {
	...
	// match: (Rsh32x8 x y)
	// cond:
	// result: (Rsh64x32 (SignExt32to64 x) (ZeroExt8to64 y))
	for {
		_ = v.Args[1]
		x := v.Args[0]
		y := v.Args[1]
...
func rewriteValueWasm_OpRsh8x16_0(v *Value) bool {
	...
	// match: (Rsh8x16 x y)
	// cond:
	// result: (Rsh64x32 (SignExt8to64 x) (ZeroExt16to64 y))
	for {
		_ = v.Args[1]
		x := v.Args[0]
		y := v.Args[1]
...
func rewriteValueWasm_OpRsh8x32_0(v *Value) bool {
	...
	// match: (Rsh8x32 x y)
	// cond:
	// result: (Rsh64x32 (SignExt8to64 x) (ZeroExt32to64 y))
	for {
		_ = v.Args[1]
		x := v.Args[0]
		y := v.Args[1]
...
func rewriteValueWasm_OpRsh8x64_0(v *Value) bool {
	...
	// match: (Rsh8x64 x y)
	// cond:
	// result: (Rsh64x32 (SignExt8to64 x) y)
	for {
		_ = v.Args[1]
		x := v.Args[0]
		y := v.Args[1]
...
func rewriteValueWasm_OpRsh8x8_0(v *Value) bool {
	...
	// match: (Rsh8x8 x y)
	// cond:
	// result: (Rsh64x32 (SignExt8to64 x) (ZeroExt8to64 y))
	for {
		_ = v.Args[1]
		x := v.Args[0]
		y := v.Args[1]
...
func rewriteValueWasm_OpSub32F_0(v *Value) bool {
	...
	// match: (Sub32F x y)
	// cond:
	// result: (LoweredRound32F (F64Sub x y))
	for {
		_ = v.Args[1]
		x := v.Args[0]
		y := v.Args[1]
		v.reset(OpWasmLoweredRound32F)
		v0 := b.NewValue0(v.Pos, OpWasmF64Sub, typ.Float64)
		v0.AddArg(x)
		v0.AddArg(y)
		v.AddArg(v0)
		return true
...
func rewriteValueWasm_OpZero_0(v *Value) bool {
	...
	// cond:
	// result: (I64Store8Const [0] destptr mem)
	for {
		if v.AuxInt != 1 {
			break
		}
	...
	// cond:
	// result: (I64Store16Const [0] destptr mem)
	for {
		if v.AuxInt != 2 {
			break
		}
	...
	// cond:
	// result: (I64Store32Const [0] destptr mem)
	for {
		if v.AuxInt != 4 {
			break
		}
	...
	// cond:
	// result: (I64StoreConst [0] destptr mem)
	for {
		if v.AuxInt != 8 {
			break
		}
	...
	// cond:
	// result: (I64Store8Const [makeValAndOff(0,2)] destptr (I64Store16Const [0] destptr mem))
	for {
		if v.AuxInt != 3 {
			break
		}
		...
		v.AddArg(destptr)
		v0 := b.NewValue0(v.Pos, OpWasmI64Store16Const, types.TypeMem)
		v0.AuxInt = 0
		v0.AddArg(destptr)
		v0.AddArg(mem)
		v.AddArg(v0)
	...
	// cond:
	// result: (I64Store8Const [makeValAndOff(0,4)] destptr (I64Store32Const [0] destptr mem))
	for {
		if v.AuxInt != 5 {
			break
		}
		...
		v.AddArg(destptr)
		v0 := b.NewValue0(v.Pos, OpWasmI64Store32Const, types.TypeMem)
		v0.AuxInt = 0
		v0.AddArg(destptr)
		v0.AddArg(mem)
		v.AddArg(v0)
	...
	// cond:
	// result: (I64Store16Const [makeValAndOff(0,4)] destptr (I64Store32Const [0] destptr mem))
	for {
		if v.AuxInt != 6 {
			break
		}
	...
	// cond:
	// result: (I64Store32Const [makeValAndOff(0,3)] destptr (I64Store32Const [0] destptr mem))
	for {
		if v.AuxInt != 7 {
			break
		}
	...
	// cond: s%8 != 0 && s > 8
	// result: (Zero [s-s%8] (OffPtr <destptr.Type> destptr [s%8]) (I64StoreConst [0] destptr mem))
	for {
		s := v.AuxInt
		_ = v.Args[1]
		destptr := v.Args[0]
		...
		v0.AddArg(destptr)
		v.AddArg(v0)
		v1 := b.NewValue0(v.Pos, OpWasmI64StoreConst, types.TypeMem)
		v1.AuxInt = 0
		v1.AddArg(destptr)
		v1.AddArg(mem)
		v.AddArg(v1)
...
func rewriteValueWasm_OpZero_10(v *Value) bool {
	...
	// cond:
	// result: (I64StoreConst [makeValAndOff(0,8)] destptr (I64StoreConst [0] destptr mem))
	for {
		if v.AuxInt != 16 {
			break
		}
		...
		v.AddArg(destptr)
		v0 := b.NewValue0(v.Pos, OpWasmI64StoreConst, types.TypeMem)
		v0.AuxInt = 0
		v0.AddArg(destptr)
		v0.AddArg(mem)
		v.AddArg(v0)
	...
	// cond:
	// result: (I64StoreConst [makeValAndOff(0,16)] destptr (I64StoreConst [makeValAndOff(0,8)] destptr (I64StoreConst [0] destptr mem)))
	for {
		if v.AuxInt != 24 {
			break
		}
	...
	// cond:
	// result: (I64StoreConst [makeValAndOff(0,24)] destptr (I64StoreConst [makeValAndOff(0,16)] destptr (I64StoreConst [makeValAndOff(0,8)] destptr (I64StoreConst [0] destptr mem))))
	for {
		if v.AuxInt != 32 {
			break
		}
		...
		v1.AddArg(destptr)
		v2 := b.NewValue0(v.Pos, OpWasmI64StoreConst, types.TypeMem)
		v2.AuxInt = 0
		v2.AddArg(destptr)
		v2.AddArg(mem)
		v1.AddArg(v2)
