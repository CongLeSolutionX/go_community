...
func rewriteValueAMD64(v *Value, config *Config) bool {
	...
	case OpSext16to32:
		...
		goto end1893b6f63c3d252190545de85b702527
	end1893b6f63c3d252190545de85b702527:
		;
	case OpSext16to64:
		// match: (Sext16to64 x)
		// cond:
		...
		goto endca60642573b29a925b379c2d4c8453e3
	endca60642573b29a925b379c2d4c8453e3:
		;
	case OpSext32to64:
		// match: (Sext32to64 x)
		// cond:
		...
		goto end167fae5ff7edb1e32b65edc01f4b3a28
	end167fae5ff7edb1e32b65edc01f4b3a28:
		;
	case OpSext8to16:
		// match: (Sext8to16 x)
		// cond:
		...
		goto endc48423aeab53d25dd2ff89ab8fadbe3d
	endc48423aeab53d25dd2ff89ab8fadbe3d:
		;
	case OpSext8to32:
		// match: (Sext8to32 x)
		// cond:
		...
		goto end2925918c7aa54f306ea1ee20f13b9506
	end2925918c7aa54f306ea1ee20f13b9506:
		;
	case OpSext8to64:
		// match: (Sext8to64 x)
		// cond:
		...
		goto end4169621a75d50b62a5e5ffc31e6ffca2
	end4169621a75d50b62a5e5ffc31e6ffca2:
		;
	case OpStaticCall:
	...
	case OpZext16to32:
		...
		goto end2751275242e3477e63c29c6175ce30ef
	end2751275242e3477e63c29c6175ce30ef:
		;
	case OpZext16to64:
		// match: (Zext16to64 x)
		// cond:
		...
		goto end06c7353268bb72ffe0f1d15c1c0b09ed
	end06c7353268bb72ffe0f1d15c1c0b09ed:
		;
	case OpZext32to64:
		// match: (Zext32to64 x)
		// cond:
		...
		goto endb31f3a9455b08be97d19b4f14a819d50
	endb31f3a9455b08be97d19b4f14a819d50:
		;
	case OpZext8to16:
		// match: (Zext8to16 x)
		// cond:
		...
		goto end2b2cd8a38183c8311d992d3aba220f73
	end2b2cd8a38183c8311d992d3aba220f73:
		;
	case OpZext8to32:
		// match: (Zext8to32 x)
		// cond:
		...
		goto ende52cefa0f1db7f941a6254d3c5721144
	ende52cefa0f1db7f941a6254d3c5721144:
		;
	case OpZext8to64:
		// match: (Zext8to64 x)
		// cond:
		...
		goto end8b0fff9996a2010b2295e45e07bd857d
	end8b0fff9996a2010b2295e45e07bd857d:
	}
	return false
}
