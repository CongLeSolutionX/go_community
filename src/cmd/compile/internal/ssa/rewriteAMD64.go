...
func rewriteValueAMD64_OpBitLen64(v *Value, config *Config) bool {
	...
	// match: (BitLen64 <t> x)
	// cond:
	// result: (SUBQ (MOVQconst <t> [64]) (CMOVQEQ <t> (Select0 <t> (BSRQ x)) (MOVQconst <t> [64]) (Select1 <TypeFlags> (BSRQ x))))
	for {
		t := v.Type
		x := v.Args[0]
		v.reset(OpAMD64SUBQ)
		v0 := b.NewValue0(v.Pos, OpAMD64MOVQconst, t)
		v0.AuxInt = 64
		v.AddArg(v0)
		v1 := b.NewValue0(v.Pos, OpAMD64CMOVQEQ, t)
		v2 := b.NewValue0(v.Pos, OpSelect0, t)
		v3 := b.NewValue0(v.Pos, OpAMD64BSRQ, MakeTuple(config.fe.TypeUInt64(), TypeFlags))
		v3.AddArg(x)
		v2.AddArg(v3)
		v1.AddArg(v2)
		v4 := b.NewValue0(v.Pos, OpAMD64MOVQconst, t)
		v4.AuxInt = 64
		v1.AddArg(v4)
		v5 := b.NewValue0(v.Pos, OpSelect1, TypeFlags)
		v6 := b.NewValue0(v.Pos, OpAMD64BSRQ, MakeTuple(config.fe.TypeUInt64(), TypeFlags))
		v6.AddArg(x)
		v5.AddArg(v6)
		v1.AddArg(v5)
		v.AddArg(v1)
