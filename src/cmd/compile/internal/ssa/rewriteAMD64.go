...
func rewriteValueAMD64_OpAMD64ADDL(v *Value) bool {
	...
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			x := v_0
			if v_1.Op != OpAMD64SHLLconst || int8(v_1.AuxInt) != 3 {
				continue
			}
			y := v_1.Args[0]
	...
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			x := v_0
			if v_1.Op != OpAMD64SHLLconst || int8(v_1.AuxInt) != 2 {
				continue
			}
			y := v_1.Args[0]
	...
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			x := v_0
			if v_1.Op != OpAMD64SHLLconst || int8(v_1.AuxInt) != 1 {
				continue
			}
			y := v_1.Args[0]
...
func rewriteValueAMD64_OpAMD64ADDLconst(v *Value) bool {
	...
	for {
		c := int32(v.AuxInt)
		if v_0.Op != OpAMD64SHLLconst || int8(v_0.AuxInt) != 1 {
			break
		}
		x := v_0.Args[0]
		v.reset(OpAMD64LEAL1)
...
func rewriteValueAMD64_OpAMD64ADDLconstmodify(v *Value) bool {
	...
	for {
		valoff1 := ValAndOff(v.AuxInt)
		sym := auxToSym(v.Aux)
		if v_0.Op != OpAMD64ADDQconst {
			break
		}
		off2 := int32(v_0.AuxInt)
		base := v_0.Args[0]
		mem := v_1
		...
		v.AuxInt = int64(ValAndOff(valoff1).addOffset32(off2))
		v.Aux = sym
		v.AddArg2(base, mem)
		return true
	}
...
func rewriteValueAMD64_OpAMD64ADDLload(v *Value) bool {
	...
	for {
		...
		x := v_0
		ptr := v_1
		if v_2.Op != OpAMD64MOVSSstore || int32(v_2.AuxInt) != off || auxToSym(v_2.Aux) != sym {
			break
		}
		y := v_2.Args[1]
		if ptr != v_2.Args[0] {
...
func rewriteValueAMD64_OpAMD64ADDQ(v *Value) bool {
	...
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			x := v_0
			if v_1.Op != OpAMD64SHLQconst || int8(v_1.AuxInt) != 3 {
				continue
			}
			y := v_1.Args[0]
	...
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			x := v_0
			if v_1.Op != OpAMD64SHLQconst || int8(v_1.AuxInt) != 2 {
				continue
			}
			y := v_1.Args[0]
	...
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			x := v_0
			if v_1.Op != OpAMD64SHLQconst || int8(v_1.AuxInt) != 1 {
				continue
			}
			y := v_1.Args[0]
...
func rewriteValueAMD64_OpAMD64ADDQconst(v *Value) bool {
	...
	for {
		c := int32(v.AuxInt)
		if v_0.Op != OpAMD64SHLQconst || int8(v_0.AuxInt) != 1 {
			break
		}
		x := v_0.Args[0]
		v.reset(OpAMD64LEAQ1)
...
func rewriteValueAMD64_OpAMD64ADDQload(v *Value) bool {
	...
	for {
		...
		x := v_0
		ptr := v_1
		if v_2.Op != OpAMD64MOVSDstore || int32(v_2.AuxInt) != off || auxToSym(v_2.Aux) != sym {
			break
		}
		y := v_2.Args[1]
		if ptr != v_2.Args[0] {
...
func rewriteValueAMD64_OpAMD64ADDSDload(v *Value) bool {
	...
	for {
		...
		x := v_0
		ptr := v_1
		if v_2.Op != OpAMD64MOVQstore || int32(v_2.AuxInt) != off || auxToSym(v_2.Aux) != sym {
			break
		}
		y := v_2.Args[1]
		if ptr != v_2.Args[0] {
...
func rewriteValueAMD64_OpAMD64ADDSSload(v *Value) bool {
	...
	for {
		...
		x := v_0
		ptr := v_1
		if v_2.Op != OpAMD64MOVLstore || int32(v_2.AuxInt) != off || auxToSym(v_2.Aux) != sym {
			break
		}
		y := v_2.Args[1]
		if ptr != v_2.Args[0] {
...
func rewriteValueAMD64_OpAMD64ANDL(v *Value) bool {
	...
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			...
			if v_0_0_0.Op != OpAMD64MOVLconst || int32(v_0_0_0.AuxInt) != 1 {
				continue
			}
			x := v_1
			v.reset(OpAMD64BTRL)
	...
	for {
		...
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			x := v_0
			if v_1.Op != OpAMD64ADDLconst || int32(v_1.AuxInt) != -1 || x != v_1.Args[0] || !(buildcfg.GOAMD64 >= 3) {
				continue
			}
			v.reset(OpSelect0)
			v.Type = t
...
func rewriteValueAMD64_OpAMD64ANDNL(v *Value) bool {
	...
	for {
		...
		y := v_1.Args[1]
		v_1_0 := v_1.Args[0]
		if v_1_0.Op != OpAMD64MOVLconst || int32(v_1_0.AuxInt) != 1 {
			break
		}
		v.reset(OpAMD64BTRL)
		v.AddArg2(x, y)
...
func rewriteValueAMD64_OpAMD64ANDQ(v *Value) bool {
	...
	for {
		...
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			x := v_0
			if v_1.Op != OpAMD64ADDQconst || int32(v_1.AuxInt) != -1 || x != v_1.Args[0] || !(buildcfg.GOAMD64 >= 3) {
				continue
			}
			v.reset(OpSelect0)
			v.Type = t
...
func rewriteValueAMD64_OpAMD64BTCLconst(v *Value) bool {
	...
	for {
		...
		x := v_0.Args[0]
		v.reset(OpAMD64XORLconst)
		v.AuxInt = int64(1<<uint32(c) | 1<<uint32(d))
		v.AddArg(x)
		return true
	}
...
func rewriteValueAMD64_OpAMD64BTRLconst(v *Value) bool {
	...
	for {
		c := int8(v.AuxInt)
		if v_0.Op != OpAMD64BTSLconst || int8(v_0.AuxInt) != c {
			break
		}
		x := v_0.Args[0]
		v.reset(OpAMD64BTRLconst)
	...
	for {
		c := int8(v.AuxInt)
		if v_0.Op != OpAMD64BTCLconst || int8(v_0.AuxInt) != c {
			break
		}
		x := v_0.Args[0]
		v.reset(OpAMD64BTRLconst)
...
func rewriteValueAMD64_OpAMD64BTRQconst(v *Value) bool {
	...
	for {
		c := int8(v.AuxInt)
		if v_0.Op != OpAMD64BTSQconst || int8(v_0.AuxInt) != c {
			break
		}
		x := v_0.Args[0]
		v.reset(OpAMD64BTRQconst)
	...
	for {
		c := int8(v.AuxInt)
		if v_0.Op != OpAMD64BTCQconst || int8(v_0.AuxInt) != c {
			break
		}
		x := v_0.Args[0]
		v.reset(OpAMD64BTRQconst)
...
func rewriteValueAMD64_OpAMD64BTSLconst(v *Value) bool {
	...
	for {
		c := int8(v.AuxInt)
		if v_0.Op != OpAMD64BTRLconst || int8(v_0.AuxInt) != c {
			break
		}
		x := v_0.Args[0]
...
func rewriteValueAMD64_OpAMD64BTSQconst(v *Value) bool {
	...
	for {
		c := int8(v.AuxInt)
		if v_0.Op != OpAMD64BTRQconst || int8(v_0.AuxInt) != c {
			break
		}
		x := v_0.Args[0]
...
func rewriteValueAMD64_OpAMD64CMPBconst(v *Value) bool {
	...
	for {
		...
		v.copyOf(v0)
		v0.AuxInt = int64(makeValAndOff(int32(c), off))
		v0.Aux = sym
		v0.AddArg2(ptr, mem)
		return true
	}
...
func rewriteValueAMD64_OpAMD64CMPBload(v *Value) bool {
	...
	for {
		...
		mem := v_2
		v.reset(OpAMD64CMPBconstload)
		v.AuxInt = int64(makeValAndOff(int32(int8(c)), off))
		v.Aux = sym
		v.AddArg2(ptr, mem)
		return true
	}
...
func rewriteValueAMD64_OpAMD64CMPLconst(v *Value) bool {
	...
	for {
		...
		v.copyOf(v0)
		v0.AuxInt = int64(makeValAndOff(c, off))
		v0.Aux = sym
		v0.AddArg2(ptr, mem)
		return true
	}
...
func rewriteValueAMD64_OpAMD64CMPLload(v *Value) bool {
	...
	for {
		...
		mem := v_2
		v.reset(OpAMD64CMPLconstload)
		v.AuxInt = int64(makeValAndOff(c, off))
		v.Aux = sym
		v.AddArg2(ptr, mem)
		return true
	}
...
func rewriteValueAMD64_OpAMD64CMPQload(v *Value) bool {
	...
	for {
		...
		v.reset(OpAMD64CMPQconstload)
		v.AuxInt = int64(makeValAndOff(int32(c), off))
		v.Aux = sym
		v.AddArg2(ptr, mem)
		return true
	}
...
func rewriteValueAMD64_OpAMD64CMPWload(v *Value) bool {
	...
	for {
		...
		mem := v_2
		v.reset(OpAMD64CMPWconstload)
		v.AuxInt = int64(makeValAndOff(int32(int16(c)), off))
		v.Aux = sym
		v.AddArg2(ptr, mem)
		return true
	}
...
func rewriteValueAMD64_OpAMD64LEAQ2(v *Value) bool {
	...
	for {
		...
		v.reset(OpAMD64LEAQ)
		v.AuxInt = int64(off + int32(scale)*2)
		v.Aux = sym
		v.AddArg(x)
		return true
	}
...
func rewriteValueAMD64_OpAMD64LEAQ4(v *Value) bool {
	...
	for {
		...
		v.reset(OpAMD64LEAQ)
		v.AuxInt = int64(off + int32(scale)*4)
		v.Aux = sym
		v.AddArg(x)
		return true
	}
...
func rewriteValueAMD64_OpAMD64LEAQ8(v *Value) bool {
	...
	for {
		...
		v.reset(OpAMD64LEAQ)
		v.AuxInt = int64(off + int32(scale)*8)
		v.Aux = sym
		v.AddArg(x)
		return true
	}
...
func rewriteValueAMD64_OpAMD64MOVBEWstore(v *Value) bool {
	...
	for {
		...
		p := v_0
		x := v_1
		if x.Op != OpAMD64ROLWconst || int8(x.AuxInt) != 8 {
			break
		}
		w := x.Args[0]
		mem := v_2
...
func rewriteValueAMD64_OpAMD64MOVBload(v *Value) bool {
	...
	for {
		...
		v.reset(OpAMD64MOVLconst)
		v.AuxInt = int64(int32(read8(sym, int64(off))))
		return true
	}
	return false
}
func rewriteValueAMD64_OpAMD64MOVBstore(v *Value) bool {
	...
	for {
		...
		p2 := x1.Args[0]
		mem2 := v_2
		if mem2.Op != OpAMD64MOVBstore || int32(mem2.AuxInt) != i-1 || auxToSym(mem2.Aux) != s {
			break
		}
		_ = mem2.Args[2]
		if p != mem2.Args[0] {
		...
		x2 := mem2.Args[1]
		if x2.Op != OpAMD64MOVBload || int32(x2.AuxInt) != j-1 || auxToSym(x2.Aux) != s2 {
			break
		}
		_ = x2.Args[1]
...
func rewriteValueAMD64_OpAMD64MOVBstoreconst(v *Value) bool {
	...
	for {
		sc := ValAndOff(v.AuxInt)
		s := auxToSym(v.Aux)
		if v_0.Op != OpAMD64ADDQconst {
			break
		}
		off := int32(v_0.AuxInt)
		ptr := v_0.Args[0]
		mem := v_1
		...
		v.reset(OpAMD64MOVBstoreconst)
		v.AuxInt = int64(ValAndOff(sc).addOffset32(off))
		v.Aux = s
		v.AddArg2(ptr, mem)
		return true
	}
...
func rewriteValueAMD64_OpAMD64MOVLload(v *Value) bool {
	...
	for {
		...
		sym := auxToSym(v.Aux)
		ptr := v_0
		if v_1.Op != OpAMD64MOVSSstore || int32(v_1.AuxInt) != off || auxToSym(v_1.Aux) != sym {
			break
		}
		val := v_1.Args[1]
		if ptr != v_1.Args[0] {
	...
	for {
		...
		v.reset(OpAMD64MOVQconst)
		v.AuxInt = int64(read32(sym, int64(off), config.ctxt.Arch.ByteOrder))
		return true
	}
	return false
}
func rewriteValueAMD64_OpAMD64MOVLstore(v *Value) bool {
	...
	for {
		...
		p2 := x1.Args[0]
		mem2 := v_2
		if mem2.Op != OpAMD64MOVLstore || int32(mem2.AuxInt) != i-4 || auxToSym(mem2.Aux) != s {
			break
		}
		_ = mem2.Args[2]
		if p != mem2.Args[0] {
		...
		x2 := mem2.Args[1]
		if x2.Op != OpAMD64MOVLload || int32(x2.AuxInt) != j-4 || auxToSym(x2.Aux) != s2 {
			break
		}
		_ = x2.Args[1]
		if p2 != x2.Args[0] || mem != x2.Args[1] || mem != mem2.Args[2] || !(x1.Uses == 1 && x2.Uses == 1 && mem2.Uses == 1 && clobber(x1, x2, mem2)) {
	...
	for {
		...
		ptr := v_0
		y := v_1
		if y.Op != OpAMD64ADDLload || int32(y.AuxInt) != off || auxToSym(y.Aux) != sym {
			break
		}
		mem := y.Args[2]
		x := y.Args[0]
	...
	for {
		...
		ptr := v_0
		y := v_1
		if y.Op != OpAMD64ANDLload || int32(y.AuxInt) != off || auxToSym(y.Aux) != sym {
			break
		}
		mem := y.Args[2]
		x := y.Args[0]
	...
	for {
		...
		ptr := v_0
		y := v_1
		if y.Op != OpAMD64ORLload || int32(y.AuxInt) != off || auxToSym(y.Aux) != sym {
			break
		}
		mem := y.Args[2]
		x := y.Args[0]
	...
	for {
		...
		ptr := v_0
		y := v_1
		if y.Op != OpAMD64XORLload || int32(y.AuxInt) != off || auxToSym(y.Aux) != sym {
			break
		}
		mem := y.Args[2]
		x := y.Args[0]
	...
	for {
		...
		for _i0 := 0; _i0 <= 1; _i0, y_0, y_1 = _i0+1, y_1, y_0 {
			l := y_0
			if l.Op != OpAMD64MOVLload || int32(l.AuxInt) != off || auxToSym(l.Aux) != sym {
				continue
			}
			mem := l.Args[1]
			if ptr != l.Args[0] {
...
func rewriteValueAMD64_OpAMD64MOVOstore(v *Value) bool {
	...
	for {
		...
		v.reset(OpAMD64MOVQstore)
		v.AuxInt = int64(dstOff + 8)
		v.Aux = dstSym
		v0 := b.NewValue0(v_1.Pos, OpAMD64MOVQconst, typ.UInt64)
		v0.AuxInt = int64(read64(srcSym, int64(srcOff)+8, config.ctxt.Arch.ByteOrder))
		v1 := b.NewValue0(v_1.Pos, OpAMD64MOVQstore, types.TypeMem)
		v1.AuxInt = int64(dstOff)
		v1.Aux = dstSym
		v2 := b.NewValue0(v_1.Pos, OpAMD64MOVQconst, typ.UInt64)
		v2.AuxInt = int64(read64(srcSym, int64(srcOff), config.ctxt.Arch.ByteOrder))
...
func rewriteValueAMD64_OpAMD64MOVQload(v *Value) bool {
	...
	for {
		...
		sym := auxToSym(v.Aux)
		ptr := v_0
		if v_1.Op != OpAMD64MOVSDstore || int32(v_1.AuxInt) != off || auxToSym(v_1.Aux) != sym {
			break
		}
		val := v_1.Args[1]
		if ptr != v_1.Args[0] {
	...
	for {
		...
		v.reset(OpAMD64MOVQconst)
		v.AuxInt = int64(read64(sym, int64(off), config.ctxt.Arch.ByteOrder))
		return true
	}
	return false
}
func rewriteValueAMD64_OpAMD64MOVQstore(v *Value) bool {
	...
	for {
		...
		ptr := v_0
		y := v_1
		if y.Op != OpAMD64ADDQload || int32(y.AuxInt) != off || auxToSym(y.Aux) != sym {
			break
		}
		mem := y.Args[2]
		x := y.Args[0]
	...
	for {
		...
		ptr := v_0
		y := v_1
		if y.Op != OpAMD64ANDQload || int32(y.AuxInt) != off || auxToSym(y.Aux) != sym {
			break
		}
		mem := y.Args[2]
		x := y.Args[0]
	...
	for {
		...
		ptr := v_0
		y := v_1
		if y.Op != OpAMD64ORQload || int32(y.AuxInt) != off || auxToSym(y.Aux) != sym {
			break
		}
		mem := y.Args[2]
		x := y.Args[0]
	...
	for {
		...
		ptr := v_0
		y := v_1
		if y.Op != OpAMD64XORQload || int32(y.AuxInt) != off || auxToSym(y.Aux) != sym {
			break
		}
		mem := y.Args[2]
		x := y.Args[0]
	...
	for {
		...
		for _i0 := 0; _i0 <= 1; _i0, y_0, y_1 = _i0+1, y_1, y_0 {
			l := y_0
			if l.Op != OpAMD64MOVQload || int32(l.AuxInt) != off || auxToSym(l.Aux) != sym {
				continue
			}
			mem := l.Args[1]
			if ptr != l.Args[0] {
...
func rewriteValueAMD64_OpAMD64MOVQstoreconst(v *Value) bool {
	...
	for {
		...
		v.reset(OpAMD64MOVOstoreconst)
		v.AuxInt = int64(makeValAndOff(0, a.Off()))
		v.Aux = s
		v.AddArg2(p0, mem)
		return true
	}
...
func rewriteValueAMD64_OpAMD64MOVSDload(v *Value) bool {
	...
	for {
		...
		sym := auxToSym(v.Aux)
		ptr := v_0
		if v_1.Op != OpAMD64MOVQstore || int32(v_1.AuxInt) != off || auxToSym(v_1.Aux) != sym {
			break
		}
		val := v_1.Args[1]
		if ptr != v_1.Args[0] {
...
func rewriteValueAMD64_OpAMD64MOVSSload(v *Value) bool {
	...
	for {
		...
		sym := auxToSym(v.Aux)
		ptr := v_0
		if v_1.Op != OpAMD64MOVLstore || int32(v_1.AuxInt) != off || auxToSym(v_1.Aux) != sym {
			break
		}
		val := v_1.Args[1]
		if ptr != v_1.Args[0] {
...
func rewriteValueAMD64_OpAMD64MOVWload(v *Value) bool {
	...
	for {
		...
		v.reset(OpAMD64MOVLconst)
		v.AuxInt = int64(int32(read16(sym, int64(off), config.ctxt.Arch.ByteOrder)))
		return true
	}
	return false
}
func rewriteValueAMD64_OpAMD64MOVWstore(v *Value) bool {
	...
	for {
		...
		p2 := x1.Args[0]
		mem2 := v_2
		if mem2.Op != OpAMD64MOVWstore || int32(mem2.AuxInt) != i-2 || auxToSym(mem2.Aux) != s {
			break
		}
		_ = mem2.Args[2]
		if p != mem2.Args[0] {
		...
		x2 := mem2.Args[1]
		if x2.Op != OpAMD64MOVWload || int32(x2.AuxInt) != j-2 || auxToSym(x2.Aux) != s2 {
			break
		}
		_ = x2.Args[1]
		if p2 != x2.Args[0] || mem != x2.Args[1] || mem != mem2.Args[2] || !(x1.Uses == 1 && x2.Uses == 1 && mem2.Uses == 1 && clobber(x1, x2, mem2)) {
...
func rewriteValueAMD64_OpAMD64MULLconst(v *Value) bool {
	...
	for {
		...
		v0.AuxInt = int64(int8(log64(int64(c) + 1)))
		v0.AddArg(x)
		v.AddArg2(v0, x)
		return true
	}
	...
	for {
		...
		v.reset(OpAMD64LEAL1)
		v0 := b.NewValue0(v.Pos, OpAMD64SHLLconst, v.Type)
		v0.AuxInt = int64(int8(log32(c - 1)))
		v0.AddArg(x)
		v.AddArg2(v0, x)
		return true
	}
	...
	for {
		...
		v.reset(OpAMD64LEAL2)
		v0 := b.NewValue0(v.Pos, OpAMD64SHLLconst, v.Type)
		v0.AuxInt = int64(int8(log32(c - 2)))
		v0.AddArg(x)
		v.AddArg2(v0, x)
		return true
	}
	...
	for {
		...
		v.reset(OpAMD64LEAL4)
		v0 := b.NewValue0(v.Pos, OpAMD64SHLLconst, v.Type)
		v0.AuxInt = int64(int8(log32(c - 4)))
		v0.AddArg(x)
		v.AddArg2(v0, x)
		return true
	}
	...
	for {
		...
		v.reset(OpAMD64LEAL8)
		v0 := b.NewValue0(v.Pos, OpAMD64SHLLconst, v.Type)
		v0.AuxInt = int64(int8(log32(c - 8)))
		v0.AddArg(x)
		v.AddArg2(v0, x)
		return true
	}
...
func rewriteValueAMD64_OpAMD64ORL(v *Value) bool {
	...
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			...
			y := v_0.Args[1]
			v_0_0 := v_0.Args[0]
			if v_0_0.Op != OpAMD64MOVLconst || int32(v_0_0.AuxInt) != 1 {
				continue
			}
			x := v_1
			v.reset(OpAMD64BTSL)
...
func rewriteValueAMD64_OpAMD64SARB(v *Value) bool {
	...
	for {
		...
		v.AuxInt = int64(int8(min(int64(c)&31, 7)))
		v.AddArg(x)
		return true
	}
...
func rewriteValueAMD64_OpAMD64SARW(v *Value) bool {
	...
	for {
		...
		v.AuxInt = int64(int8(min(int64(c)&31, 15)))
		v.AddArg(x)
		return true
	}
...
func rewriteValueAMD64_OpAMD64SETB(v *Value) bool {
	...
	for {
		if v_0.Op != OpAMD64BTLconst || int8(v_0.AuxInt) != 0 {
			break
		}
		x := v_0.Args[0]
		v.reset(OpAMD64ANDLconst)
	...
	for {
		if v_0.Op != OpAMD64BTQconst || int8(v_0.AuxInt) != 0 {
			break
		}
		x := v_0.Args[0]
		v.reset(OpAMD64ANDQconst)
...
func rewriteValueAMD64_OpAMD64SETEQ(v *Value) bool {
	...
	for {
		if v_0.Op != OpAMD64CMPLconst || int32(v_0.AuxInt) != 1 {
			break
		}
		s := v_0.Args[0]
		if s.Op != OpAMD64ANDLconst || int32(s.AuxInt) != 1 {
			break
		}
	...
	for {
		if v_0.Op != OpAMD64CMPQconst || int32(v_0.AuxInt) != 1 {
			break
		}
		s := v_0.Args[0]
		if s.Op != OpAMD64ANDQconst || int32(s.AuxInt) != 1 {
			break
		}
		v.reset(OpAMD64SETNE)
		v0 := b.NewValue0(v.Pos, OpAMD64CMPQconst, types.TypeFlags)
	...
	for {
		...
		for _i0 := 0; _i0 <= 1; _i0, v_0_0, v_0_1 = _i0+1, v_0_1, v_0_0 {
			z1 := v_0_0
			if z1.Op != OpAMD64SHLQconst || int8(z1.AuxInt) != 63 {
				continue
			}
			z1_0 := z1.Args[0]
			if z1_0.Op != OpAMD64SHRQconst || int8(z1_0.AuxInt) != 63 {
				continue
			}
			x := z1_0.Args[0]
			z2 := v_0_1
	...
	for {
		...
		for _i0 := 0; _i0 <= 1; _i0, v_0_0, v_0_1 = _i0+1, v_0_1, v_0_0 {
			z1 := v_0_0
			if z1.Op != OpAMD64SHLLconst || int8(z1.AuxInt) != 31 {
				continue
			}
			z1_0 := z1.Args[0]
			if z1_0.Op != OpAMD64SHRQconst || int8(z1_0.AuxInt) != 31 {
				continue
			}
			x := z1_0.Args[0]
			z2 := v_0_1
	...
	for {
		...
		for _i0 := 0; _i0 <= 1; _i0, v_0_0, v_0_1 = _i0+1, v_0_1, v_0_0 {
			z1 := v_0_0
			if z1.Op != OpAMD64SHRQconst || int8(z1.AuxInt) != 63 {
				continue
			}
			z1_0 := z1.Args[0]
			if z1_0.Op != OpAMD64SHLQconst || int8(z1_0.AuxInt) != 63 {
				continue
			}
			x := z1_0.Args[0]
			z2 := v_0_1
	...
	for {
		...
		for _i0 := 0; _i0 <= 1; _i0, v_0_0, v_0_1 = _i0+1, v_0_1, v_0_0 {
			z1 := v_0_0
			if z1.Op != OpAMD64SHRLconst || int8(z1.AuxInt) != 31 {
				continue
			}
			z1_0 := z1.Args[0]
			if z1_0.Op != OpAMD64SHLLconst || int8(z1_0.AuxInt) != 31 {
				continue
			}
			x := z1_0.Args[0]
			z2 := v_0_1
...
func rewriteValueAMD64_OpAMD64SETEQstore(v *Value) bool {
	...
	for {
		...
		for _i0 := 0; _i0 <= 1; _i0, v_1_0, v_1_1 = _i0+1, v_1_1, v_1_0 {
			...
			if v_1_0_0.Op != OpAMD64MOVLconst || int32(v_1_0_0.AuxInt) != 1 {
				continue
			}
			y := v_1_1
			mem := v_2
	...
	for {
		...
		sym := auxToSym(v.Aux)
		ptr := v_0
		if v_1.Op != OpAMD64CMPLconst || int32(v_1.AuxInt) != 1 {
			break
		}
		s := v_1.Args[0]
		if s.Op != OpAMD64ANDLconst || int32(s.AuxInt) != 1 {
	...
	for {
		...
		sym := auxToSym(v.Aux)
		ptr := v_0
		if v_1.Op != OpAMD64CMPQconst || int32(v_1.AuxInt) != 1 {
			break
		}
		s := v_1.Args[0]
		if s.Op != OpAMD64ANDQconst || int32(s.AuxInt) != 1 {
	...
	for {
		...
		for _i0 := 0; _i0 <= 1; _i0, v_1_0, v_1_1 = _i0+1, v_1_1, v_1_0 {
			...
			z1_0 := z1.Args[0]
			if z1_0.Op != OpAMD64SHRLconst || int8(z1_0.AuxInt) != 31 {
				continue
			}
			x := z1_0.Args[0]
			z2 := v_1_1
...
func rewriteValueAMD64_OpAMD64SETNE(v *Value) bool {
	...
	// result: (ANDLconst [1] x)
	for {
		if v_0.Op != OpAMD64TESTBconst || int8(v_0.AuxInt) != 1 {
			break
		}
		x := v_0.Args[0]
		v.reset(OpAMD64ANDLconst)
	...
	// result: (ANDLconst [1] x)
	for {
		if v_0.Op != OpAMD64TESTWconst || int16(v_0.AuxInt) != 1 {
			break
		}
		x := v_0.Args[0]
		v.reset(OpAMD64ANDLconst)
...
func rewriteValueAMD64_OpAMD64SHLLconst(v *Value) bool {
	...
	for {
		if int8(v.AuxInt) != 1 || v_0.Op != OpAMD64SHRLconst || int8(v_0.AuxInt) != 1 {
			break
		}
		x := v_0.Args[0]
		v.reset(OpAMD64BTRLconst)
...
func rewriteValueAMD64_OpAMD64SHLQconst(v *Value) bool {
	...
	for {
		if int8(v.AuxInt) != 1 || v_0.Op != OpAMD64SHRQconst || int8(v_0.AuxInt) != 1 {
			break
		}
		x := v_0.Args[0]
		v.reset(OpAMD64BTRQconst)
...
func rewriteValueAMD64_OpAMD64SHRLconst(v *Value) bool {
	...
	for {
		if int8(v.AuxInt) != 1 || v_0.Op != OpAMD64SHLLconst || int8(v_0.AuxInt) != 1 {
			break
		}
		x := v_0.Args[0]
		v.reset(OpAMD64BTRLconst)
...
func rewriteValueAMD64_OpAMD64SHRQconst(v *Value) bool {
	...
	for {
		if int8(v.AuxInt) != 1 || v_0.Op != OpAMD64SHLQconst || int8(v_0.AuxInt) != 1 {
			break
		}
		x := v_0.Args[0]
		v.reset(OpAMD64BTRQconst)
...
func rewriteValueAMD64_OpAMD64TESTB(v *Value) bool {
	...
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			...
			v0 := b.NewValue0(l.Pos, OpAMD64CMPBconstload, types.TypeFlags)
			v.copyOf(v0)
			v0.AuxInt = int64(makeValAndOff(0, off))
			v0.Aux = sym
			v0.AddArg2(ptr, mem)
			return true
		}
...
func rewriteValueAMD64_OpAMD64TESTLconst(v *Value) bool {
	...
	for {
		c := int32(v.AuxInt)
		if v_0.Op != OpAMD64MOVLconst || int32(v_0.AuxInt) != c || !(c == 0) {
			break
		}
		v.reset(OpAMD64FlagEQ)
		return true
...
func rewriteValueAMD64_OpAMD64XORLconst(v *Value) bool {
	...
	// result: (SETEQ x)
	for {
		if int32(v.AuxInt) != 1 || v_0.Op != OpAMD64SETNE {
			break
		}
		x := v_0.Args[0]
		v.reset(OpAMD64SETEQ)
	...
	// result: (SETNE x)
	for {
		if int32(v.AuxInt) != 1 || v_0.Op != OpAMD64SETEQ {
			break
		}
		x := v_0.Args[0]
		v.reset(OpAMD64SETNE)
	...
	// result: (SETGE x)
	for {
		if int32(v.AuxInt) != 1 || v_0.Op != OpAMD64SETL {
			break
		}
		x := v_0.Args[0]
		v.reset(OpAMD64SETGE)
	...
	// result: (SETL x)
	for {
		if int32(v.AuxInt) != 1 || v_0.Op != OpAMD64SETGE {
			break
		}
		x := v_0.Args[0]
		v.reset(OpAMD64SETL)
	...
	// result: (SETG x)
	for {
		if int32(v.AuxInt) != 1 || v_0.Op != OpAMD64SETLE {
			break
		}
		x := v_0.Args[0]
		v.reset(OpAMD64SETG)
	...
	// result: (SETLE x)
	for {
		if int32(v.AuxInt) != 1 || v_0.Op != OpAMD64SETG {
			break
		}
		x := v_0.Args[0]
		v.reset(OpAMD64SETLE)
	...
	// result: (SETAE x)
	for {
		if int32(v.AuxInt) != 1 || v_0.Op != OpAMD64SETB {
			break
		}
		x := v_0.Args[0]
		v.reset(OpAMD64SETAE)
	...
	// result: (SETB x)
	for {
		if int32(v.AuxInt) != 1 || v_0.Op != OpAMD64SETAE {
			break
		}
		x := v_0.Args[0]
		v.reset(OpAMD64SETB)
	...
	// result: (SETA x)
	for {
		if int32(v.AuxInt) != 1 || v_0.Op != OpAMD64SETBE {
			break
		}
		x := v_0.Args[0]
		v.reset(OpAMD64SETA)
	...
	// result: (SETBE x)
	for {
		if int32(v.AuxInt) != 1 || v_0.Op != OpAMD64SETA {
			break
		}
		x := v_0.Args[0]
		v.reset(OpAMD64SETBE)
...
func rewriteValueAMD64_OpMove(v *Value) bool {
	...
	for {
		...
		v.reset(OpAMD64MOVQstore)
		v.AuxInt = int64(int32(s - 8))
		v0 := b.NewValue0(v.Pos, OpAMD64MOVQload, typ.UInt64)
		v0.AuxInt = int64(int32(s - 8))
		v0.AddArg2(src, mem)
		v1 := b.NewValue0(v.Pos, OpAMD64MOVQstore, types.TypeMem)
		v2 := b.NewValue0(v.Pos, OpAMD64MOVQload, typ.UInt64)
		v2.AddArg2(src, mem)
...
func rewriteValueAMD64_OpZero(v *Value) bool {
	...
	for {
		...
		mem := v_1
		v.reset(OpAMD64MOVBstoreconst)
		v.AuxInt = int64(makeValAndOff(0, 0))
	...
	for {
		...
		mem := v_1
		v.reset(OpAMD64MOVBstoreconst)
		v.AuxInt = int64(makeValAndOff(0, 2))
		v0 := b.NewValue0(v.Pos, OpAMD64MOVWstoreconst, types.TypeMem)
		v0.AuxInt = int64(makeValAndOff(0, 0))
	...
	for {
		...
		mem := v_1
		v.reset(OpAMD64MOVBstoreconst)
		v.AuxInt = int64(makeValAndOff(0, 4))
	...
	for {
		...
		mem := v_1
		v.reset(OpAMD64MOVLstoreconst)
		v.AuxInt = int64(makeValAndOff(0, 3))
		v0 := b.NewValue0(v.Pos, OpAMD64MOVLstoreconst, types.TypeMem)
		v0.AuxInt = int64(makeValAndOff(0, 0))
		v0.AddArg2(destptr, mem)
		v.AddArg2(destptr, v0)
	...
	for {
		...
		v1.AuxInt = int64(makeValAndOff(0, 0))
	...
	for {
		...
		v.reset(OpAMD64MOVQstoreconst)
		v.AuxInt = int64(makeValAndOff(0, 8))
	...
	for {
		...
		v.reset(OpAMD64MOVQstoreconst)
		v.AuxInt = int64(makeValAndOff(0, 16))
		v0 := b.NewValue0(v.Pos, OpAMD64MOVQstoreconst, types.TypeMem)
		v0.AuxInt = int64(makeValAndOff(0, 8))
		v1 := b.NewValue0(v.Pos, OpAMD64MOVQstoreconst, types.TypeMem)
		v1.AuxInt = int64(makeValAndOff(0, 0))
		v1.AddArg2(destptr, mem)
	...
	for {
		...
		v.reset(OpAMD64MOVQstoreconst)
		v.AuxInt = int64(makeValAndOff(0, 24))
		v0 := b.NewValue0(v.Pos, OpAMD64MOVQstoreconst, types.TypeMem)
		v0.AuxInt = int64(makeValAndOff(0, 16))
		v1 := b.NewValue0(v.Pos, OpAMD64MOVQstoreconst, types.TypeMem)
		v1.AuxInt = int64(makeValAndOff(0, 8))
		v2 := b.NewValue0(v.Pos, OpAMD64MOVQstoreconst, types.TypeMem)
		v2.AuxInt = int64(makeValAndOff(0, 0))
	...
	for {
		...
		v.reset(OpAMD64MOVQstoreconst)
		v.AuxInt = int64(makeValAndOff(0, int32(s-8)))
		v0 := b.NewValue0(v.Pos, OpAMD64MOVQstoreconst, types.TypeMem)
		v0.AuxInt = int64(makeValAndOff(0, 0))
		v0.AddArg2(destptr, mem)
		v.AddArg2(destptr, v0)
	...
	for {
		...
		v.reset(OpAMD64MOVOstoreconst)
		v.AuxInt = int64(makeValAndOff(0, 32))
		v0 := b.NewValue0(v.Pos, OpAMD64MOVOstoreconst, types.TypeMem)
		v0.AuxInt = int64(makeValAndOff(0, 16))
		v1 := b.NewValue0(v.Pos, OpAMD64MOVOstoreconst, types.TypeMem)
		v1.AuxInt = int64(makeValAndOff(0, 0))
	...
	for {
		...
		v.reset(OpAMD64MOVOstoreconst)
		v.AuxInt = int64(makeValAndOff(0, 48))
		v0 := b.NewValue0(v.Pos, OpAMD64MOVOstoreconst, types.TypeMem)
		v0.AuxInt = int64(makeValAndOff(0, 32))
		v1 := b.NewValue0(v.Pos, OpAMD64MOVOstoreconst, types.TypeMem)
		v1.AuxInt = int64(makeValAndOff(0, 16))
