...
func rewriteValueAMD64_OpAMD64MOVBstore(v *Value, config *Config) bool {
	...
	for {
		...
		v.Aux = s
		v.AddArg(p)
		v0 := b.NewValue0(v.Line, OpAMD64ROLWconst, w.Type)
		v0.AuxInt = 8
		v0.AddArg(w)
		v.AddArg(v0)
		v.AddArg(mem)
...
func rewriteValueAMD64_OpAMD64ORL(v *Value, config *Config) bool {
	...
	for {
		...
		b = mergePoint(b, x0, x1)
		v0 := b.NewValue0(v.Line, OpAMD64ROLWconst, v.Type)
		v.reset(OpCopy)
		v.AddArg(v0)
		v0.AuxInt = 8
		v1 := b.NewValue0(v.Line, OpAMD64MOVWload, config.fe.TypeUInt16())
		v1.AuxInt = i - 1
		v1.Aux = s
		v1.AddArg(p)
		v1.AddArg(mem)
	...
	for {
		...
		v.AddArg(v0)
		v0.AuxInt = 8
		v1 := b.NewValue0(v.Line, OpAMD64MOVWloadidx1, v.Type)
		v1.AuxInt = i - 1
		v1.Aux = s
		v1.AddArg(p)
		v1.AddArg(idx)
