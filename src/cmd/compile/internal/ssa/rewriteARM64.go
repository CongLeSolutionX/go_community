...
func rewriteValueARM64(v *Value) bool {
	...
	case OpARM64EONconst:
		return rewriteValueARM64_OpARM64EONconst_0(v)
	...
	case OpARM64ORNconst:
		return rewriteValueARM64_OpARM64ORNconst_0(v)
...
func rewriteValueARM64_OpARM64EONconst_0(v *Value) bool {
	// match: (EONconst [0] x)
	// cond:
	// result: (MVN x)
	for {
...
func rewriteValueARM64_OpARM64EONshiftLL_0(v *Value) bool {
	...
	// cond:
	// result: (EONconst x [int64(uint64(c)<<uint64(d))])
	for {
		d := v.AuxInt
		_ = v.Args[1]
		x := v.Args[0]
...
func rewriteValueARM64_OpARM64EONshiftRA_0(v *Value) bool {
	...
	// cond:
	// result: (EONconst x [int64(int64(c)>>uint64(d))])
	for {
		d := v.AuxInt
		_ = v.Args[1]
		x := v.Args[0]
...
func rewriteValueARM64_OpARM64ORNconst_0(v *Value) bool {
	// match: (ORNconst [0] _)
	// cond:
	// result: (MOVDconst [-1])
	for {
...
func rewriteValueARM64_OpARM64ORNshiftLL_0(v *Value) bool {
	...
	// cond:
	// result: (ORNconst x [int64(uint64(c)<<uint64(d))])
	for {
		d := v.AuxInt
		_ = v.Args[1]
		x := v.Args[0]
...
func rewriteValueARM64_OpARM64ORNshiftRA_0(v *Value) bool {
	...
	// cond:
	// result: (ORNconst x [int64(int64(c)>>uint64(d))])
	for {
		d := v.AuxInt
		_ = v.Args[1]
		x := v.Args[0]
