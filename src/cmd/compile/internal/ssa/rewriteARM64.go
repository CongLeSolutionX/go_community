...
func rewriteValueARM64_OpPopCount16_0(v *Value) bool {
	...
	// cond:
	// result: (FMOVDfpgp <typ.Int32> (VUADDLV <typ.Float32> (VCNT <typ.Float32> (FMOVDgpfp <typ.Float32> (ANDconst <t> [(1<<16) -1] x)))))
	for {
		t := v.Type
		x := v.Args[0]
		...
		v2 := b.NewValue0(v.Pos, OpARM64FMOVDgpfp, typ.Float32)
...
func rewriteValueARM64_OpPopCount32_0(v *Value) bool {
	...
	// match: (PopCount32 x)
	// cond:
	// result: (FMOVDfpgp <typ.Int32> (VUADDLV <typ.Float32> (VCNT <typ.Float32> (FMOVDgpfp <typ.Float32> x))))
	for {
		x := v.Args[0]
		v.reset(OpARM64FMOVDfpgp)
		v.Type = typ.Int32
...
func rewriteValueARM64_OpPopCount64_0(v *Value) bool {
	...
	// match: (PopCount64 x)
	// cond:
	// result: (FMOVDfpgp <typ.Int32> (VUADDLV <typ.Float64> (VCNT <typ.Float64> (FMOVDgpfp <typ.Float64> x))))
	for {
		x := v.Args[0]
		v.reset(OpARM64FMOVDfpgp)
		v.Type = typ.Int32
