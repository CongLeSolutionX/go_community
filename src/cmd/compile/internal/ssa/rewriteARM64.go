...
func rewriteValueARM64_OpARM64ADDconst(v *Value) bool {
	...
	for {
		...
		v.AuxInt = int64(int32(off1) + off2)
		v.Aux = sym
		v.AddArg(ptr)
		return true
	}
...
func rewriteValueARM64_OpARM64ADDshiftLL(v *Value) bool {
	...
	// result: (REV16W x)
	for {
		if v.Type != typ.UInt16 || v.AuxInt != 8 || v_0.Op != OpARM64UBFX || v_0.Type != typ.UInt16 || arm64BitField(v_0.AuxInt) != armBFAuxInt(8, 8) {
			break
		}
		x := v_0.Args[0]
		if x != v_1 {
	...
	// result: (REV16W x)
	for {
		if v.AuxInt != 8 || v_0.Op != OpARM64UBFX || arm64BitField(v_0.AuxInt) != armBFAuxInt(8, 24) {
			break
		}
		v_0_0 := v_0.Args[0]
	...
	// result: (REV16 x)
	for {
		if v.AuxInt != 8 || v_0.Op != OpARM64SRLconst || v_0.AuxInt != 8 {
			break
		}
		v_0_0 := v_0.Args[0]
		if v_0_0.Op != OpARM64ANDconst {
...
func rewriteValueARM64_OpARM64ANDconst(v *Value) bool {
	...
	for {
		...
		v.AuxInt = int64(armBFAuxInt(sc, arm64BFWidth(ac, sc)))
		v.AddArg(x)
		return true
	}
	...
	for {
		...
		v.reset(OpARM64UBFX)
		v.AuxInt = int64(armBFAuxInt(sc, arm64BFWidth(ac, 0)))
		v.AddArg(x)
		return true
	}
	...
	for {
		...
		v.reset(OpARM64UBFX)
		v.AuxInt = int64(armBFAuxInt(bfc.getARM64BFlsb(), min(bfc.getARM64BFwidth(), arm64BFWidth(c, 0))))
		v.AddArg(x)
		return true
	}
	return false
...
func rewriteValueARM64_OpARM64ANDshiftLL(v *Value) bool {
	...
	for {
		c := v.AuxInt
		y := v_0
		if y.Op != OpARM64SLLconst || y.AuxInt != c {
			break
		}
		x := y.Args[0]
		if x != v_1 {
...
func rewriteValueARM64_OpARM64ANDshiftRA(v *Value) bool {
	...
	for {
		c := v.AuxInt
		y := v_0
		if y.Op != OpARM64SRAconst || y.AuxInt != c {
			break
		}
		x := y.Args[0]
		if x != v_1 {
...
func rewriteValueARM64_OpARM64ANDshiftRL(v *Value) bool {
	...
	for {
		c := v.AuxInt
		y := v_0
		if y.Op != OpARM64SRLconst || y.AuxInt != c {
			break
		}
		x := y.Args[0]
		if x != v_1 {
...
func rewriteValueARM64_OpARM64ANDshiftRO(v *Value) bool {
	...
	for {
		c := v.AuxInt
		y := v_0
		if y.Op != OpARM64RORconst || y.AuxInt != c {
			break
		}
		x := y.Args[0]
		if x != v_1 {
...
func rewriteValueARM64_OpARM64BICshiftRA(v *Value) bool {
	...
	for {
		c := v.AuxInt
		if v_0.Op != OpARM64SRAconst || v_0.AuxInt != c {
			break
		}
		x := v_0.Args[0]
		if x != v_1 {
...
func rewriteValueARM64_OpARM64BICshiftRO(v *Value) bool {
	...
	for {
		c := v.AuxInt
		if v_0.Op != OpARM64RORconst || v_0.AuxInt != c {
			break
		}
		x := v_0.Args[0]
		if x != v_1 {
...
func rewriteValueARM64_OpARM64CMNWconst(v *Value) bool {
	...
	for {
		...
		v.AuxInt = int64(addFlags32(int32(x), y))
		return true
	}
	return false
}
...
func rewriteValueARM64_OpARM64CMPWconst(v *Value) bool {
	...
	for {
		...
		x := v_0.AuxInt
		v.reset(OpARM64FlagConstant)
		v.AuxInt = int64(subFlags32(int32(x), y))
		return true
	}
...
func rewriteValueARM64_OpARM64CSEL(v *Value) bool {
	...
	for {
		cc := Op(v.AuxInt)
		if v_0.Op != OpARM64MOVDconst || v_0.AuxInt != -1 || v_1.Op != OpARM64MOVDconst || v_1.AuxInt != 0 {
			break
		}
		flag := v_2
	...
	for {
		cc := Op(v.AuxInt)
		if v_0.Op != OpARM64MOVDconst || v_0.AuxInt != 0 || v_1.Op != OpARM64MOVDconst || v_1.AuxInt != -1 {
			break
		}
		flag := v_2
		v.reset(OpARM64CSETM)
		v.AuxInt = int64(arm64Negate(cc))
		v.AddArg(flag)
		return true
	}
	...
	for {
		cc := Op(v.AuxInt)
		if v_0.Op != OpARM64ADDconst || v_0.AuxInt != 1 {
			break
		}
		a := v_0.Args[0]
		x := v_1
	...
	for {
		...
		x := v_0
		y := v_1
		if v_2.Op != OpARM64CMPWconst || int32(v_2.AuxInt) != 0 {
			break
		}
		boolval := v_2.Args[0]
	...
	for {
		...
		v.reset(OpARM64CSEL)
		v.AuxInt = int64(arm64Negate(boolval.Op))
		v.AddArg3(x, y, flagArg(boolval))
		return true
	}
	return false
...
func rewriteValueARM64_OpARM64CSEL0(v *Value) bool {
	...
	for {
		cc := Op(v.AuxInt)
		x := v_0
		if v_1.Op != OpARM64CMPWconst || int32(v_1.AuxInt) != 0 {
			break
		}
		boolval := v_1.Args[0]
		if !(cc == OpARM64NotEqual && flagArg(boolval) != nil) {
...
func rewriteValueARM64_OpARM64DIVW(v *Value) bool {
	...
	for {
		...
		v.reset(OpARM64MOVDconst)
		v.AuxInt = int64(uint32(int32(c) / int32(d)))
		return true
	}
	return false
}
...
func rewriteValueARM64_OpARM64Equal(v *Value) bool {
	...
	for {
		if v_0.Op != OpARM64CMPconst || v_0.AuxInt != 0 {
			break
		}
		z := v_0.Args[0]
		if z.Op != OpARM64AND {
	...
	for {
		if v_0.Op != OpARM64CMPWconst || int32(v_0.AuxInt) != 0 {
			break
		}
		x := v_0.Args[0]
...
func rewriteValueARM64_OpARM64FMOVDload(v *Value) bool {
	...
	for {
		...
		sym := auxToSym(v.Aux)
		ptr := v_0
		if v_1.Op != OpARM64MOVDstore || int32(v_1.AuxInt) != off || auxToSym(v_1.Aux) != sym {
			break
		}
		val := v_1.Args[1]
		if ptr != v_1.Args[0] {
...
func rewriteValueARM64_OpARM64FMOVSload(v *Value) bool {
	...
	for {
		...
		sym := auxToSym(v.Aux)
		ptr := v_0
		if v_1.Op != OpARM64MOVWstore || int32(v_1.AuxInt) != off || auxToSym(v_1.Aux) != sym {
			break
		}
		val := v_1.Args[1]
		if ptr != v_1.Args[0] {
...
func rewriteValueARM64_OpARM64GreaterEqualNoov(v *Value) bool {
	...
	for {
		...
		x := v_0.Args[0]
		v.reset(OpARM64CSINC)
		v.AuxInt = int64(OpARM64NotEqual)
...
func rewriteValueARM64_OpARM64MOVBUload(v *Value) bool {
	...
	for {
		...
		v.reset(OpARM64MOVDconst)
		v.AuxInt = int64(read8(sym, int64(off)))
		return true
	}
	return false
}
...
func rewriteValueARM64_OpARM64MOVBUreg(v *Value) bool {
	...
	for {
		...
		v.reset(OpARM64UBFIZ)
		v.AuxInt = int64(armBFAuxInt(lc, 8-lc))
		v.AddArg(x)
		return true
	}
	...
	for {
		...
		v.reset(OpARM64UBFX)
		v.AuxInt = int64(armBFAuxInt(rc, 8))
		v.AddArg(x)
		return true
	}
...
func rewriteValueARM64_OpARM64MOVDload(v *Value) bool {
	...
	for {
		...
		sym := auxToSym(v.Aux)
		ptr := v_0
		if v_1.Op != OpARM64FMOVDstore || int32(v_1.AuxInt) != off || auxToSym(v_1.Aux) != sym {
			break
		}
		val := v_1.Args[1]
		if ptr != v_1.Args[0] {
...
func rewriteValueARM64_OpARM64MOVDstorezero(v *Value) bool {
	...
	for {
		...
		ptr := v_0
		x := v_1
		if x.Op != OpARM64MOVDstorezero || int32(x.AuxInt) != i+8 || auxToSym(x.Aux) != s {
			break
		}
		mem := x.Args[1]
...
func rewriteValueARM64_OpARM64MOVHUload(v *Value) bool {
	...
	for {
		...
		v.reset(OpARM64MOVDconst)
		v.AuxInt = int64(read16(sym, int64(off), config.ctxt.Arch.ByteOrder))
		return true
	}
	return false
}
...
func rewriteValueARM64_OpARM64MOVHUreg(v *Value) bool {
	...
	for {
		...
		v.reset(OpARM64UBFIZ)
		v.AuxInt = int64(armBFAuxInt(lc, 16-lc))
		v.AddArg(x)
		return true
	}
	...
	for {
		...
		v.reset(OpARM64UBFX)
		v.AuxInt = int64(armBFAuxInt(rc, 16))
		v.AddArg(x)
		return true
	}
...
func rewriteValueARM64_OpARM64MOVWUload(v *Value) bool {
	...
	for {
		...
		sym := auxToSym(v.Aux)
		ptr := v_0
		if v_1.Op != OpARM64FMOVSstore || int32(v_1.AuxInt) != off || auxToSym(v_1.Aux) != sym {
			break
		}
		val := v_1.Args[1]
		if ptr != v_1.Args[0] {
...
func rewriteValueARM64_OpARM64MOVWUreg(v *Value) bool {
	...
	for {
		...
		v.reset(OpARM64UBFIZ)
		v.AuxInt = int64(armBFAuxInt(lc, 32-lc))
		v.AddArg(x)
		return true
	}
	...
	for {
		...
		v.reset(OpARM64UBFX)
		v.AuxInt = int64(armBFAuxInt(rc, 32))
		v.AddArg(x)
		return true
	}
...
func rewriteValueARM64_OpARM64ORshiftRL(v *Value) bool {
	...
	for {
		...
		v.reset(OpARM64BFI)
		v.AuxInt = int64(armBFAuxInt(lc-rc, 64-lc))
		v.AddArg2(x, y)
		return true
	}
	...
	for {
		...
		v.reset(OpARM64BFXIL)
		v.AuxInt = int64(armBFAuxInt(rc-lc, 64-rc))
		v.AddArg2(y, x)
		return true
	}
	return false
...
func rewriteValueARM64_OpARM64SLL(v *Value) bool {
	...
	for {
		x := v_0
		if v_1.Op != OpARM64ANDconst || v_1.AuxInt != 63 {
			break
		}
		y := v_1.Args[0]
		v.reset(OpARM64SLL)
...
func rewriteValueARM64_OpARM64SLLconst(v *Value) bool {
	...
	for {
		...
		x := v_0.Args[0]
		v.reset(OpARM64SBFIZ)
		v.AuxInt = int64(armBFAuxInt(lc, min(32, 64-lc)))
		v.AddArg(x)
		return true
	}
	...
	for {
		...
		x := v_0.Args[0]
		v.reset(OpARM64SBFIZ)
		v.AuxInt = int64(armBFAuxInt(lc, min(16, 64-lc)))
		v.AddArg(x)
		return true
	}
	...
	for {
		...
		x := v_0.Args[0]
		v.reset(OpARM64SBFIZ)
		v.AuxInt = int64(armBFAuxInt(lc, min(8, 64-lc)))
		v.AddArg(x)
		return true
	}
	...
	for {
		...
		v.reset(OpARM64UBFIZ)
		v.AuxInt = int64(armBFAuxInt(bfc.getARM64BFlsb()+sc, bfc.getARM64BFwidth()))
		v.AddArg(x)
		return true
	}
	return false
...
func rewriteValueARM64_OpARM64SRAconst(v *Value) bool {
	...
	for {
		...
		v.reset(OpARM64SBFX)
		v.AuxInt = int64(armBFAuxInt(rc, 32-rc))
		v.AddArg(x)
		return true
	}
	...
	for {
		...
		v.reset(OpARM64SBFX)
		v.AuxInt = int64(armBFAuxInt(rc, 16-rc))
		v.AddArg(x)
		return true
	}
	...
	for {
		...
		v.reset(OpARM64SBFX)
		v.AuxInt = int64(armBFAuxInt(rc, 8-rc))
		v.AddArg(x)
		return true
	}
	...
	for {
		...
		v.reset(OpARM64SBFX)
		v.AuxInt = int64(armBFAuxInt(sc-bfc.getARM64BFlsb(), bfc.getARM64BFlsb()+bfc.getARM64BFwidth()-sc))
		v.AddArg(x)
		return true
	}
	return false
...
func rewriteValueARM64_OpARM64SRLconst(v *Value) bool {
	...
	for {
		...
		v.reset(OpARM64UBFX)
		v.AuxInt = int64(armBFAuxInt(bfc.getARM64BFlsb()+sc, bfc.getARM64BFwidth()-sc))
		v.AddArg(x)
		return true
	}
	...
	for {
		...
		v.reset(OpARM64ANDconst)
		v.AuxInt = 1<<uint(bfc.getARM64BFwidth()) - 1
		v.AddArg(x)
		return true
	}
	// match: (SRLconst [sc] (UBFIZ [bfc] x))
...
func rewriteValueARM64_OpARM64TSTWconst(v *Value) bool {
	...
	for {
		...
		x := v_0.AuxInt
		v.reset(OpARM64FlagConstant)
		v.AuxInt = int64(logicFlags32(int32(x) & y))
		return true
	}
	return false
}
func rewriteValueARM64_OpARM64TSTconst(v *Value) bool {
	...
	for {
		...
		x := v_0.AuxInt
		v.reset(OpARM64FlagConstant)
		v.AuxInt = int64(logicFlags64(x & y))
		return true
	}
	return false
}
...
func rewriteValueARM64_OpLeq16U(v *Value) bool {
	...
	for {
		x := v_0
		zero := v_1
		if zero.Op != OpARM64MOVDconst || zero.AuxInt != 0 {
			break
		}
		v.reset(OpEq16)
		v.AddArg2(x, zero)
...
func rewriteValueARM64_OpLsh16x16(v *Value) bool {
	...
	for {
		...
		v.reset(OpARM64CSEL)
		v.AuxInt = int64(OpARM64LessThanU)
...
func rewriteValueARM64_OpRsh16x16(v *Value) bool {
	...
	for {
		...
		v1.AuxInt = int64(OpARM64LessThanU)
...
func rewriteValueARM64_OpRsh64x16(v *Value) bool {
	...
	for {
		...
		v0.AuxInt = int64(OpARM64LessThanU)
...
func rewriteBlockARM64(b *Block) bool {
	...
	case BlockARM64EQ:
		...
		for b.Controls[0].Op == OpARM64TSTWconst {
			...
			b.resetWithControl(BlockARM64TBZ, x)
			b.AuxInt = int64(ntz64(int64(uint32(c))))
			return true
		}
