...
func rewriteValueARM64_OpARM64ANDconst_0(v *Value) bool {
	...
	for {
		...
		v.setAuxInt64(arm64BFAuxInt(sc, arm64BFWidth(ac, sc)))
		v.AddArg(x)
		return true
	}
	...
	for {
		...
		v.reset(OpARM64UBFX)
		v.setAuxInt64(arm64BFAuxInt(sc, arm64BFWidth(ac, 0)))
		v.AddArg(x)
		return true
	}
	return false
...
func rewriteValueARM64_OpARM64DIVW_0(v *Value) bool {
	...
	for {
		...
		d := v_1.auxInt64()
		v.reset(OpARM64MOVDconst)
		v.setAuxInt64(int64(int32(c) / int32(d)))
		return true
	}
	return false
}
...
func rewriteValueARM64_OpARM64MOVBUreg_0(v *Value) bool {
	...
	for {
		...
		v.reset(OpARM64UBFIZ)
		v.setAuxInt64(arm64BFAuxInt(sc, arm64BFWidth(1<<8-1, sc)))
		v.AddArg(x)
		return true
	}
	...
	for {
		...
		v.reset(OpARM64UBFX)
		v.setAuxInt64(arm64BFAuxInt(sc, 8))
		v.AddArg(x)
		return true
	}
	return false
...
func rewriteValueARM64_OpARM64MOVBreg_0(v *Value) bool {
	...
	for {
		...
		v.setAuxInt64(arm64BFAuxInt(lc, 8-lc))
		v.AddArg(x)
		return true
	}
	return false
...
func rewriteValueARM64_OpARM64MOVBstore_10(v *Value) bool {
	...
	for {
		...
		if v_1.auxInt64() != arm64BFAuxInt(8, 8) {
			break
		}
		w := v_1.Args[0]
		x := v.Args[2]
	...
	for {
		...
		if v_1.auxInt64() != arm64BFAuxInt(8, 24) {
			break
		}
		w := v_1.Args[0]
		x := v.Args[2]
...
func rewriteValueARM64_OpARM64MOVBstore_20(v *Value) bool {
	...
	for {
		...
		if x0_1.auxInt64() != arm64BFAuxInt(8, 24) {
			break
		}
		if w != x0_1.Args[0] {
			break
		...
		if x1_1.auxInt64() != arm64BFAuxInt(16, 16) {
			break
		}
		if w != x1_1.Args[0] {
			break
		...
		if x2_1.auxInt64() != arm64BFAuxInt(24, 8) {
			break
		}
		if w != x2_1.Args[0] {
			break
	...
	for {
		...
		if x2_2.auxInt64() != arm64BFAuxInt(24, 8) {
			break
		}
		if w != x2_2.Args[0] {
			break
...
func rewriteValueARM64_OpARM64MOVBstore_30(v *Value) bool {
	...
	for {
		...
		if x_1.auxInt64() != arm64BFAuxInt(8, 8) {
			break
		}
		if w != x_1.Args[0] {
			break
	...
	for {
		...
		if x_2.auxInt64() != arm64BFAuxInt(8, 8) {
			break
		}
		if w != x_2.Args[0] {
			break
	...
	for {
		...
		if x_1.auxInt64() != arm64BFAuxInt(8, 24) {
			break
		}
		if w != x_1.Args[0] {
			break
	...
	for {
		...
		if x_2.auxInt64() != arm64BFAuxInt(8, 24) {
			break
		}
		if w != x_2.Args[0] {
			break
...
func rewriteValueARM64_OpARM64MOVBstoreidx_10(v *Value) bool {
	...
	for {
		...
		if x0_2.auxInt64() != arm64BFAuxInt(8, 24) {
			break
		}
		if w != x0_2.Args[0] {
			break
		...
		if x1_2.auxInt64() != arm64BFAuxInt(16, 16) {
			break
		}
		if w != x1_2.Args[0] {
			break
...
func rewriteValueARM64_OpARM64MOVHUreg_0(v *Value) bool {
	...
	for {
		...
		v.reset(OpARM64UBFIZ)
		v.setAuxInt64(arm64BFAuxInt(sc, arm64BFWidth(1<<16-1, sc)))
		v.AddArg(x)
		return true
	}
	return false
...
func rewriteValueARM64_OpARM64MOVHUreg_10(v *Value) bool {
	...
	for {
		...
		v.reset(OpARM64UBFX)
		v.setAuxInt64(arm64BFAuxInt(sc, 16))
		v.AddArg(x)
		return true
	}
	return false
...
func rewriteValueARM64_OpARM64MOVHreg_10(v *Value) bool {
	...
	for {
		...
		v.reset(OpARM64SBFIZ)
		v.setAuxInt64(arm64BFAuxInt(lc, 16-lc))
		v.AddArg(x)
		return true
	}
	return false
...
func rewriteValueARM64_OpARM64MOVHstore_10(v *Value) bool {
	...
	for {
		...
		if v_1.auxInt64() != arm64BFAuxInt(16, 16) {
			break
		}
		w := v_1.Args[0]
		x := v.Args[2]
...
func rewriteValueARM64_OpARM64MOVWUreg_10(v *Value) bool {
	...
	for {
		...
		v.reset(OpARM64UBFIZ)
		v.setAuxInt64(arm64BFAuxInt(sc, arm64BFWidth(1<<32-1, sc)))
		v.AddArg(x)
		return true
	}
	...
	for {
		...
		v.reset(OpARM64UBFX)
		v.setAuxInt64(arm64BFAuxInt(sc, 32))
		v.AddArg(x)
		return true
	}
	return false
...
func rewriteValueARM64_OpARM64MOVWreg_10(v *Value) bool {
	...
	for {
		...
		v.reset(OpARM64SBFIZ)
		v.setAuxInt64(arm64BFAuxInt(lc, 32-lc))
		v.AddArg(x)
		return true
	}
	return false
...
func rewriteValueARM64_OpARM64ORshiftRL_0(v *Value) bool {
	...
	for {
		...
		v.reset(OpARM64BFI)
		v.setAuxInt64(arm64BFAuxInt(lc-rc, 64-lc))
		v.AddArg(x)
		v.AddArg(y)
		return true
	}
...
func rewriteValueARM64_OpARM64SLLconst_0(v *Value) bool {
	...
	for {
		...
		v.reset(OpARM64UBFIZ)
		v.setAuxInt64(arm64BFAuxInt(getARM64BFlsb(bfc)+sc, getARM64BFwidth(bfc)))
		v.AddArg(x)
		return true
	}
	return false
...
func rewriteValueARM64_OpARM64SRAconst_0(v *Value) bool {
	...
	for {
		...
		v.reset(OpARM64SBFX)
		v.setAuxInt64(arm64BFAuxInt(rc-lc, 64-rc))
		v.AddArg(x)
		return true
	}
	...
	for {
		...
		v.reset(OpARM64SBFX)
		v.setAuxInt64(arm64BFAuxInt(rc, 32-rc))
		v.AddArg(x)
		return true
	}
	...
	for {
		...
		v.reset(OpARM64SBFX)
		v.setAuxInt64(arm64BFAuxInt(rc, 16-rc))
		v.AddArg(x)
		return true
	}
	...
	for {
		...
		v.reset(OpARM64SBFX)
		v.setAuxInt64(arm64BFAuxInt(rc, 8-rc))
		v.AddArg(x)
		return true
	}
	...
	for {
		...
		v.reset(OpARM64SBFX)
		v.setAuxInt64(arm64BFAuxInt(sc-getARM64BFlsb(bfc), getARM64BFlsb(bfc)+getARM64BFwidth(bfc)-sc))
		v.AddArg(x)
		return true
	}
	return false
...
func rewriteValueARM64_OpARM64SRLconst_0(v *Value) bool {
	...
	for {
		...
		d := v_0.auxInt64()
		v.reset(OpARM64MOVDconst)
		v.setAuxInt64(int64(uint64(d) >> uint64(c)))
		return true
	}
	...
	for {
		...
		v.reset(OpARM64UBFX)
		v.setAuxInt64(arm64BFAuxInt(getARM64BFlsb(bfc)+sc, getARM64BFwidth(bfc)-sc))
		v.AddArg(x)
		return true
	}
	...
	for {
		...
		v.reset(OpARM64ANDconst)
		v.setAuxInt64(1<<uint(getARM64BFwidth(bfc)) - 1)
		v.AddArg(x)
		return true
	}
	return false
...
func rewriteValueARM64_OpARM64UDIVW_0(v *Value) bool {
	...
	for {
		...
		d := v_1.auxInt64()
		v.reset(OpARM64MOVDconst)
		v.setAuxInt64(int64(uint32(c) / uint32(d)))
		return true
	}
	return false
}
...
func rewriteValueARM64_OpMove_10(v *Value) bool {
	...
	for {
		...
		v0.setAuxInt64(s - s%8)
		v0.AddArg(dst)
		v.AddArg(v0)
		v1 := b.NewValue0(v.Pos, OpOffPtr, src.Type)
		v1.setAuxInt64(s - s%8)
		v1.AddArg(src)
		v.AddArg(v1)
		v2 := b.NewValue0(v.Pos, OpMove, types.TypeMem)
		v2.setAuxInt64(s - s%8)
		v2.AddArg(dst)
		v2.AddArg(src)
		v2.AddArg(mem)
		v.AddArg(v2)
