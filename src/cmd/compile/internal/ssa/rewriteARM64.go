...
func rewriteValueARM64(v *Value) bool {
	...
	case OpARM64NEGW:
		return rewriteValueARM64_OpARM64NEGW(v)
...
func rewriteValueARM64_OpARM64MADDW(v *Value) bool {
	...
	// match: (MADDW a x (MOVDconst [c]))
	// cond: isPowerOfTwo64(c)
	// result: (ADDWshiftLL a x [log64(c)])
	for {
		a := v_0
		x := v_1
		if v_2.Op != OpARM64MOVDconst {
	...
	// result: (ADDW a (ADDWshiftLL <x.Type> x x [log64(c-1)]))
	for {
		a := v_0
		x := v_1
		if v_2.Op != OpARM64MOVDconst {
		...
		v.reset(OpARM64ADDW)
		v0 := b.NewValue0(v.Pos, OpARM64ADDWshiftLL, x.Type)
		v0.AuxInt = int64ToAuxInt(log64(c - 1))
		v0.AddArg2(x, x)
		v.AddArg2(a, v0)
		return true
	...
	// result: (SUBW a (SUBWshiftLL <x.Type> x x [log64(c+1)]))
	for {
		a := v_0
		x := v_1
		if v_2.Op != OpARM64MOVDconst {
		...
		v.reset(OpARM64SUBW)
		v0 := b.NewValue0(v.Pos, OpARM64SUBWshiftLL, x.Type)
		v0.AuxInt = int64ToAuxInt(log64(c + 1))
		v0.AddArg2(x, x)
		v.AddArg2(a, v0)
		return true
	...
	// result: (SUBWshiftLL a (SUBWshiftLL <x.Type> x x [2]) [log64(c/3)])
	for {
		a := v_0
		x := v_1
		if v_2.Op != OpARM64MOVDconst {
	...
	// result: (ADDWshiftLL a (ADDWshiftLL <x.Type> x x [2]) [log64(c/5)])
	for {
		a := v_0
		x := v_1
		if v_2.Op != OpARM64MOVDconst {
	...
	// result: (SUBWshiftLL a (SUBWshiftLL <x.Type> x x [3]) [log64(c/7)])
	for {
		a := v_0
		x := v_1
		if v_2.Op != OpARM64MOVDconst {
	...
	// result: (ADDWshiftLL a (ADDWshiftLL <x.Type> x x [3]) [log64(c/9)])
	for {
		a := v_0
		x := v_1
		if v_2.Op != OpARM64MOVDconst {
	...
	// result: (ADDWconst [int32(c)] (MULW <x.Type> x y))
	for {
		if v_0.Op != OpARM64MOVDconst {
			break
		}
...
func rewriteValueARM64_OpARM64MNEGW(v *Value) bool {
	...
	// match: (MNEGW x (MOVDconst [c]))
	// cond: isPowerOfTwo64(c)
	// result: (NEGW (SLLconst <x.Type> [log64(c)] x))
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			x := v_0
			if v_1.Op != OpARM64MOVDconst {
	...
	// match: (MNEGW x (MOVDconst [c]))
	// cond: isPowerOfTwo64(c-1) && int32(c) >= 3
	// result: (NEGW (ADDWshiftLL <x.Type> x x [log64(c-1)]))
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			x := v_0
			if v_1.Op != OpARM64MOVDconst {
	...
	// match: (MNEGW x (MOVDconst [c]))
	// cond: isPowerOfTwo64(c+1) && int32(c) >= 7
	// result: (NEGW (ADDWshiftLL <x.Type> (NEGW <x.Type> x) x [log64(c+1)]))
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			x := v_0
			if v_1.Op != OpARM64MOVDconst {
			...
			v0 := b.NewValue0(v.Pos, OpARM64ADDWshiftLL, x.Type)
			v0.AuxInt = int64ToAuxInt(log64(c + 1))
			v1 := b.NewValue0(v.Pos, OpARM64NEGW, x.Type)
			v1.AddArg(x)
			v0.AddArg2(v1, x)
			v.AddArg(v0)
			return true
	...
	// match: (MNEGW x (MOVDconst [c]))
	// cond: c%3 == 0 && isPowerOfTwo64(c/3) && is32Bit(c)
	// result: (SLLWconst <x.Type> [log64(c/3)] (SUBWshiftLL <x.Type> x x [2]))
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			x := v_0
			if v_1.Op != OpARM64MOVDconst {
	...
	// match: (MNEGW x (MOVDconst [c]))
	// cond: c%5 == 0 && isPowerOfTwo64(c/5) && is32Bit(c)
	// result: (NEGW (SLLWconst <x.Type> [log64(c/5)] (ADDWshiftLL <x.Type> x x [2])))
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			x := v_0
			if v_1.Op != OpARM64MOVDconst {
			...
			v.reset(OpARM64NEGW)
			v0 := b.NewValue0(v.Pos, OpARM64SLLWconst, x.Type)
			v0.AuxInt = int64ToAuxInt(log64(c / 5))
			v1 := b.NewValue0(v.Pos, OpARM64ADDWshiftLL, x.Type)
			v1.AuxInt = int64ToAuxInt(2)
			v1.AddArg2(x, x)
			v0.AddArg(v1)
			v.AddArg(v0)
	...
	// match: (MNEGW x (MOVDconst [c]))
	// cond: c%7 == 0 && isPowerOfTwo64(c/7) && is32Bit(c)
	// result: (SLLWconst <x.Type> [log64(c/7)] (SUBWshiftLL <x.Type> x x [3]))
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			x := v_0
			if v_1.Op != OpARM64MOVDconst {
	...
	// match: (MNEGW x (MOVDconst [c]))
	// cond: c%9 == 0 && isPowerOfTwo64(c/9) && is32Bit(c)
	// result: (NEGW (SLLWconst <x.Type> [log64(c/9)] (ADDWshiftLL <x.Type> x x [3])))
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			x := v_0
			if v_1.Op != OpARM64MOVDconst {
...
func rewriteValueARM64_OpARM64MSUBW(v *Value) bool {
	...
	// match: (MSUBW a x (MOVDconst [c]))
	// cond: isPowerOfTwo64(c)
	// result: (SUBWshiftLL a x [log64(c)])
	for {
		a := v_0
		x := v_1
		if v_2.Op != OpARM64MOVDconst {
	...
	// match: (MSUBW a x (MOVDconst [c]))
	// cond: isPowerOfTwo64(c-1) && int32(c)>=3
	// result: (SUBW a (ADDWshiftLL <x.Type> x x [log64(c-1)]))
	for {
		a := v_0
		x := v_1
		if v_2.Op != OpARM64MOVDconst {
	...
	// match: (MSUBW a x (MOVDconst [c]))
	// cond: isPowerOfTwo64(c+1) && int32(c)>=7
	// result: (ADDW a (SUBWshiftLL <x.Type> x x [log64(c+1)]))
	for {
		a := v_0
		x := v_1
		if v_2.Op != OpARM64MOVDconst {
	...
	// match: (MSUBW a x (MOVDconst [c]))
	// cond: c%3 == 0 && isPowerOfTwo64(c/3) && is32Bit(c)
	// result: (ADDWshiftLL a (SUBWshiftLL <x.Type> x x [2]) [log64(c/3)])
	for {
		a := v_0
		x := v_1
		if v_2.Op != OpARM64MOVDconst {
	...
	// match: (MSUBW a x (MOVDconst [c]))
	// cond: c%5 == 0 && isPowerOfTwo64(c/5) && is32Bit(c)
	// result: (SUBWshiftLL a (ADDWshiftLL <x.Type> x x [2]) [log64(c/5)])
	for {
		a := v_0
		x := v_1
		if v_2.Op != OpARM64MOVDconst {
	...
	// match: (MSUBW a x (MOVDconst [c]))
	// cond: c%7 == 0 && isPowerOfTwo64(c/7) && is32Bit(c)
	// result: (ADDWshiftLL a (SUBWshiftLL <x.Type> x x [3]) [log64(c/7)])
	for {
		a := v_0
		x := v_1
		if v_2.Op != OpARM64MOVDconst {
	...
	// match: (MSUBW a x (MOVDconst [c]))
	// cond: c%9 == 0 && isPowerOfTwo64(c/9) && is32Bit(c)
	// result: (SUBWshiftLL a (ADDWshiftLL <x.Type> x x [3]) [log64(c/9)])
	for {
		a := v_0
		x := v_1
		if v_2.Op != OpARM64MOVDconst {
	...
	// result: (ADDWconst [int32(c)] (MNEGW <x.Type> x y))
	for {
		if v_0.Op != OpARM64MOVDconst {
			break
		}
...
func rewriteValueARM64_OpARM64MULW(v *Value) bool {
	...
	// match: (MULW x (MOVDconst [c]))
	// cond: isPowerOfTwo64(c-1) && int32(c) >= 3
	// result: (ADDWshiftLL x x [log64(c-1)])
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			x := v_0
			if v_1.Op != OpARM64MOVDconst {
	...
	// match: (MULW x (MOVDconst [c]))
	// cond: isPowerOfTwo64(c+1) && int32(c) >= 7
	// result: (ADDWshiftLL (NEGW <x.Type> x) x [log64(c+1)])
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			x := v_0
			if v_1.Op != OpARM64MOVDconst {
			...
			v.reset(OpARM64ADDWshiftLL)
			v.AuxInt = int64ToAuxInt(log64(c + 1))
			v0 := b.NewValue0(v.Pos, OpARM64NEGW, x.Type)
			v0.AddArg(x)
			v.AddArg2(v0, x)
			return true
		}
	...
	// match: (MULW x (MOVDconst [c]))
	// cond: c%3 == 0 && isPowerOfTwo64(c/3) && is32Bit(c)
	// result: (SLLWconst [log64(c/3)] (ADDWshiftLL <x.Type> x x [1]))
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			x := v_0
			if v_1.Op != OpARM64MOVDconst {
	...
	// match: (MULW x (MOVDconst [c]))
	// cond: c%5 == 0 && isPowerOfTwo64(c/5) && is32Bit(c)
	// result: (SLLWconst [log64(c/5)] (ADDWshiftLL <x.Type> x x [2]))
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			x := v_0
			if v_1.Op != OpARM64MOVDconst {
	...
	// match: (MULW x (MOVDconst [c]))
	// cond: c%7 == 0 && isPowerOfTwo64(c/7) && is32Bit(c)
	// result: (SLLWconst [log64(c/7)] (ADDWshiftLL <x.Type> (NEGW <x.Type> x) x [3]))
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			x := v_0
			if v_1.Op != OpARM64MOVDconst {
	...
	// match: (MULW x (MOVDconst [c]))
	// cond: c%9 == 0 && isPowerOfTwo64(c/9) && is32Bit(c)
	// result: (SLLWconst [log64(c/9)] (ADDWshiftLL <x.Type> x x [3]))
	for {
		for _i0 := 0; _i0 <= 1; _i0, v_0, v_1 = _i0+1, v_1, v_0 {
			x := v_0
			if v_1.Op != OpARM64MOVDconst {
...
func rewriteValueARM64_OpARM64NEGW(v *Value) bool {
	v_0 := v.Args[0]
	// match: (NEGW (MULW x y))
	// result: (MNEGW x y)
	for {
