...
func rewriteValueARM64_OpARM64MOVBstorezero_0(v *Value) bool {
	...
	// match: (MOVBstorezero [i] {s} p x:(MOVBstorezero [i-1] {s} p mem))
	// cond: x.Uses == 1 && clobber(x)
	// result: (MOVHstorezero [i-1] {s} p mem)
	for {
		i := v.AuxInt
		s := v.Aux
		_ = v.Args[1]
...
func rewriteValueARM64_OpARM64MOVDstorezero_0(v *Value) bool {
	...
	// match: (MOVDstorezero [i] {s} p x:(MOVDstorezero [i-8] {s} p mem))
	// cond: x.Uses == 1 && clobber(x)
	// result: (MOVQstorezero [i-8] {s} p mem)
	for {
		i := v.AuxInt
		s := v.Aux
		_ = v.Args[1]
...
func rewriteValueARM64_OpARM64MOVHstorezero_0(v *Value) bool {
	...
	// match: (MOVHstorezero [i] {s} p x:(MOVHstorezero [i-2] {s} p mem))
	// cond: x.Uses == 1 && clobber(x)
	// result: (MOVWstorezero [i-2] {s} p mem)
	for {
		i := v.AuxInt
		s := v.Aux
		_ = v.Args[1]
...
func rewriteValueARM64_OpARM64MOVWstorezero_0(v *Value) bool {
	...
	// match: (MOVWstorezero [i] {s} p x:(MOVWstorezero [i-4] {s} p mem))
	// cond: x.Uses == 1 && clobber(x)
	// result: (MOVDstorezero [i-4] {s} p mem)
	for {
		i := v.AuxInt
		s := v.Aux
		_ = v.Args[1]
