...
func rewriteValueARM64_OpARM64ADD_10(v *Value) bool {
	...
	for {
		...
		if v_0_1_0_1.Op != OpARM64ANDconst || v_0_1_0_1.Type != t || v_0_1_0_1.AuxInt != 63 || y != v_0_1_0_1.Args[0] || v_1.Op != OpARM64SLL {
			break
		}
		_ = v_1.Args[1]
		if x != v_1.Args[0] {
...
func rewriteValueARM64_OpARM64ADD_20(v *Value) bool {
	...
	for {
		...
		v_0_1_0_1 := v_0_1_0.Args[1]
		if v_0_1_0_1.Op != OpARM64ANDconst || v_0_1_0_1.Type != t || v_0_1_0_1.AuxInt != 63 || y != v_0_1_0_1.Args[0] || v_1.Op != OpARM64SRL || v_1.Type != typ.UInt64 {
			break
		}
		_ = v_1.Args[1]
		if x != v_1.Args[0] {
	...
	for {
		...
		v_0_1_0_1 := v_0_1_0.Args[1]
		if v_0_1_0_1.Op != OpARM64ANDconst || v_0_1_0_1.Type != t || v_0_1_0_1.AuxInt != 31 || y != v_0_1_0_1.Args[0] || v_1.Op != OpARM64SLL {
			break
		}
		_ = v_1.Args[1]
		if x != v_1.Args[0] {
	...
	for {
		...
		v_0_1_0_1 := v_0_1_0.Args[1]
		if v_0_1_0_1.Op != OpARM64ANDconst || v_0_1_0_1.Type != t || v_0_1_0_1.AuxInt != 31 || y != v_0_1_0_1.Args[0] || v_1.Op != OpARM64SRL || v_1.Type != typ.UInt32 {
			break
		}
		_ = v_1.Args[1]
		v_1_0 := v_1.Args[0]
...
func rewriteValueARM64_OpARM64ADDshiftLL_0(v *Value) bool {
	...
	for {
		...
		bfc := v_0.AuxInt
		x := v_0.Args[0]
		if x != v.Args[1] || !(c < 32 && t.Size() == 4 && bfc == armBFAuxInt(32-c, c)) {
			break
		}
