...
// loopReschedChecksEnabled indicates whether the compiler pass that
// inserts rescheduling checks on loop backedges is enabled.  Dead
// store elimination use this to control (usually avoid) allocation
// of a temporary slice passing necessary information to that pass.
var loopReschedChecksEnabled bool
...
func Compile(f *Func) {
	...
	loopReschedChecksEnabled = !passes[passNameToIndex["insert resched checks"]].disabled
...
var passes = [...]pass{
	...
	{name: "fuse", fn: fuse},
	{name: "dse", fn: dse},
	{name: "insert resched checks", fn: altinsertLoopReschedChecks,
...
var passOrder = [...]constraint{
	// dse defines Func.lastMems for use by insert resched checks
