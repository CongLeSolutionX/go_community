...
func TestDeadStore(t *testing.T) {
	...
	fun := c.Fun("entry",
		Bloc("entry",
			...
			Valu("addr2", OpAddr, ptrType, 0, nil, "sb", "start"),
			Valu("addr3", OpAddr, ptrType, 0, nil, "sb", "start"),
...
func TestDeadStorePhi(t *testing.T) {
	...
	fun := c.Fun("entry",
		Bloc("entry",
			...
			Valu("sb", OpSB, c.config.Types.Uintptr, 0, nil),
			Valu("v", OpConstBool, c.config.Types.Bool, 1, nil),
			Valu("addr", OpAddr, ptrType, 0, nil, "sb", "start"),
			Goto("loop")),
		Bloc("loop",
...
func TestDeadStoreTypes(t *testing.T) {
	...
	fun := c.Fun("entry",
		Bloc("entry",
			...
			Valu("sb", OpSB, c.config.Types.Uintptr, 0, nil),
			Valu("v", OpConstBool, c.config.Types.Bool, 1, nil),
			Valu("addr1", OpAddr, t1, 0, nil, "sb", "start"),
			Valu("addr2", OpAddr, t2, 0, nil, "sb", "start"),
