...
func rewriteValueRISCV64_OpZero(v *Value) bool {
	...
	// result: (MOVBstore [3] ptr (MOVBconst) (MOVBstore [2] ptr (MOVBconst) (MOVBstore [1] ptr (MOVBconst) (MOVBstore ptr (MOVBconst) mem))))
	for {
		if auxIntToInt64(v.AuxInt) != 4 {
			break
		}
	...
	// match: (Zero [8] {t} ptr mem)
	// cond: t.Alignment()%2 == 0
	// result: (MOVHstore [6] ptr (MOVHconst) (MOVHstore [4] ptr (MOVHconst) (MOVHstore [2] ptr (MOVHconst) (MOVHstore ptr (MOVHconst) mem))))
	for {
		if auxIntToInt64(v.AuxInt) != 8 {
			break
		}
	...
	// result: (MOVBstore [2] ptr (MOVBconst) (MOVBstore [1] ptr (MOVBconst) (MOVBstore ptr (MOVBconst) mem)))
	for {
		if auxIntToInt64(v.AuxInt) != 3 {
			break
		}
	...
	// cond: t.Alignment()%2 == 0
	// result: (MOVHstore [4] ptr (MOVHconst) (MOVHstore [2] ptr (MOVHconst) (MOVHstore ptr (MOVHconst) mem)))
	for {
		if auxIntToInt64(v.AuxInt) != 6 {
			break
		}
	...
	// cond: t.Alignment()%4 == 0
	// result: (MOVWstore [8] ptr (MOVWconst) (MOVWstore [4] ptr (MOVWconst) (MOVWstore ptr (MOVWconst) mem)))
	for {
		if auxIntToInt64(v.AuxInt) != 12 {
			break
		}
	...
	// cond: t.Alignment()%8 == 0
	// result: (MOVDstore [24] ptr (MOVDconst) (MOVDstore [16] ptr (MOVDconst) (MOVDstore [8] ptr (MOVDconst) (MOVDstore ptr (MOVDconst) mem))))
	for {
		if auxIntToInt64(v.AuxInt) != 32 {
			break
		}
