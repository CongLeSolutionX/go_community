...
func rewriteValueRISCV64_OpConst32F(v *Value) bool {
	...
	for {
		...
		v0.AuxInt = int64(math.Float32bits(val))
		v.AddArg(v0)
		return true
	}
}
...
func rewriteValueRISCV64_OpConst64F(v *Value) bool {
	...
	for {
		...
		v0 := b.NewValue0(v.Pos, OpRISCV64MOVDconst, typ.UInt64)
		v0.AuxInt = int64(math.Float64bits(val))
		v.AddArg(v0)
		return true
	}
}
...
func rewriteValueRISCV64_OpRISCV64SLTIU(v *Value) bool {
	...
	for {
		...
		y := v_0.AuxInt
		v.reset(OpRISCV64MOVDconst)
		v.AuxInt = b2i(uint64(y) < uint64(x))
		return true
	}
...
func rewriteValueRISCV64_OpRISCV64SRLI(v *Value) bool {
	...
	for {
		...
		y := v_0.AuxInt
		v.reset(OpRISCV64MOVDconst)
		v.AuxInt = int64(uint64(y) >> uint32(x))
		return true
	}
	return false
}
...
func rewriteValueRISCV64_OpZero(v *Value) bool {
	...
	for {
		...
		v1 := b.NewValue0(v.Pos, OpRISCV64MOVDconst, typ.UInt64)
		v1.AuxInt = s - moveSize(t.Alignment(), config)
		v0.AddArg2(ptr, v1)
		v.AddArg3(ptr, v0, mem)
		return true
	}
