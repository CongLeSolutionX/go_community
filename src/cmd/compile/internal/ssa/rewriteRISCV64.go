...
func rewriteValueRISCV64_OpRISCV64OR(v *Value) bool {
	...
	v_0 := v.Args[0]
	b := v.Block
	// match: (OR <t> o0a:(MOVDnop x0:(MOVBUload {s} [i0] p mem)) o0b:(SLLI [8] n0:(MOVDnop x1:(MOVBUload {s} [i1] p mem))))
	...
	// match: (OR <t> o3a:(SLLI [24] n3:(MOVDnop x3:(MOVBUload {s} [i3] p mem))) o3b:(OR o0a:(MOVHUload {s} [i0] p mem) o0b:(SLLI [16] n2:(MOVDnop x2:(MOVBUload {s} [i2] p mem)))))
	...
	// match: (OR <t> o7a:(SLLI [56] n7:(MOVDnop x7:(MOVBUload {s} [i7] p mem))) o7b:(OR o6a:(SLLI [48] n6:(MOVDnop x6:(MOVBUload {s} [i6] p mem))) o6b:(OR o5a:(SLLI [40] n5:(MOVDnop x5:(MOVBUload {s} [i5] p mem))) o5b:(OR o0a:(MOVWUload {s} [i0] p mem) o0b:(SLLI [32] n4:(MOVDnop x4:(MOVBUload {s} [i4] p mem)))))))
