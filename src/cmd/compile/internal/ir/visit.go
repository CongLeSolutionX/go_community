...
// a node x satisfying find(x) (for which find(x) returns true),
// at which point the entire traversal stops and returns true.
//
...
// Visit visits each node x in the IR tree rooted at n
