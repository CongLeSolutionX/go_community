...
const (
	...
	//   for nil) or an expression indicating a *runtime._type for generics.
	//   If a type-switch variable is specified, Rlist is an
	...
	ODYNAMICTYPE     // a type node for type switches (represents a dynamic target type of a type switch)
