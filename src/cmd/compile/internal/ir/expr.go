...
func NewAddStringExpr(pos src.XPos, exprs []Node) *AddStringExpr {
	n := &AddStringExpr{}
	n.pos = pos
	n.op = OADDSTR
	n.Exprs.Set(exprs)
...
func (n *AddStringExpr) List() Nodes                   { return n.Exprs }
func (n *AddStringExpr) PtrList() *Nodes               { return &n.Exprs }
func (n *AddStringExpr) SetList(x Nodes)               { n.Exprs = x }
...
type CallExpr struct {
	...
	X        Node
	Args     Nodes
	Rargs    Nodes // TODO DELETE
	body     Nodes // TODO DELETE
	init     Nodes
	orig     Node
	DDD      bool
	noInline bool
...
func NewCallExpr(pos src.XPos, x Node, args []Node) *CallExpr {
	n := &CallExpr{X: x}
	n.pos = pos
	n.orig = n
	n.op = OCALL
...
func (n *CallExpr) AddInit(init []Node) Node      { n.init.Prepend(init...); return n }
...
var _ AddInitNode = (*CallExpr)(nil)
...
func (n *CompLitExpr) List() Nodes                   { return n.Vals }
func (n *CompLitExpr) PtrList() *Nodes               { return &n.Vals }
func (n *CompLitExpr) SetList(x Nodes)               { n.Vals = x }
...
func NewIndexExpr(pos src.XPos, x, y Node) *IndexExpr {
	n := &IndexExpr{X: x, Y: y}
	n.pos = pos
	n.op = OINDEX
	return n
...
func (n *IndexExpr) Right() Node                   { return n.Y }
func (n *IndexExpr) SetRight(y Node)               { n.Y = y }
...
func NewKeyExpr(pos src.XPos, x, y Node) *KeyExpr {
	n := &KeyExpr{X: x, Y: y}
	n.pos = pos
	n.op = OKEY
...
func (n *KeyExpr) Left() Node                    { return n.X }
func (n *KeyExpr) SetLeft(x Node)                { n.X = x }
func (n *KeyExpr) Right() Node                   { return n.Y }
func (n *KeyExpr) SetRight(y Node)               { n.Y = y }
...
func (n *InlinedCallExpr) AddInit(init []Node) Node      { n.init.Prepend(init...); return n }
...
func NewSelectorExpr(pos src.XPos, x Node, sym *types.Sym) *SelectorExpr {
	n := &SelectorExpr{X: x, sym: sym}
	n.pos = pos
	n.op = OXDOT
	n.offset = types.BADWIDTH
	return n
...
func (n *SelectorExpr) Sym() *types.Sym               { return n.sym }
func (n *SelectorExpr) SetSym(x *types.Sym)           { n.sym = x }
...
// A SliceExpr is a slice expression X[Lo:Hi].
...
func NewTypeAssertionExpr(pos src.XPos, x Node, typ Ntype) *TypeAssertionExpr {
	n := &TypeAssertionExpr{X: x, Ntype: typ}
	n.pos = pos
	n.op = ODOTTYPE
	return n
}

func (n *TypeAssertionExpr) String() string                { return fmt.Sprint(n) }
func (n *TypeAssertionExpr) Format(s fmt.State, verb rune) { FmtNode(n, s, verb) }
func (n *TypeAssertionExpr) RawCopy() Node                 { c := *n; return &c }
func (n *TypeAssertionExpr) Left() Node                    { return n.X }
func (n *TypeAssertionExpr) SetLeft(x Node)                { n.X = x }
func (n *TypeAssertionExpr) Right() Node                   { return n.Ntype }
func (n *TypeAssertionExpr) SetRight(x Node)               { n.Ntype = x } // TODO: toNtype(x)
func (n *TypeAssertionExpr) List() Nodes                   { return n.Itab }
func (n *TypeAssertionExpr) PtrList() *Nodes               { return &n.Itab }
func (n *TypeAssertionExpr) SetList(x Nodes)               { n.Itab = x }

func (n *TypeAssertionExpr) SetOp(op Op) {
	switch op {
	default:
		panic(n.no("SetOp " + op.String()))
...
func (n *UnaryExpr) SetOp(op Op) {
	...
	default:
		panic(n.no("SetOp " + op.String()))
	case OBITNOT, ONEG, ONOT, OPAREN, OPLUS, OPTRLIT, ORECV,
