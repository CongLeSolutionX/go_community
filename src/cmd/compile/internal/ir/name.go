...
// fn. If n is a free variable declared within a function that encloses fn, then
// CaptureName returns a closure variable that refers to n and adds it to
// fn.ClosureVars. Otherwise, it simply returns n.
func CaptureName(pos src.XPos, fn *Func, n *Name) *Name {
	if n.Op() != ONAME || n.Curfn == nil || n.Curfn == fn {
		return n
	}

	// fn is referring to var declared in outer func n.Curfn.
	if fn == nil {
