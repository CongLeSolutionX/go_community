...
//
// First, a closure function (fn.OClosure != nil) cannot be the root
// of a connected component. Refusing to use it as a root forces it
// into the component of the function in which it appears.  This is
...
func (v *bottomUpVisitor) visit(n *Func) uint32 {
	...
	if (min == id || min == id+1) && n.OClosure == nil {
