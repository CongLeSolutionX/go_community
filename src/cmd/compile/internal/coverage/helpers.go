...
// fixupMetaAndCounterVariables reads (from the data taken from the
// file provided by the -coverargecfg command line option) the names
// of the coverage counter and meta-data variables used for this
// "-cover" build, looks them up, reclassifies them appropriately, and
