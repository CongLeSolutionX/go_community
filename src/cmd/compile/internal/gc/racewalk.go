...
// by the (*state).instrument method, so here we just set the
// Func.InstrumentBody flag as needed. For background on why this is
// done during SSA construction rather than a separate SSA pass, see
// issue #19054.
