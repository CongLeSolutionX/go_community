...
func adderr(line src.Lineno, format string, args ...interface{}) {
...
func linestr(line src.Lineno) string {
...
var lasterror struct {
	syntax src.Lineno // line of last syntax error
	other  src.Lineno // line of last non-syntax error
	msg    string     // error message of last non-syntax error
}

func yyerrorl(line src.Lineno, format string, args ...interface{}) {
...
func Warnl(line src.Lineno, fmt_ string, args ...interface{}) {
...
func setlineno(n *Node) src.Lineno {
	lno := lineno
	if n != nil {
		switch n.Op {
		case ONAME, OPACK:
...
func treecopy(n *Node, lineno src.Lineno) *Node {
	if n == nil {
		return nil
	}
...
func listtreecopy(l []*Node, lineno src.Lineno) []*Node {
	var out []*Node
	for _, n := range l {
