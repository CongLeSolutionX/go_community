...
// line.
// TODO(gri) We need to also look at the filename now because
// a line number is not unique anymore across all files.
var lasterror struct {
	syntax uint   // line of last syntax error
	other  uint   // line of last non-syntax error
