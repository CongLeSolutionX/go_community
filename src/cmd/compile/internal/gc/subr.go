...
func Eqtype(t1, t2 *Type) bool {
	return eqtype1(t1, t2, make(map[TypePair]struct{}))
}

func eqtype1(t1, t2 *Type, assumed_equal map[TypePair]struct{}) bool {
	if t1 == t2 {
		return true
	}
	...
	if _, ok := assumed_equal[TypePair{t1, t2}]; ok {
		return true
	}
	assumed_equal[TypePair{t1, t2}] = struct{}{}
	...
	case TINTER, TSTRUCT:
		...
		for ; t1 != nil && t2 != nil; t1, t2 = t1.Down, t2.Down {
			...
			if t1.Sym != t2.Sym || t1.Embedded != t2.Embedded || !eqtype1(t1.Type, t2.Type, assumed_equal) || !eqnote(t1.Note, t2.Note) {
				return false
			}
		}
	...
	case TFUNC:
		...
		for ; t1 != nil && t2 != nil; t1, t2 = t1.Down, t2.Down {
			...
			for ; ta != nil && tb != nil; ta, tb = ta.Down, tb.Down {
				...
				if ta.Isddd != tb.Isddd || !eqtype1(ta.Type, tb.Type, assumed_equal) {
					return false
				}
			}
	...
	return eqtype1(t1.Down, t2.Down, assumed_equal) && eqtype1(t1.Type, t2.Type, assumed_equal)
}
