...
opswitch:
	...
	case OANDAND, OOROR:
		...
		res, sucsess := walkinrange(n, init)
		n = res
		if !sucsess && n.Left.Op == OANDAND && n.Op == OANDAND { //&& n.Left.Right.isIntOrdering() && n.Right.isIntOrdering() {
			...
			n.Right, _ = walkinrange(n.Right, init)
		}
