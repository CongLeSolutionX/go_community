...
func walkexpr1(n ir.Node, init *ir.Nodes) ir.Node {
	...
	case ir.OAS, ir.OASOP:
		...
		if !base.Flag.Cfg.Instrumenting && ir.IsZero(n.Y) {
			return n
		}
	...
	case ir.OCONVIFACE:
		...
		if ir.Names.Staticuint64s == nil {
			ir.Names.Staticuint64s = typecheck.NewName(types.Pkgs.Runtime.Lookup("staticuint64s"))
			...
			ir.Names.Zerobase = typecheck.NewName(types.Pkgs.Runtime.Lookup("zerobase"))
