...
opswitch:
	...
	case OCONV, OCONVNOP:
		n.Left = walkexpr(n.Left, init)
		if Debug_checkptr != 0 && !compiling_runtime && n.Op == OCONVNOP {
...
func walkcheckptr(n *Node, init *Nodes) *Node {
	...
	case n.Type.Etype == TUNSAFEPTR && n.Left.Type.Etype == TUINTPTR && !checkptrVisiting[n]:
