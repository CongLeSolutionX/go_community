...
func runtimeTypes() []*Type {
	...
	typs[77] = tostruct([]*Node{namedfield("enabled", typs[13]), namedfield("pad", typs[76]), namedfield("needed", typs[13]), namedfield("cgo", typs[13]), namedfield("roc", typs[13]), namedfield("mark", typs[13]), namedfield("alignme", typs[19])})
	...
	typs[82] = functype(nil, []*Node{anonfield(typs[1]), anonfield(typs[74]), anonfield(typs[3])}, []*Node{anonfield(typs[13])})
	typs[83] = functype(nil, []*Node{anonfield(typs[1]), anonfield(typs[3]), anonfield(typs[71])}, []*Node{anonfield(typs[13])})
	typs[84] = typPtr(typs[13])
	typs[85] = functype(nil, []*Node{anonfield(typs[1]), anonfield(typs[3]), anonfield(typs[84]), anonfield(typs[71])}, []*Node{anonfield(typs[13])})
	typs[86] = functype(nil, []*Node{anonfield(typs[1]), anonfield(typs[17]), anonfield(typs[10])}, nil)
	typs[87] = functype(nil, []*Node{anonfield(typs[1]), anonfield(typs[71]), anonfield(typs[3]), anonfield(typs[84])}, []*Node{anonfield(typs[13])})
