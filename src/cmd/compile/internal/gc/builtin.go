...
var runtimeDecls = [...]struct {
	...
	{"deferreturn", funcTag, 111},
	{"deferproc", funcTag, 113},
	{"newproc", funcTag, 113},
	{"memhash_varlen", funcTag, 114},
...
func runtimeTypes() []*types.Type {
	...
	typs[113] = functype(nil, []*Node{anonfield(typs[8]), anonfield(typs[47])}, nil)
	typs[114] = functype(nil, []*Node{anonfield(typs[58]), anonfield(typs[47])}, []*Node{anonfield(typs[47])})
	return typs[:]
}
