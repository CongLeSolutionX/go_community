...
func tempAt(pos src.XPos, curfn ir.INode, t *types.Type) ir.INode {
	if curfn == nil {
	...
	if t == nil {
		base.Fatal("tempAt called with nil type")
	}
...
func temp(t *types.Type) ir.INode {
