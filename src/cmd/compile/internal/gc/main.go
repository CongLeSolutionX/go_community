...
func Main(archInit func(*Arch)) {
	...
	flag.BoolVar(&smallStacks, "smallstacks", false, "reduce the size limit for stack allocated objects")
	...
	recordFlags("B", "N", "l", "msan", "race", "shared", "dynlink", "dwarflocationlists", "newescape", "dwarfbasentries", "smallStacks")
