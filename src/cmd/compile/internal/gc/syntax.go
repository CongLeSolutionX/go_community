...
const (
	...
	funcAutogenerated            // autogenerated by the compiler
)
...
func (f *Func) Autogenerated() bool            { return f.flags&funcAutogenerated != 0 }
...
func (f *Func) SetAutogenerated(b bool)            { f.flags.set(funcAutogenerated, b) }
