...
type Node struct {
	...
	Walkdef   uint8 // Counter used to detect loops during typecheckdef
	Typecheck uint8 // Counter used to detect loops during type checks
	Local     bool
	Dodata    uint8
	Initorder uint8
	Used      bool // is the variable declared and not used
