...
func initssaconfig() {
	...
	Duffcopy = sysfunc("duffcopy")             // asm func with special ABI
	Duffzero = sysfunc("duffzero")             // asm func with special ABI
	gcWriteBarrier = sysfunc("gcWriteBarrier") // asm func with special ABI
