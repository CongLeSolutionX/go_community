...
// newValue3I adds a new value with three arguments and aux and auxint values to the current block.
...
func SlotAddr(slot *ssa.LocalSlot, a *obj.Addr) {
