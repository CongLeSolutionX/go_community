...
func init() {
	...
	// ReverseBytes16 lowers to a rotate, no need for anything special here except
	// those architectures that can't lower it to a rotate.
	alias("math/bits", "ReverseBytes", "math/bits", "ReverseBytes32", sys.ArchARM)
	alias("math/bits", "ReverseBytes", "math/bits", "ReverseBytes64", sys.ArchARM64)
