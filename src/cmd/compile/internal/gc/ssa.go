...
var opToSSA = map[opAndType]ssa.Op{
	...
	{ONEG, TINT8}:    ssa.OpNeg8,
	{ONEG, TUINT8}:   ssa.OpNeg8,
	{ONEG, TINT16}:   ssa.OpNeg16,
	{ONEG, TUINT16}:  ssa.OpNeg16,
	{ONEG, TINT32}:   ssa.OpNeg32,
	{ONEG, TUINT32}:  ssa.OpNeg32,
	{ONEG, TINT64}:   ssa.OpNeg64,
	{ONEG, TUINT64}:  ssa.OpNeg64,
	{ONEG, TFLOAT32}: ssa.OpNeg32F,
	{ONEG, TFLOAT64}: ssa.OpNeg64F,

	{OBITNOT, TINT8}:   ssa.OpCom8,
	{OBITNOT, TUINT8}:  ssa.OpCom8,
	{OBITNOT, TINT16}:  ssa.OpCom16,
	{OBITNOT, TUINT16}: ssa.OpCom16,
	{OBITNOT, TINT32}:  ssa.OpCom32,
	{OBITNOT, TUINT32}: ssa.OpCom32,
	{OBITNOT, TINT64}:  ssa.OpCom64,
	{OBITNOT, TUINT64}: ssa.OpCom64,
...
var fpConvOpToSSA = map[twoTypes]twoOpsAndType{
	...
	{TFLOAT64, TFLOAT64}: {ssa.OpRound64F, ssa.OpCopy, TFLOAT64},
	{TFLOAT32, TFLOAT32}: {ssa.OpRound32F, ssa.OpCopy, TFLOAT32},
...
var fpConvOpToSSA32 = map[twoTypes]twoOpsAndType{
	{TUINT32, TFLOAT32}: {ssa.OpCopy, ssa.OpCvt32Uto32F, TUINT32},
	{TUINT32, TFLOAT64}: {ssa.OpCopy, ssa.OpCvt32Uto64F, TUINT32},
	{TFLOAT32, TUINT32}: {ssa.OpCvt32Fto32U, ssa.OpCopy, TUINT32},
	{TFLOAT64, TUINT32}: {ssa.OpCvt64Fto32U, ssa.OpCopy, TUINT32},
}

// uint64<->float conversions, only on machines that have intructions for that
var uint64fpConvOpToSSA = map[twoTypes]twoOpsAndType{
	{TUINT64, TFLOAT32}: {ssa.OpCopy, ssa.OpCvt64Uto32F, TUINT64},
	{TUINT64, TFLOAT64}: {ssa.OpCopy, ssa.OpCvt64Uto64F, TUINT64},
	{TFLOAT32, TUINT64}: {ssa.OpCvt32Fto64U, ssa.OpCopy, TUINT64},
	{TFLOAT64, TUINT64}: {ssa.OpCvt64Fto64U, ssa.OpCopy, TUINT64},
}
...
func softfloatInit() {
	...
	softFloatOps = map[ssa.Op]sfRtCallDef{
		...
		ssa.OpGreater64F: {sysfunc("fgt64"), TBOOL},
		ssa.OpGreater32F: {sysfunc("fgt32"), TBOOL},
		ssa.OpLeq64F:     {sysfunc("fge64"), TBOOL},
		ssa.OpLeq32F:     {sysfunc("fge32"), TBOOL},
		ssa.OpGeq64F:     {sysfunc("fge64"), TBOOL},
		ssa.OpGeq32F:     {sysfunc("fge32"), TBOOL},
