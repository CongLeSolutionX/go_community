...
func (s *state) slice(t *types.Type, v, i, j, k *ssa.Value, bounded bool) (p, l, c *ssa.Value) {
	...
	// For strings always set rcap to rlen for use in masking.
	...
	switch i.Op {
	case ssa.OpConst64, ssa.OpConst32:
		if i.AuxInt == 0 {
