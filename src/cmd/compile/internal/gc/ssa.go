...
func (e *ssaExport) SplitInt64(name ssa.LocalSlot) (ssa.LocalSlot, ssa.LocalSlot) {
	...
	if n.Class == PAUTO && !n.Addrtaken {
		...
		l := e.namedAuto(n.Sym.Name+".lo", t)
		return ssa.LocalSlot{N: h, Type: t, Off: 0}, ssa.LocalSlot{N: l, Type: t, Off: 0}
	}
	// Return the two parts of the larger variable.
	// Assuming little endian (we don't support big endian 32-bit architecture yet)
	return ssa.LocalSlot{N: n, Type: t, Off: name.Off + 4}, ssa.LocalSlot{N: n, Type: t, Off: name.Off}
}
