...
func (s *state) expr(n *Node) *ssa.Value {
	...
	case OLEN, OCAP:
		...
		case n.Left.Type.IsMap(), n.Left.Type.IsChan():
			return s.lenCapOfMapChan(n, s.expr(n.Left))
		default: // array
...
// lenCapOfMapChan generates code for the len/cap builtins for maps and channels.
func (s *state) lenCapOfMapChan(n *Node, x *ssa.Value) *ssa.Value {
