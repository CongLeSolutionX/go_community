...
func (s *state) call(n *Node, k callKind) *ssa.Value {
	...
	case closure != nil:
		...
		// closure is always safe, but IsSafeAddr can't always
		// figure that out currently, and it's critical that
		// we not clobber any arguments already stored onto
		// the stack.
