...
func (s *state) openDeferExit() {
	...
	for i := len(s.openDefers) - 1; i >= 0; i-- {
		...
		if r.closure != nil {
			...
			call = s.newValue3A(ssa.OpClosureCall, types.TypeMem /*&ssa.AuxCall{}*/, nil, codeptr, v, s.mem())
		} else {
...
func (s *state) call(n *Node, k callKind) *ssa.Value {
	...
	if k == callDeferStack {
		...
		case closure != nil:
			...
			call = s.newValue3A(ssa.OpClosureCall, types.TypeMem /*&ssa.AuxCall{}*/, nil, codeptr, closure, s.mem())
		case codeptr != nil:
			call = s.newValue2A(ssa.OpInterCall, types.TypeMem /*&ssa.AuxCall{}*/, nil, codeptr, s.mem())
		case sym != nil:
