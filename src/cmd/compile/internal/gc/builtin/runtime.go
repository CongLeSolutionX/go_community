...
func convT2Estring(typ *byte, val any) (ret any)
func convT2Eslice(typ *byte, val any) (ret any)
...
func convT2Istring(tab *byte, val any) (ret any)
func convT2Islice(tab *byte, val any) (ret any)
