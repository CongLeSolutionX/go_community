...
// TODO(gri) get rid of this - ugly hack to satisfy
// fixedbugs/bug332.go, fixedbugs/bug435.go, fixedbugs/issue13274.go
var lexer_eofnl bool
...
type lexer struct {
	...
	// EOF handling
	// TODO(gri) this is overly complicated - simplify
	last int
	// eofnl bool
