...
func slicelit(ctxt initContext, n *Node, var_ *Node, init *Nodes) {
	...
	if ctxt == inNonInitFunction {
		...
		s := Linksym(nam.Sym)
		s.WriteAddr(Ctxt, nam.Xoffset+int64(array_array), Widthptr, Linksym(vstat.Sym), vstat.Xoffset)
		s.WriteInt(Ctxt, nam.Xoffset+int64(array_nel), Widthint, t.NumElem())
		s.WriteInt(Ctxt, nam.Xoffset+int64(array_cap), Widthint, t.NumElem())
		return
	}
