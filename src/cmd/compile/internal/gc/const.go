...
func defaultType(n *Node) *types.Type {
	...
	switch {
	case k == CTBOOL || t == types.Idealbool:
		return types.Types[TBOOL]
	case k == CTSTR || t == types.Idealstring:
		return types.Types[TSTRING]
	case k == CTINT || t == types.Idealint:
		return types.Types[TINT]
	case k == CTRUNE || t == types.Idealrune:
		return types.Runetype
	case k == CTFLT || t == types.Idealfloat:
		return types.Types[TFLOAT64]
	case k == CTCPLX || t == types.Idealcomplex:
