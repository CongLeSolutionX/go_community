...
// add add constant expression n to s. If a constant expression of
...
// nodeAndVal reports both an expression and its constant valuation,
// if the latter is non-obvious.
//
