...
// unaliasForReflect replaces byte and rune aliases with real types.
// They've been separate internally to make error messages
// better, but we have to merge them in the reflect tables.
func unaliasForReflect(t *types.Type) *types.Type {
...
func addsignat(t *types.Type) {
	signatlist[unaliasForReflect(t)] = true
}
