...
func dumpobj1(outfile string, mode int) {
	...
	// The first call to dumptypestructs can generate functions to compile,
	// like method wrappers and hash and equality routines.
	// Track where we were in externdcl to avoid re-processing any types.
	ntypedcl := len(externdcl)
	// Compile any functions generated by dumptypestructs.
	compileFunctions()
	// Process any new types added by those compiled functions.
	// Compilation of the generated functions should not themselves
	// trigger any new functions that need compiling.
	dumptypestructs(externdcl[ntypedcl:])
