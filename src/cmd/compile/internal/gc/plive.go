...
func (m *LivenessMap) set(v *ssa.Value, i wobj.LivenessIndex) {
	m.vals[v.ID] = i
}

func (m LivenessMap) Get(v *ssa.Value) wobj.LivenessIndex {
...
func newliveness(fn *ir.Func, f *ssa.Func, vars []*ir.Name, idx map[*ir.Name]int32, stkptrsize int64) *Liveness {
	...
	if lc, _ := f.Cache.Liveness.(*livenessFuncCache); lc == nil {
		...
		lv.livenessMap = LivenessMap{vals: lc.livenessMap.vals, deferreturn: wobj.LivenessDontCare}
...
func liveness(curfn *ir.Func, f *ssa.Func, stkptrsize int64, pp *wobj.Progs) LivenessMap {
