...
var minintval [types.NTYPE]*ir.Int

var maxintval [types.NTYPE]*ir.Int

var minfltval [types.NTYPE]*ir.Float

var maxfltval [types.NTYPE]*ir.Float

var xtop []ir.INode

var exportlist []ir.INode

var importlist []ir.INode // imported functions and methods with inlinable bodies
