...
func genhash(t *types.Type) *obj.LSym {
	...
	case types.AMEM:
		...
		ot := 0
		ot = wobj.SymPtr(closure, ot, memhashvarlen, 0)
		ot = wobj.Uintptr(closure, ot, uint64(t.Width)) // size encoded in closure
		wobj.Global(closure, int32(ot), obj.DUPOK|obj.RODATA)
		return closure
	case types.ASPECIAL:
		break
	}
	...
	wobj.SymPtr(closure, 0, sym.Linksym(), 0)
	wobj.Global(closure, int32(types.PtrSize), obj.DUPOK|obj.RODATA)
...
func sysClosure(name string) *obj.LSym {
	...
	if len(s.P) == 0 {
		...
		wobj.SymPtr(s, 0, f, 0)
		wobj.Global(s, int32(types.PtrSize), obj.DUPOK|obj.RODATA)
	}
	return s
}
...
func geneq(t *types.Type) *obj.LSym {
	...
	case types.AMEM:
		...
		ot := 0
		ot = wobj.SymPtr(closure, ot, memequalvarlen, 0)
		ot = wobj.Uintptr(closure, ot, uint64(t.Width))
		wobj.Global(closure, int32(ot), obj.DUPOK|obj.RODATA)
		return closure
	case types.ASPECIAL:
		break
