...
var progtable = [x86.ALAST & obj.AMask]gc.ProgInfo{
	...
	x86.APOPCNTL & obj.AMask:  {Flags: gc.SizeL | gc.LeftRead | gc.RightWrite},
	x86.APOPCNTQ & obj.AMask:  {Flags: gc.SizeQ | gc.LeftRead | gc.RightWrite},
	x86.APOPCNTW & obj.AMask:  {Flags: gc.SizeW | gc.LeftRead | gc.RightWrite},
