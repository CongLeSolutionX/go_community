...
// Edit the documentation in other files and rebuild the go compiler.
// Execute '$GOROOT/bin/go generate cmd/go' to generate this one by the new built go compiler.
