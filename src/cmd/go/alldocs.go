...
//
// If the vendor directory is present, it will be used automatically if the
// "go" version in the main module's go.mod file is 1.14 or higher. Build commands
// like 'go build' and 'go test' will load packages from the vendor directory
// instead of accessing the network or the local module cache. To explicitly
// enable vendoring, invoke the go command with the flag -mod=vendor.
// To disable vendoring, use the flag -mod=mod.
//
