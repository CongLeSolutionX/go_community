...
//
// The go command caches packages it has built, to reuse in future builds.
...
// useful recently. Running 'go clean -cache' deletes all cached data.
//
// The build cache correctly accounts for changes to Go source files,
// compilers, compiler options, and so on, so cleaning the cache explicitly
// should not be necessary in typical use. However, the build cache
// does not detect changes to C libraries imported with cgo.
// If you have made changes to the C libraries on your system, you
// will need to clean the cache explicitly or else use the -a build flag
// (see 'go help build') to force rebuilding of packages that seem up-to-date
// but need to be recompiled against the modified C code.
//
...
// The output is voluminous but can be useful for debugging specific problems.
//
