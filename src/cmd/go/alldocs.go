...
//		func_align_32 is an option to force aligning all functions to 32-bytes, it might be helpful to
//		get more stable performance measuremetns, while it has certain overhead for code size.
//	GO386
