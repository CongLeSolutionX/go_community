...
If the vendoring experiment is enabled, by setting the environment variable,
GO15VENDOREXPERIMENT=1, then import path checking is disabled for
code found within vendor/ subtrees. This makes it possible to copy code
into alternate locations in vendor trees without needing to update import
comments.
