...
var vcsHg = &vcsCmd{
	...
	scheme:     []scheme{{"https", true}, {"http", false}, {"ssh", true}},
...
var vcsGit = &vcsCmd{
	...
	scheme:     []scheme{{"git", false}, {"https", true}, {"http", false}, {"git+ssh", true}},
...
var vcsBzr = &vcsCmd{
	...
	scheme:      []scheme{{"https", true}, {"http", false}, {"bzr", false}, {"bzr+ssh", true}},
...
var vcsSvn = &vcsCmd{
	...
	scheme:     []scheme{{"https", true}, {"http", false}, {"svn", false}, {"svn+ssh", true}},
	pingCmd:    "info {scheme}://{repo}",
