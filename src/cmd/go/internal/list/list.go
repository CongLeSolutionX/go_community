...
to -f '{{.ImportPath}}'. The struct being passed to the template is:
    ...
    type Package struct {
        ...
        // Directives appearing before the package clause
        Directives      []string // directives in package source files
        TestDirectives  []string // directives in test source files
        XTestDirectives []string // directives in package p_test source files
