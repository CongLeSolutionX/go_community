...
func Help(w io.Writer, args []string) {
	...
	if len(args) == 1 && args[0] == "documentation" {
		...
		fmt.Fprintln(w, "// Edit the documentation in other files and rebuild the go compiler.")
		fmt.Fprintln(w, "// Execute '$GOROOT/bin/go generate cmd/go' to generate this one by the new built go compiler.")
		fmt.Fprintln(w)
