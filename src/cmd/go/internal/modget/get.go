...
known commit. get will use the version it looked up unless the module
is already required at a later version (for example, a pre-release newer than
the latest release), in which case, get will use the later version.
