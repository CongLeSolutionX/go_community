...
identify non-public modules. For example, an editor might link an import of
a public package to its godoc.org page and could use GOPRIVATE to identify
packages for which the link would be inappropriate.
