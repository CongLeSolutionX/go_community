...
//
//	(1) vX.0.0-yyymmddhhmmss-abcdef123456
//	(2) vX.Y.(Z+1)-0.yyymmddhhmmss-abcdef123456
//	(3) vX.Y.(Z+1)-0.yyymmddhhmmss-abcdef123456+incompatible
//	(4) vX.Y.Z-pre.0.yyymmddhhmmss-abcdef123456
//	(5) vX.Y.Z-pre.0.yyymmddhhmmss-abcdef123456+incompatible
//
...
var pseudoVersionRE = regexp.MustCompile(`^v[0-9]+\.(0\.0-|\d+\.[1-9]\d*-([^+]*\.)?0\.)\d{14}-[A-Za-z0-9]+(\+incompatible)?$`)
