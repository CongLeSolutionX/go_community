...
//
// Two exceptions: if GOOS=android, then files with GOOS=linux are also matched;
// if GOOS=illumos, then files with GOOS=solaris are matched as well.
//
