...
// target itself. No other version of target will be selected, even if higher
// versions (according to reqs.Max) are visited. The remaining elements of the
// list are sorted by path.
//
