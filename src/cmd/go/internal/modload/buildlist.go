...
// tidyEagerRoots returns a set of root requirements that maintains the selected
// version of every module that provided a package in pkgs, and includes the
// selected version of every such module in rs.direct as a root.
