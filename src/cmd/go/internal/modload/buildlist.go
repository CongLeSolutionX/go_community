...
// OverrideBuildList edits the global build list by replacing the specific module versions.
func OverrideBuildList(ctx context.Context, replace []module.Version) {
	rs := requirements
