...
func BenchmarkListModules(b *testing.B) {
	...
	for _, m := range modulesForTest {
		...
		moduleTempDir := copyModulesToTempDir(b, testDataDir, m.testDataFolder)
