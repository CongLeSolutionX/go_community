...
var (
	initialized bool
	workRoot    string
	modRoots    []string // These are used to initialize the MainModules. TODO(matloob): move uses of modRoots to MainModuleSet
	gopath      string
)
...
func (mms *MainModuleSet) Contains(m module.Version) bool {
...
func (mms *MainModuleSet) VersionWithPath(path string) (m module.Version, ok bool) {
	if mms == nil {
...
func (mms *MainModuleSet) ModFilePath(m module.Version) string {
	modRoot := mms.ModRoot(m)
	return modFilePath(modRoot)
}

func (mms *MainModuleSet) HasModRoot(m module.Version) bool {
