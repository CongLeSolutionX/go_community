...
var (
	...
	// allowDefaultVendor controls whether setDefaultBuildMod may choose "vendor"
	// as the default.
	allowDefaultVendor = true
	defaultBuildModSet = false
)
...
func DisableDefaultVendor() {
	if defaultBuildModSet {
		panic("DisableDefaultVendor called after setDefaultBuildMod has run")
	}
	allowDefaultVendor = false
}

// setDefaultBuildMod sets a default value for cfg.BuildMod
// if it is currently empty.
func setDefaultBuildMod() {
	defer func() { defaultBuildModSet = true }()
