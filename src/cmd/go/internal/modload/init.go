...
func (mms *mainModules) SetIndex(m module.Version, fileIndex *modFileIndex)
...
func Init() {
	...
	if modRoots != nil {
		...
		modRoots = nil
	} else if workRoot = findWorkspaceRoot(base.Cwd()); workRoot != "" {
...
func commitRequirements(ctx context.Context, goVersion string, rs *Requirements) {
	...
	defer func() {
		...
		newIndex := indexModFile(new, modFile, mainModule, false)
		*index = *newIndex
