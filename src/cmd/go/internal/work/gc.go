...
func (gcToolchain) gc(b *Builder, a *Action, nonGoOverlay nonGoOverlay, archive string, importcfg, embedcfg []byte, symabis string, asmhdr bool, gofiles []string) (ofile string, output []byte, err error) {
	p := a.Package
	objdir := a.Objdir
	if archive != "" {
		ofile = archive
...
func (a *Action) trimpath(nonGoOverlay nonGoOverlay) string {
...
func asmArgs(a *Action, p *load.Package, nonGoOverlay nonGoOverlay) []interface{} {
...
func (gcToolchain) asm(b *Builder, a *Action, nonGoOverlay nonGoOverlay, sfiles []string) ([]string, error) {
	p := a.Package
...
func (gcToolchain) symabis(b *Builder, a *Action, nonGoOverlay nonGoOverlay, sfiles []string) (string, error) {
