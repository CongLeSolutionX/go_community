...
type toolchain interface {
	...
	gc(b *Builder, a *Action, nonGoOverlay nonGoOverlay, archive string, importcfg, embedcfg []byte, symabis string, asmhdr bool, gofiles []string) (ofile string, out []byte, err error)
	// cc runs the toolchain's C compiler in a directory on a C file
	// to produce an output file.
	cc(b *Builder, a *Action, ofile, cfile string) error
	// asm runs the assembler in a specific directory on specific files
	// and returns a list of named output files.
	asm(b *Builder, a *Action, nonGoOverlay nonGoOverlay, sfiles []string) ([]string, error)
	// symabis scans the symbol ABIs from sfiles and returns the
	// path to the output symbol ABIs file, or "" if none.
	symabis(b *Builder, a *Action, nonGoOverlay nonGoOverlay, sfiles []string) (string, error)
...
func (noToolchain) gc(b *Builder, a *Action, nonGoOverlay nonGoOverlay, archive string, importcfg, embedcfg []byte, symabis string, asmhdr bool, gofiles []string) (ofile string, out []byte, err error) {
	return "", nil, noCompiler()
}

func (noToolchain) asm(b *Builder, a *Action, nonGoOverlay nonGoOverlay, sfiles []string) ([]string, error) {
	return nil, noCompiler()
}

func (noToolchain) symabis(b *Builder, a *Action, nonGoOverlay nonGoOverlay, sfiles []string) (string, error) {
	return "", noCompiler()
}
