...
func (tools gccgoToolchain) gc(b *Builder, a *Action, nonGoOverlay nonGoOverlay, archive string, importcfg, embedcfg []byte, symabis string, asmhdr bool, gofiles []string) (ofile string, output []byte, err error) {
	p := a.Package
	objdir := a.Objdir
	out := "_go_.o"
	ofile = objdir + out
...
func (tools gccgoToolchain) asm(b *Builder, a *Action, nonGoOverlay nonGoOverlay, sfiles []string) ([]string, error) {
	p := a.Package
	var ofiles []string
...
func (gccgoToolchain) symabis(b *Builder, a *Action, nonGoOverlay nonGoOverlay, sfiles []string) (string, error) {
	return "", nil
}
