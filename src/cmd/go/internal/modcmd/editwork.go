...
By default, editwork reads and writes the go.work file found using
the default mechanism, but a different target file can be specified
after the editing flags.
