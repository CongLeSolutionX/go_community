...
var cmdDownload = &base.Command{
	UsageLine: "go mod download [-v] [-json] [modules]",
...
The -v flag causes download to print information about fetched modules to
standard error.
...
func init() {
	...
	cmdDownload.Flag.BoolVar(&cfg.BuildV, "v", false, "")
}
