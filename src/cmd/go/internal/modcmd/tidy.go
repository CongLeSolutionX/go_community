...
The -diff flag shows the necessary changes to go.mod and go.sum
to make them tidy. It does not modify these files, but exits
with a non-zero code if updates are needed.
