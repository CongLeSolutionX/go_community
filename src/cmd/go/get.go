...
var cmdGet = &Command{
	UsageLine: "get [-d] [-f] [-fix] [-t] [-u] [-insecure] [build flags] [packages]",
...
The -insecure flag permits fetching from repositories using insecure schemes
(such as HTTP) and resolving custom domains over HTTP. Use with caution.
