...
// aActionList returns a list of actions closest to root that produce .a files.  It
// walks the dag somewhat like actionList above but only traverses through actions
