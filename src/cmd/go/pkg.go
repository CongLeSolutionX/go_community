...
func (p *Package) load(stk *importStack, bp *build.Package, err error) *Package {
	...
	// Currently build modes c-shared and shared, or -linkshared,
	// forces external linking mode, and external linking mode
	// forces an import of runtime/cgo.
	if p.Name == "main" && !p.Goroot && (buildBuildmode == "c-shared" || buildBuildmode == "shared" || buildLinkshared) {
		importPaths = append(importPaths, "runtime/cgo")
	}
