...
//func BenchmarkExecGoListEmpty(b *testing.B) { benchmarkGoList(b) }
//func BenchmarkExecGoListCmd(b *testing.B)   { benchmarkGoList(b) }
//func BenchmarkExecGoListK8S(b *testing.B)   { benchmarkGoList(b) }
