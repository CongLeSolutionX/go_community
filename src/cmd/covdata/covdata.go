...
func usage(msg string) {
	...
	fmt.Fprintf(os.Stderr, "textfmt     convert coverage data to textual format\n")
	fmt.Fprintf(os.Stderr, "percent     output total percentage of statements covered\n")
	...
	fmt.Fprintf(os.Stderr, "debugdump   dump coverage data in human-readable format for debugging purposes\n")
