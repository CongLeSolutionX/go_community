...
// This file contains functions and apis to support the
// following "go tool covdata" sub-commands: "debugdump", "percent",
// "textfmt".
...
// Setup is called once at program startup time to vett flag values
