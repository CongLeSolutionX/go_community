...
func mkzdefaultcc(dir, file string) {
	...
	fmt.Fprintf(&buf, "const DefaultCC = %#q\n", defaultcctarget)
	fmt.Fprintf(&buf, "const DefaultCXX = %#q\n", defaultcxxtarget)
	fmt.Fprintf(&buf, "const DefaultPkgConfig = %#q\n", defaultpkgconfigtarget)
	...
	// Convert file name.
	file = strings.Replace(file, "go/internal/cfg", "cgo", 1)
	writefile(buf.String(), file, writeSkipSame)
}
