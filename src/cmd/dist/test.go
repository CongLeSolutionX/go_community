...
func (t *tester) registerTests() {
	...
	if t.cgoEnabled && gogcflags == "" {
		t.registerHostTest("testso", "../misc/cgo/testso", t.goTest())
		t.registerHostTest("testsovar", "../misc/cgo/testso", t.goTest())
		...
		if t.supportedBuildmode("plugin") {
			t.registerTest("testplugin", "../misc/cgo/testplugin", t.goTest())
		}
