...
func (t *tester) registerTests() {
	...
	if fipsSupported() {
		...
		t.registerTest("GODEBUG=fips140=on go test crypto/...", &goTest{
			...
			skip:    "TestHandshake|TestServerResumption|TestClientAuth|TestRenegotiate|TestDynamicRecordSizingWithCBC|TestDynamicRecordSizingWithStreamCipher|TestFIPSServerProtocolVersion|TestSignatureSelection", // TODO(valsorda): remove once crypto/tls passes
			pkg:     "crypto/...",
		})
