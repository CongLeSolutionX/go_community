...
func bootstrapFixImports(srcFile string) string {
	...
	for i, line := range lines {
		...
		if strings.HasPrefix(line, `import "`) || strings.HasPrefix(line, `import . "`) ||
			inBlock && (strings.HasPrefix(line, "\t\"") || strings.HasPrefix(line, "\t. \"") || strings.HasPrefix(line, "\texec \"") || strings.HasPrefix(line, "\trtabi \"") || strings.HasPrefix(line, "\tpgoir \"") || strings.HasPrefix(line, "\tbasepkg \"")) {
