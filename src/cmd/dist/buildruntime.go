...
func mkzversion(dir, file string) {
	...
	fmt.Fprintf(&buf, "const StackGuardMultiplierHost = %d\n", stackGuardMultiplierHost())
...
//	const stackGuardMultiplierHost = <multiplier value>
//	const goexperiment = <goexperiment>
//
...
// stackGuardMultiplierHost returns a multiplier to apply to the default
// stack guard size. Larger multipliers are used for non-optimized
// builds that have larger stack frames.
func stackGuardMultiplierHost() int {
