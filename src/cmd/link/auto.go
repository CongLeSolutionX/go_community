...
var linkerDefined = map[string]bool{
	"runtime/internal/gc.Bss":             true,
	"runtime/internal/gc.Data":            true,
	"runtime/internal/gc.Ebss":            true,
	"runtime/internal/gc.Edata":           true,
	"runtime.efunctab":                    true,
	"runtime/internal/schedinit.end":      true,
	"runtime/internal/finalize.enoptrbss": true,
	"runtime.enoptrdata":                  true,
	"runtime.erodata":                     true,
	"runtime.etext":                       true,
	"runtime.etypelink":                   true,
	"runtime.functab":                     true,
	"runtime/internal/gc.Gcbss":           true,
	"runtime/internal/gc.Gcdata":          true,
	"runtime/internal/finalize.noptrbss":  true,
