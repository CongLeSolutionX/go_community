...
func LoadReloc(l *Loader, r *obj.Reader, lib *sym.Library, localSymVersion int, libByPkg map[string]*sym.Library) {
	// PkgIdx
	pkglist := r.Pkglist()
...
func LoadFull(l *Loader, r *obj.Reader, lib *sym.Library, localSymVersion int, libByPkg map[string]*sym.Library) {
	// PkgIdx
	pkglist := r.Pkglist()
