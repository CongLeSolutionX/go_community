...
// RelocAllocator helps parcels out slices of loader.Reloc's from a
// larger reloc slab, helping to reduce allocation overhead. Intended
// to be helpful in cases where clients need what amounts to a stack
// of relocation slices.
//
// Intended usage:
//
...
// specified RelocAllocator. It allocates a new chunk if need
// be, and does book-keeping to record what's been used so far.
...
// Release returns the sub-slice of loader.Relocs requested by
