...
// MaterializeSymbol announces to the loader that the linker is going to be
// constructing the body/payload of the symbol with the specified name.
// The loader may have already seen references to this symbol (in which case
// we'll reuse the existing index).
