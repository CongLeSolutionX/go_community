...
func (l *Loader) LoadNonpkgSyms(arch *sys.Arch) {
	...
	st := loadState{
		l:            l,
		hashed64Syms: make(map[uint64]symAndSize, 10000),          // TODO: tune preallocation sizes
		hashedSyms:   make(map[goobj2.HashType]symAndSize, 20000), // TODO: tune preallocation sizes
	}
