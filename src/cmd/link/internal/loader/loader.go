...
// All method reads all relocations into the specified slice. If the
// slice capacity is not large enough, a new larger slice will be
// allocated. Final slice is returned.
