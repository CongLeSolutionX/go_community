...
var wasmFuncTypes = map[string]*wasmFuncType{
	...
	"runtime.wasmtruncu":     &wasmFuncType{Params: []byte{F64}, Results: []byte{I64}},                // x -> int(x)
	"runtime.gcWriteBarrier": &wasmFuncType{Params: []byte{I32, I64}, Results: []byte{I32}},           // ptr, val -> unwind-flag
