...
func elfreloc1(ctxt *ld.Link, out *ld.OutBuf, ldr *loader.Loader, s loader.Sym, r loader.ExtReloc, ri int, sectoff int64) bool {
	...
	// The low 12-bit of the symbol address need to be concatenated, but there is no such
	// instruction. The addi.d must be used. The addi.d instruction have signed 12-bit
	// immediate operand, and calculating with addi.d is not equivalent to concatenation.
	// So the 0x800 (addr'12bit <=> addr+0x800+S12) is introduced to correct this. The 0x804
	// is 0x800 + 4, 4 is instruction bit width on Loong64 and is used correct the PC of next
	// instruction addi.d.
