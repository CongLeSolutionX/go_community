...
// writeDirFileTables emits the portion of the DWARF line table prolog
// containing the include directories and file names, described in
// section 6.2.4 of the DWARF 4 standard. This version walks the
