...
func defdwsymb(ctxt *Link) func(sym *Symbol, s string, t int, v int64, size int64, ver int, gotype *Symbol) {
	return func(sym *Symbol, s string, t int, v int64, size int64, ver int, gotype *Symbol) {
