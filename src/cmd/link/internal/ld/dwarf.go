...
func writeframes(syms []*LSym) []*LSym {
	...
	dwarf.Sleb128put(dwarfctxt, fs, dataAlignmentFactor)       // guess
	dwarf.Uleb128put(dwarfctxt, fs, int64(Thearch.Dwarfreglr)) // return_address_register

	Adduint8(Ctxt, fs, dwarf.DW_CFA_def_cfa)
	dwarf.Uleb128put(dwarfctxt, fs, int64(Thearch.Dwarfregsp)) // register SP (**ABI-dependent, defined in l.h)
	if haslinkregister() {
