...
func (ctxt *Link) domacho() {
	...
	// Add an .llvmasm section used to convince Apple tools
	// to use the object file in bitcode mode.
	if ctxt.LinkMode == LinkExternal {
...
func machoshbits(ctxt *Link, mseg *MachoSeg, sect *sym.Section, segname string) {
	...
	// toolchain that the Go text came from assembler and thus have no
