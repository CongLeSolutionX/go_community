...
func (state *pclnState) addGeneratedSym(ctxt *Link, name string, size int64, f generatorFunc) loader.Sym {
...
func (state *pclnState) walkFuncs(ctxt *Link, f func(loader.Sym)) {
	ldr := ctxt.loader
...
func (state *pclnState) generateFuncnametab(ctxt *Link) {
	...
	var size int64
	state.walkFuncs(ctxt, func(s loader.Sym) {
