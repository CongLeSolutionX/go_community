...
func (out *OutBuf) Msync() error {
	...
	// When call msync, we need to pass the start address of the range to sync,
	// where that address has to be on a page boundary. We adjust the address
	// to the beginning of the page, and the length accordingly.
