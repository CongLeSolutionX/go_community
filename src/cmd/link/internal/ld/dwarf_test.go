...
//go:noinline
func ABC(c1, c2, c3 int, d1, d2, d3, d4 string, f1, f2, f3 float32, g1 [1024]int) (r1 int, r2 int, r3 [1024]int, r4 byte, r5 string) {
	g1[0] = 6
	r1, r2, r3, r4, r5 = c3, c2, g1, 'a', d1+d2+d3+d4
	return
}

func main() {
	a := [1024]int{}
	v1, v2, v3, v4, sr := ABC(1, 2, 3, "a", "b", "c", "d", 1.0, 2.0, 1.0, a)
	println(v1, v2, v3[0], v4, sr)
}
`
	dir := t.TempDir()
	f := gobuild(t, dir, prog, NoOpt)
	...
	// for the returns.
	expected := "[c1:0:1 c2:1:1 c3:2:1 d1:3:1 d2:4:1 d3:5:1 d4:9:1 f1:6:1 f2:7:1 f3:8:1 g1:10:1 r1:13:2 r2:14:2 r3:11:2 r4:15:2 r5:12:2]"
