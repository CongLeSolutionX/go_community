...
func machoCombineDwarf(ctxt *Link, exef *os.File, exem *macho.File, dsym, outexe string) error {
	...
	return machoUpdateDwarfHeader(&reader, ctxt.BuildMode, compressedSects, dwarfsize)
}
...
func machoUpdateDwarfHeader(r *loadCmdReader, buildmode BuildMode, compressedSects []*macho.Section, dwarfsize uint64) error {
