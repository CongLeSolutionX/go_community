...
<html>
  ...
  <body>
	...
	<p>
	  ...
	  <span class="help">?<span>Consider per-goroutine utilization. When even one goroutine is interrupted by GC, mutator utilizatoin is 0.</span></span><br/>
	</p>
	<p>
	  <b>Include</b><br/>
...
func httpMMUDetails(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		log.Printf("failed to parse window parameter '%v': %v", windowStr, err)
		return
	}
