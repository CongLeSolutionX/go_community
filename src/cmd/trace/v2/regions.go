...
// UserTasksHandlerFunc returns a HanderFunc that reports all regions found in the trace.
...
// UserRegionHandlerFunc returns a HanderFunc that presents the details of the selected regions.
