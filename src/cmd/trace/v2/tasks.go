...
// UserTasksHandlerFunc returns a HanderFunc that reports all tasks found in the trace.
...
// UserTaskHandlerFunc returns a HanderFunc that presents the details of the selected tasks.
