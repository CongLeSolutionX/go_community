...
var (
	httpFlag  = flag.String("http", "127.0.0.1:8000", "HTTP service address (e.g., '127.0.0.1:8000'). Due to golang.org/issue/34374, the trace viewer (the 'view trace' page) works only with ports between 8000-8003.")
