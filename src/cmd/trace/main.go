...
func main() {
	...
	mux.HandleFunc("/cpu", traceviewer.SVGProfileHandlerFunc(pprofByGoroutine(pprofCPU, parsed)))
	...
	mux.HandleFunc("/regioncpu", traceviewer.SVGProfileHandlerFunc(pprofByRegion(pprofCPU, parsed)))
