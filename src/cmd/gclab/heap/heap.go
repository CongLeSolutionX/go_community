...
const (
	...
	//
	// TODO: In the runtime, this is effectively 8, which saves a lot of space
	// in the mark/alloc bitmaps, but is also going to make it a pain to do
	// direct operations from the dartboard.
	objectCountAlign = 64
)
