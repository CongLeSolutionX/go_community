...
/*
	...
	In the text that follows, ``space'' means any Unicode white
	...
	in the format string consumes zero or more spaces
	in the input followed by a single newline or the end of the input.
	A space following a newline in the format string
	consumes zero or more spaces in the input.
	Otherwise, any run of one or more spaces in the format string
	consumes as many spaces as possible in the input.
	Unless the run of spaces in the format string appears at the end
	of the format string or around a newline, the run must consume
	at least one space from the input.
