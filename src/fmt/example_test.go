...
func Example_formats() {
	...
	// Floats have multiple formats: %v and %g are compact representations,
	// while %f prints decimal and %e uses exponential notation. The format
	// %6.2f used here shows how to set the width and precision to control the
	// appearance of a floating-point value. In this instance, 6 is the total
	// width of the printed text for the value (note the extra spaces in the
	// output) and 2 is the number of decimal places to show.
	pi := math.Pi
	...
	isLegume := map[string]bool{
		"peanut": true,
		// TODO: Include this line when maps are printed in consistent order.
		// See Issue #21095
		// "dachshund": false,
	}
	fmt.Printf("%v %#v\n", isLegume, isLegume)
