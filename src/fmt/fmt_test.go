...
var fmtTests = []struct {
	...
	{"%b", []int{1, 2, 3}, "[1 10 11]"},
	{"%b", []byte{1, 2, 3}, "000000010000001000000011"},
	{"% b", []byte{1, 2, 3}, "00000001 00000010 00000011"},
	...
	{"%02b", []byte{}, "00"},
	{"% 02b", []byte{}, "00"},
	{"%09b", []byte{0x83}, "010000011"},
	{"% 09b", []byte{0x83}, "010000011"},
	{"%020b", []byte{0x83, 0x0f}, "00001000001100001111"},
	{"% 020b", []byte{0x83, 0x0f}, "00010000011 00001111"},
	{"%9b", []byte{0x83}, " 10000011"},
	{"% 9b", []byte{0x83}, " 10000011"},
	{"%20b", []byte{0x83, 0x0f}, "    1000001100001111"},
	{"% 20b", []byte{0x83, 0x0f}, "   10000011 00001111"},
	{"%-9b", []byte{0x83}, "10000011 "},
	{"% -9b", []byte{0x83}, "10000011 "},
	{"%-20b", []byte{0x83, 0x0f}, "1000001100001111    "},
	{"% -20b", []byte{0x83, 0x0f}, "10000011 00001111   "},
