...
func TestNewXxxBadRectangle(t *testing.T) {
	// call calls f(r), returning whether it didn't panic.
	...
	for _, tc := range testCases {
		// Calling NewXxx(r) should fail (i.e. panic, since NewXxx doesn't return
		// an error) unless r's width and height are both non-negative.
