...
func (d *decoder) applyBlack() (image.Image, error) {
	...
	if d.adobeTransform == adobeTransformYCbCrK {
	...
	// If the 4-component JPEG image isn't explicitly marked as YCbCrK, we
	// assume that it is CMYK. The first three channels (cyan, magenta, yellow)
	// are decoded into d.img3, but each channel was decoded into a separate
