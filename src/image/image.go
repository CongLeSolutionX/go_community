...
func pixelBufferLength(bytesPerPixel int, r Rectangle) int {
	totalLength := mul3NonNeg(bytesPerPixel, r.Dx(), r.Dy())
	if totalLength < 0 {
		panic("image: NewXxx Rectangle has huge or negative dimensions")
	}
	return totalLength
}
...
func NewRGBA(r Rectangle) *RGBA {
	return &RGBA{
		Pix:    make([]uint8, pixelBufferLength(4, r)),
		Stride: 4 * r.Dx(),
		Rect:   r,
	}
}
...
func NewRGBA64(r Rectangle) *RGBA64 {
	return &RGBA64{
		Pix:    make([]uint8, pixelBufferLength(8, r)),
		Stride: 8 * r.Dx(),
		Rect:   r,
	}
}
...
func NewAlpha(r Rectangle) *Alpha {
	return &Alpha{
		Pix:    make([]uint8, pixelBufferLength(1, r)),
		Stride: 1 * r.Dx(),
		Rect:   r,
	}
}
...
func NewAlpha16(r Rectangle) *Alpha16 {
	return &Alpha16{
		Pix:    make([]uint8, pixelBufferLength(2, r)),
		Stride: 2 * r.Dx(),
		Rect:   r,
	}
}
