...
// Package internal contains code shared by image-related packages.
package internal
...
func DrawYCbCr(dst *image.RGBA, r image.Rectangle, src *image.YCbCr, sp image.Point) (ok bool) {
	// This function exists in the image/internal package because it is needed
	// by both the image/draw and image/jpeg packages, but it doesn't seem
	// right for one of those two to depend on the other.
	//
