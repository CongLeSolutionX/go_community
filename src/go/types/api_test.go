...
func TestTypesInfo(t *testing.T) {
	...
	var tests = []struct {
		...
		{`package issue47243_b; var x int32; var _ = x << 3.`, `3.`, `uint`}, // incorrect: should be untyped float
		...
		{`package issue47243_g; var x int32; var _ = 1 << (2 << x)`, `1`, `int`},
		{`package issue47243_h; var x int32; var _ = 1 << (2 << x)`, `(2 << x)`, `untyped int`}, // incorrect: should be int
		{`package issue47243_i; var x int32; var _ = 1 << (2 << x)`, `2`, `untyped int`},        // incorrect: should be int
