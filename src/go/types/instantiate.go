...
// expanded. If ctxt is non-nil, it is the context associated with the
// current type-checking pass or call to Instantiate. At least one of expanding or
// ctxt must be non-nil.
//
