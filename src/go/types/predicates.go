...
func Comparable(T Type) bool {
	return _IsComparable(T, true)
}

// _IsComparable reports whether values of type T are comparable.
// If dynamic is set, interfaces are always comparable; otherwise
// they are comparable if all types in their type sets are comparable.
func _IsComparable(T Type, dynamic bool) bool {
	return isComparable(T, dynamic, nil, nil)
}
