...
func (check *Checker) shift(x, y *operand, e ast.Expr, op token.Token) {
	...
	if y.mode == constant_ {
		...
		// Caution: Check for representability here, rather than the switch below,
		//          because isInteger includes untyped integers (was bug #43697).
	...
	//
	// This behavior has known bugs.
	// TODO: file these bugs and document.
	switch {
