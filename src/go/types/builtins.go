...
func (check *Checker) builtin(x *operand, call *ast.CallExpr, id builtinId) (_ bool) {
	...
	case _Make:
		...
		case *Map, *Chan:
			min = 1
		case *top:
			check.errorf(arg0, _InvalidMake, "cannot make %s; type parameter has no structural type", arg0)
			return
		default:
			check.errorf(arg0, _InvalidMake, "cannot make %s; type must be slice, map, or channel", arg0)
			return
		}
