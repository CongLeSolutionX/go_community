...
func (check *Checker) builtin(x *operand, call *ast.CallExpr, id builtinId) (_ bool) {
	...
	if hasDots(call) && id != _Append {
		...
		dddErrPos := atPos(call.Ellipsis) // needed for generation of go/types/builtins.go
	...
	// check argument count
	{
		...
		if msg != "" {
			argErrPos := inNode(call, call.Rparen) // needed for generation of go/types/builtins.go
