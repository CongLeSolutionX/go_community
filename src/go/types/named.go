...
func (n *Named) expand(tctx *Context) *Named {
	if n.instPos != nil {
		...
		if n.check.validateTArgLen(*n.instPos, n.tparams.Len(), n.targs.Len()) {
			...
			if tctx == nil {
				...
				h := tctx.typeHash(n.orig, n.targs.list())
				...
				tctx.typeForHash(h, n)
			}
			u = n.check.subst(*n.instPos, n.orig.underlying, makeSubstMap(n.TypeParams().list(), n.targs.list()), tctx)
		} else {
			u = Typ[Invalid]
		}
		n.underlying = u
