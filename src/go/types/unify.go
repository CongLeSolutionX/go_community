...
type unifier struct {
	...
	tparams []*TypeParam
	// handles maps each type parameter to a type handle *Type.
	// Joined type parameters (parameters that have been unified)
	// share the same handle and thus type. Type parameters may
	// have a nil handle, or a non-nil handle holding a nil type.
