...
func (u *unifier) nify(x, y Type, p *ifacePair) (result bool) {
	...
	// If we have exactly one type parameter, because it is is x,
	...
	// (not recorded with the unifier). Unify their core types, if any
	...
	if enableCoreTypeUnification {
		...
		if isTypeParam(x) {
			...
			// defined or literal type automaticaly.
