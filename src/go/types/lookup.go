...
func MissingMethod(V Type, T *Interface, static bool) (method *Func, wrongType bool) {
	return (*Checker)(nil).missingMethod(V, false, T, static)
}
...
func (check *Checker) missingMethod(V Type, addressable bool, T *Interface, static bool) (method *Func, wrongType bool) {
	check.completeInterface(token.NoPos, T)
