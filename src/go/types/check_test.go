...
var (
	...
	testFiles   = flag.String("files", "", "comma-separated list of test files for TestCheckFiles")
	goVersion   = flag.String("lang", "", "Go language version (e.g. \"go1.12\") for TestCheckFiles")
)
...
// TestCheckFiles is for manual testing of selected input files, provided with
// -files.
