...
func (check *Checker) funcInst(tsig *Signature, x *operand, ix *typeparams.IndexExpr, infer bool) ([]Type, []ast.Expr) {
	...
	if got < want {
		...
		targs = check.infer(atPos(x.Pos()), tparams, targs, params2.(*Tuple), args)
		if targs == nil {
