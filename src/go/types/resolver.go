...
// rtyp is a pointer receiver, base is the receiver base type, and tparams are its type
// parameters, if any. The type parameters are only unpacked if unpackParams is set.
