...
func (check *Checker) objDecl(obj Object, def *Named, path []*TypeName) {
	...
	case grey:
		...
		// type may be nil (because it's not known and depends on
		// the as of yet unknown initialization value), or not nil
		// (because it's known). In the former case, set the type
		// to Typ[Invalid] because we have an initialization cycle.
		// The cycle error will be reported later, when determining
