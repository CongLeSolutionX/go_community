...
// Origin returns the canonical object from which the receiver was
// instantiated, for instantiated vars. i.e. the object appearing in Info.Defs.
// For other objects, Origin returns the receiver.
func (obj *Var) Origin() Object {
	if obj.origin != nil {
		return obj.origin
	}
	return obj
...
// Origin returns the canonical object from which the receiver was
// instantiated, for instantiated funcs. i.e. the object appearing in
// Info.Defs. For other objects, Origin returns the receiver.
func (obj *Func) Origin() Object {
	if obj.origin != nil {
		return obj.origin
	}
	return obj
