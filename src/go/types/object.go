...
type Func struct {
	...
	isIncompleteMethod bool // whether the Func is an incomplete instantiated method
}
...
func NewFunc(pos token.Pos, pkg *Package, name string, sig *Signature) *Func {
	...
	return &Func{object{nil, pos, pkg, name, typ, 0, colorFor(typ), token.NoPos}, false, false}
}
