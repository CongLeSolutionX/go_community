...
func (m gcimports) Import(path string) (*types.Package, error) {
	// Import should not be called if we have an Importer2, but don't crash.
	return m.Import2(path, ".", 0)
}

func (m gcimports) Import2(path, srcDir string, _ types.ImportMode) (*types.Package, error) {
...
func (m *gccgoimports) Import2(path, srcDir string, _ types.ImportMode) (*types.Package, error) {
