...
// queries for its Pos interval will yield a negative result.
// This reduces the memory usage of a long-lived FileSet that
// encounters an unbounded stream of files. Removing a file
// that does not belong to the set has no effect.
