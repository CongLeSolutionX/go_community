...
func TestIssue15920(t *testing.T) {
	...
	compile(t, "testdata", "issue15920.go", filepath.Join(tmpdir, "testdata"))

	importPkg(t, "./testdata/issue15920", tmpdir)
}
...
func TestIssue20046(t *testing.T) {
	...
	compile(t, "testdata", "issue20046.go", filepath.Join(tmpdir, "testdata"))

	// "./issue20046".V.M must exist
	pkg := importPkg(t, "./testdata/issue20046", tmpdir)
...
func TestIssue25301(t *testing.T) {
	...
	compile(t, "testdata", "issue25301.go", filepath.Join(tmpdir, "testdata"))

	importPkg(t, "./testdata/issue25301", tmpdir)
}
...
func TestIssue25596(t *testing.T) {
	...
	compile(t, "testdata", "issue25596.go", filepath.Join(tmpdir, "testdata"))

	importPkg(t, "./testdata/issue25596", tmpdir)
}
