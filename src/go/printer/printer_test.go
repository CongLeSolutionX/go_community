...
// Verify that we never print a newline between "return" and its results, as
// that would incorrectly mean a naked return.
...
func f() {
	...
	// Replace the result with call(), which is in the next line.
