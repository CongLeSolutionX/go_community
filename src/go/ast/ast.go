...
// by https://golang.org/s/generatedcode.
//
// The syntax tree must have been parsed with the ParseComment flag.
// Example:
//
//	f, err := parser.ParseFile(fset, filename, parser.ParseComment|parser.PackageClauseOnly)
//	if err != nil { ... }
