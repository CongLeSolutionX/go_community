...
func TestNumbers(t *testing.T) {
	for _, test := range []struct {
		...
		{token.FLOAT, "0b1e10", "0b1e10", "invalid exponent on binary literal"},
		{token.FLOAT, "0b1P-1", "0b1P-1", "invalid exponent on binary literal"},
		...
		{token.FLOAT, "0o1E+2", "0o1E+2", "invalid exponent on octal literal"},
		{token.FLOAT, "0o1p10", "0o1p10", "invalid exponent on octal literal"},
