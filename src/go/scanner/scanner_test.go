...
var segments = []segment{
	...
	{"\n//line foo\t:42\n  line42", "foo\t", 42, 0},
	{"\n //line foo:42\n  line44", "foo\t", 44, 0}, // bad line comment, ignored (use existing, prior filename)
	{"\n//line foo 42\n  line46", "foo\t", 46, 0},  // bad line comment, ignored (use existing, prior filename)
	{"\n//line ./foo:42\n  line42", "./foo", 42, 0},
	{"\n//line a/b/c/File1.go:100\n  line100", filepath.Join("a", "b", "c", "File1.go"), 100, 0},
