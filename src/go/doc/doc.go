...
// and its examples.
//
// NewWithExamples associates examples based on their name with the corresponding
// type, function, method, or the package itself. If the example has a suffix in
