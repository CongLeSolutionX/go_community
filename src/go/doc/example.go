...
type Example struct {
	...
	Suffix      string // example suffix, without leading '_' (populated when NewWithExamples is used)
...
// To populate the Suffix field, provide the examples to NewWithExamples.
//
