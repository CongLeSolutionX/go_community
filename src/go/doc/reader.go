...
// parseNote parses note from a sequence of comments
//
func parseNote(text string) (uid string, body string, marker string, err bool) {
...
func (r *reader) readNote(list []*ast.Comment) {
	...
	if uid, body, marker, err := parseNote(text); err {
