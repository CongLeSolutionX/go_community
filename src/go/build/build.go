...
type Context struct {
	...
	// WorkingDir is the caller's working directory, if different from the
	// directory reported by os.Getwd. In module mode, this is used to locate the
	// main module.
	WorkingDir string
