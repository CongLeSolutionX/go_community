...
var depsRules = `
    ...
    FMT, encoding/binary, internal/coverage, io, os, bufio, crypto/md5
    ...
    FMT, bufio, crypto/md5, encoding/binary, internal/coverage,
    internal/coverage/encodemeta, os, path/filepath, reflect, time, unsafe
    < runtime/coverage;
`
