...
func BenchmarkWriteStringKoopmanCopy(b *testing.B) {
	benchmarkWriteStringCopy(b, New(MakeTable(Koopman)))
}
...
func BenchmarkWriteStringIEEECopy(b *testing.B) {
	benchmarkWriteStringCopy(b, NewIEEE())
}
