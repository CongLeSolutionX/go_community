...
TEXT ·crc32_le_vgfm(SB),NOSPLIT,$0
	MOVWZ   crc+0(FP), R2     // R2 stores the CRC value
	MOVD    p+8(FP), R3       // data pointer
	MOVD    p_len+16(FP), R4  // len(p)

	MOVD    $·crclecons(SB), R5
	BR      crc32·crc32_le_generic(SB)

// func crc32c_le_vgfm(crc uint32, p []byte) uint32
TEXT ·crc32c_le_vgfm(SB),NOSPLIT,$0
	MOVWZ   crc+0(FP), R2     // R2 stores the CRC value
	MOVD    p+8(FP), R3       // data pointer
	MOVD    p_len+16(FP), R4  // len(p)
...
TEXT crc32·crc32_le_generic(SB),NOSPLIT,$0
