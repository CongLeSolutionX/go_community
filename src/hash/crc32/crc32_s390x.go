...
// updateCastagnoli calculates the checksum using the callbacks given.
// genericCastagnoli is used to calculate the checksum of the head and tail of
// the data if the data is unaligned. vectorizedCastagnoli is used to calculate the
...
// updateIEEE calculates the checksum using the callbacks given.
// genericIEEE is used to calculate the checksum of the head and tail of
// the data if the data is unaligned. vectorizedIEEE is used to calculate the
// checksum of the aligned body of the data.
