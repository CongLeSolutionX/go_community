...
// if vector facility is unavailable or data chunk is less than or equal to vxMinLen.
...
// data if the data is unaligned, and is also used if vector facility is
// unavailable or data size is less than or equal to vxMinLen. vectorizedIEEE
// is used to calculate the checksum of the aligned body of the data.
