...
var fileTests = []fileTest{
	{
		...
		[]*SectionHeader{
			{".text", 0x10000150, 0x00000bbd, STYP_TEXT, 0x8b0a, 0x36},
			{".data", 0x20000d0d, 0x0000042b, STYP_DATA, 0x8d26, 0x2b},
			{".bss", 0x20001138, 0x00000218, STYP_BSS, 0, 0},
			{".loader", 0x00000000, 0x000004b3, STYP_LOADER, 0, 0},
			{".debug", 0x00000000, 0x0000751e, STYP_DEBUG, 0, 0},
		},
		[]string{"libc.a/shr.o"},
	},
	{
		...
		[]*SectionHeader{
			{".text", 0x10000240, 0x00000afd, STYP_TEXT, 0x978e, 0x34},
			{".data", 0x20000d3d, 0x000002e3, STYP_DATA, 0x9a66, 0x25},
			{".bss", 0x20001020, 0x00000428, STYP_BSS, 0, 0},
			{".loader", 0x00000000, 0x00000535, STYP_LOADER, 0, 0},
			{".debug", 0x00000000, 0x00008238, STYP_DEBUG, 0, 0},
		},
	...
	},
	{
		...
		FileHeader{U802TOCMAGIC},
		[]*SectionHeader{
			{".text", 0x10000150, 0x00000372, STYP_TEXT, 0xb1e, 0x1a},
			{".data", 0x200004c2, 0x0000032e, STYP_DATA, 0xc22, 0x16},
			{".bss", 0x200007f0, 0x00000004, STYP_BSS, 0, 0},
			{".loader", 0x00000000, 0x0000029d, STYP_LOADER, 0, 0},
			{".debug", 0x00000000, 0x0000008f, STYP_DEBUG, 0, 0},
		},
		[]string{"libc.a/shr.o"},
	},
	{
		...
		FileHeader{U64_TOCMAGIC},
		[]*SectionHeader{
			{".text", 0x100000240, 0x00000326, STYP_TEXT, 0xa6e, 0x1a},
			{".data", 0x110000566, 0x00000182, STYP_DATA, 0xbda, 0x11},
			{".bss", 0x1100006e8, 0x00000008, STYP_BSS, 0, 0},
			{".loader", 0x00000000, 0x0000029b, STYP_LOADER, 0, 0},
			{".debug", 0x00000000, 0x000000ea, STYP_DEBUG, 0, 0},
		},
		[]string{"libc.a/shr_64.o"},
	},
	{
