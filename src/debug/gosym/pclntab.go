...
func (t *LineTable) parsePclnTab() {
	...
	// offset returns the offset specified at t.Data[8+word*t.ptrsize:].
	offset := func(word uint32) uint64 {
		return t.uintptr(t.Data[8+word*t.ptrsize:])
	}
	// data returns a slice of t.Data starting at the
	// offset specified at t.Data[8+word*t.ptrsize:].
