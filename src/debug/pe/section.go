...
// Reloc represents PE COFF Relocations. Each section
// contains its own relocation list.
type Reloc struct {
	VirtualAddress   uint32
...
func newRelocs(sh *SectionHeader, r io.ReadSeeker) ([]Reloc, error) {
