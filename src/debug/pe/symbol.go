...
// is the index of a section symbol in the symbol array 'symbols'.
// Return value is a pointer to the appropriate aux symbol struct. For
// more info, see:
//
...
//
func COFFSymbolReadSectionDefAux(idx int, symbols []COFFSymbol) (*COFFSymbolAuxFormat5, error) {
