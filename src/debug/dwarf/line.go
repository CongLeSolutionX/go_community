...
//
// The file name table of a compilation unit is not fixed. Calling
// Next may add more entries to the line table, but will never change
// an existing entry. Seeking or resetting the LineReader will reset
// the line table to the number of entries it had as of the new seek
// position.
