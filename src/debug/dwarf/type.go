...
// the enclosing entity to the start of the bit field in question.
// This corresponds to the DW_AT_data_bit_offset DWARF attribute that
// was introduced in DWARF 4.
//
...
// most significant bit of the bit field. This value can vary
// depending on the endianness of the system. This corresponds to the
...
//
// If the compiler instead decides to emit DW_AT_data_bit_offset,
