...
// 40 (args of callReflect/callMethod) + (8 bool with padding) + 392 (abi.RegArgs) = 440.

// makeFuncStub is the code half of the function returned by MakeFunc.
// See the comment on the declaration of makeFuncStub in makefunc.go
// for more details.
// No arg size here, runtime pulls arg map out of the func value.
TEXT ·makeFuncStub(SB),(NOSPLIT|WRAPPER),$440
	NO_LOCAL_POINTERS
...
// for more details.
// No arg size here; runtime pulls arg map out of the func value.
TEXT ·methodValueCall(SB),(NOSPLIT|WRAPPER),$440
	NO_LOCAL_POINTERS
	ADD	$LOCAL_REGARGS, SP, X25 // spillArgs using X25
	CALL	runtime·spillArgs(SB)
