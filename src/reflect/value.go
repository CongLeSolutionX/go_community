...
func assignRegParam(regs *cpu.RegParamState, a abiParam, v Value) {
	if a.stackAllocated() {
...
func assignRegParam1(regs *cpu.RegParamState, a abiParam, t *rtype, v unsafe.Pointer) {
	switch t.Kind() {
...
// register parameter state regs. a.stackAllocated() must be false.
func extractRegParam(regs *cpu.RegParamState, a abiParam, t *rtype) Value {
	if a.stackAllocated() {
...
func extractRegParam1(regs *cpu.RegParamState, a abiParam, t *rtype, p *unsafe.Pointer) {
