...
// writebarrierpartial is like typedmemmovepartial but assumes that
// the actual copying has already been done, and only the write barrier
// needs to be executed. It must be called immediately (without any
// possibility of preemption) following the actual copy.
func writebarrierpartial(t *rtype, dst unsafe.Pointer, off, size uintptr)
