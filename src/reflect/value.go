...
// For valid values, if one of them is uncomparable, and the other is comparable,
// Equal reports false; if v and u are both uncomparable, Equal will panic.
func (v Value) Equal(u Value) bool {
	...
	panic("reflect.Value.Equal using two uncomparable values")
}
