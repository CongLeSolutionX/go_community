...
// TestFloatAdd tests Float.Mul/Quo by comparing the result of a "manual"
// multiplication/division of arguments represented by bits lists with the
// respective floating-point multiplication/division for a variety of precisions
// and rounding modes.
