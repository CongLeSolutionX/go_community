...
func TestIssue6866(t *testing.T) {
	...
	for _, prec := range [...]uint{1, 2, 5, 10, 50, 64, 100, 128, 500, 511, 512, 513, 1000, 10000} {
		two := NewFloat(2.0, prec, ToNearest)
		one := NewFloat(1.0, prec, ToNearest)
		three := NewFloat(3.0, prec, ToNearest)
		msix := NewFloat(-6.0, prec, ToNearest)
		psix := NewFloat(+6.0, prec, ToNearest)
