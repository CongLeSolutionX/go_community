...
// decimal integer or (independently) use a prefix of ``0b'', ``0'', ``0o'',
// or ``0x'' (or their upper-case variants) to denote a binary, octal, or
// hexadecimal integer value, respectively. The divisor may not be signed;
// e.g., -1/-1 is not valid.
// If a floating-point number is provided, it may be in decimal form or
// use any of the prefixes above except for ``0'' to denote a non-decimal
// mantissa. A leading ``0'' is considered a decimal leading 0.
...
func (z *Rat) SetString(s string) (*Rat, bool) {
	...
	// mantissa
	var base int
	var fcount int // fractional digit count; valid if <= 0 // before: ecorr
	...
	// reduces the the size of shift/multiplication factors or
	// divisors required to create the final fraction.
