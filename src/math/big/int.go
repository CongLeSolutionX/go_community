...
//   == u^(p+1)          mod p
//   == u^2              mod p
// to calculate the square root of any quadratic
// residue mod p quickly for 3 mod 4 primes.
...
// modSqrtTonelliShanks uses the Tonelli-Shanks algorithm
// to find the square root of a quadratic residue modulo
// any prime.
...
func (z *Int) ModSqrt(x, p *Int) *Int {
	...
	// Check whether p is 3 mod 4, and if so, use the
	// faster algorithm.
