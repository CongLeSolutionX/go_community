...
// and returns z. If g and n are not relatively prime, or if n is zero, then g has
// no multiplicative inverse in the ring ℤ/nℤ. In this case, z is unchanged and
