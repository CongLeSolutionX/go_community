...
// than IEEE-754 because Float exponents hace a much larger range.
//
...
// If prec == 0, the result is ±0 for finite z, ±Inf for infinite z (with the
// sign set according to z), and NaN for NaN. If prec > MaxPrec, it is set to
// MaxPrec.
...
// SetNaN sets z to a NaN (Not-a-Number), and returns z.
