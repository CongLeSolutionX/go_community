...
var floatScanTests = []struct {
	...
	0: {"10.0", "%f", "10", 0},
	1: {"23.98+2.0", "%v", "23.98", 4},
	2: {"-1+1", "%v", "-1", 2},
	3: {" 00000", "%v", "0", 0},
	4: {"-123456p-78", "%b", "-4.084816388e-19", 0},
	5: {"+123", "%b", "123", 0},
	6: {"-1.234e+56", "%e", "-1.234e+56", 0},
	7: {"-1.234E-56", "%E", "-1.234e-56", 0},
	8: {"-1.234e+567", "%g", "-1.234e+567", 0},
	9: {"+1234567891011.234", "%G", "1.234567891e+12", 0},
}
