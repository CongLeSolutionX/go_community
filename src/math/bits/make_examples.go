...
func eReg(fname string, size uint, in interface{}, res interface{}) (cond, out string) {
...
func eRev(fname string, size uint, in interface{}, res interface{}) (cond, out string) {
...
func eRot(fname string, size uint, in interface{}, res interface{}) (cond, out string) {
	args := in.([]int)
	condF := "fmt.Printf(\"%%0%db\\n\", %d)\n\tfmt.Printf(\"%%0%db\\n\", bits.%s(%d, %d))"
	outF := fmt.Sprintf("// %%0%db\n\t// %%0%db", size, size)
