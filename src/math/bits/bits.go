...
// RotateLeftN returns the value of x rotated left by n%N bits.
// N is one of 8, 16, 32, 64.
func RotateLeft8(x uint8, n uint) uint8    { return uint8(rot(uint64(x), 8, n%8)) }
func RotateLeft16(x uint16, n uint) uint16 { return uint16(rot(uint64(x), 16, n%16)) }
func RotateLeft32(x uint32, n uint) uint32 { return uint32(rot(uint64(x), 32, n%32)) }
func RotateLeft64(x uint64, n uint) uint64 { return rot(x, 64, n%64) }

// RotateRightN returns the value of x rotated right by n%N bits.
// N is one of 8, 16, 32, 64.
func RotateRight8(x uint8, n uint) uint8    { return uint8(rot(uint64(x), 8, 8-n%8)) }
func RotateRight16(x uint16, n uint) uint16 { return uint16(rot(uint64(x), 16, 16-n%16)) }
func RotateRight32(x uint32, n uint) uint32 { return uint32(rot(uint64(x), 32, 32-n%32)) }
func RotateRight64(x uint64, n uint) uint64 { return rot(x, 64, 64-n%64) }
