...
func (c *ChaCha8) Seed(seed [32]byte) {
	c.seed = *(*[8]uint32)(unsafe.Pointer(&seed))
}
...
func (c *ChaCha8) refill() {
	chacha8block(c.counter, &c.seed, (*[16][4]uint32)(unsafe.Pointer(&c.buf)))
	c.counter += 4
	c.n = uint(len(c.buf))
}
...
func chacha8block_generic(counter uint64, seed *[8]uint32, b *[16][4]uint32) {
