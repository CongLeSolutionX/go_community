...
var regressGolden = []any{
	...
	int32(1014896637),                   // Int31()
	int32(263029257),                    // Int31()
	int32(704327676),                    // Int31()
	int32(1132093077),                   // Int31()
	int32(1468435581),                   // Int31()
	int32(1384569072),                   // Int31()
	int32(206629383),                    // Int31()
	int32(1777399362),                   // Int31()
	int32(2037070468),                   // Int31()
	int32(179695464),                    // Int31()
	int32(1383608308),                   // Int31()
	int32(2042906397),                   // Int31()
	int32(912444629),                    // Int31()
	int32(293181774),                    // Int31()
	int32(653994876),                    // Int31()
	int32(1346102887),                   // Int31()
	int32(1905520479),                   // Int31()
	int32(18769825),                     // Int31()
	int32(1918856049),                   // Int31()
	int32(1932084271),                   // Int31()
	int32(0),                            // Int31n(1)
	int32(1),                            // Int31n(10)
	int32(25),                           // Int31n(32)
	int32(310570),                       // Int31n(1048576)
	int32(717010),                       // Int31n(1048577)
	int32(644740216),                    // Int31n(1000000000)
	int32(413258767),                    // Int31n(1073741824)
	int32(1777399360),                   // Int31n(2147483646)
	int32(2037070467),                   // Int31n(2147483647)
	int32(0),                            // Int31n(1)
	int32(6),                            // Int31n(10)
	int32(27),                           // Int31n(32)
	int32(367019),                       // Int31n(1048576)
	int32(143155),                       // Int31n(1048577)
	int32(304540095),                    // Int31n(1000000000)
	int32(544722126),                    // Int31n(1073741824)
	int32(1905520477),                   // Int31n(2147483646)
	int32(18769824),                     // Int31n(2147483647)
	int32(0),                            // Int31n(1)
	int32(8),                            // Int31n(10)
	...
	[]int{},                             // Perm(0)
	[]int{0},                            // Perm(1)
	[]int{1, 3, 0, 4, 2},                // Perm(5)
	[]int{1, 2, 7, 5, 6, 0, 4, 3},       // Perm(8)
	[]int{5, 2, 6, 4, 7, 1, 0, 3, 8},    // Perm(9)
	[]int{9, 7, 0, 2, 6, 3, 5, 4, 1, 8}, // Perm(10)
	[]int{10, 12, 5, 14, 13, 4, 8, 11, 1, 6, 9, 0, 2, 7, 3, 15}, // Perm(16)
	[]int{},                             // Perm(0)
	[]int{0},                            // Perm(1)
	[]int{2, 0, 1, 3, 4},                // Perm(5)
	[]int{1, 3, 4, 7, 2, 6, 5, 0},       // Perm(8)
	[]int{3, 1, 6, 7, 8, 2, 5, 4, 0},    // Perm(9)
	[]int{5, 7, 3, 9, 8, 4, 2, 6, 0, 1}, // Perm(10)
	[]int{0, 15, 9, 4, 11, 14, 2, 3, 8, 1, 13, 12, 7, 10, 5, 6}, // Perm(16)
	[]int{},                             // Perm(0)
	[]int{0},                            // Perm(1)
	[]int{3, 4, 1, 2, 0},                // Perm(5)
	[]int{5, 2, 6, 0, 3, 7, 1, 4},       // Perm(8)
	[]int{4, 0, 7, 1, 8, 6, 3, 2, 5},    // Perm(9)
	[]int{0, 4, 1, 5, 7, 8, 3, 6, 2, 9}, // Perm(10)
