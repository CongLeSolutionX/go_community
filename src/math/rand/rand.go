...
func Seed(seed int64) {
	...
	// Otherwise either
	// 1) r == nil, which is the normal case when Seed is the first
	// top-level function to be called, or
	// 2) r is already a fastSource, in which we need to change to a
	// lockedSource.
