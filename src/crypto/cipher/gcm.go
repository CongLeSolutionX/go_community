...
type AEAD interface {
	...
	//
	// The ciphertext and dst may alias exactly or not at all. To overwrite
	// plaintext with the encrypted output, use plaintext[:0] as dst.
	...
	//
	// The ciphertext and dst may alias exactly or not at all. To overwrite
	// ciphertext with the decrypted output, use ciphertext[:0] as dst.
