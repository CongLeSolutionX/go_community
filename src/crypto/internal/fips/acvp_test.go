...
var (
	...
	commands = map[string]command{
		...
		"HMAC-SHA2-512/224": cmdHmacAft(sha512.New512_224(), sha512.New512_224()),
		"HMAC-SHA2-512/256": cmdHmacAft(sha512.New512_256(), sha512.New512_256()),
		"HMAC-SHA3-224":     cmdHmacAft(sha3.New224(), sha3.New224()),
...
func TestACVP(t *testing.T) {
	...
	const (
		// TODO(@cpu): Restore using upstream acvptool after the following CR lands:
		// 	https://boringssl-review.googlesource.com/c/boringssl/+/72207
		// bsslModule    = "boringssl.googlesource.com/boringssl.git"
		// bsslVersion   = "v0.0.0-20241015160643-2587c4974dbe"
		bsslModule    = "github.com/cpu/acvptool"
		bsslVersion   = "v0.0.0-20241018210544-91896e0d0731"
		goAcvpModule  = "github.com/cpu/go-acvp"
		goAcvpVersion = "v0.0.0-20241018205731-fc461f091bc9"
	)
	...
	// TODO(@cpu): Restore using upstream acvptool path.
	...
	args := []string{
		"run",
		// TODO(@cpu): Restore using upstream acpvtool check_expected.go path
