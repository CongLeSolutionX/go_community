...
func p224Reduce(a *p224FieldElement) {
	...
	// don't actually check if a[0..2] went/go negative, like in p224Contract,
	// because here we can afford to go above 28 bits.)
...
// maskIsNegative returns 0xffffffff if the MSB of v is set, and 0 otherwise.
