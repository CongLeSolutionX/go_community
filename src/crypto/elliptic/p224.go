...
func (curve p224Curve) IsOnCurve(x, y *big.Int) bool {
	...
	// p224PointFromAffine, but let SetBytes reject the invalid Marshal output.
	_, err := nistec.NewP224Point().SetBytes(Marshal(curve, x, y))
	return err == nil
}
...
func (curve p224Curve) Add(x1, y1, x2, y2 *big.Int) (*big.Int, *big.Int) {
...
func (curve p224Curve) Double(x1, y1 *big.Int) (*big.Int, *big.Int) {
...
func (curve p224Curve) ScalarMult(Bx, By *big.Int, scalar []byte) (*big.Int, *big.Int) {
...
func (curve p224Curve) ScalarBaseMult(scalar []byte) (*big.Int, *big.Int) {
