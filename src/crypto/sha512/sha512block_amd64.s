...
loop:
	...
	// END func MSGSCHEDULE0(index int)
	...
	// END func SHA512T1(konst uint64, e, f, g, h GPPhysical)
	...
	// END func SHA512T2(a, b, c GPPhysical)
	MOVQ BX, R15
	ADDQ AX, R11
	ADDQ AX, R15

	// END func SHA512ROUND(index int, konst uint64, a, b, c, d, e, f, g, h GPPhysical)
	// END func SHA512ROUND0(index int, konst uint64, a, b, c, d, e, f, g, h GPPhysical)
	// func SHA512ROUND0(index int, konst uint64, a, b, c, d, e, f, g, h GPPhysical)
	// func MSGSCHEDULE0(index int)
	MOVQ   8(SI), AX
	BSWAPQ AX
	...
	// END func MSGSCHEDULE1(index int)
	// func SHA512ROUND(index int, konst uint64, a, b, c, d, e, f, g, h GPPhysical)
	// func SHA512T1(konst uint64, e, f, g, h GPPhysical)
	...
	// END func SHA512ROUND(index int, konst uint64, a, b, c, d, e, f, g, h GPPhysical)
	// END func SHA512ROUND1(index int, konst uint64, a, b, c, d, e, f, g, h GPPhysical)
	// func SHA512ROUND1(index int, konst uint64, a, b, c, d, e, f, g, h GPPhysical)
	// func MSGSCHEDULE1(index int)
	MOVQ 120(BP), AX
	MOVQ AX, CX
...
loop0:
	...
	// END func COPY_YMM_AND_BSWAP(p1 VecPhysical, p2 Mem, p3 VecPhysical)
	// func COPY_YMM_AND_BSWAP(p1 VecPhysical, p2 Mem, p3 VecPhysical)
	VMOVDQU 32(DI), Y5
	VPSHUFB Y9, Y5, Y5
...
loop1:
	...
	// END func MY_VPALIGNR(YDST, YSRC1, YSRC2 VecPhysical, RVAL int)
	VPADDQ Y4, Y0, Y0
...
loop2:
	...
	// END func addm(p1 Mem, p2 GPPhysical)
	// func addm(p1 Mem, p2 GPPhysical)
	ADDQ 8(SI), BX
	MOVQ BX, 8(SI)
