...
// Wrap Macro assembly with function signature comments via defer call
func macroComment(s string) func() {
	Comment(s)
	return func() { Comment("END " + s) }
}
...
func MSGSCHEDULE0(index int) {
	defer macroComment("func MSGSCHEDULE0(index int)")()
...
func MSGSCHEDULE1(index int) {
	defer macroComment("func MSGSCHEDULE1(index int)")()
...
func SHA512T1(konst uint64, e, f, g, h GPPhysical) {
	defer macroComment("func SHA512T1(konst uint64, e, f, g, h GPPhysical)")()
	MOVQ(U64(konst), RDX)
	ADDQ(RAX, h)
	MOVQ(e, RAX)
	ADDQ(RDX, h)
...
func SHA512T2(a, b, c GPPhysical) {
	defer macroComment("func SHA512T2(a, b, c GPPhysical)")()
	MOVQ(a, RDI)
	MOVQ(c, RBX)
	RORQ(Imm(28), RDI)
	MOVQ(a, RDX)
...
func SHA512ROUND(index int, konst uint64, a, b, c, d, e, f, g, h GPPhysical) {
	defer macroComment("func SHA512ROUND(index int, konst uint64, a, b, c, d, e, f, g, h GPPhysical)")()
...
func SHA512ROUND0(index int, konst uint64, a, b, c, d, e, f, g, h GPPhysical) {
	defer macroComment("func SHA512ROUND0(index int, konst uint64, a, b, c, d, e, f, g, h GPPhysical)")()
	MSGSCHEDULE0(index)
...
func SHA512ROUND1(index int, konst uint64, a, b, c, d, e, f, g, h GPPhysical) {
	defer macroComment("func SHA512ROUND1(index int, konst uint64, a, b, c, d, e, f, g, h GPPhysical)")()
	MSGSCHEDULE1(index)
	SHA512ROUND(index, konst, a, b, c, d, e, f, g, h)
}
...
func addm(p1 Mem, p2 GPPhysical) {
	defer macroComment("func addm(p1 Mem, p2 GPPhysical)")()
	ADDQ(p1, p2)
	MOVQ(p2, p1)
}
...
func COPY_YMM_AND_BSWAP(p1 VecPhysical, p2 Mem, p3 VecPhysical) {
	defer macroComment("func COPY_YMM_AND_BSWAP(p1 VecPhysical, p2 Mem, p3 VecPhysical)")()
	VMOVDQU(p2, p1)
	VPSHUFB(p3, p1, p1)
}
...
func MY_VPALIGNR(YDST, YSRC1, YSRC2 VecPhysical, RVAL int) {
	defer macroComment("func MY_VPALIGNR(YDST, YSRC1, YSRC2 VecPhysical, RVAL int)")()
