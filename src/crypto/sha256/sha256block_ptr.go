...
// Defined in sha256block_386.s and sha256block_amd64.s.
//
// Because the hashing functions for SHA256 exceed the stack limit
// for NOSPLIT, we cannot safely JMP from another assembly routine
// like elsewhere (e.g. SHA1). To ensure we have a well-formed stack
