...
func msgSchedule0(index int) {
	var SI Mem = Mem{Base: SI}
	var BP Mem = Mem{Base: BP}

	MOVL(SI.Offset(index*4), EAX)
	BSWAPL(EAX)
	MOVL(EAX, BP.Offset(index*4))
}
...
func msgSchedule1(index int) {
	...
	MOVL(BP.Offset((index-2)*4), EAX)
	MOVL(EAX, ECX)
	RORL(Imm(17), EAX)
	MOVL(ECX, EDX)
	RORL(Imm(19), ECX)
	SHRL(Imm(10), EDX)
	MOVL(BP.Offset((index-15)*4), EBX)
	XORL(ECX, EAX)
	MOVL(EBX, ECX)
	XORL(EDX, EAX)
	RORL(Imm(7), EBX)
	...
	SHRL(Imm(3), EDX)
	RORL(Imm(18), ECX)
	ADDL(BP.Offset((index-7)*4), EAX)
	XORL(ECX, EBX)
	XORL(EDX, EBX)
	ADDL(BP.Offset((index-16)*4), EBX)
	ADDL(EBX, EAX)
	MOVL(EAX, BP.Offset((index)*4))
}
...
func loop() {
	...
	sha256Round0(0, 0x428a2f98, R8L, R9L, R10L, R11L, R12L, R13L, R14L, R15L)
	sha256Round0(1, 0x71374491, R15L, R8L, R9L, R10L, R11L, R12L, R13L, R14L)
	sha256Round0(2, 0xb5c0fbcf, R14L, R15L, R8L, R9L, R10L, R11L, R12L, R13L)
	sha256Round0(3, 0xe9b5dba5, R13L, R14L, R15L, R8L, R9L, R10L, R11L, R12L)
	sha256Round0(4, 0x3956c25b, R12L, R13L, R14L, R15L, R8L, R9L, R10L, R11L)
	sha256Round0(5, 0x59f111f1, R11L, R12L, R13L, R14L, R15L, R8L, R9L, R10L)
	sha256Round0(6, 0x923f82a4, R10L, R11L, R12L, R13L, R14L, R15L, R8L, R9L)
	sha256Round0(7, 0xab1c5ed5, R9L, R10L, R11L, R12L, R13L, R14L, R15L, R8L)
	sha256Round0(8, 0xd807aa98, R8L, R9L, R10L, R11L, R12L, R13L, R14L, R15L)
	sha256Round0(9, 0x12835b01, R15L, R8L, R9L, R10L, R11L, R12L, R13L, R14L)
	sha256Round0(10, 0x243185be, R14L, R15L, R8L, R9L, R10L, R11L, R12L, R13L)
	sha256Round0(11, 0x550c7dc3, R13L, R14L, R15L, R8L, R9L, R10L, R11L, R12L)
	sha256Round0(12, 0x72be5d74, R12L, R13L, R14L, R15L, R8L, R9L, R10L, R11L)
	sha256Round0(13, 0x80deb1fe, R11L, R12L, R13L, R14L, R15L, R8L, R9L, R10L)
	sha256Round0(14, 0x9bdc06a7, R10L, R11L, R12L, R13L, R14L, R15L, R8L, R9L)
	sha256Round0(15, 0xc19bf174, R9L, R10L, R11L, R12L, R13L, R14L, R15L, R8L)

	sha256Round1(16, 0xe49b69c1, R8L, R9L, R10L, R11L, R12L, R13L, R14L, R15L)
	sha256Round1(17, 0xefbe4786, R15L, R8L, R9L, R10L, R11L, R12L, R13L, R14L)
	sha256Round1(18, 0x0fc19dc6, R14L, R15L, R8L, R9L, R10L, R11L, R12L, R13L)
	sha256Round1(19, 0x240ca1cc, R13L, R14L, R15L, R8L, R9L, R10L, R11L, R12L)
	sha256Round1(20, 0x2de92c6f, R12L, R13L, R14L, R15L, R8L, R9L, R10L, R11L)
	sha256Round1(21, 0x4a7484aa, R11L, R12L, R13L, R14L, R15L, R8L, R9L, R10L)
	sha256Round1(22, 0x5cb0a9dc, R10L, R11L, R12L, R13L, R14L, R15L, R8L, R9L)
	sha256Round1(23, 0x76f988da, R9L, R10L, R11L, R12L, R13L, R14L, R15L, R8L)
	sha256Round1(24, 0x983e5152, R8L, R9L, R10L, R11L, R12L, R13L, R14L, R15L)
	sha256Round1(25, 0xa831c66d, R15L, R8L, R9L, R10L, R11L, R12L, R13L, R14L)
	sha256Round1(26, 0xb00327c8, R14L, R15L, R8L, R9L, R10L, R11L, R12L, R13L)
	sha256Round1(27, 0xbf597fc7, R13L, R14L, R15L, R8L, R9L, R10L, R11L, R12L)
	sha256Round1(28, 0xc6e00bf3, R12L, R13L, R14L, R15L, R8L, R9L, R10L, R11L)
	sha256Round1(29, 0xd5a79147, R11L, R12L, R13L, R14L, R15L, R8L, R9L, R10L)
	sha256Round1(30, 0x06ca6351, R10L, R11L, R12L, R13L, R14L, R15L, R8L, R9L)
	sha256Round1(31, 0x14292967, R9L, R10L, R11L, R12L, R13L, R14L, R15L, R8L)
	sha256Round1(32, 0x27b70a85, R8L, R9L, R10L, R11L, R12L, R13L, R14L, R15L)
	sha256Round1(33, 0x2e1b2138, R15L, R8L, R9L, R10L, R11L, R12L, R13L, R14L)
	sha256Round1(34, 0x4d2c6dfc, R14L, R15L, R8L, R9L, R10L, R11L, R12L, R13L)
	sha256Round1(35, 0x53380d13, R13L, R14L, R15L, R8L, R9L, R10L, R11L, R12L)
	sha256Round1(36, 0x650a7354, R12L, R13L, R14L, R15L, R8L, R9L, R10L, R11L)
	sha256Round1(37, 0x766a0abb, R11L, R12L, R13L, R14L, R15L, R8L, R9L, R10L)
	sha256Round1(38, 0x81c2c92e, R10L, R11L, R12L, R13L, R14L, R15L, R8L, R9L)
	sha256Round1(39, 0x92722c85, R9L, R10L, R11L, R12L, R13L, R14L, R15L, R8L)
	sha256Round1(40, 0xa2bfe8a1, R8L, R9L, R10L, R11L, R12L, R13L, R14L, R15L)
	sha256Round1(41, 0xa81a664b, R15L, R8L, R9L, R10L, R11L, R12L, R13L, R14L)
	sha256Round1(42, 0xc24b8b70, R14L, R15L, R8L, R9L, R10L, R11L, R12L, R13L)
	sha256Round1(43, 0xc76c51a3, R13L, R14L, R15L, R8L, R9L, R10L, R11L, R12L)
	sha256Round1(44, 0xd192e819, R12L, R13L, R14L, R15L, R8L, R9L, R10L, R11L)
	sha256Round1(45, 0xd6990624, R11L, R12L, R13L, R14L, R15L, R8L, R9L, R10L)
	sha256Round1(46, 0xf40e3585, R10L, R11L, R12L, R13L, R14L, R15L, R8L, R9L)
	sha256Round1(47, 0x106aa070, R9L, R10L, R11L, R12L, R13L, R14L, R15L, R8L)
	sha256Round1(48, 0x19a4c116, R8L, R9L, R10L, R11L, R12L, R13L, R14L, R15L)
	sha256Round1(49, 0x1e376c08, R15L, R8L, R9L, R10L, R11L, R12L, R13L, R14L)
	sha256Round1(50, 0x2748774c, R14L, R15L, R8L, R9L, R10L, R11L, R12L, R13L)
	sha256Round1(51, 0x34b0bcb5, R13L, R14L, R15L, R8L, R9L, R10L, R11L, R12L)
	sha256Round1(52, 0x391c0cb3, R12L, R13L, R14L, R15L, R8L, R9L, R10L, R11L)
	sha256Round1(53, 0x4ed8aa4a, R11L, R12L, R13L, R14L, R15L, R8L, R9L, R10L)
	sha256Round1(54, 0x5b9cca4f, R10L, R11L, R12L, R13L, R14L, R15L, R8L, R9L)
	sha256Round1(55, 0x682e6ff3, R9L, R10L, R11L, R12L, R13L, R14L, R15L, R8L)
	sha256Round1(56, 0x748f82ee, R8L, R9L, R10L, R11L, R12L, R13L, R14L, R15L)
	sha256Round1(57, 0x78a5636f, R15L, R8L, R9L, R10L, R11L, R12L, R13L, R14L)
	sha256Round1(58, 0x84c87814, R14L, R15L, R8L, R9L, R10L, R11L, R12L, R13L)
	sha256Round1(59, 0x8cc70208, R13L, R14L, R15L, R8L, R9L, R10L, R11L, R12L)
	sha256Round1(60, 0x90befffa, R12L, R13L, R14L, R15L, R8L, R9L, R10L, R11L)
	sha256Round1(61, 0xa4506ceb, R11L, R12L, R13L, R14L, R15L, R8L, R9L, R10L)
	sha256Round1(62, 0xbef9a3f7, R10L, R11L, R12L, R13L, R14L, R15L, R8L, R9L)
	sha256Round1(63, 0xc67178f2, R9L, R10L, R11L, R12L, R13L, R14L, R15L, R8L)
...
// To hold constants for K256_DATA
var _K [64]uint32
...
func K256_DATA() Mem {
	...
	parseKValuesFromSha256blockDotGo()
...
// Parse and load _K values from ../sha256block.go
func parseKValuesFromSha256blockDotGo() {
	const filename string = "../sha256block.go"
	...
	ast.Inspect(file, findK)
}

// Traverse AST and find "_K" ValueSpec
func findK(n ast.Node) bool {
...
func extractKValues(vs *ast.ValueSpec) {
	if vs.Values == nil {
		panic("error: expected ValueSpec _K to contain a value, found nil")
	}

	if len(vs.Values) != 1 {
		panic(fmt.Sprintf("error: expected ValueSpec _K to contain a single CompositeLit, found %d value(s)", len(vs.Values)))
	}

	cl, ok := vs.Values[0].(*ast.CompositeLit)
	if !ok {
		panic(fmt.Sprintf("error: expected ast values in ValueSpec _K to be of type CompositeLit, found %v", reflect.TypeOf(vs.Values[0])))
	}

	if len(cl.Elts) != 64 {
		panic(fmt.Sprintf("error: expected ValueSpec _K to contain 64 expressions, found %d", len(cl.Elts)))
	}

	for i, elt := range cl.Elts {
		be, ok := elt.(*ast.BasicLit)
		if !ok {
			panic(fmt.Sprintf("error: expected all _K elements to be of type *ast.BasicLit, found %v", reflect.TypeOf(elt)))
		}

		kVal, err := strconv.ParseUint(be.Value, 0, 32)
		if err != nil {
			panic(err)
		}
		_K[i] = uint32(kVal)
