...
func testBytes(t *testing.T, h hash.Hash, i int, tt hmacTest) {
	n, err := h.Write([]byte(tt.in))
	if n != len(tt.in) || err != nil {
		t.Errorf("Test %d: Write(%d) = %d, %v", i, len(tt.in), n, err)
		return
	}
...
func testString(t *testing.T, h hash.Hash, i int, tt hmacTest) {
	n, err := io.WriteString(h, tt.in)
	if n != len(tt.in) || err != nil {
		t.Errorf("Test %d: WriteString(%d) = %d, %v", i, len(tt.in), n, err)
		return
	}
