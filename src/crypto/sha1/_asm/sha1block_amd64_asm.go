...
func BSWAP_SHUFB_CTL_DATA() Mem {
	...
	DATA(0x00, U32(0x00010203))
	DATA(0x04, U32(0x04050607))
	DATA(0x08, U32(0x08090a0b))
	DATA(0x0c, U32(0x0c0d0e0f))
	DATA(0x10, U32(0x00010203))
	DATA(0x14, U32(0x04050607))
	DATA(0x18, U32(0x08090a0b))
	DATA(0x1c, U32(0x0c0d0e0f))
