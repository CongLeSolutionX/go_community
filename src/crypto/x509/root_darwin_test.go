...
func TestSystemRoots(t *testing.T) {
	...
	for _, tt := range []*CertPool{sysRoots, execRoots} {
		...
		// On Mavericks, there are 212 bundled certs, at least at
		// at one point in time on one machine. (corp laptop?)
		// Other OS X users report 135, 142, 145...
		// Let's try requiring at least 100, since this is
		// just a sanity check.
