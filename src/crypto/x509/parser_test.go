...
func TestPolicyParse(t *testing.T) {
	...
	fmt.Println(c.PolicyMappings)
	fmt.Println(c.RequireExplicitPolicyZero, c.RequireExplicitPolicy)
	fmt.Println(c.InhibitPolicyMappingZero, c.InhibitPolicyMapping)
	fmt.Println(c.InhibitAnyPolicyZero, c.InhibitAnyPolicy)
}
