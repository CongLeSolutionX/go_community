...
type Certificate struct {
	...
	// should be treated equivalent to -1 (unset).
	//
	// When generating a certificate, an unset pathLenConstraint can be
	// requested with either InhibitAnyPolicy == -1 or using the zero value for
	// both InhibitAnyPolicy and InhibitAnyPolicyZero.
	...
	//
	// When generating a certificate, an unset pathLenConstraint can be
	// requested with either InhibitPolicyMapping == -1 or using the zero value
	// for both InhibitPolicyMapping and InhibitPolicyMappingZero.
	...
	//
	// When generating a certificate, an unset pathLenConstraint can be
	// requested with either RequireExplicitPolicy == -1 or using the zero value
	// for both RequireExplicitPolicy and RequireExplicitPolicyZero.
