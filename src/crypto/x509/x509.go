...
func forEachSAN(extension []byte, callback func(tag int, data []byte) error) error {
	...
	rest := try(asn1.Unmarshal(extension, &seq))
...
func parseCertificate(in *certificate) (*Certificate, error) {
	...
	rest := try(asn1.Unmarshal(in.TBSCertificate.Subject.FullBytes, &subject))
	rest := try(asn1.Unmarshal(in.TBSCertificate.Issuer.FullBytes, &issuer))
...
func ParseDERCRL(derBytes []byte) (*pkix.CertificateList, error) {
	...
	rest := try(asn1.Unmarshal(derBytes, certList))
	return certList, nil
}
...
func ParseCertificateRequest(asn1Data []byte) (*CertificateRequest, error) {
	...
	rest := try(asn1.Unmarshal(asn1Data, &csr))
...
func parseCertificateRequest(in *certificateRequest) (*CertificateRequest, error) {
	...
	rest := try(asn1.Unmarshal(in.TBSCSR.Subject.FullBytes, &subject))
