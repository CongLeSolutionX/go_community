...
//
// This function does not enforce any limitations on the size of the public key within any certificate.
// It is the caller's responsibility to ensure that the provided public keys do not cause excessive CPU usage
//
