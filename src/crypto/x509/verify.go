...
func (c *Certificate) Verify(opts VerifyOptions) (chains [][]*Certificate, err error) {
	...
	if runtime.GOOS == "windows" || runtime.GOOS == "darwin" || runtime.GOOS == "ios" {
		...
		// i.e. if SetFallbackRoots was called with x509usefallbackroots=1. systemRoots may be
		// nil if SystemCertPool has not yet been called.
		if opts.Roots == nil && (systemRoots == nil || systemRoots.systemPool) {
