...
func TestPoliciesValid(t *testing.T) {
	// These test cases, and the certificates they rely on, are stolen from
	// BoringSSL [0]. We skip the tests which involve certificate parsing as
	// part of the verification process. Those tests are in TestParsePolicies.
	//
	...
	// intermediate_duplicate := loadTestCert(t, "testdata/policy_intermediate_duplicate.pem")
	// intermediate_invalid := loadTestCert(t, "testdata/policy_intermediate_invalid.pem")
	...
	// intermediate_require_duplicate := loadTestCert(t, "testdata/policy_intermediate_require_duplicate.pem")
	...
	// leaf_duplicate := loadTestCert(t, "testdata/policy_leaf_duplicate.pem")
	// leaf_invalid := loadTestCert(t, "testdata/policy_leaf_invalid.pem")
