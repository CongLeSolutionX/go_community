...
func TestRSAPSAParameters(t *testing.T) {
	...
	for h, params := range hashToPSSParameters {
		...
		if !bytes.Equal(params, generated) {
			t.Errorf("hardcoded parameters for %s didn't match generated parameters: wanted (hardcoded) %x, got (generated) %x", h, params, generated)
			fmt.Println(h, generated)
		}
	}
}
