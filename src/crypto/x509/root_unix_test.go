...
// variable with colons, allows loadSystemRoots to load all
// the roots in the respective directories.
// See https://golang.org/issue/35325.
func TestLoadSystemCertsLoadColonSeparatedDirs(t *testing.T) {
	origDir := os.Getenv(certDirEnv)
	defer os.Setenv(certDirEnv, origDir)
