...
// For keyp of 10, V6, V12-V21 hold the expanded key.
// For keyp of 12, V6, V10-V21 hold the expanded key.
// For keyp of 14, V6, V7,V9-V21 hold the expanded key.
#define LOAD_KEY(Rkeyp) \
	...
	L_start12: \
	LXVD2X (Rkeyp)(R0), V10 \
	LXVD2X (Rkeyp)(R12), V11 \
	ADD $32, Rkeyp \
	L_start10: \
	LXVD2X (Rkeyp)(R0), V12 \
	LXVD2X (Rkeyp)(R12), V13 \
	LXVD2X (Rkeyp)(R14), V14 \
	LXVD2X (Rkeyp)(R15), V15 \
	LXVD2X (Rkeyp)(R16), V16 \
	LXVD2X (Rkeyp)(R17), V17 \
	LXVD2X (Rkeyp)(R18), V18 \
	LXVD2X (Rkeyp)(R19), V19 \
	LXVD2X (Rkeyp)(R20), V20 \
	LXVD2X (Rkeyp)(R21), V21 \
	Lstart:
...
#define CIPHER_BLOCK(Vinout, vcipher, vciphel, label10, label12) \
	BEQ     CR1, label10 \
	BEQ     CR2, label12 \
	...
	vcipher Vinout, V20, Vinout \
	vciphel Vinout, V21, Vinout \
...
Lcbc_enc:
	...
	CIPHER_BLOCK(INOUT, VCIPHER, VCIPHERLAST, Lcbc_enc10, Lcbc_enc12)
...
Lcbc_dec:
	...
	ADD  $16, INP
	VXOR TMP, V6, INOUT
	CIPHER_BLOCK(INOUT, VNCIPHER, VNCIPHERLAST, Lcbc_dec10, Lcbc_dec12)
	VXOR INOUT, IVEC, INOUT
	VOR  TMP, TMP, IVEC
	P8_STXVB16X(INOUT, OUTP, R0)
	ADD  $16, OUTP
