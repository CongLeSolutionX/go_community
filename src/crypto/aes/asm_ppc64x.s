...
// Vxor is usually V6 (Key[0-3], but for performance reasons during
// encrypting, the initial IVEC xor (Key[0-3] xor CipherText), it is
// faster (3.3%) to swap the xor order on P9.
...
TEXT ·cryptBlocksChain(SB), NOSPLIT|NOFRAME, $0
	...
	LVX	(R11), ESPERM   // Load LE to BE permute.
#endif
