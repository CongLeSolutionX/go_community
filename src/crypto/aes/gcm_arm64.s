...
#define mul128P64(r0, r1, a, b, t0, t1, z) \
	PMULL	a.D1, b.D1, r0.Q1;\
	PMULL2	a.D2, b.D2, r1.Q1;\
	VEXT	$8, b.B16, b.B16, t0.B16;\
	PMULL	a.D1, t0.D1, t1.Q1;\
	PMULL2	a.D2, t0.D2, t0.Q1;\
...
TEXT ·gcmAesCtrEncAsm(SB),NOSPLIT,$0
	...
	// V5 = nonce
	// V6 = nonce + 1
	// r5 = less significant 32 bit of counter
	// r6 = less significant 32 bit of counter + 1
	// r8 = less significant 32 bit of counter + 2
	VLD1.P	16(R3), [V5.B16]
	VMOV	V5.S[3], R5
	REV32	R5, R5
	VMOV	V5.B16, V6.B16
