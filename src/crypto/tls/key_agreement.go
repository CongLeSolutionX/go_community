...
NextCandidate:
	...
	signatureAlgorithm, sigType, hashFunc := try(pickSignatureAlgorithm(priv.Public(), clientHello.supportedSignatureAlgorithms, supportedSignatureAlgorithmsTLS12, ka.version))
