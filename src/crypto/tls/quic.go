...
type QUICEvent struct {
	...
	Data []byte // owned by crypto/tls, valid until next HandleData call
...
type quicState struct {
	...
	// eventArr is a staticly allocated event array, large enough to handle
