...
func (hs *serverHandshakeState) processClientHello() error {
	...
	hs.ecdhOk = supportsECDHE(c.config, hs.clientHello.supportedCurves, hs.clientHello.supportedPoints)
...
func supportsECDHE(c *Config, supportedCurves []CurveID, supportedPoints []uint8) bool {
	...
	preferredCurves := c.curvePreferences()
Curves:
	...
	return supportedCurve && supportedPointFormat
}
