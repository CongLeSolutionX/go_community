...
type ConnectionState struct {
	...
	// It is not always guaranteed to be from Config.NextProtos.
	// For example, with server side NPN, a client may select a protocol that the server did not advertise.
