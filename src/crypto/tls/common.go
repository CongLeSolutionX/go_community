...
type Config struct {
	...
	// KeyLogWriter is a log of TLS master secrets in NSS key log format
	// that can be used to allow external programs such as Wireshark to
	// decrypt TLS connections.
	// See https://developer.mozilla.org/en-US/docs/Mozilla/Projects/NSS/Key_Log_Format.
	// KeyLogWriter uses only the CLIENT_RANDOM format, with no header.
	// Logging TLS secrets compromises forward secrecy, so
	// this should be used only for debugging, and never by default.
