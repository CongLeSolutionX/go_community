...
// ExportKeyingMaterial returns length bytes of exported key material as
...
func (cs ConnectionState) ExportKeyingMaterial(label string, context []byte, length int) ([]byte, bool) {
