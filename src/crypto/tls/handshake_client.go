...
NextCipherSuite:
	...
	// configured when we will never send a CertificateVerify message and
...
func (hs *clientHandshakeState) doFullHandshake() error {
	...
	if chainToSend != nil {
		...
		certVerify.signatureAndHash, err = hs.finishedHash.selectClientCertSignatureAlgorithm(certReq.signatureAndHashes, supportedSKXSignatureAlgorithms, signatureType)
		if err != nil {
			c.sendAlert(alertInternalError)
			return err
		}
