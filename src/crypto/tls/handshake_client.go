...
func (c *Conn) clientHandshake() error {
	...
	hello := &clientHelloMsg{
		...
		ocspStapling:        true,
		scts:                true,
		serverName:          canonHostnameInSNI(c.config.ServerName),
...
// canonHostnameInSNI converts name into an approriate hostname for SNI.
// Literal IP addresses and absolute FQDNs are not permitted as SNI values.
// See https://tools.ietf.org/html/rfc6066#section-3 for futher information.
func canonHostnameInSNI(name string) string {
	host := name
