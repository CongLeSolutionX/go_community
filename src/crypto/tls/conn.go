...
func (hc *halfConn) decrypt(record []byte) ([]byte, recordType, error) {
	...
	if hc.mac != nil {
		...
		// Extract it with copySecretSlice. As an optimization, compute
		// the minimum value for n to avoid searching unnecessary parts
		// of the payload. (paddingLen is at most 256.)
