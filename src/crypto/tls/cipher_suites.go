...
var (
	supportedUpToTLS12 = []uint16{VersionSSL30, VersionTLS10, VersionTLS11, VersionTLS12}
...
// (e.g. TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256), or a fallback string if the
// cipher suite is not implemented by this package.
func CipherSuiteName(id uint16) string {
	...
	default:
		return fmt.Sprintf("cipher suite %#04x", id)
	}
}
