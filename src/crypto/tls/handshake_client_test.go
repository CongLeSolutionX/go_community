...
func TestResumption(t *testing.T) {
	// TODO(cpu): TLSv12 failing with mutual ciphersuite support err...
...
func testResumption(t *testing.T, version uint16) {
	...
	serverConfig := &Config{
		MaxVersion:   version,
		CipherSuites: []uint16{TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256, TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256},
	...
	if version != VersionTLS13 {
		clientConfig.CipherSuites = []uint16{TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256}
