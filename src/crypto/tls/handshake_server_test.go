...
func TestTLSPointFormats(t *testing.T) {
	skipFips(t) // TODO(@cpu): Why is this test incompatible (handshake failure)?
...
func TestHandshakeServerECDHEECDSAAES(t *testing.T) {
	skipFips(t) // TLS 1.0 not applicable, TLS 1.2 test uses SHA1, TLS 1.3 test mismatch for non-FIPS golden data.
