...
func (hs *clientHandshakeStateTLS13) establishHandshakeKeys() error {
	...
	if c.quic != nil {
		...
		c.quicSetWriteSecret(EncryptionLevelHandshake, hs.suite.id, clientSecret)
		c.quicSetReadSecret(EncryptionLevelHandshake, hs.suite.id, serverSecret)
	}
...
func (hs *clientHandshakeStateTLS13) readServerParameters() error {
	...
	if c.quic != nil {
		...
		if err := c.quicSetTransportParameters(encryptedExtensions.quicTransportParameters); err != nil {
			return err
		}
	}
...
func (hs *clientHandshakeStateTLS13) sendClientFinished() error {
	...
	if c.quic != nil {
		...
		c.quicSetWriteSecret(EncryptionLevelApplication, hs.suite.id, hs.trafficSecret)
	}
