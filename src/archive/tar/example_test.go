...
// Sparse files can be used to efficiently represent a large file that is
// mostly empty. Sparse files consists of a sequence of fragments
// that represents the holes in a file, for which there is no data.
func Example_sparse() {
	buf := new(bytes.Buffer)
