...
//	var rawData = "abcdefgh"
//
// And the sparse map had the following entries:
//	var sp = []sparseEntry{
//		{offset: 2,  numBytes: 5} // Data fragment for [2..7]
//		{offset: 18, numBytes: 3} // Data fragment for [18..21]
//	}
//
// Then the resulting sparse file that has a "realsize" of 25 is:
//	var sparseData = "\x00"*2 + "abcde" + "\x00"*11 + "fgh" + "\x00"*4
type sparseEntry struct {
	offset   int64 // Starting position of the fragment
	numBytes int64 // Length of the of the fragment
}
...
func (sfr *sparseFileReader) Read(b []byte) (n int, err error) {
	...
	if len(sfr.sp) == 0 {
		...
		// However, GNU tar stops returning data even if sfr.tot is unmet.
		if sfr.pos < sfr.tot {
