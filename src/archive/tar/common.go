...
type Header struct {
	...
	// AccessTime and ChangeTime when considering the USTAR format.
	...
	// then it choses a compatible format (in the order of USTAR, PAX, GNU)
	// and when considering USTAR, it ignores AccessTime and ChangeTime.
	// Otherwise, it uses the specified format.
	Format Format
}
