...
//
// Unless the Files on Reader are accessed serially (i.e., only one file is
// opened at a time), the dcomp provided must support being called concurrently.
// Otherwise, it is safe to reuse the underlying compressor for each call to dcomp.
