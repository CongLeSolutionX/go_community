...
func returnCorruptCRC32Zip() (r io.ReaderAt, size int64) {
	return messWith("go-with-datadesc-sig.zip", func(b []byte) {
		// // According to the spec, the CRC32 in the data descriptor and
		// // central header should match and the CRC32 in the local header
		// // should be 0. Since the data descriptor is read last, we
		// b[0x82] = 0
