...
// GO_ARGS is inserted implicitly by the assembler for any non-static
// function whose package-qualified symbol name belongs to the current
// package; it is therefore usually not necessary to write explicitly.
