...
TEXT runtime·exit1(SB),NOSPLIT,$8
	...
	MOVW	$0x12E, R12
	SWI	$0xA0012E		// sys___threxit
	MOVW.CS	$1, R8			// crash on syscall failure
	MOVW.CS	R8, (R8)
	RET

TEXT runtime·open(SB),NOSPLIT,$-4
	MOVW	0(FP), R0		// arg 1 - path
	MOVW	4(FP), R1		// arg 2 - flags
	MOVW	8(FP), R2		// arg 3 - mode
	MOVW	$0x5, R12
	SWI	$0xA00005		// sys_open
	MOVW	R0, ret+12(FP)
	RET
...
TEXT runtime·usleep(SB),NOSPLIT,$16
	...
	MOVW	$0x5B, R12
	SWI	$0xA0005B		// sys_nanosleep
	RET

TEXT runtime·raise(SB),NOSPLIT,$12
	MOVW	$0x12B, R12
	SWI	$0xA0012B		// sys_getthrid
...
TEXT runtime·mmap(SB),NOSPLIT,$16
	...
	MOVW	16(FP), R4		// arg 5 - fd (on stack)
	MOVW	R4, 4(R13)
	MOVW	$0, R5			// arg 6 - pad (on stack)
	MOVW	R5, 8(R13)
	MOVW	20(FP), R6		// arg 7 - offset (on stack)
...
TEXT runtime·setitimer(SB),NOSPLIT,$0
	...
	MOVW	4(FP), R1		// arg 2 - value
	MOVW	8(FP), R2		// arg 3 - ovalue
	MOVW	$0x45, R12
	SWI	$0xA00045
	RET
...
TEXT time·now(SB), NOSPLIT, $32
	...
	MOVW	$0x57, R12
	SWI	$0xA00057		// sys_clock_gettime
...
TEXT runtime·sigprocmask(SB),NOSPLIT,$0
	...
	MOVW	4(FP), R1		// arg 2 - mask
	MOVW	$0x30, R12
	SWI	$0xA00030		// sys_sigprocmask
	MOVW.CS	$3, R8			// crash on syscall failure
	MOVW.CS	R8, (R8)
	MOVW	R0, ret+8(FP)
	RET
...
TEXT runtime·osyield(SB),NOSPLIT,$0
	MOVW	$0x12A, R12
	SWI	$0xA0012A		// sys_sched_yield
	RET

TEXT runtime·thrsleep(SB),NOSPLIT,$4
	MOVW	0(FP), R0		// arg 1 - ident
	MOVW	4(FP), R1		// arg 2 - clock_id
	MOVW	8(FP), R2		// arg 3 - tp
	MOVW	12(FP), R3		// arg 4 - lock
	MOVW	16(FP), R4		// arg 5 - abort (on stack)
	MOVW	R4, 4(R13)
	ADD	$4, R13
	MOVW	$0x5E, R12
	SWI	$0xA0005E		// sys___thrsleep
	SUB	$4, R13
	MOVW	R0, ret+20(FP)
	RET
...
TEXT runtime·thrwakeup(SB),NOSPLIT,$0
	MOVW	0(FP), R0		// arg 1 - ident
	MOVW	4(FP), R1		// arg 2 - n
	MOVW	$0x12D, R12
	SWI	0xA0012D		// sys___thrwakeup
	MOVW	R0, ret+8(FP)
	RET
...
TEXT runtime·sysctl(SB),NOSPLIT,$8
	...
	MOVW	16(FP), R4		// arg 5 - newp (on stack)
	MOVW	R4, 4(R13)
	MOVW	20(FP), R5		// arg 6 - newlen (on stack)
	MOVW	R5, 8(R13)
	ADD	$4, R13
	MOVW	$0xCA, R12
...
TEXT runtime·kevent(SB),NOSPLIT,$8
	MOVW	0(FP), R0		// arg 1 - fd
	MOVW	4(FP), R1		// arg 2 - changelist
	MOVW	8(FP), R2		// arg 3 - nchanges
	MOVW	12(FP), R3		// arg 4 - eventlist
	MOVW	16(FP), R4		// arg 5 - nevents (on stack)
	MOVW	R4, 4(R13)
	MOVW	20(FP), R5		// arg 6 - timeout (on stack)
	MOVW	R5, 8(R13)
	ADD	$4, R13
	MOVW	$0x48, R12
	SWI	$0xA00048		// sys_kevent
	RSB.CS	$0, R0
	SUB	$4, R13
	MOVW	R0, ret+24(FP)
	RET
