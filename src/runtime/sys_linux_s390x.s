...
TEXT ·timer_create(SB),NOSPLIT|NOFRAME,$0-28
...
TEXT ·timer_settime(SB),NOSPLIT|NOFRAME,$0-28
...
TEXT ·timer_delete(SB),NOSPLIT|NOFRAME,$0-12
	MOVW	timerid+0(FP), R2
...
TEXT ·walltime(SB),NOSPLIT,$32-12
	MOVW	$0, R2			// CLOCK_REALTIME
	MOVD	R15, R7			// Backup stack pointer

	MOVD	g_m(g), R6		//m

	MOVD	·vdsoClockgettimeSym(SB), R9	// Check for VDSO availability
...
TEXT ·nanotime1(SB),NOSPLIT,$32-8
