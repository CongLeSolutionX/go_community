...
// R0 which is constant zero.
// R1 for Assembler temporary.
...
// func runtime·racereadpc(addr unsafe.Pointer, callerpc, pc uintptr)
...
TEXT	sync∕atomic·AddInt32(SB), NOSPLIT, $0
	...
	JAL	racecallatomic<>(SB)
	MOVW	add+8(FP), R4	// convert fetch_add to add_fetch
	MOVV	ret+16(FP), R5
	ADDV    R4, R5, R4
	MOVV	R4, ret+16(FP)
	RET
