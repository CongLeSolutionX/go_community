...
// memory contention.
//
// TODO(austin): Make this adaptive. If bgScanCredit is low, flush
// often. If it's high, flush infrequently.
...
func gc(mode int) {
	...
	if debug.gctrace > 0 {
		...
		// We report idle time below, but omit it from the
