...
func gcSetTriggerRatio(triggerRatio float64) {
	...
	// this growth in RSS.
	//
	// The current constant was chosen the following way: given a
	// sufficiently fast/scalable allocator with 48 Ps that could drive the
	// trigger ratio to <0.05, this constant causes applications to
	// retain the same average RSS compared to not having this allocator.
