...
func (c *gcControllerState) revise() {
	...
	// heap size increases, the initial assist ratio may target
	// too little scan work.
	//
...
// optionally, gcController.bgScanCredit. Lower values give mutator
// assists more accurate accounting of background scanning. Higher
// values reduce memory contention.
...
// amortizes the cost of an assist by pre-paying for many future
// allocations.
