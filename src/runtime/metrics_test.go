...
func TestReadMetricsConsistency(t *testing.T) {
	...
	for i := range samples {
		...
		if strings.HasPrefix(samples[i].Name, "/memory") {
	...
	if totalVirtual.got != totalVirtual.want {
		t.Errorf("\"/aggregates/total-virtual-memory:bytes\" does not match sum of /memory/**: got %d, want %d", totalVirtual.got, totalVirtual.want)
	}
