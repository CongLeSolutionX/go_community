...
type mOS struct {
	...
	//
	// It is valid when the profileTimerValid field is true. A thread creates
	// and manages its own timer. These fields are also read by this thread in
