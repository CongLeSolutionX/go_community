...
// touchStackBeforeSignal reports whether we should touch the signal
// stack before sending a signal. This is used on systems that have
// a bug when the signal stack must be faulted in.  See #35777 and #37436.
//
