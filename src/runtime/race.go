...
// RaceAcquire/RaceRelease/RaceReleaseMerge annotations establish happens-before
// relations between goroutines. These should be used to tell race detector about
// actual synchronization that it can't see for some reason (e.g. synchronization
// established by non-instrumented runtime, or synchronization within RaceDisable/RaceEnable
// sections of code).
...
// RaceReleaseMerge -- to atomic_exchange(memory_order_release), and RaceRelease --
// to atomic_store(memory_order_release). See C++ 1.10/7 for more details.
