...
// The following sync/atomic functions are implemented in runtime
// assembly in -race mode. Provide Go declarations to go with their
// assembly definitions.

//go:linkname sync_atomic_LoadInt32 sync/atomic.LoadInt32
func sync_atomic_LoadInt32(addr *int32) (val int32)

//go:linkname sync_atomic_LoadInt64 sync/atomic.LoadInt64
func sync_atomic_LoadInt64(addr *int64) (val int64)

//go:linkname sync_atomic_LoadUint32 sync/atomic.LoadUint32
func sync_atomic_LoadUint32(addr *uint32) (val uint32)

//go:linkname sync_atomic_LoadUint64 sync/atomic.LoadUint64
func sync_atomic_LoadUint64(addr *uint64) (val uint64)

//go:linkname sync_atomic_LoadUintptr sync/atomic.LoadUintptr
func sync_atomic_LoadUintptr(addr *uintptr) (val uintptr)

//go:linkname sync_atomic_LoadPointer sync/atomic.LoadPointer
func sync_atomic_LoadPointer(addr *unsafe.Pointer) (val unsafe.Pointer)

//go:linkname sync_atomic_StoreInt32 sync/atomic.StoreInt32
func sync_atomic_StoreInt32(addr *int32, val int32)

//go:linkname sync_atomic_StoreInt64 sync/atomic.StoreInt64
func sync_atomic_StoreInt64(addr *int64, val int64)

//go:linkname sync_atomic_StoreUint32 sync/atomic.StoreUint32
func sync_atomic_StoreUint32(addr *uint32, val uint32)

//go:linkname sync_atomic_StoreUint64 sync/atomic.StoreUint64
func sync_atomic_StoreUint64(addr *uint64, val uint64)

//go:linkname sync_atomic_SwapInt32 sync/atomic.SwapInt32
func sync_atomic_SwapInt32(addr *int32, new int32) (old int32)

//go:linkname sync_atomic_SwapInt64 sync/atomic.SwapInt64
func sync_atomic_SwapInt64(addr *int64, new int64) (old int64)

//go:linkname sync_atomic_SwapUint32 sync/atomic.SwapUint32
func sync_atomic_SwapUint32(addr *uint32, new uint32) (old uint32)

//go:linkname sync_atomic_SwapUint64 sync/atomic.SwapUint64
func sync_atomic_SwapUint64(addr *uint64, new uint64) (old uint64)

//go:linkname sync_atomic_AddInt32 sync/atomic.AddInt32
func sync_atomic_AddInt32(addr *int32, delta int32) (new int32)

//go:linkname sync_atomic_AddUint32 sync/atomic.AddUint32
func sync_atomic_AddUint32(addr *uint32, delta uint32) (new uint32)

//go:linkname sync_atomic_AddInt64 sync/atomic.AddInt64
func sync_atomic_AddInt64(addr *int64, delta int64) (new int64)

//go:linkname sync_atomic_AddUint64 sync/atomic.AddUint64
func sync_atomic_AddUint64(addr *uint64, delta uint64) (new uint64)

//go:linkname sync_atomic_AddUintptr sync/atomic.AddUintptr
func sync_atomic_AddUintptr(addr *uintptr, delta uintptr) (new uintptr)

//go:linkname sync_atomic_CompareAndSwapInt32 sync/atomic.CompareAndSwapInt32
func sync_atomic_CompareAndSwapInt32(addr *int32, old, new int32) (swapped bool)

//go:linkname sync_atomic_CompareAndSwapInt64 sync/atomic.CompareAndSwapInt64
func sync_atomic_CompareAndSwapInt64(addr *int64, old, new int64) (swapped bool)

//go:linkname sync_atomic_CompareAndSwapUint32 sync/atomic.CompareAndSwapUint32
func sync_atomic_CompareAndSwapUint32(addr *uint32, old, new uint32) (swapped bool)

//go:linkname sync_atomic_CompareAndSwapUint64 sync/atomic.CompareAndSwapUint64
func sync_atomic_CompareAndSwapUint64(addr *uint64, old, new uint64) (swapped bool)
