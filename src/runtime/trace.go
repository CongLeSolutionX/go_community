...
func StartTrace() error {
	...
	_base.Trace.TicksStart = _base.Cputicks()
...
func StopTrace() {
	...
	_lock.Semacquire(&_base.Trace.ShutdownSema, false)
	if _base.Raceenabled {
		_base.Raceacquire(unsafe.Pointer(&_base.Trace.ShutdownSema))
	}
...
func ReadTrace() []byte {
	...
	if _base.Trace.Shutdown {
		...
		_lock.Semrelease(&_base.Trace.ShutdownSema)
		return nil
	}
