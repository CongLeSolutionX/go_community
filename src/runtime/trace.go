...
// traceStackSize. skip control the number of leaf frames to omit in order to
...
// B, this will return a PC for only B. The nosplit pragma is used to prevent
// fp from pointing to the old stack.
//
//go:nosplit
