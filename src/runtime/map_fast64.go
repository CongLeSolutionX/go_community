...
func mapassign_fast64(t *maptype, h *hmap, key uint64, reused *bool) unsafe.Pointer {
	if h == nil {
...
func mapassignop_fast64(t *maptype, h *hmap, key uint64) unsafe.Pointer {
	var reused bool
	val := mapassign_fast64(t, h, key, &reused)
...
func mapassign_fast64ptr(t *maptype, h *hmap, key unsafe.Pointer, reused *bool) unsafe.Pointer {
	if h == nil {
		panic(plainError("assignment to entry in nil map"))
	}
	if raceenabled {
...
func mapassignop_fast64ptr(t *maptype, h *hmap, key unsafe.Pointer) unsafe.Pointer {
	var reused bool
	val := mapassign_fast64ptr(t, h, key, &reused)
	if reused && t.elem.kind&kindNoPointers != 0 {
		memclrNoHeapPointers(val, t.elem.size)
	}
	return val
