...
// mips64x: R1: framesize, R2: argsize, R3: LR
// loong64: R5: LR TODO
//
...
// 2. sub 4 bytes to get back to JAL deferreturn
// 3. JMP to fn
TEXT runtime·jmpdefer(SB), NOSPLIT|NOFRAME, $0-16
	MOVV	0(R3), R1
	//-4 because loong doesn't have delay slot
	ADDV	$-4, R1
...
TEXT _cgo_topofstack(SB),NOSPLIT,$16
	...
	MOVV	g_m(g), R19
	MOVV	m_curg(R19), R19
	MOVV	(g_stack+stack_hi)(R19), R4 // return value in R2
