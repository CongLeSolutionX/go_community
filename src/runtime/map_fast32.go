...
func mapassign_fast32_helper(t *maptype, h *hmap, key uint32, clear bool) unsafe.Pointer {
	if h == nil {
...
func mapassign_fast32(t *maptype, h *hmap, key uint32) unsafe.Pointer {
	return mapassign_fast32_helper(t, h, key, false)
}

func mapassignop_fast32(t *maptype, h *hmap, key uint32) unsafe.Pointer {
	return mapassign_fast32_helper(t, h, key, true)
}

func mapassign_fast32ptr_helper(t *maptype, h *hmap, key unsafe.Pointer, clear bool) unsafe.Pointer {
	if h == nil {
		panic(plainError("assignment to entry in nil map"))
	}
	if raceenabled {
...
func mapassign_fast32ptr(t *maptype, h *hmap, key unsafe.Pointer) unsafe.Pointer {
	return mapassign_fast32ptr_helper(t, h, key, false)
}

func mapassignop_fast32ptr(t *maptype, h *hmap, key unsafe.Pointer) unsafe.Pointer {
	return mapassign_fast32ptr_helper(t, h, key, true)
}
