...
nocgo:
	...
	MOVD	$·debugCallV2<ABIInternal>(SB), R31
#endif
	MOVD	R0, 0(R0)
	RET
...
TEXT ·reginit(SB),NOSPLIT|NOFRAME,$0-0
...
TEXT ·systemstack_switch(SB), NOSPLIT, $0-0
	...
	// $·systemstack_switch lies within them whether or not the
...
TEXT ·procyield(SB),NOSPLIT|NOFRAME,$0-4
	MOVW	cycles+0(FP), R7
...
TEXT gosave_systemstack_switch<>(SB),NOSPLIT|NOFRAME,$0
	MOVD	$·systemstack_switch(SB), R31
...
TEXT _cgo_topofstack(SB),NOSPLIT|NOFRAME,$0
	...
	BL	·load_g(SB)	// clobbers g (R30), R31
	MOVD	g_m(g), R3
	MOVD	m_curg(R3), R3
...
TEXT ·prepGoExitFrame(SB),NOSPLIT,$0-8
	MOVD    sp+0(FP), R3
	MOVD    R2, 24(R3)
	RET
...
TEXT ·addmoduledata(SB),NOSPLIT|NOFRAME,$0-0
	ADD	$-8, R1
	MOVD	R31, 0(R1)
	MOVD	·lastmoduledatap(SB), R4
	MOVD	R3, moduledata_next(R4)
	MOVD	R3, ·lastmoduledatap(SB)
	MOVD	0(R1), R31
	ADD	$8, R1
	RET
...
// goroutine stacks.
#ifdef GOARCH_ppc64le
TEXT ·debugCallV2<ABIInternal>(SB), NOSPLIT|NOFRAME, $0-0
...
TEXT ·debugCallPanicked(SB),NOSPLIT,$32-16
...
// functions.
TEXT ·elf_savegpr0(SB),NOSPLIT|NOFRAME,$0
	...
	MOVD	R0, 16(R1)
	RET
TEXT ·elf_restgpr0(SB),NOSPLIT|NOFRAME,$0
	...
	MOVD	R0, LR
	RET
TEXT ·elf_savegpr1(SB),NOSPLIT|NOFRAME,$0
	...
	MOVD	R31, -8(R12)
	RET
TEXT ·elf_restgpr1(SB),NOSPLIT|NOFRAME,$0
	// R12 holds the save location
	MOVD	-144(R12), R14
	MOVD	-136(R12), R15
	MOVD	-128(R12), R16
	...
	MOVD	-8(R12), R31
	RET
TEXT ·elf_savefpr(SB),NOSPLIT|NOFRAME,$0
	// R0 holds the LR of the caller's caller, R1 holds save location
	FMOVD	F14, -144(R1)
	FMOVD	F15, -136(R1)
	FMOVD	F16, -128(R1)
	...
	MOVD	R0, 16(R1)
	RET
TEXT ·elf_restfpr(SB),NOSPLIT|NOFRAME,$0
	// R1 holds save location. This returns to the LR saved on stack (bypassing the caller)
	FMOVD	-144(R1), F14
	FMOVD	-136(R1), F15
	FMOVD	-128(R1), F16
	...
	MOVD	R0, LR
	RET
TEXT ·elf_savevr(SB),NOSPLIT|NOFRAME,$0
	...
	STVX	V31, (R0+R12)
	RET
TEXT ·elf_restvr(SB),NOSPLIT|NOFRAME,$0
	// R0 holds the save location, R12 is clobbered
	MOVD	$-192, R12
	LVX	(R0+R12), V20
	MOVD	$-176, R12
