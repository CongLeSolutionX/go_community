...
TEXT runtime·indexbytebody<>(SB),NOSPLIT|NOFRAME,$0-0
	...
	// Quadword aligned at this point. We can use LVX.
qw_align:
	...
	// Check for 64-byte alignment for the vectorized loop.
	ANDCC	  $63,R8,R11
	BEQ	  CR0,preloop

	// Not aligned. Load one vector at a time until aligned.
	LVX	    (R8+R0),V4
...
preloop:
	...
	// Main loop we will load 64 bytes per iteraction
loop:
