...
type mstats struct {
	...
	_ uint32 // ensure the sysMemStats after this are aligned.

	// These stats are effectively duplicates of fields from heapStats
	// but are updated atomically and don't provide the same
	// consistency guarantees. They are used internally by the runtime.
