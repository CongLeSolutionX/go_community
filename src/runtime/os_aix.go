...
// Structure representing a function descriptor
// A variable with this value is always made in assembler
...
func newosproc(mp *m, stk unsafe.Pointer) {
	...
	if pthread_attr_setstackaddr(&attr, stk) != 0 {
...
//go:nosplit
func badstack(stk uint64) {
	g := getg()
	print("New thread stack is corrumpted: R1=", hex(stk), ", g.stack.lo=", hex(g.stack.lo), ", g.stack.hi= ", hex(g.stack.hi), " \n")
	throw("badstack")
}
