...
top:
	...
	if gp == nil {
		...
		if gp != nil && _g_.m.spinning {
			println("inheritTime", inheritTime, "loops", loops, "mstartfn", _g_.m.mstartfn, "mspinning", funcPC(mspinning), "runqhead", _g_.m.p.ptr().runqhead, "runqtail", _g_.m.p.ptr().runqtail)
