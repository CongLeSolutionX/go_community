...
TEXT runtime·mstart_stub(SB),NOSPLIT,$0
	...
	// Go relies on R0 being $0, however it may not be coming from C code.
	XOR	R0, R0
	...
	// TODO(jsing): Restore callee-save registers (R2, R14-R31, F14-F31).
...
TEXT runtime·sigtramp(SB),NOSPLIT|TOPFRAME,$16
	// Go relies on R0 being $0, however it may not be coming from
	// C code.
	XOR	R0, R0
...
TEXT runtime·pthread_attr_destroy_trampoline(SB),NOSPLIT,$80
	MOVD	0(R3), R3		// arg 1 - attr
...
TEXT runtime·pthread_create_trampoline(SB),NOSPLIT,$80
...
TEXT runtime·thrkill_trampoline(SB),NOSPLIT,$80
...
TEXT runtime·thrsleep_trampoline(SB),NOSPLIT,$80
...
TEXT runtime·thrwakeup_trampoline(SB),NOSPLIT,$80
...
TEXT runtime·getthrid_trampoline(SB),NOSPLIT,$80
...
TEXT runtime·pipe2_trampoline(SB),NOSPLIT,$80
	MOVW	8(R3), R4		// arg 2 - flags
...
TEXT runtime·clock_gettime_trampoline(SB),NOSPLIT,$80
...
TEXT runtime·fcntl_trampoline(SB),NOSPLIT,$80
	MOVW	4(R3), R4		// arg 2 - cmd
	MOVW	8(R3), R5		// arg 3 - arg
	MOVW	0(R3), R3		// arg 1 - fd
	MOVD	$0, R6			// vararg
	CALL	libc_fcntl(SB)
	RET
...
TEXT runtime·syscall(SB),NOSPLIT,$80
	MOVD    R3, R14			// pointer to args
...
TEXT runtime·syscallX(SB),NOSPLIT,$80
	MOVD    R3, R14			// pointer to args
...
// to decide there was an error.
TEXT runtime·syscall6(SB),NOSPLIT,$80
	MOVD    R3, R14			// pointer to args
...
// and tests for 64-bit -1 to decide there was an error.
TEXT runtime·syscall6X(SB),NOSPLIT,$80
	MOVD    R3, R14			// pointer to args
...
// this).
TEXT runtime·syscall10(SB),NOSPLIT,$80
	MOVD    R3, R14			// pointer to args
...
// and tests for 64-bit -1 to decide there was an error.
TEXT runtime·syscall10X(SB),NOSPLIT,$80
	MOVD    R3, R14			// pointer to args
