...
TEXT ·mstart_stub(SB),NOSPLIT,$32
	// R3 points to the m.
...
TEXT ·sigtramp(SB),NOSPLIT|TOPFRAME,$16
...
TEXT ·pthread_attr_init_trampoline(SB),NOSPLIT,$32
	MOVD	0(R3), R3		// arg 1 - attr
	CALL	libc_pthread_attr_init(SB)
	RET

TEXT ·pthread_attr_destroy_trampoline(SB),NOSPLIT,$32
	MOVD	0(R3), R3		// arg 1 - attr
	CALL	libc_pthread_attr_destroy(SB)
	RET

TEXT ·pthread_attr_getstacksize_trampoline(SB),NOSPLIT,$32
	MOVD	8(R3), R4		// arg 2 - size
	MOVD	0(R3), R3		// arg 1 - attr
	CALL	libc_pthread_attr_getstacksize(SB)
	RET

TEXT ·pthread_attr_setdetachstate_trampoline(SB),NOSPLIT,$32
	MOVD	8(R3), R4		// arg 2 - state
	MOVD	0(R3), R3		// arg 1 - attr
	CALL	libc_pthread_attr_setdetachstate(SB)
	RET

TEXT ·pthread_create_trampoline(SB),NOSPLIT,$32
...
TEXT ·thrkill_trampoline(SB),NOSPLIT,$32
...
TEXT ·thrsleep_trampoline(SB),NOSPLIT,$32
...
TEXT ·thrwakeup_trampoline(SB),NOSPLIT,$32
	MOVW	8(R3), R4		// arg 2 - count
	MOVD	0(R3), R3		// arg 1 - id
	CALL	libc_thrwakeup(SB)
	RET

TEXT ·exit_trampoline(SB),NOSPLIT,$32
...
TEXT ·getthrid_trampoline(SB),NOSPLIT,$32
	MOVD	R3, R14			// pointer to args
	CALL	libc_getthrid(SB)
	MOVW	R3, 0(R14)		// return value
	RET

TEXT ·raiseproc_trampoline(SB),NOSPLIT,$32
	MOVD	R3, R14			// pointer to args
...
TEXT ·sched_yield_trampoline(SB),NOSPLIT,$32
	CALL	libc_sched_yield(SB)
	RET

TEXT ·mmap_trampoline(SB),NOSPLIT,$32
	MOVD    R3, R14			// pointer to args
...
TEXT ·munmap_trampoline(SB),NOSPLIT,$32
...
TEXT ·madvise_trampoline(SB),NOSPLIT,$32
	MOVD	8(R3), R4		// arg 2 - len
...
TEXT ·open_trampoline(SB),NOSPLIT,$32
...
TEXT ·close_trampoline(SB),NOSPLIT,$32
	MOVW	0(R3), R3		// arg 1 - fd
	CALL	libc_close(SB)
	RET

TEXT ·read_trampoline(SB),NOSPLIT,$32
...
TEXT ·write_trampoline(SB),NOSPLIT,$32
	MOVD	8(R3), R4		// arg 2 - buf
	MOVW	16(R3), R5		// arg 3 - count
...
TEXT ·pipe2_trampoline(SB),NOSPLIT,$32
	MOVW	8(R3), R4		// arg 2 - flags
...
TEXT ·setitimer_trampoline(SB),NOSPLIT,$32
...
TEXT ·usleep_trampoline(SB),NOSPLIT,$32
	MOVW	0(R3), R3		// arg 1 - usec
	CALL	libc_usleep(SB)
	RET

TEXT ·sysctl_trampoline(SB),NOSPLIT,$32
...
TEXT ·kqueue_trampoline(SB),NOSPLIT,$32
	CALL	libc_kqueue(SB)
	RET

TEXT ·kevent_trampoline(SB),NOSPLIT,$32
...
TEXT ·clock_gettime_trampoline(SB),NOSPLIT,$32
...
TEXT ·fcntl_trampoline(SB),NOSPLIT,$32
	MOVD    R3, R14			// pointer to args
...
TEXT ·sigaction_trampoline(SB),NOSPLIT,$32
	MOVD	8(R3), R4		// arg 2 - new
	MOVD	16(R3), R5		// arg 3 - old
...
TEXT ·sigprocmask_trampoline(SB),NOSPLIT,$32
	MOVD	8(R3), R4		// arg 2 - new
	MOVD	16(R3), R5		// arg 3 - old
...
TEXT ·sigaltstack_trampoline(SB),NOSPLIT,$32
...
TEXT ·issetugid_trampoline(SB),NOSPLIT,$32
	MOVD	R3, R14			// pointer to args
	CALL	libc_getthrid(SB)
	MOVW	R3, 0(R14)		// return value
	RET
