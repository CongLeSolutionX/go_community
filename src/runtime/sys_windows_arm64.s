...
TEXT runtime·asmstdcall(SB),NOSPLIT|NOFRAME,$0
	...
	// R25: size of stack arguments (n-8)*8
	// R21: &args[8]
	// R22: loop counter, from 0 to (n-8)*8
	// R23: scratch
	// R24: copy of RSP - (R2)(RSP) assembles as (R2)(ZR)
	SUB	$8, R0, R25
	LSL	$3, R25
	ADD	$(8*8), R12, R21
	MOVD	$0, R22
...
TEXT sigtramp<>(SB),NOSPLIT|NOFRAME,$0
	...
	MOVD	g, R17 			// saved R28 (callee-save)
...
switch:
	...
	MOVD	RSP, R8
	MOVD	(g_sched+gobuf_sp)(R2), R3	// R3 = g->gobuf.sp
	SUB	$(6*8), R3			// alloc space for saves
	MOVD	R3, RSP				// switch to g0 stack
...
TEXT sigtramp_g0<>(SB),NOSPLIT,$128
	...
	// and return to returntramp on the g0 stack.
	// returntramp makes no use of the stack at all,
