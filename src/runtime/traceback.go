		...
		if pcbuf != nil {
			...
			if inldata := funcdata(f, _FUNCDATA_InlTree); inldata != nil {
				...
				for {
					...
					if inltree[ix].funcID == funcID_wrapper && elideWrapperCalling2(lastFuncID) {
						// ignore wrappers
					} else if skip > 0 {
						skip--
					} else if n < max {
			...
			if f.funcID == funcID_wrapper && elideWrapperCalling2(lastFuncID) {
...
func elideWrapperCalling2(id funcID) bool {
