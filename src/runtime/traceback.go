...
func traceback1(pc, sp, lr uintptr, gp *g, flags uint) {
	...
	// TODO(odeke-em, iant): It is unfortunate that we have to
	//  perform 2 tracebacks each time. In the future, revise
	//  the solution in https://go-review.googlesource.com/c/go/+/37222/9/src/runtime/traceback.go
