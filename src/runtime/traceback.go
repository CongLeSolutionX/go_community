...
// n always returns the number of total frames <= max. nregularframes is only valid if op == countingframes.
...
func countframes(pc0, sp0, lr0 uintptr, gp *g, flags uint) (ntotalframes, nregularframes int) {
...
func printtraceback(pc, sp, lr uintptr, gp *g, flags uint) {
	...
	totalframes, nregularframes := countframes(pc, sp, lr, gp, flags)
