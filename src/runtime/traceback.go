...
// The maximumum value for skip provided to physicalCallers
const maxFrameSkip = 20
...
func physicalCallers(gp *g, skip int, pcbuf []uintptr) int {
	...
	if skip > maxFrameSkip {
		panic("Skip argument to physicalCallers is too large")
	}
	...
	if framepointer_enabled {
		...
		//
		// So, if first value of a callers array is less than maxFrameSkip,
