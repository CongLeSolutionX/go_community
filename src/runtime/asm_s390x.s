...
// DI and SI.
TEXT _rt0_s390x_lib(SB),NOSPLIT,$0x50
        ...
        MOVD    $runtime·libpreinit(SB), R11
        BL      R11

        // Create a new thread to finish Go runtime initialization.
        MOVD    _cgo_sys_thread_create(SB), R11 
	CMP     R11, $0
	BEQ	nocgo
...
nocgo:
        MOVD    $0x800000, R11                    // stacksize
	MOVD	R11, 0(R15)
        MOVD    $_rt0_s390x_lib_go(SB), R11
        MOVD    R11, 8(R15)                       // fn
	MOVD	$runtime·newosproc(SB), R11
        BL      R11
...
TEXT _rt0_s390x_lib_go(SB),NOSPLIT,$0
