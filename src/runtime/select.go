...
retc:
	if cas.releasetime > 0 {
		_lock.Blockevent(cas.releasetime-t0, 2)
	}
...
func reflect_rselect(cases []runtimeSelect) (chosen int, recvOK bool) {
	...
	sel := (*hselect)(_iface.Mallocgc(size, nil, _base.FlagNoScan))
