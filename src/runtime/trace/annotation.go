...
// and newly created goroutines. If the context does not carry any span,
// the goroutine is not associated with any span.
// A goroutine can have at most one span attached to it at any given time.
// It returns a detach function that associates the calling goroutine back
// to the original span before Attach.
...
// Logf is similar to Log but performs formatting.
