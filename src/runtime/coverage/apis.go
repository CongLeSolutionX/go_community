...
// EmitMetaDataToWriter writes the meta-data content (the
...
// EmitCounterDataToWriter writes coverage counter-data
...
// program in question was not built with the "-cover" flag.
func ClearCoverageCounters() error {
	...
	// counter value corresponding the "HERE" block, which will then
