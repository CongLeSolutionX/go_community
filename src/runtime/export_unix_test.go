...
// when it is set up to receive SIGUSR1. It returns the ID of the
// current M and the ID of the M the SIGUSR1 was received on, or -1 if
// the signal was not received after timeoutNS nanoseconds.
