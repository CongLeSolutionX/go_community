...
func windowsFindfunc(name []byte, l uintptr) stdFunction {
...
func loadOptionalSyscalls() {
	...
	if l != 0 {
		_AddDllDirectory = windowsFindfunc(addDllDirectory, l)
		_AddVectoredContinueHandler = windowsFindfunc(addVectoredContinueHandler, l)
		_GetQueuedCompletionStatusEx = windowsFindfunc(getQueuedCompletionStatusEx, l)
		_LoadLibraryExW = windowsFindfunc(loadLibraryExW, l)
	}
}
