...
var (
	abiRegArgsType           *_type // set in stackobjectinit
...
func stkobjinit() {
	...
	if mod == nil {
		throw("methodValueCallFrameObjs not in a module")
	}
	methodValueCallFrameObjs[0].gcdataoff = uint32(uintptr(unsafe.Pointer(abiRegArgsType.gcdata)) - mod.rodata)
}
...
func (r *stackObjectRecord) gcdata() *byte {
	...
	if mod == nil {
		// If you hit this error, you may have made a copy of a stackObjectRecord.
		// You must use the original pointer.
		println("r=", unsafe.Pointer(r))
		throw("failed to find module for stackObjectRecord")
	}
