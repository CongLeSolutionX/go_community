...
const (
	...
	// linux/ppc64{,le}   TASK_SIZE_USER64  0x00400000000000 (46 bit addresses)
	// aix/ppc64          --                1<<60 (60 bit addresses)
	...
	//     aix/64-bit         48       256MB        4096    4M (32MB)
	...
	// arenaBaseOffset is the pointer value that correspond to
