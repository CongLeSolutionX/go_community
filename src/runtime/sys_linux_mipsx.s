...
TEXT time·now(SB),NOSPLIT,$4-12
	MOVW	$0(R29), R4
	MOVW	$0, R5
	MOVW	$SYS_gettimeofday, R2
	SYSCALL
	MOVW	0(R29), R3	// sec
	MOVW	4(R29), R5	// usec
	MOVW	$1000, R4
...
TEXT runtime·nanotime(SB),NOSPLIT,$4-8
...
TEXT runtime·rt_sigaction(SB),NOSPLIT,$-8-20
	MOVW	sig+0(FP), R4
	MOVW	new+4(FP), R5
	MOVW	old+8(FP), R6
	MOVW	size+12(FP), R7
...
TEXT runtime·sigfwd(SB),NOSPLIT,$0-16
	...
	MOVW	R29, R22
	SUBU	$16, R29
	AND	$0x7, R29	// shadow space for 4 args aligned to 8 bytes
	JAL	(R25)
	MOVW	R22, R29
	RET
...
TEXT runtime·mmap(SB),NOSPLIT,$24-28
	MOVW	addr+0(FP), R4
	MOVW	n+4(FP), R5
	MOVW	prot+8(FP), R6
	MOVW	flags+12(FP), R7
