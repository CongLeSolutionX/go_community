...
TEXT ·switchToCrashStack0<ABIInternal>(SB), NOSPLIT, $0-8
	...
	// set g to gcrash
	MOV	$·gcrash(SB), g	// g = &gcrash
	CALL	·save_g(SB)	// clobbers X31
...
TEXT ·goexit(SB),NOSPLIT|NOFRAME|TOPFRAME,$0-0
	MOV	ZERO, ZERO	// NOP
	JMP	·goexit1(SB)	// does not return
