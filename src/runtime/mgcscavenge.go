...
func (p *pageAlloc) scavengeRangeLocked(ci chunkIdx, base, npages uint) uintptr {
	...
	// Mark the range as scavenged. We must be locked when we do
	// this because the set is not atomic. If a page in the same
	// byte or word of the bitmap is updated, we could get an
