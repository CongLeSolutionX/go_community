...
TEXT runtime·futex(SB),NOSPLIT,$0-44
	MOVQ	$SYS_futex, AX
	MOVQ	addr+0(FP), DI
	MOVL	op+8(FP), SI
	MOVL	val+12(FP), DX
...
TEXT runtime·epollcreate(SB),NOSPLIT,$0-12
	MOVQ	$SYS_epoll_create, AX
	MOVL	size+0(FP), DI
	SYSCALL
	MOVL	AX, ret+8(FP)
	RET

TEXT runtime·epollcreate1(SB),NOSPLIT,$0-12
	MOVQ	$SYS_epoll_create1, AX
	MOVL	flags+0(FP), DI
	SYSCALL
	MOVL	AX, ret+8(FP)
	RET

TEXT runtime·epollctl(SB),NOSPLIT,$0-28
	MOVQ	$SYS_epoll_ctl, AX
	MOVL	epfd+0(FP), DI
	MOVL	op+4(FP), SI
	MOVL	fd+8(FP), DX
	MOVQ	ev+16(FP), R10
...
TEXT runtime·epollwait(SB),NOSPLIT,$0-28
	MOVQ	$SYS_epoll_wait, AX
	MOVL	epfd+0(FP), DI
	MOVQ	ev+8(FP), SI
	MOVL	nev+16(FP), DX
...
TEXT runtime·sysMunmap(SB),NOSPLIT,$0-16
	MOVQ	$SYS_munmap, AX
	MOVQ	addr+0(FP), DI
	MOVQ	n+8(FP), SI
	SYSCALL
