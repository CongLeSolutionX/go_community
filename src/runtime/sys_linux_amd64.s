...
sigtrampnog:
	...
	// The C calling convention is active, so it's hard to call ignoreSIGPROF
	// here. Instead, do a direct check of si_code against SI_KERNEL.
	MOVL	$0x80, BX // 0x80 == SI_KERNEL
	MOVL	8(SI), CX // si_code is a uint32 at an 8-byte offset in siginfo
	CMPL	BX, CX
	JNE	2(PC)
	RET
