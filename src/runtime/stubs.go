...
//go:nosplit
func getcallerfp(argp unsafe.Pointer) (r uintptr) {
	// TODO: amd64 only.  Is this valid for most other architectures with fp?
	return *(*uintptr)(unsafe.Pointer(uintptr(argp) - 2*sys.RegSize))
}
