...
const regSize = 4 << (^sys.Uintreg(0) >> 63)               // unsafe.Sizeof(uintreg(0)) but an ideal const
const spAlign = 1*(1-sys.GoarchArm64) + 16*sys.GoarchArm64 // SP alignment: 1 normally, 16 for ARM64
