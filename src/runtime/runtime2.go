...
const (
	...
	// _Gdead means this goroutine is on a free list. It is not
	// executing user code. It may not may not have a stack.
	_Gdead // 6
	...
	//
	// _Gscanrunning is different: it indicates that GC wants the
	// goroutine to scan its own stack at the next preemption. The
	// rules of _Grunning apply.
	//
