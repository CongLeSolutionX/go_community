...
func secret_dec() {
	...
	case "arm64":
		// Note: avoid clobbering the saved frame pointer,
		// which is at sp-8.
		memclrNoHeapPointers(unsafe.Pointer(lo), (sp-8)-lo)
	}
	...
	case "arm64":
		// Avoid clobbering frame pointer and return address.
		// Return address is saved at the bottom of the frame,
		// at sp. Frame pointer is at the top of the frame,
		// at csp-8.
