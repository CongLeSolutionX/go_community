...
func testAtomic64() {
	...
	if atomic.Atomicload64(&test_z64) != 1 {
		throw("load64 failed")
	}
	atomic.Atomicstore64(&test_z64, (1<<40)+1)
	if atomic.Atomicload64(&test_z64) != (1<<40)+1 {
		throw("store64 failed")
	}
	if atomic.Xadd64(&test_z64, (1<<40)+1) != (2<<40)+2 {
		throw("xadd64 failed")
	}
	if atomic.Atomicload64(&test_z64) != (2<<40)+2 {
		throw("xadd64 failed")
	}
	if atomic.Xchg64(&test_z64, (3<<40)+3) != (2<<40)+2 {
		throw("xchg64 failed")
	}
	if atomic.Atomicload64(&test_z64) != (3<<40)+3 {
		throw("xchg64 failed")
	}
}
