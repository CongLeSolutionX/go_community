...
TEXT ·rt0_go(SB),NOSPLIT|NOFRAME|TOPFRAME,$0
	...
	BL	·_initcgo(SB)	// will clobber R0-R3
...
TEXT gosave_systemstack_switch<>(SB),NOSPLIT|NOFRAME,$0
	MOVW	$·systemstack_switch(SB), R11
...
TEXT ·setg(SB),NOSPLIT|NOFRAME,$0-4
	MOVW	gg+0(FP), R0
	B	setg<>(SB)
...
//
TEXT ·armPublicationBarrier(SB),NOSPLIT|NOFRAME,$0-0
	MOVB	·goarm(SB), R11
	CMP	$7, R11
	BLT	2(PC)
	DMB	MB_ST
...
TEXT ·procyield(SB),NOSPLIT|NOFRAME,$0
	MOVW	cycles+0(FP), R1
	MOVW	$0, R0
yieldloop:
...
TEXT ·addmoduledata(SB),NOSPLIT,$0-0
	...
	MOVW	·lastmoduledatap(SB), R1
	MOVW	R0, moduledata_next(R1)
	MOVW	R0, ·lastmoduledatap(SB)
