...
func pcvalue(f *_func, off int32, targetpc uintptr, cache *pcvalueCache, strict bool) int32 {
	// XXX Scan spends a boatload of time here (at least 32% of
	// the total time in the scheme interpreter from #10898). Deep
	// stacks are probably highly recursive, so a small cache in
	// front of this would be VERY effective.
