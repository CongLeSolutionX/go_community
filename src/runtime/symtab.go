...
// Information about the layout of the executable image, provided by
// the linker. Any changes here must be matched changes to the code in
// cmd/internal/ld/symtab.go:symtab().
