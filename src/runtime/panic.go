...
func reflectcallSave(p *_panic, fn, arg unsafe.Pointer, argsize uint32) {
	...
	reflectcall(nil, fn, arg, argsize, argsize, argsize, (*abi.RegArgs)(noescape(unsafe.Pointer(&regs))))
	if p != nil {
		p.pc = 0
...
func gopanic(e interface{}) {
	...
	for {
		...
		if d.openDefer {
			...
			var regs abi.RegArgs
			reflectcall(nil, unsafe.Pointer(d.fn), deferArgs(d), uint32(d.siz), uint32(d.siz), uint32(d.siz), (*abi.RegArgs)(noescape(unsafe.Pointer(&regs))))
		}
		p.argp = nil
