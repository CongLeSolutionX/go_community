...
func generateDot(w io.Writer, g *dag.Graph) {
	...
	// Layout ranks from bottom to top. This way the edges point
	// up, but the order you can acquire locks in goes top to
	// bottom, which seems like the least confusing compromise.
