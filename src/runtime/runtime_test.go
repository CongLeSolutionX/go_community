...
// TestIntendedInlining enforces that some runtime functions are inlined.
// This allows refactoring for code clarity and re-use without fear that
// changes to the compiler's inlining heuristics will cause silent performance regressions.
