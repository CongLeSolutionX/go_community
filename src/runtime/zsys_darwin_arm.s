...
TEXT runtime·sigprocmask(SB),NOSPLIT,$0-12
	MOVW	$SYS___pthread_sigmask, R12
	MOVW	how+0(FP), R0
	MOVW	new+4(FP), R1
	MOVW	old+8(FP), R2
	SWI	$0x80
...
TEXT runtime·sigaction(SB),NOSPLIT,$0-12
...
TEXT runtime·sigaltstack(SB),NOSPLIT,$0-8
...
TEXT runtime·kqueue(SB),NOSPLIT,$0-4
	MOVW	$SYS_kqueue, R12
	SWI	$0x80
	RSB.CS	$0, R0, R0
	MOVW	R0, ret+0(FP)
...
TEXT runtime·kevent(SB),NOSPLIT,$0-28
	MOVW	$SYS_kevent, R12
	MOVW	kq+0(FP), R0
	MOVW	ch+4(FP), R1
	MOVW	nch+8(FP), R2
