...
func resetcpuprofiler(hz int32) {
	...
	// TODO: This and the other code that manipulates sigtable
	// flags and fwdSig needs some sort of atomic access.
	// These fields are accessed by the signal handler.
	t := &sigtable[_SIGPROF]
	if hz != 0 {
		if t.flags&_SigHandling == 0 {
			t.flags |= _SigHandling
