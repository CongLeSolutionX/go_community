...
func (s *mspan) allocBitsForIndex(allocBitIndex uintptr) markBits {
	...
	bytePtr := (*uint8)(unsafe.Pointer((uintptr(unsafe.Pointer(s.allocBits)) + uintptr(whichByte))))
...
// setMarked sets the marked bit in the markbits, atomically. Due to the
// instrinsic some compilers are not able to inline function so if
// it appears as a hot spot consider inlining it manually.
