...
func (s *mspan) refillAllocCache(whichByte uintptr) {
	byteArr := (*[maxObjsPerSpan]uint8)(unsafe.Pointer(s.allocBits))
	bytes := byteArr[whichByte : whichByte+8]
	aCache := uint64(0)
...
func (s *mspan) nextFreeIndex() uintptr {
	...
	if sfreeindex%64 == 0 && sfreeindex != snelems {
		...
		// s.allocCache is now stale and contains the bits
		// in allocBits corresponding to the 8 bytes prior to
		// s.freeindex.
