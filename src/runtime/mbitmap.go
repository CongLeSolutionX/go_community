...
// has no more pointers beyond those described by ha.bitmap[8*i+j]. Also,
// entries in ha.bitmap[8*i+j+1], ..., are junk, until the start of the
// next object. [TODO: oblets]
//
