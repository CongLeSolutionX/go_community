...
#ifdef GOEXPERIMENT_regabiargs
TEXT runtime·memhash<ABIInternal>(SB),NOSPLIT,$0-0
	// AX = ptr to data
	// BX = seed
	// CX = size
#else
...
#ifdef GOEXPERIMENT_regabiargs
TEXT runtime·strhash<ABIInternal>(SB),NOSPLIT,$0-0
...
#ifdef GOEXPERIMENT_regabiargs
TEXT runtime·memhash32<ABIInternal>(SB),NOSPLIT,$0-0
	// AX = ptr to data
	// BX = seed
#else
...
// ABIInternal for performance.
#ifdef GOEXPERIMENT_regabiargs
TEXT runtime·memhash64<ABIInternal>(SB),NOSPLIT,$0-0
	// AX = ptr to data
	// BX = seed
#else
