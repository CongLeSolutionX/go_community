...
const (
	...
	// frames at some pointer after collecting the stack. So
...
func mProf_Malloc(mp *m, p unsafe.Pointer, size uintptr) {
	// Only use mp.profStack up to debug.profstackdepth since we don't use frame
	// pointer unwinding here yet.
...
// memProfileInternal returns the number of records n in the thread creation
// profile. If there are less than size records, copyFn is invoked for each
// record, and ok returns true.
...
// blockProfileInternal returns the number of records n in the thread creation
// profile. If there are less than size records, copyFn is invoked for each
// record, and ok returns true.
...
// mutexProfileInternal returns the number of records n in the thread creation
// profile. If there are less than size records, copyFn is invoked for each
// record, and ok returns true.
...
// threadCreateProfileInternal returns the number of records n in the thread
// creation profile. If there are less than size records, copyFn is invoked for
// each record, and ok returns true.
