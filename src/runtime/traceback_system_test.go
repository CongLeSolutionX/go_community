...
traceback_system_test.go:52: runtime_test.grandchild: 	panic("oops")
traceback_system_test.go:42: runtime_test.child: 	grandchild()
traceback_system_test.go:36: runtime_test.crash.func1: 		child()
