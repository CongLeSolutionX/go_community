...
func TestTracebackSystem(t *testing.T) {
	...
	// cmd.Stderr = os.Stderr // uncomment to debug, or see runtime.Callers's view
...
traceback_system_test.go:50: runtime_test.grandchild: 	panic("oops")
traceback_system_test.go:40: runtime_test.child: 	grandchild()
traceback_system_test.go:36: runtime_test.child.func1: 		child()
