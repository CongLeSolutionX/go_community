...
func mapassign_faststr_helper(t *maptype, h *hmap, s string, clear bool) unsafe.Pointer {
	if h == nil {
...
func mapassign_faststr(t *maptype, h *hmap, s string) unsafe.Pointer {
	return mapassign_faststr_helper(t, h, s, false)
}

func mapassignop_faststr(t *maptype, h *hmap, s string) unsafe.Pointer {
	return mapassign_faststr_helper(t, h, s, true)
}
