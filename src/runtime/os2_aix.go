...
// This file contains all aix syscalls with libc
...
//go:cgo_import_dynamic libc___pthread __pthread "libpthread.a/shr_xpg5_64.o"
//go:cgo_import_dynamic libc___mod_init __mod_init "libc.a/shr_64.o"
//go:linkname libc___n_pthreads libc___n_pthread
//go:linkname libc___pthread libc___pthread
...
// TODO(aix): Improves return values for syscalls
...
// Therefor, err returns by syscall means nothing and must not be used
...
// On multi-thread program, sigprocmask must not be used
