...
var lockNames []string = []string{
	...
	"stackpool",   // below scavenge, sweepWaiters, assistQueue, cpuprof, sched, pollDesc, timers, itab, reflectOffs, notifyList, traceBuf, traceStrings, hchan, prof, root, trace, gcBitsArenas?, traceTab?, netPollInit
...
var arcs [][20]int = [][20]int{
	...
	{_Lscavenge, _Lcpuprof, _Lsched, _Lallg, _Lallp, _Ltimers, _Litab, _LreflectOffs, _LnotifyList, _LtraceBuf, _LtraceStrings, _Lhchan}, // _Lprof
	{_Lscavenge, _Lsched, _Lallg, _Ltimers, _Litab, _LreflectOffs, _LnotifyList, _LtraceBuf, _LtraceStrings, _Lhchan},                    // _LgcBitsArenas
	{}, // _Lroot
	{_Lscavenge, _LassistQueue, _Lsched, _Lhchan, _LtraceBuf, _LtraceStrings, _Lroot, _Lsweep}, // _Ltrace
	{_Ltimers}, // _LnetpollInit
	{_Lscavenge, _LsweepWaiters, _LassistQueue, _Lcpuprof, _Lsched, _LpollDesc, _Ltimers, _Litab, _LreflectOffs, _LnotifyList, _LtraceBuf, _LtraceStrings, _Lhchan, _Lprof, _Lroot, _Ltrace, _LnetpollInit}, // _Lstackpool
...
func lockLabeled(l *mutex, rank int) {
	...
	systemstack(func() {
		...
		gp.m.lockIndex++
		i++
		if i > 1 /* && !(gp.m.locksHeld[i-2].rank == _LtraceTab && gp.m.locksHeld[i-1].rank == _Lstackpool) */ {
			found := false
