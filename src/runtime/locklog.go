...
var lockNames []string = []string{
	...
	"traceTab", // below scavenge, forcegc, sweepWaiters, assistQueue, sweep, sched, allg, timers, fin, notifyList, traceBuf, traceStrings, hchan, root, trace
	...
	"mheap",        // below scavenge, assistQueue, cpuprof, sweep, sched, allg, allp, timers, itab, reflectOffs, notifyList, traceBuf, traceStrings, hchan, mspanSpecial, prof, root, stackPool, stackLarge, defer, wbufSpans, sudog?
...
var arcs [][25]int = [][25]int{
	...
	{_Lscavenge, _LassistQueue, _Lcpuprof, _Lsweep, _Lsched, _Lallg, _Lallp, _Ltimers, _Litab, _LreflectOffs, _LnotifyList, _LtraceBuf, _LtraceStrings, _Lhchan, _LmspanSpecial, _Lprof, _Lroot, _Lstackpool, _LstackLarge, _Ldefer, _LwbufSpans}, // _Lmheap
