...
// stricttime stores a strictly-increasing lower bound for the timestamps
// written to fd 1 or 2 when using faketime.
//
// After each write that includes a timestamp, stricttime > faketime.
