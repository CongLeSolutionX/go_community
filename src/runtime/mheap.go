...
func arenaIndex(p uintptr) arenaIdx {
	return arenaIdx(offsetAddress(p) / heapArenaBytes)
}

// arenaBase returns the low address of the region covered by heap
// arena i.
func arenaBase(i arenaIdx) uintptr {
	return offAddr(uintptr(i) * heapArenaBytes).addr()
}
...
// maniupulation of the page allocator) and iterates over the whole
