...
func (h *mheap) coalesce(s *mspan) {
	...
	merge := func(a, b, other *mspan) {
		...
		if b == other {
			a.npages += other.npages
			a.needzero |= other.needzero
			h.setSpan(a.base()+a.npages*pageSize-1, a)
		} else {
			b.npages += other.npages
			b.needzero |= other.needzero
			b.startAddr = other.startAddr
			h.setSpan(b.base(), b)
		}
