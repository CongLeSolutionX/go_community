...
func rawstring(size int) (s string, b []byte) {
	p := _iface.Mallocgc(uintptr(size), nil, _base.FlagNoScan|_base.FlagNoZero)
...
func rawbyteslice(size int) (b []byte) {
	...
	p := _iface.Mallocgc(cap, nil, _base.FlagNoScan|_base.FlagNoZero)
	if cap != uintptr(size) {
...
func rawruneslice(size int) (b []rune) {
	...
	p := _iface.Mallocgc(mem, nil, _base.FlagNoScan|_base.FlagNoZero)
