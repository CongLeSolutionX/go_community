...
func chansend1(t *Chantype, c *Hchan, elem unsafe.Pointer) {
	Chansend(t, c, elem, true, _lock.Getcallerpc(unsafe.Pointer(&t)))
}
...
func Chansend(t *Chantype, c *Hchan, ep unsafe.Pointer, block bool, callerpc uintptr) bool {
	...
	if c == nil {
		...
		_sched.Gopark(nil, nil, "chan send (nil chan)", _sched.TraceEvGoStop)
	...
	if c.Dataqsiz == 0 { // synchronous channel
		...
		_sched.Goparkunlock(&c.Lock, "chan send", _sched.TraceEvGoBlockSend)
...
func chanrecv(t *Chantype, c *Hchan, ep unsafe.Pointer, block bool) (selected, received bool) {
	...
	if c == nil {
		...
		_sched.Gopark(nil, nil, "chan receive (nil chan)", _sched.TraceEvGoStop)
		_lock.Throw("unreachable")
	}
	...
	if c.Dataqsiz == 0 { // synchronous channel
		...
		_sched.Goparkunlock(&c.Lock, "chan receive", _sched.TraceEvGoBlockRecv)
