...
// void runtime∕internal∕channels·Racereadpc(void *addr, void *callpc, void *pc)
TEXT	runtime∕internal∕channels·Racereadpc(SB), NOSPLIT, $0-24
	MOVQ	addr+0(FP), RARG1
...
// void runtime∕internal∕maps·Racewritepc(void *addr, void *callpc, void *pc)
TEXT	runtime∕internal∕maps·Racewritepc(SB), NOSPLIT, $0-24
	MOVQ	addr+0(FP), RARG1
	MOVQ	callpc+8(FP), RARG2
	MOVQ	pc+16(FP), RARG3
