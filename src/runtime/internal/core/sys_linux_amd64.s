...
TEXT runtime∕internal∕core·Exit(SB),NOSPLIT,$0-4
	MOVL	code+0(FP), DI
...
TEXT runtime∕internal∕hash·open(SB),NOSPLIT,$0-20
	MOVQ	name+0(FP), DI
	MOVL	mode+8(FP), SI
	MOVL	perm+12(FP), DX
...
TEXT runtime∕internal∕hash·close(SB),NOSPLIT,$0-12
	MOVL	fd+0(FP), DI
...
TEXT runtime∕internal∕core·Write(SB),NOSPLIT,$0-28
	MOVQ	fd+0(FP), DI
	MOVQ	p+8(FP), SI
	MOVL	n+16(FP), DX
...
TEXT runtime∕internal∕hash·read(SB),NOSPLIT,$0-28
	MOVL	fd+0(FP), DI
	MOVQ	p+8(FP), SI
	MOVL	n+16(FP), DX
...
TEXT runtime∕internal∕lock·Raise(SB),NOSPLIT,$0
...
TEXT runtime∕internal∕sched·raiseproc(SB),NOSPLIT,$0
...
TEXT runtime∕internal∕sched·setitimer(SB),NOSPLIT,$0-24
	MOVL	mode+0(FP), DI
	MOVQ	new+8(FP), SI
	MOVQ	old+16(FP), DX
