...
TEXT runtime∕internal∕lock·sigtramp(SB),NOSPLIT,$0-0
	MOVL	ptrs+0(FP), CX
	SUBL	$40, SP
	...
	SUBL	$4, DI
	MOVL	$runtime∕internal∕sched·Mstart(SB), 0(DI)
...
TEXT runtime·exceptiontramp(SB),NOSPLIT,$0
	...
	JMP	runtime∕internal∕lock·sigtramp(SB)
...
TEXT runtime·externalthreadhandler(SB),NOSPLIT,$0
	...
	MOVL	SP, 0(SP)
	MOVL	$m__size, 4(SP)
	CALL	runtime∕internal∕core·Memclr(SB)	// smashes AX,BX,CX
