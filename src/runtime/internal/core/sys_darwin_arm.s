...
TEXT runtime∕internal∕core·Write(SB),NOSPLIT,$0
	MOVW	fd+0(FP), R0
	MOVW	p+4(FP), R1
	MOVW	n+8(FP), R2
	MOVW	$SYS_write, R12
...
TEXT runtime∕internal∕lock·Raise(SB),NOSPLIT,$24
	MOVW	$SYS_getpid, R12
	SWI	$0x80
...
TEXT runtime∕internal∕sched·setitimer(SB),NOSPLIT,$0
	MOVW	0(FP), R0
	MOVW	4(FP), R1
	MOVW	8(FP), R2
...
ret:
	...
	B	runtime∕internal∕core·Exit(SB)
...
TEXT runtime∕internal∕lock·Sigaction(SB),NOSPLIT,$0
	MOVW	0(FP), R0
	MOVW	4(FP), R1
	MOVW	8(FP), R2
...
TEXT runtime∕internal∕core·Usleep(SB),NOSPLIT,$12
	MOVW	usec+0(FP), R0
	MOVW	R0, R1
	MOVW	$1000000, R2
	DIV     R2, R0
...
TEXT runtime∕internal∕sched·bsdthread_create(SB),NOSPLIT,$0
...
TEXT runtime∕internal∕schedinit·bsdthread_register(SB),NOSPLIT,$0
...
TEXT runtime∕internal∕lock·mach_msg_trap(SB),NOSPLIT,$0
	MOVW    0(FP), R0
	MOVW    4(FP), R1
	MOVW    8(FP), R2
	MOVW    12(FP), R3
...
TEXT runtime∕internal∕lock·Mach_task_self(SB),NOSPLIT,$0
...
TEXT runtime∕internal∕lock·mach_reply_port(SB),NOSPLIT,$0
...
TEXT runtime∕internal∕lock·mach_semaphore_wait(SB),NOSPLIT,$0
	MOVW	0(FP), R0
...
TEXT runtime∕internal∕lock·mach_semaphore_timedwait(SB),NOSPLIT,$0
	MOVW	0(FP), R0
	MOVW	4(FP), R1
	MOVW	8(FP), R2
...
TEXT runtime∕internal∕lock·mach_semaphore_signal(SB),NOSPLIT,$0
	MOVW    0(FP), R0
...
// int32 runtime∕internal∕sched·Kevent(int Kq, Kevent *changelist, int nchanges, Kevent *eventlist, int events, Timespec *timeout)
