...
TEXT runtime∕internal∕sched·aeshash(SB),NOSPLIT,$0-16
	MOVL	p+0(FP), AX	// Ptr to Data
	MOVL	s+8(FP), CX	// size
	LEAL	ret+12(FP), DX
	JMP	runtime·aeshashbody(SB)

TEXT runtime∕internal∕hash·aeshashstr(SB),NOSPLIT,$0-12
...
TEXT runtime∕internal∕hash·aeshash32(SB),NOSPLIT,$0-12
	MOVL	p+0(FP), AX	// Ptr to Data
	MOVL	h+4(FP), X0	// seed
	PINSRD	$1, (AX), X0	// Data
...
TEXT runtime∕internal∕hash·aeshash64(SB),NOSPLIT,$0-12
	MOVL	p+0(FP), AX	// Ptr to Data
	MOVQ	(AX), X0	// Data
