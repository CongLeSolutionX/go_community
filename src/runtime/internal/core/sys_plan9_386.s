...
TEXT time·now(SB),NOSPLIT,$8-12
	CALL	runtime∕internal∕lock·Nanotime(SB)
	MOVL	0(SP), AX
	MOVL	4(SP), DX
...
TEXT runtime∕internal∕lock·sigtramp(SB),NOSPLIT,$0
	get_tls(AX)
...
// See ../syscall/asm_plan9_386.s:/runtime·Syscall/
TEXT runtime·errstr(SB),NOSPLIT,$8-8
	...
	MOVL	$ERRMAX, 4(SP)
	CALL	errstr<>(SB)
	CALL	runtime∕internal∕lock·Findnull(SB)
	MOVL	4(SP), AX
