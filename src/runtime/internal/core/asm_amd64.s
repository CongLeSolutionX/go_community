...
ok:
	...
	MOVQ	CX, g(BX)
	LEAQ	runtime∕internal∕core·M0(SB), AX
...
TEXT runtime∕internal∕sched·gosave(SB), NOSPLIT, $0-8
...
TEXT runtime∕internal∕sched·Gogo(SB), NOSPLIT, $0-8
...
// to keep running g.
TEXT  runtime∕internal∕sched·Mcall(SB), NOSPLIT, $0-8
	MOVQ	fn+0(FP), DI
...
switch:
	...
	MOVQ	$runtime∕internal∕schedinit·systemstack_switch(SB), BP
	...
	SUBQ	$8, BX
	MOVQ	$runtime∕internal∕sched·Mstart(SB), DX
	MOVQ	DX, 0(BX)
	MOVQ	BX, SP
...
// TODO(matloob): Does this need to be in runtime?	
...
TEXT runtime∕internal∕finalize·Reflectcall(SB), NOSPLIT, $0-24
	MOVLQZX argsize+16(FP), CX
	DISPATCH(runtime∕internal∕core·call16, 16)
	DISPATCH(runtime∕internal∕core·call32, 32)
	DISPATCH(runtime∕internal∕core·call64, 64)
	DISPATCH(runtime∕internal∕core·call128, 128)
	DISPATCH(runtime∕internal∕core·call256, 256)
	DISPATCH(runtime∕internal∕core·call512, 512)
	DISPATCH(runtime∕internal∕core·call1024, 1024)
	DISPATCH(runtime∕internal∕core·call2048, 2048)
	DISPATCH(runtime∕internal∕core·call4096, 4096)
	DISPATCH(runtime∕internal∕core·call8192, 8192)
	DISPATCH(runtime∕internal∕core·call16384, 16384)
	DISPATCH(runtime∕internal∕core·call32768, 32768)
	DISPATCH(runtime∕internal∕core·call65536, 65536)
	DISPATCH(runtime∕internal∕core·call131072, 131072)
	DISPATCH(runtime∕internal∕core·call262144, 262144)
	DISPATCH(runtime∕internal∕core·call524288, 524288)
	DISPATCH(runtime∕internal∕core·call1048576, 1048576)
	DISPATCH(runtime∕internal∕core·call2097152, 2097152)
	DISPATCH(runtime∕internal∕core·call4194304, 4194304)
	DISPATCH(runtime∕internal∕core·call8388608, 8388608)
	DISPATCH(runtime∕internal∕core·call16777216, 16777216)
	DISPATCH(runtime∕internal∕core·call33554432, 33554432)
	DISPATCH(runtime∕internal∕core·call67108864, 67108864)
	DISPATCH(runtime∕internal∕core·call134217728, 134217728)
	DISPATCH(runtime∕internal∕core·call268435456, 268435456)
	DISPATCH(runtime∕internal∕core·call536870912, 536870912)
	DISPATCH(runtime∕internal∕core·call1073741824, 1073741824)
...
TEXT runtime∕internal∕core·Casuintptr(SB), NOSPLIT, $0-25
	JMP	runtime∕internal∕sched·Cas64(SB)

TEXT runtime∕internal∕core·Atomicloaduintptr(SB), NOSPLIT, $0-16
	JMP	runtime∕internal∕sched·Atomicload64(SB)

TEXT runtime∕internal∕channels·atomicloaduint(SB), NOSPLIT, $0-16
	JMP	runtime∕internal∕sched·Atomicload64(SB)

TEXT runtime∕internal∕core·atomicstoreuintptr(SB), NOSPLIT, $0-16
	JMP	runtime∕internal∕sched·Atomicstore64(SB)
...
TEXT runtime∕internal∕netpoll·xchguintptr(SB), NOSPLIT, $0-24
	JMP	runtime∕internal∕sched·Xchg64(SB)
...
TEXT runtime∕internal∕schedinit·Jmpdefer(SB), NOSPLIT, $0-16
	MOVQ	fv+0(FP), DX	// fn
...
TEXT runtime∕internal∕cgo·asmcgocall_errno(SB),NOSPLIT,$0-20
	MOVQ	fn+0(FP), AX
	MOVQ	arg+8(FP), BX
	CALL	asmcgocall<>(SB)
	MOVL	AX, ret+16(FP)
...
needm:
	MOVQ	$0, 0(SP)
	MOVQ	$runtime∕internal∕core·needm(SB), AX
	CALL	AX
	MOVQ	0(SP), R8
	get_tls(CX)
	MOVQ	g(CX), BP
...
TEXT runtime∕internal∕lock·Getcallerpc(SB),NOSPLIT,$0-16
...
TEXT runtime∕internal∕channels·setcallerpc(SB),NOSPLIT,$0-16
	MOVQ	argp+0(FP),AX		// addr of first arg
	MOVQ	pc+8(FP), BX
...
TEXT runtime∕internal∕hash·aeshash(SB),NOSPLIT,$0-32
	MOVQ	p+0(FP), AX	// ptr to data
	MOVQ	s+8(FP), CX	// size
	JMP	runtime·aeshashbody(SB)

TEXT runtime∕internal∕hash·aeshashstr(SB),NOSPLIT,$0-32
...
aes65to128:
	...
	AESENC	runtime∕internal∕hash·aeskeysched+32(SB), X2
	AESENC	runtime∕internal∕hash·aeskeysched+48(SB), X3
	AESENC	runtime∕internal∕hash·aeskeysched+64(SB), X4
	AESENC	runtime∕internal∕hash·aeskeysched+80(SB), X5
	AESENC	runtime∕internal∕hash·aeskeysched+96(SB), X8
	AESENC	runtime∕internal∕hash·aeskeysched+112(SB), X9
	AESENC	X7, X0
	AESENC	X7, X1
	AESENC	X7, X2
	AESENC	X7, X3
...
TEXT runtime∕internal∕hash·aeshash32(SB),NOSPLIT,$0-32
	MOVQ	p+0(FP), AX	// ptr to data
...
TEXT runtime∕internal∕hash·aeshash64(SB),NOSPLIT,$0-32
	MOVQ	p+0(FP), AX	// ptr to data
...
TEXT runtime∕internal∕hash·Memeq(SB),NOSPLIT,$0-25
	MOVQ	a+0(FP), SI
	MOVQ	b+8(FP), DI
	MOVQ	size+16(FP), BX
...
// equivalent Go code.
TEXT runtime∕internal∕core·eqstring(SB),NOSPLIT,$0-33
	MOVQ	s1len+8(FP), AX
	MOVQ	s2len+24(FP), BX
	CMPQ	AX, BX
	JNE	noteq
...
TEXT runtime∕internal∕core·cmpstring(SB),NOSPLIT,$0-40
...
TEXT runtime∕internal∕core·Getg(SB),NOSPLIT,$0-8
	get_tls(CX)
	MOVQ	g(CX), AX
	MOVQ	AX, ret+0(FP)
	RET
