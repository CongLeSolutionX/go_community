...
switch:
	...
	MOVQ	$runtime∕internal∕schedinit·systemstack_switch(SB), SI
...
TEXT runtime∕internal∕finalize·Reflectcall(SB), NOSPLIT, $0-32
...
TEXT runtime∕internal∕sched·aeshash(SB),NOSPLIT,$0-32
	MOVQ	p+0(FP), AX	// Ptr to Data
	MOVQ	s+16(FP), CX	// size
	LEAQ	ret+24(FP), DX
	JMP	runtime·aeshashbody(SB)

TEXT runtime∕internal∕hash·aeshashstr(SB),NOSPLIT,$0-24
...
TEXT runtime∕internal∕hash·aeshash32(SB),NOSPLIT,$0-24
	MOVQ	p+0(FP), AX	// Ptr to Data
	MOVQ	h+8(FP), X0	// seed
	PINSRD	$2, (AX), X0	// Data
...
TEXT runtime∕internal∕hash·aeshash64(SB),NOSPLIT,$0-24
	MOVQ	p+0(FP), AX	// Ptr to Data
	MOVQ	h+8(FP), X0	// seed
	PINSRQ	$1, (AX), X0	// Data
	AESENC	runtime∕internal∕hash·aeskeysched+0(SB), X0
