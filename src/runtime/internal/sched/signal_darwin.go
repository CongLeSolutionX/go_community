...
var Sigtable = [...]SigTabT{
	...
	/* 4 */ {SigThrow, "SIGILL: illegal instruction"},
	/* 5 */ {SigThrow, "SIGTRAP: trace trap"},
	/* 6 */ {SigNotify + SigThrow, "SIGABRT: abort"},
	/* 7 */ {SigThrow, "SIGEMT: emulate instruction executed"},
	/* 8 */ {SigPanic, "SIGFPE: floating-point exception"},
	/* 9 */ {0, "SIGKILL: kill"},
	/* 10 */ {SigPanic, "SIGBUS: bus error"},
	/* 11 */ {SigPanic, "SIGSEGV: segmentation violation"},
	...
	/* 20 */ {SigNotify, "SIGCHLD: child status has changed"},
	...
	/* 27 */ {SigNotify, "SIGPROF: profiling alarm clock"},
