...
retry:
	...
	if n < 0 {
		// TODO(panjf2000): ignore the ETIMEDOUT error for now,
		// but try to dive deep and figure out what really happened
		// with n == ETIMEOUT, see https://go.dev/issue/59679 for details.
