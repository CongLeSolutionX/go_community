...
func init() {
	register("CoroCgoIterCallback", func() { CoroCgo(callerExhaust, iterCallback) })
	register("CoroCgoIterCallbackYield", func() { CoroCgo(callerExhaust, iterCallbackYield) })
	register("CoroCgoCallback", func() { CoroCgo(callerExhaustCallback, iterSimple) })
	register("CoroCgoCallbackIterNested", func() { CoroCgo(callerExhaustCallback, iterNested) })
	register("CoroCgoCallbackIterCallback", func() { CoroCgo(callerExhaustCallback, iterCallback) })
	register("CoroCgoCallbackIterCallbackYield", func() { CoroCgo(callerExhaustCallback, iterCallbackYield) })
	register("CoroCgoCallbackAfterPull", func() { CoroCgo(callerCallbackAfterPull, iterSimple) })
	register("CoroCgoStopCallback", func() { CoroCgo(callerStopCallback, iterSimple) })
	register("CoroCgoStopCallbackIterNested", func() { CoroCgo(callerStopCallback, iterNested) })
}
