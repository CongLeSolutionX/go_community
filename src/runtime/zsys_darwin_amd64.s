...
TEXT runtime·exit(SB),NOSPLIT,$0-4
	MOVQ	$(0x2000000+SYS_exit), AX
	MOVL	code+0(FP), DI
	SYSCALL
	MOVL	$0xf1, 0xf1

TEXT runtime·setitimer(SB),NOSPLIT,$0-24
	MOVQ	$(0x2000000+SYS_setitimer), AX
	MOVL	mode+0(FP), DI
	MOVQ	new+8(FP), SI
	MOVQ	old+16(FP), DX
	SYSCALL
...
TEXT runtime·sigprocmask(SB),NOSPLIT,$0-24
	MOVQ	$(0x2000000+SYS___pthread_sigmask), AX
	MOVL	how+0(FP), DI
	MOVQ	new+8(FP), SI
	MOVQ	old+16(FP), DX
	SYSCALL
...
TEXT runtime·sigaction(SB),NOSPLIT,$0-24
	MOVQ	$(0x2000000+SYS_sigaction), AX
	MOVL	mode+0(FP), DI
	MOVQ	new+8(FP), SI
	MOVQ	old+16(FP), DX
	SYSCALL
...
TEXT runtime·sigaltstack(SB),NOSPLIT,$0-16
	MOVQ	$(0x2000000+SYS_sigaltstack), AX
	MOVQ	new+0(FP), DI
	MOVQ	old+8(FP), SI
	SYSCALL
	JCC	2(PC)
...
TEXT runtime·kevent(SB),NOSPLIT,$0-52
	MOVQ	$(0x2000000+SYS_kevent), AX
	MOVL	kq+0(FP), DI
	MOVQ	ch+8(FP), SI
	MOVL	nch+16(FP), DX
	MOVQ	ev+24(FP), R10
