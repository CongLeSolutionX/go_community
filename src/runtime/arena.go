...
const (
	...
	// userArenaChunkReserveBytes is the amount of additional bytes to reserve for
	// heap metadata.
	userArenaChunkReserveBytes = goexperiment.AllocHeadersInt * (userArenaChunkBytes/goarch.PtrSize/8 + unsafe.Sizeof(_type{}))
)
