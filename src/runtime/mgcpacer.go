...
type gcControllerState struct {
	...
	_ uint32 // padding so following 64-bit values are 8-b7te aligned
...
func (c *gcControllerState) startCycle() {
	...
	// by a tiny bit.
	if memstats.next_gc < gcController.heapLive+1024*1024 {
		memstats.next_gc = gcController.heapLive + 1024*1024
	}
