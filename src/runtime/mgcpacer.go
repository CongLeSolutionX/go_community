...
type gcControllerState struct {
	...
	// commitMinTrigger is the minimum trigger last computed at commit time.
	//
	// There are a few factors to determining the minimum trigger point that
	// must only be computed at commit time, such as giving the sweeper some
	// headroom if, say, gcPercent changes in the middle of a sweep.
	//
	...
	commitMinTrigger atomic.Uint64
