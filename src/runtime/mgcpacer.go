...
// by the application.
func (c *gcControllerState) endCycle(now int64, procs int, userForced bool, heapGoal uint64) {
...
// heapGoal returns the current heap goal. If the memory limit applies,
// this number is a function of heapAlloc and mappedReady, otherwise
...
// trigger returns the current point at which a GC should trigger from
// the current heap goal. goal must be a recent result of calling heapGoal.
//
...
func (c *gcControllerState) trigger(goal uint64) uint64 {
