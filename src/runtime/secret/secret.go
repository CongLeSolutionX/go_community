...
// implemented in assembly, for testing.
...
// Load the contents of memory at addr.
// This is in assembly to hide the cast back to a real pointer
// from things like the checkptr pass.
