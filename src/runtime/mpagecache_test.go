	...
	tests := map[string]struct {
		...
		"ManyArena": {
			before: map[int][]BitRange{
				...
				BaseChunkIdx + 2: {{0, MallocChunkPages - 64}},
			},
			scav: map[int][]BitRange{
				BaseChunkIdx:     {{0, MallocChunkPages}},
				BaseChunkIdx + 1: {{0, MallocChunkPages}},
			...
			hits: []PageCache{
				NewPageCache(PageBase(BaseChunkIdx+2, MallocChunkPages-64), ^uint64(0), 0),
			},
			after: map[int][]BitRange{
				BaseChunkIdx:     {{0, MallocChunkPages}},
				BaseChunkIdx + 1: {{0, MallocChunkPages}},
		...
		"NotContiguous": {
			...
			hits: []PageCache{
				NewPageCache(PageBase(BaseChunkIdx+0xff, 0), ^uint64(0), SetConsecBits64(0, 31, 33)),
			},
			after: map[int][]BitRange{
				BaseChunkIdx:        {{0, MallocChunkPages}},
		...
		"First": {
			...
			hits: []PageCache{
				...
				NewPageCache(PageBase(BaseChunkIdx, 64), SetConsecBits64(0, 0, 32), SetConsecBits64(0, 2, 2)),
			},
			after: map[int][]BitRange{
				BaseChunkIdx: {{0, 128}},
			},
