...
func TestCallersDeferNilFuncPanicWithLoop(t *testing.T) {
	state := 1
	// TODO(mdempsky): Why does runDefers appear in the stack trace now,
	// but deferreturn no longer does?
	want := []string{"runtime.Callers", "runtime_test.TestCallersDeferNilFuncPanicWithLoop.func1",
		"runtime.gopanic", "runtime.panicmem", "runtime.sigpanic", "runtime.runDefers", "runtime_test.TestCallersDeferNilFuncPanicWithLoop"}
