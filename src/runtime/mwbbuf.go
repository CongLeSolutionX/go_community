...
// assembly and doesn't clobber any registers, so it doesn't have the
// usual overheads of a Go call.
//
...
func wbBufFlush1(_p_ *p) {
	...
	for _, ptr := range ptrs {
		if ptr == 0 {
			// This is very common, especially for the
			// "old" values.
			//
			// TODO: Should we filter these in the fast
