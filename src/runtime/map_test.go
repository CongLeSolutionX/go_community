...
var mapBucketTests = [...]struct {
	...
	{bs, 1, 1},
	{bs + 1, 2, 2},
	{bs * 12 / 8, 2, 2},     // 1.5 bs = 2 buckets @ 75%
	{bs*13/8 + 1, 4, 4},     // 13/8 bs + 1 == overflow to 4
	{2 * bs * 12 / 8, 4, 4}, // 3 bs = 4 buckets @75%
	{bs*13/4 + 1, 8, 8},     // 13/4 bs + 1 = overflow to 8
	{4 * bs * 12 / 8, 8, 8}, // 6 bs = 8 buckets @ 75%
	{bs*13/2 + 1, 16, 16},   // 13/2 bs + 1 = overflow to 16
}
