...
// sigRecvFixup is used to temporarily wake up the signal_recv()
// running thread while it is blocked waiting for the arrival of a
// signal. If it causes the thread to wake up, the sig.state travels
// through this sequence: sigReceiving -> sigFixup -> sigIdle ->
// sigReceiving and resumes. (This is only called while GC is
// disabled.)
//
//go:nosplit
func sigRecvFixup() {
