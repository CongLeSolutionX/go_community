...
func (p *cpuProfile) add(gp *g, stk []uintptr) {
	...
	if prof.hz != 0 { // implies cpu.log != nil
...
// The 'extra' buf should be able to hold at least a few
// seconds of profiling events; hopefully Go gets the
// profiling signal at least every few seconds.
