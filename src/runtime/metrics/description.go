...
var allDesc = []Description{
	{
		Name:        "/cgo/calls:calls",
		Description: "Count of cgo calls made by the current process.",
		Kind:        KindUint64,
		Cumulative:  true,
	},
	{
		Name: "/cpu/classes/gc/assist:cpu-seconds",
	...
	{
		Name: "/cpu/classes/gc/dedicated:cpu-seconds",
	...
	{
		Name: "/cpu/classes/gc/idle:cpu-seconds",
		Description: "Estimated total CPU time spent performing GC tasks on " +
	...
	{
		Name: "/cpu/classes/other:cpu-seconds",
		Description: "Estimated total CPU time spent on tasks not explicitly " +
	...
	},
	{
		...
		Description: "Estimated total CPU time used by this process. " +
			"This metric is an overestimate, and not directly comparable to " +
			"system CPU time measurements. Compare only with other /cpu/classes " +
	...
	{
		Name: "/gc/cpu/limiter-overflow:cpu-seconds",
		Description: "Total GC CPU time that exceeded the limiter's threshold. " +
			"A non-zero rate-of-change of this value indicates that the fraction of CPU time " +
			"used by the GC persistently exceeded a reasonable threshold, so the GC was limited " +
			"at the expense of using more memory. This value is useful in determining the cause of " +
			"an out-of-memory error, as it may point to excessive allocation rendering the GC unable " +
			"to keep up without effectively stalling the program.",
		Kind:       KindUint64,
		Cumulative: true,
	},
	{
