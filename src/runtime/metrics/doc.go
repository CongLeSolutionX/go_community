...
Below is the full list of supported metrics, ordered lexicographically.
	...
	/cgo/calls:calls
		Count of cgo calls made by the current process.

	/cpu/classes/gc/assist:cpu-seconds
	...
	/cpu/classes/gc/dedicated:cpu-seconds
	...
	/cpu/classes/gc/idle:cpu-seconds
		Estimated total CPU time spent performing GC tasks on
	...
	/cpu/classes/other:cpu-seconds
		Estimated total CPU time spent on tasks not explicitly
		specified by a metric in /cpu/classes.
		This metric is an overestimate, and not directly comparable to
		system CPU time measurements. Compare only with other /cpu/classes
		metrics.
	...
	/cpu/classes/total:cpu-seconds
		Estimated total CPU time used by this process.
		This metric is an overestimate, and not directly comparable to
		system CPU time measurements. Compare only with other /cpu/classes
		metrics. Sum of all metrics in /cpu/classes.

	/gc/cpu/limiter-overflow:cpu-seconds
		Total GC CPU time that exceeded the limiter's threshold.
		A non-zero rate-of-change of this value indicates that the fraction
		of CPU time used by the GC persistently exceeded a reasonable
		threshold, so the GC was limited at the expense of using more memory.
		This value is useful in determining the cause of an out-of-memory error,
		as it may point to excessive allocation rendering the GC unable to keep
		up without effectively stalling the program.
