...
var sigtable = [...]sigTabT{
	...
	/* 7 */ {_SigPanic + _SigUnblock + _SigFatalDFL, "SIGBUS: bus error"},
	/* 8 */ {_SigPanic + _SigUnblock + _SigFatalDFL, "SIGFPE: floating-point exception"},
	/* 9 */ {0, "SIGKILL: kill"},
	/* 10 */ {_SigNotify + _SigFatalDFL, "SIGUSR1: user-defined signal 1"},
	/* 11 */ {_SigPanic + _SigUnblock + _SigFatalDFL, "SIGSEGV: segmentation violation"},
	/* 12 */ {_SigNotify + _SigFatalDFL, "SIGUSR2: user-defined signal 2"},
	...
	/* 16 */ {_SigThrow + _SigUnblock + _SigFatalDFL, "SIGSTKFLT: stack fault"},
	...
	/* 29 */ {_SigNotify + _SigFatalDFL, "SIGIO: i/o now possible"},
	/* 30 */ {_SigNotify + _SigFatalDFL, "SIGPWR: power failure restart"},
	/* 31 */ {_SigNotify + _SigFatalDFL, "SIGSYS: bad system call"},
