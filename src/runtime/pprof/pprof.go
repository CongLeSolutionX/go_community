...
func printCountCycleProfile(w io.Writer, countName, cycleName string, records []runtime.BlockProfileRecord) error {
	...
	for _, r := range records {
		...
		locs = b.appendLocsForStack(locs[:0], runtime_StackRecord_stack(&r.StackRecord, pcbuf))
...
func (p *runtimeProfile) Stack(dst []uintptr, i int) []uintptr {
	return runtime_StackRecord_stack(&p.stk[i], dst)
}
...
//go:linkname runtime_MemProfileRecord_stack runtime.(*MemProfileRecord).stack
func runtime_MemProfileRecord_stack(r *runtime.MemProfileRecord, stk []uintptr) []uintptr

//go:linkname runtime_StackRecord_stack runtime.(*StackRecord).stack
func runtime_StackRecord_stack(r *runtime.StackRecord, stk []uintptr) []uintptr

//go:linkname runtime_makeProfStack runtime.makeProfStack
