...
func runtime_copyMemProfileRecordStack(r *runtime.MemProfileRecord, stk []uintptr) []uintptr
func runtime_copyStackRecordStack(r *runtime.StackRecord, stk []uintptr) []uintptr
