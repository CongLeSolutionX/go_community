...
func TestCPUProfile(t *testing.T) {
	testCPUProfile(t, []string{"runtime/pprof.cpuHog1"}, avoidFunctions(), func(dur time.Duration) {
...
func TestCPUProfileMultithreaded(t *testing.T) {
	...
	testCPUProfile(t, []string{"runtime/pprof.cpuHog1", "runtime/pprof.cpuHog2"}, avoidFunctions(), func(dur time.Duration) {
		c := make(chan int)
		go func() {
			cpuHogger(cpuHog1, &salt1, dur)
			c <- 1
...
func TestCPUProfileInlining(t *testing.T) {
	testCPUProfile(t, []string{"runtime/pprof.inlinedCallee", "runtime/pprof.inlinedCaller"}, avoidFunctions(), func(dur time.Duration) {
...
func TestCPUProfileLabel(t *testing.T) {
	testCPUProfile(t, []string{"runtime/pprof.cpuHogger;key=value"}, avoidFunctions(), func(dur time.Duration) {
