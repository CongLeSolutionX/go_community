...
func TestCPUProfileMultithreadMagnitude(t *testing.T) {
	...
	// request a GC twice: first to be sure that any cycle that had already
	// started has come to an end, and a second time to force any resulting
	// sweep work to complete.
