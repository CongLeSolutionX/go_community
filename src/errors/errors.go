...
// returns w.
//
// Use the Unwrap function to get wrapped errors. It calls the Unwrap method once on
// its argument, if the argument's type has an Unwrap method. Otherwise, it returns
// nil.
//
