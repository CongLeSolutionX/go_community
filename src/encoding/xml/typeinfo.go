...
// Parameter is using reflection package and panics on invalid case. As a consequence, you need to check if
//  value is available before calling .value. Impossible to fix here except by getting rid of it.
