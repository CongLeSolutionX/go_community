...
var unmarshalTests = []unmarshalTest{
	...
	{in: `{"x": 1}`, ptr: new(tx), err: &UnmarshalExtraKeysError{Keys: []string{"x"}}, allFields: boolPtr(true)},
	...
	{in: `{"Y": 1, "Z": 2}`, ptr: new(T), err: &UnmarshalExtraKeysError{Keys: []string{"Z"}}, allFields: boolPtr(true)},
	...
	{in: `{"alpha": "abc", "alphabet": "xyz"}`, ptr: new(U), err: &UnmarshalExtraKeysError{Keys: []string{"alphabet"}}, allFields: boolPtr(true)},
	{in: `{"alpha": "abc"}`, ptr: new(U), out: U{Alphabet: "abc"}, allFields: boolPtr(true)},
	{in: `{"alphabet": "xyz"}`, ptr: new(U), err: &UnmarshalExtraKeysError{Keys: []string{"alphabet"}}, allFields: boolPtr(true)},
