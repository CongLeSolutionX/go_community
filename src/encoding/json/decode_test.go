...
var unmarshalTests = []unmarshalTest{
	...
	// syntax errors
	{in: `{"X": "foo", "Y"}`, err: &SyntaxError{"json: invalid character '}' after object key", 17}},
	{in: `[1, 2, 3+]`, err: &SyntaxError{"json: invalid character '+' after array element", 9}},
	{in: `{"X":12x}`, err: &SyntaxError{"json: invalid character 'x' after object key:value pair", 8}, useNumber: true},
	{in: `[2, 3`, err: &SyntaxError{msg: "json: unexpected end of JSON input", Offset: 5}},

	// raw value errors
	{in: "\x01 42", err: &SyntaxError{"json: invalid character '\\x01' looking for beginning of value", 1}},
	{in: " 42 \x01", err: &SyntaxError{"json: invalid character '\\x01' after top-level value", 5}},
	{in: "\x01 true", err: &SyntaxError{"json: invalid character '\\x01' looking for beginning of value", 1}},
	{in: " false \x01", err: &SyntaxError{"json: invalid character '\\x01' after top-level value", 8}},
	{in: "\x01 1.2", err: &SyntaxError{"json: invalid character '\\x01' looking for beginning of value", 1}},
	{in: " 3.4 \x01", err: &SyntaxError{"json: invalid character '\\x01' after top-level value", 6}},
	{in: "\x01 \"string\"", err: &SyntaxError{"json: invalid character '\\x01' looking for beginning of value", 1}},
	{in: " \"string\" \x01", err: &SyntaxError{"json: invalid character '\\x01' after top-level value", 11}},
