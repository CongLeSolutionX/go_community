...
func (d *decoder) Read(p []byte) (n int, err error) {
	...
	// Handle the buffer as last fragment without padding in case the total size
	// was smaller than 4 bytes or the buffer size is not a multiple of 4 and
	// NoPadding is used. If NoPadding is used, it might be valid data,
	// if not, just omit the data and continue.
