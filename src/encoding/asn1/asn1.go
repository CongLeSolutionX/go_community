...
//
// Any bytes left from b that were not parsed while filling val will be
// returned in rest. When parsing a SEQUENCE into a struct any trailing
// elements of the SEQUENCE that do not have matching fields in val will
// not be included in rest, as these are considered valid elements of the
// SEQUENCE and not trailing data.
//
