...
type Reader struct {
	...
	// Lines beginning with the Comment character without any preceding
	// whitespace are ignored. With leading whitespace the Comment character
	// becomes part of the field, even if TrimLeadingSpace is true.
	Comment rune
