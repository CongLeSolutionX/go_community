...
func TestExec(t *testing.T) {
	...
	execTests := []execTest{
		...
		// Invalid conversions:
		{[]interface{}{"Brad", int64(0xFFFFFFFF)}, "sql: converting argument $2 type: value 4294967295 overflows int32"},
		{[]interface{}{"Brad", "strconv fail"}, `sql: converting argument $2 type: value "strconv fail" can't be converted to int32`},
