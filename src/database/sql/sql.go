...
func (t dsnConnector) Connect() (driver.Conn, error) {
...
// OpenDB opens a database using a Connector which provides a method for creating
// driver.Conn, and the underlying driver.
//
