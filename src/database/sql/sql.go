...
func (db *DB) prepare(ctx context.Context, query string, strategy connReuseStrategy) (*Stmt, error) {
	...
	return db.prepareDC(ctx, query, dc, dc.releaseConn)
}

func (db *DB) prepareDC(ctx context.Context, query string, dc *driverConn, release func(error)) (*Stmt, error) {
	var ds *driverStmt
	var err error
	defer func() {
		release(err)
...
func (db *DB) begin(ctx context.Context, opts *TxOptions, strategy connReuseStrategy) (tx *Tx, err error) {
	...
	return db.beginDC(ctx, opts, dc, dc.releaseConn)
}

// beginDC starts a transaction and assumes a driverConn has been obtained and is
// ready to be used.
func (db *DB) beginDC(ctx context.Context, opts *TxOptions, dc *driverConn, release func(error)) (tx *Tx, err error) {
	var txi driver.Tx
	withLock(dc, func() {
