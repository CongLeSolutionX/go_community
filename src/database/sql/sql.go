...
//
// If an argument has type a type implementing the Scanner interface,
// any error returned from its Scan method will be wrapped in the
// returned error.
// This behavior is implemented in Go 1.16.
