...
func Example_openDBCLI() {
	...
	signal.Notify(appSignal, os.Kill)
	...
	// Check if the DSN provided by the user is valid. If not valid,
	// the only option left is to exit.
	...
	// Now that we know the DSN is valid, attempt to run the query.
	var name string
