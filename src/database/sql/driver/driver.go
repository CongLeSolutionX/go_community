...
// Out is a standard type to check for in the NamedValueChecker. It should
// expect a pointer to a value in Value and store the pointer internally
// until it receives the ouput value it should assign to it.
type Out struct {
	Value Value
}
