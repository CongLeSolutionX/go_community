...
var ErrSkipNamedValue = errors.New("driver: skip NamedValue as it wasn't passed")
...
//
// If ErrSkipNamedValue is returned, the NamedValue will not be included in
// the final query arguments. If ErrSkip is returned the entire interface
// will not be used for any arguments and the ColumnConverter is used instead.
